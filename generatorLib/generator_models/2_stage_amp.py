...
class _SingleEndedOPAmp(StickDiagram._StickDiagram):
    ...
    def _CalculateDesignParameter(self,
        ...
        _tmpPbodyMet1XWidth = max(self._DesignParameter['NCAP']['_DesignObj']._DesignParameter['NWELL']['_XWidth'], self._DesignParameter['RES']['_DesignObj']._DesignParameter['_PRESLayer']['_XWidth'] + 2 * PRESspace)
        ...
        if P1_Finger + P2_Finger < N1_Finger + N3_Finger:
            if abs(P1_Finger + P2_Finger - (N1_Finger + N3_Finger)) == 1:
                tmpP2Dummy_Finger = 1
                tmpN1Dummy_Finger = 0
            else:
                tmpP2Dummy_Finger = N1_Finger + N3_Finger - (P1_Finger + P2_Finger) - 1
                tmpN1Dummy_Finger = 0
        else:
            if abs(P1_Finger + P2_Finger - (N1_Finger + N3_Finger)) == 1:
                tmpP2Dummy_Finger = 0
                ...
                tmpP2Dummy_Finger = 0
                tmpN1Dummy_Finger = P1_Finger + P2_Finger - (N1_Finger + N3_Finger) - 1
        if P0_Finger + P3_Finger < N0_Finger + N4_Finger:
            if abs(P0_Finger + P3_Finger - (N0_Finger + N4_Finger)) == 1:
                tmpP0Dummy_Finger = 1
                tmpN0Dummy_Finger = 0
            else:
                tmpP0Dummy_Finger = N0_Finger + N4_Finger - (P0_Finger + P3_Finger) - 1
                tmpN0Dummy_Finger = 0
        else:
            if abs(P0_Finger + P3_Finger - (N0_Finger + N4_Finger)) == 1:
                tmpP0Dummy_Finger = 0
                ...
                tmpP0Dummy_Finger = 0
                tmpN0Dummy_Finger = P0_Finger + P3_Finger - (N0_Finger + N4_Finger) - 1


        # find maximum X width of elements (MOS vs CAP / RES / Pbodycontact)
        MOS_total_width = (P0_Finger + P1_Finger + P2_Finger + P3_Finger + tmpP0Dummy_Finger + tmpP1Dummy_Finger + tmpP2Dummy_Finger + 7) * UnitPitch + ChannelLength + _DRCObj._MetalxMinSpace41 * 2
        if _GuardringPPEnclosure + _DRCObj._PpMinSpacetoPRES > _DRCObj._RXMinSpacetoPRES:
            CapRes_total_width = abs(self.getYWidth('NCAP', 'NWELL') + _GuardringThickness + tmpGRPPEnclosure * 2 + self.getYWidth('RES', '_PRESLayer')) + _DRCObj._PpMinSpacetoPRES * 2
        else:
            CapRes_total_width = abs(self.getYWidth('NCAP', 'NWELL') + _GuardringThickness + tmpGRPPEnclosure * 2 - _GuardringPPEnclosure * 2 + self.getYWidth('RES', '_PRESLayer')) + _DRCObj._RXMinSpacetoPRES * 2
        ...
        if Max_XWidth == CapRes_total_width:
            ...
            if N1Dummy_Finger == 0:
                ...
                N0Dummy_Finger += (N1_Finger + N1Dummy_Finger + N3_Finger) - (N0_Finger + N0Dummy_Finger + N4_Finger)
                P0Dummy_Finger += (P1_Finger + P2Dummy_Finger + P2_Finger) - (P0_Finger + P0Dummy_Finger + P3_Finger)
            if P2Dummy_Finger == 0:
                P2Dummy_Finger += 1
            ...
            if N0Dummy_Finger == 0:
                ...
                N1Dummy_Finger += (N0_Finger + N0Dummy_Finger + N4_Finger) - (N1_Finger + N1Dummy_Finger + N3_Finger)
                P2Dummy_Finger += (P0_Finger + P0Dummy_Finger + P3_Finger) - (P1_Finger + P2Dummy_Finger + P2_Finger)
            if P0Dummy_Finger == 0:
                P0Dummy_Finger += 1
        ...
        # Guardring for NMOS
        NMOSringXWidth = max((abs(self.getXYRight('N3', '_PODummyLayer')[0][0] - self.getXYLeft('N4', '_PODummyLayer')[-1][0]) + _DRCObj._MetalxMinSpace41 * 2), CapRes_total_width + _GuardringPPEnclosure * 2)
        ...
        if Max_XWidth == CapRes_total_width:
            ...
            NewCenter = (self.getXY('N3', '_PODummyLayer')[0][0] + self.getXY('N4', '_PODummyLayer')[-1][0]) / 2

        self._DesignParameter['PSubRing'] = self._SrefElementDeclaration(_Reflect=[0, 0, 0], _Angle=0, _DesignObj=PSubRing_sm.PSubRing(_Name='PSubRingIn{}'.format(_Name)), _XYCoordinates=[])[0]
        ...
        self._DesignParameter['NSubRing'] = self._SrefElementDeclaration(_Reflect=[0, 0, 0], _Angle=0, _DesignObj=NSubRing_sm.NSubRing(_Name='NSubRingIn{}'.format(_Name)), _XYCoordinates=[])[0]
        ...
        NCAPRXSubringMinEnclosure = abs(abs(self.getXYBot('PSubRing', 'bot', '_Met1Layer')[0][1]) - abs(CapRes_Ycoordinate + self._DesignParameter['NCAP']['_DesignObj'].getXY('Viapoly2Met1V')[-1][0] + self.getXWidth('NCAP', 'Viapoly2Met1V', '_Met1Layer') / 2))
        if NCAPRXSubringMinEnclosure < _DRCObj._PolygateMinEnclosureByNcap:
            ...
            pass
        self._DesignParameter['PSubRing_CapRes'] = self._SrefElementDeclaration(_Reflect=[0, 0, 0], _Angle=0, _DesignObj=PSubRing_sm.PSubRing(_Name='PSubRing_CapResIn{}'.format(_Name)), _XYCoordinates=[])[0]
        ...
        self._DesignParameter['PbodyContact'] = self._SrefElementDeclaration(_Reflect=[0, 0, 0], _Angle=90, _DesignObj=PbodyContact_sm._PbodyContact(_Name='PbodyContactIn{}'.format(_Name)), _XYCoordinates=[])[0]
        ...
        if _GuardringPPEnclosure + _DRCObj._PpMinSpacetoPRES > _DRCObj._RXMinSpacetoPRES:
            self._DesignParameter['RES']['_XYCoordinates'] = [[NewCenter + self._DesignParameter['PSubRing_CapRes']['_DesignObj']._DesignParameter['right']['_XYCoordinates'][0][0]
        ...
        for i in range(0, int(roundReal(N3_Finger / 2, 0))):
            tmp.append([self.getXYTop('N3', '_Met1Layer')[2 * i + 1], [self.getXY('N3', '_Met1Layer')[2*i+1][0], self.getXYBot('PSubRing', 'bot', '_Met1Layer')[0][1]]])
        ...
        for i in range(0, int(roundReal(P2_Finger / 2, 0))):
            tmp.append([self.getXYBot('P2', '_Met1Layer')[2 * i + 1], [self.getXY('P2', '_Met1Layer')[2*i+1][0], self.getXYTop('NSubRing', 'top', '_Met1Layer')[0][1]]])
        ...
        print('********************************************* NCAP Routing *********************************************')
        # RX Metal1 Routing
        self._DesignParameter['_NCAPMet1RXRouting'] = self._PathElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL1'][0], _Datatype=DesignParameters._LayerMapping['METAL1'][1], _Width=NCAP_YWidth / 2, _XYCoordinates=[])
        tmp = []
        ...
        if NCAP_NumofGate >= 2:
            self._DesignParameter['_NCAPMet1PolyRouting'] = self._PathElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL1'][0], _Datatype=DesignParameters._LayerMapping['METAL1'][1], _Width=self.getYWidth('NCAP', 'Viapoly2Met1H', '_Met1Layer'), _XYCoordinates=[])
            tmp = []
        ...
        print('********************************************** VB Routing **********************************************')
        # N4 Gate - Drain (M1)
        self._DesignParameter['_VBMet1Routing'] = self._PathElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL1'][0], _Datatype=DesignParameters._LayerMapping['METAL1'][1], _Width=SDWidth, _XYCoordinates=[])
        tmp = []
        ...
        self._DesignParameter['_VBMet3Routing'] = self._PathElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL3'][0], _Datatype=DesignParameters._LayerMapping['METAL3'][1], _Width=_DRCObj._MetalxMinWidth, _XYCoordinates=[])
        ...
        self._DesignParameter['_VBMet2Routing'] = self._PathElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL2'][0], _Datatype=DesignParameters._LayerMapping['METAL2'][1], _Width=_DRCObj._MetalxMinWidth, _XYCoordinates=[])
        ...
        self._DesignParameter['_P2DMet2Routing'] = self._PathElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL2'][0], _Datatype=DesignParameters._LayerMapping['METAL2'][1], _Width=_DRCObj._MetalxMinWidth, _XYCoordinates=[])
        ...
        self._DesignParameter['_N3DMet2Routing'] = self._PathElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL2'][0], _Datatype=DesignParameters._LayerMapping['METAL2'][1], _Width=_DRCObj._MetalxMinWidth, _XYCoordinates=[])
        ...
        self._DesignParameter['_OUTMet22Met3Via'] = self._SrefElementDeclaration(_Reflect=[0, 0, 0], _Angle=90, _DesignObj=ViaMet22Met3._ViaMet22Met3(_Name='_OUTMet22Met3ViaIn{}'.format(_Name)), _XYCoordinates=[])[0]
        ...
        self._DesignParameter['_OUTMet22Met3Via']['_XYCoordinates'] = [self._DesignParameter['_P2DMet12Met2Via']['_XYCoordinates'][0], self._DesignParameter['_N3DMet12Met2Via']['_XYCoordinates'][0]]

        self._DesignParameter['_OUTMet3Routing'] = self._PathElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL3'][0], _Datatype=DesignParameters._LayerMapping['METAL3'][1], _Width=_DRCObj._MetalxMinWidth, _XYCoordinates=[])
        ...
        self._DesignParameter['PIN_VSS']['_XYCoordinates'] = [[NewCenter + self._DesignParameter['PSubRing']['_DesignObj']._DesignParameter['left']['_XYCoordinates'][0][0], self.getXY('PSubRing', 'top')[0][1]]]
        self._DesignParameter['PIN_VDD']['_XYCoordinates'] = [[NewCenter + self._DesignParameter['NSubRing']['_DesignObj']._DesignParameter['left']['_XYCoordinates'][0][0], self.getXY('NSubRing', 'top')[0][1]]]
...
if __name__ == '__main__':
    ...
    #     _ParallelStripes = 1
    #
    #     # _GuardringCOpitch = random.randrange(100,200,2)
    #     _GuardringCOpitch = 175
    #     _GuardringbyArea = True
    #     _GuardringNumofCO = None
    #     # _GuardringThickness = random.randrange(200,500,2)
    #     _GuardringThickness = 348
    #     _GuardringPPEnclosure = 56
    #     print(f"{i}nd loop")
