...
class DFF(StickDiagram._StickDiagram):
    ...
    def _CalculateDesignParameter(self,
        ...
        # # insert via for q routing(Metal2 minimum area DRC error)
        ...
        # self._DesignParameter['_ViaMet12Met2q']['_XYCoordinates'] = [[self.getXY('INV4', '_PMOS', '_XYCoordinatePMOSOutputRouting')[-1][0] + self.getWidth('INV4', '_OutputRouting') / 2- tmpMet2Width/2, YCoord_iclkb]]
