...
class TG_2X_CRIT_SLVT_v1(StickDiagram._StickDiagram):
	...
	def _CalculateDesignParameter(self,nmos_gate=3,pmos_gate=3,nmos_width=320,pmos_width=584,length=30,XVT='SLVT',vss2nmos=350,vdd2pmos=433,gate_y=860,vss2vdd_height=1800,gate_spacing=100,sdwidth=66,power_xdistance=130, out_even_up_mode=True):
		...
		# 	_XWidth=(self._DesignParameter['slvtpfet_b_CDNS_637732429401_0']['_DesignObj']._DesignParameter['_ODLayer']['_XWidth'] + (2 * drc._PpMinExtensiononPactive)),
		# 	_YWidth=(self._DesignParameter['slvtpfet_b_CDNS_637732429401_0']['_DesignObj']._DesignParameter['_ODLayer']['_YWidth'] + (2 * drc._PpMinExtensiononPactive)))
		# self._DesignParameter['PIMP_boundary_1']['_XYCoordinates'] = [[self._DesignParameter['slvtpfet_b_CDNS_637732429401_0']['_XYCoordinates'][0][0], self._DesignParameter['slvtpfet_b_CDNS_637732429401_0']['_XYCoordinates'][0][1]]]
		self._DesignParameter['vss_pplayer'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['PIMP'][0], _Datatype=DesignParameters._LayerMapping['PIMP'][1], _XWidth=(self._DesignParameter['vss_odlayer']['_XWidth'] + (2 * drc._PpMinExtensiononPactive)), _YWidth=(self._DesignParameter['vss_odlayer']['_YWidth'] + (2 * drc._PpMinExtensiononPactive)))
		self._DesignParameter['vss_pplayer']['_XYCoordinates'] = [[(+ self._DesignParameter['vss_odlayer']['_XYCoordinates'][0][0]), (+ self._DesignParameter['vss_odlayer']['_XYCoordinates'][0][1])]]
	...
	def _CalculateDesignParameter_v2(self, nmgateY=None, pmgateY=None, nmos_gate=3, pmos_gate=3, nmos_width=320, pmos_width=584, length=30, XVT='SLVT', vss2nmos=350, vdd2pmos=433, gate_y=860, vss2vdd_height=1800, gate_spacing=100, sdwidth=66, power_xdistance=130, out_even_up_mode=True):
		...
		ObjNMOS = 'slvtnfet_b_CDNS_637732429400_0'
		ObjPMOS = 'slvtpfet_b_CDNS_637732429401_0'
		...
		yCoord_MinGate = self.getXYTop('slvtnfet_b_CDNS_637732429400_0', '_PODummyLayer')[0][1] + tmpDRC_polyspace + tmpDRC_PolygateMinSpace2Co3 + botCO2CenterPCCOM1
		...
		YCoord_nmos_poly_gate_routing_x = self.getXYTop('slvtnfet_b_CDNS_637732429400_0', '_PODummyLayer')[0][1] + tmpDRC_polyspace + self.getWidth('nmos_poly_gate_routing_x') / 2
		...
		tmpXYs = []
		for XYs in self.getXY('slvtnfet_b_CDNS_637732429400_0', '_POLayer'):
			tmpXYs.append(
		...
		yCoord_MaxGate = self.getXYBot('slvtpfet_b_CDNS_637732429401_0', '_PODummyLayer')[0][1] - tmpDRC_polyspace - tmpDRC_PolygateMinSpace2Co3 - topCO2CenterPCCOM1
		...
		YCoord_pmos_poly_gate_routing_x = self.getXYBot('slvtpfet_b_CDNS_637732429401_0', '_PODummyLayer')[0][1] - tmpDRC_polyspace - self.getWidth('pmos_poly_gate_routing_x') / 2
		...
		tmpXYs = []
		for XYs in self.getXY('slvtpfet_b_CDNS_637732429401_0', '_POLayer'):
			tmpXYs.append(
