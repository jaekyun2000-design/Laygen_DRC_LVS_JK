...
class DFF(StickDiagram._StickDiagram):
    ...
    def _CalculateDesignParameter(self,
        ...
        rightBoundary = self.getXYRight('INV5', 'PbodyContact', '_Met2Layer')[0][0]
        self._DesignParameter['VSSRail_Met2'] = self._BoundaryElementDeclaration(
            ...
            _YWidth=self.getYWidth('INV5', 'PbodyContact', '_Met2Layer'),
            _XYCoordinates=[[(rightBoundary + leftBoundary) / 2, 0]]
        )
        # VSS OD(RX)
        leftBoundary = self.getXYLeft('TG1', 'vss_odlayer')[0][0]
        rightBoundary = self.getXYRight('INV5', 'PbodyContact', '_ODLayer')[0][0]
        self._DesignParameter['VSSRail_OD'] = self._BoundaryElementDeclaration(
            ...
            _XWidth=rightBoundary - leftBoundary,
            _YWidth=self.getYWidth('INV5', 'PbodyContact', '_ODLayer'),
            _XYCoordinates=[[(rightBoundary + leftBoundary) / 2, 0]]
        )
        # VSS PP(BP)
        leftBoundary = self.getXYLeft('TG1', 'vss_pplayer')[0][0]
        rightBoundary = self.getXYRight('INV5', 'PbodyContact', '_PPLayer')[0][0]
        self._DesignParameter['VSSRail_PP'] = self._BoundaryElementDeclaration(
            ...
            _XWidth=rightBoundary - leftBoundary,
            _YWidth=self.getYWidth('INV5', 'PbodyContact', '_PPLayer'),
            _XYCoordinates=[[(rightBoundary + leftBoundary) / 2, 0]]
        )
        ## VDD
        # VDD M2
        leftBoundary = self.getXYLeft('TG1', 'vdd_supply_m2_y')[0][0]
        rightBoundary = self.getXYRight('INV5', 'NbodyContact', '_Met2Layer')[0][0]
        self._DesignParameter['VDDRail_Met2'] = self._BoundaryElementDeclaration(
            _Layer=DesignParameters._LayerMapping['METAL2'][0], _Datatype=DesignParameters._LayerMapping['METAL2'][1],
            _XWidth=rightBoundary - leftBoundary,
            _YWidth=self.getYWidth('INV5', 'NbodyContact', '_Met2Layer'),
            _XYCoordinates=[[(rightBoundary + leftBoundary) / 2, self.getXY('INV5', 'NbodyContact', '_Met2Layer')[0][1]]]
        )
        # VDD OD(RX)
        leftBoundary = self.getXYLeft('TG1', 'vdd_odlayer')[0][0]
        rightBoundary = self.getXYRight('INV5', 'NbodyContact', '_ODLayer')[0][0]
        self._DesignParameter['VDDRail_OD'] = self._BoundaryElementDeclaration(
            _Layer=DesignParameters._LayerMapping['DIFF'][0], _Datatype=DesignParameters._LayerMapping['DIFF'][1],
            _XWidth=rightBoundary - leftBoundary,
            _YWidth=self.getYWidth('INV5', 'NbodyContact', '_ODLayer'),
            _XYCoordinates=[[(rightBoundary + leftBoundary) / 2, self.getXY('INV5', 'NbodyContact', '_ODLayer')[0][1]]]
        )

        # NWLayer
        leftBoundary = self.getXYLeft('TG1', 'NWELL_boundary_0')[0][0]
        rightBoundary = self.getXYRight('INV5', '_NWLayerBoundary')[0][0]
        topBoundary = max(
        ...
        botBoundary = min(
            ...
            self.getXYBot('INV5', '_NWLayerBoundary')[0][1]
        )
        ...
        rightBoundary = self.getXYRight('INV5', '_PMOS', '_PPLayer')[0][0]
        if TSI1_Finger >= 3:
        ...
        rightBoundary = self.getXYRight('INV5', 'XVTLayer')[0][0]
        self._DesignParameter['XVTLayer'] = self._BoundaryElementDeclaration(
            ...
            _XWidth=rightBoundary - leftBoundary,
            _YWidth=self.getYWidth('INV5', 'XVTLayer'),
            _XYCoordinates=[[(rightBoundary + leftBoundary) / 2, self.getXY('INV5', 'XVTLayer')[0][1]]]
        )
        ...
        ###### inv5in to inv4out (added by jwlee)
        if INV5_Finger <= 2:
            inv5input = self.getXYRight('INV5', '_VIAPoly2Met1_F1', '_Met1Layer')[0][0]
        elif INV5_Finger >= 3:
            inv5input = self.getXYRight('INV5', '_VIAMOSPoly2Met1LeftMost', '_Met1Layer')[-1][0]
        self._DesignParameter['_Met2_q'] = self._PathElementDeclaration(
            _Layer=DesignParameters._LayerMapping['METAL2'][0], _Datatype=DesignParameters._LayerMapping['METAL2'][1],
            _Width=tmpMet2Width
        )
        self._DesignParameter['_Met2_q']['_XYCoordinates']=[[[self.getXY('INV4', '_PMOS', '_XYCoordinatePMOSOutputRouting')[-1][0] + self.getWidth('INV4', '_OutputRouting') / 2- tmpMet2Width/2, YCoord_iclkb],
                                                             [inv5input- tmpMet2Width/2, YCoord_iclkb]]]
        ...
        ##### Met1 layer added on via12 ###
        self._DesignParameter['_ViaMet12Met2q_added'] = self._SrefElementDeclaration(_DesignObj=ViaMet12Met2._ViaMet12Met2(_Name='_ViaMet12Met2q_addedIn{}'.format(_Name)))[0]
        self._DesignParameter['_ViaMet12Met2q_added']['_DesignObj']._CalculateDesignParameterSameEnclosure(**dict(_ViaMet12Met2NumberOfCOX=1, _ViaMet12Met2NumberOfCOY=1))
        self._DesignParameter['_ViaMet12Met2q_added']['_DesignObj']._DesignParameter['_Met2Layer']['_YWidth'] = tmpViaMet2Width
        self._DesignParameter['_ViaMet12Met2q_added']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] = tmpViaMet2Width
        self._DesignParameter['_ViaMet12Met2q_added']['_DesignObj']._DesignParameter['_COLayer']['_YWidth'] = tmpVia1YWidth
        self._DesignParameter['_ViaMet12Met2q_added']['_XYCoordinates'] = [[self.getXY('INV4', '_PMOS', '_XYCoordinatePMOSOutputRouting')[-1][0] + self.getWidth('INV4', '_OutputRouting') / 2- tmpMet2Width/2, YCoord_iclkb],[inv5input- tmpMet2Width/2, YCoord_iclkb]]
        ...
        self._DesignParameter['_ViaMet12Met2q']['_XYCoordinates'] = [[self.getXY('INV4', '_PMOS', '_XYCoordinatePMOSOutputRouting')[-1][0] + self.getWidth('INV4', '_OutputRouting') / 2- tmpMet2Width/2, YCoord_iclkb],[inv5input- tmpMet2Width/2, YCoord_iclkb]]
        ...
        self._DesignParameter['_Met1_iclk2']['_XYCoordinates'].append([[self.getXYRight('TG2', 'gate_output', '_Met1Layer')[0][0]-tmpMet2Width / 2, self.getXYTop('_Met2_iclk')[0][1]],
