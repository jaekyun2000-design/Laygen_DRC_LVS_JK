...
from generatorLib.generator_models import vpnp_test_
...
class RandGen:
    ...
    def create_layout(self, params, word='1'):
        ...
        if self.cell_name == 'vpnp_test':
            ...
            vpnp_test = vpnp_test_.vpnp_test(_DesignParameter=None, _Name='vpnp_test')
            ...
            vpnp_test._CalculateDesignParameter(W=params.get('W'))
            # inv._UpdateDesignParameter2GDSStructure(_DesignParameterInDictionary=inv._DesignParameter)
            vpnp_test._UpdateDesignParameter2GDSStructure(_DesignParameterInDictionary=vpnp_test._DesignParameter)
            ...
            with open(f'./vpnp_test/vpnp_test{word}.gds', 'wb') as f:
                gds_stream = vpnp_test._CreateGDSStream(vpnp_test._DesignParameter['_GDSFile']['_GDSFile'])
                gds_stream.write_binary_gds_stream(f)
...
if __name__=="__main__":
    ...
    randgen = RandGen(cell_name='vpnp_test',
                      W=(100, [1100, 22000])
                      )
