...
class RandGen:
    ...
    def create_layout(self, params, word='1'):
        ...
        if self.cell_name == '_2stageamp':
            ...
            _2stageamp = A53_TIA_2stageamp._TIA_2stageamp(_DesignParameter=None, _Name='_2stageamp')
            ...
            _2stageamp._CalculateDesignParameter(
                # PMOS
                _Tr0_PMOSNumberofGate=params.get('_Tr0_PMOSNumberofGate'),
                _Tr0_PMOSChannelWidth=params.get('_Tr0_PMOSChannelWidth'),
                _Tr0_PMOSChannellength=params.get('_Tr0_PMOSChannellength'),
                _Tr0_PMOSGateSpacing=params.get('_Tr0_PMOSGateSpacing'),
                _Tr0_PMOSSDWidth	= params.get('_Tr0_PMOSSDWidth'),
                _Tr0_PMOSXVT			= params.get('_Tr0_PMOSXVT'),
                _Tr0_PMOSPCCrit			= params.get('_Tr0_PMOSPCCrit'),

                # Source_node_ViaM1M2
                _Tr0_PMOSSource_Via_TF= params.get('_Tr0_PMOSSource_Via_TF'),

                # Drain_node_ViaM1M2
                _Tr0_PMOSDrain_Via_TF= params.get('_Tr0_PMOSDrain_Via_TF'),

                # POLY dummy setting
                _Tr0_PMOSDummy= params.get('_Tr0_PMOSDummy')  , # TF
                # if _PMOSDummy == True
                _Tr0_PMOSDummy_length = params.get('_Tr0_PMOSDummy_length'), # None/Value
                _Tr0_PMOSDummy_placement = params.get('_Tr0_PMOSDummy_placement'), # None/Up/Dn/

                # PMOS
                _Tr1_PMOSNumberofGate=params.get('_Tr1_PMOSNumberofGate'),
                _Tr1_PMOSChannelWidth=params.get('_Tr1_PMOSChannelWidth'),
                _Tr1_PMOSChannellength=params.get('_Tr1_PMOSChannellength'),
                _Tr1_PMOSGateSpacing	= params.get('_Tr1_PMOSGateSpacing'),
                _Tr1_PMOSSDWidth			= params.get('_Tr1_PMOSSDWidth'),
                _Tr1_PMOSXVT				= params.get('_Tr1_PMOSXVT'),
                _Tr1_PMOSPCCrit				= params.get('_Tr1_PMOSPCCrit'),

                # Source_node_ViaM1M2
                _Tr1_PMOSSource_Via_TF = params.get('_Tr1_PMOSSource_Via_TF'),

                # Drain_node_ViaM1M2
                _Tr1_PMOSDrain_Via_TF = params.get('_Tr1_PMOSDrain_Via_TF'),

                # POLY dummy setting
                _Tr1_PMOSDummy = params.get('_Tr1_PMOSDummy'), # TF
                # if _PMOSDummy == True
                _Tr1_PMOSDummy_length = params.get('_Tr1_PMOSDummy_length'), # None/Value
                _Tr1_PMOSDummy_placement = params.get('_Tr1_PMOSDummy_placement'), # None/'Up'/'Dn'/

                # PMOS
                _Tr2_PMOSNumberofGate=params.get('_Tr2_PMOSNumberofGate'),
                _Tr2_PMOSChannelWidth=params.get('_Tr2_PMOSChannelWidth'),
                _Tr2_PMOSChannellength=params.get('_Tr2_PMOSChannellength'),
                _Tr2_PMOSGateSpacing	= params.get('_Tr2_PMOSGateSpacing'),
                _Tr2_PMOSSDWidth			= params.get('_Tr2_PMOSSDWidth'),
                _Tr2_PMOSXVT				= params.get('_Tr2_PMOSXVT'),
                _Tr2_PMOSPCCrit				= params.get('_Tr2_PMOSPCCrit'),

                # Source_node_ViaM1M2
                _Tr2_PMOSSource_Via_TF = params.get('_Tr2_PMOSSource_Via_TF'),

                # Drain_node_ViaM1M2
                _Tr2_PMOSDrain_Via_TF = params.get('_Tr2_PMOSDrain_Via_TF'),

                # POLY dummy setting
                _Tr2_PMOSDummy = params.get('_Tr2_PMOSDummy'), # TF
                # if _PMOSDummy == True
                _Tr2_PMOSDummy_length = params.get('_Tr2_PMOSDummy_length'), # None/Value
                _Tr2_PMOSDummy_placement = params.get('_Tr2_PMOSDummy_placement'), # None/Up/Dn/

                # PMOS
                _Tr3_PMOSNumberofGate=params.get('_Tr3_PMOSNumberofGate'),
                _Tr3_PMOSChannelWidth=params.get('_Tr3_PMOSChannelWidth'),
                _Tr3_PMOSChannellength=params.get('_Tr3_PMOSChannellength'),
                _Tr3_PMOSGateSpacing	= params.get('_Tr3_PMOSGateSpacing'),
                _Tr3_PMOSSDWidth			= params.get('_Tr3_PMOSSDWidth'),
                _Tr3_PMOSXVT				= params.get('_Tr3_PMOSXVT'),
                _Tr3_PMOSPCCrit				= params.get('_Tr3_PMOSPCCrit'),

                # Source_node_ViaM1M2
                _Tr3_PMOSSource_Via_TF = params.get('_Tr3_PMOSSource_Via_TF'),

                # Drain_node_ViaM1M2
                _Tr3_PMOSDrain_Via_TF = params.get('_Tr3_PMOSDrain_Via_TF'),

                # POLY dummy setting
                _Tr3_PMOSDummy = params.get('_Tr3_PMOSDummy'), # TF
                # if _PMOSDummy == True
                _Tr3_PMOSDummy_length = params.get('_Tr3_PMOSDummy_length'), # None/Value
                _Tr3_PMOSDummy_placement = params.get('_Tr3_PMOSDummy_placement'), # None/Up/Dn/

                # PMOS
                _Tr4_PMOSNumberofGate	= params.get('_Tr4_PMOSNumberofGate'),
                _Tr4_PMOSChannelWidth	= params.get('_Tr4_PMOSChannelWidth'),
                _Tr4_PMOSChannellength	= params.get('_Tr4_PMOSChannellength'),
                _Tr4_PMOSGateSpacing		= params.get('_Tr4_PMOSGateSpacing'),
                _Tr4_PMOSSDWidth			= params.get('_Tr4_PMOSSDWidth'),
                _Tr4_PMOSXVT				= params.get('_Tr4_PMOSXVT'),
                _Tr4_PMOSPCCrit				= params.get('_Tr4_PMOSPCCrit'),

                # Source_node_ViaM1M2
                _Tr4_PMOSSource_Via_TF = params.get('_Tr4_PMOSSource_Via_TF'),

                # Drain_node_ViaM1M2
                _Tr4_PMOSDrain_Via_TF = params.get('_Tr4_PMOSDrain_Via_TF'),

                # POLY dummy setting
                _Tr4_PMOSDummy = params.get('_Tr4_PMOSDummy'), # TF
                # if _PMOSDummy == True
                _Tr4_PMOSDummy_length = params.get('_Tr4_PMOSDummy_length'), # None/Value
                _Tr4_PMOSDummy_placement = params.get('_Tr4_PMOSDummy_placement'), # None/Up/Dn/

                # NMOS Tr0
                _Tr0_NMOSNumberofGate=params.get('_Tr0_NMOSNumberofGate'),
                _Tr0_NMOSChannelWidth=params.get('_Tr0_NMOSChannelWidth'),
                _Tr0_NMOSChannellength=params.get('_Tr0_NMOSChannellength'),
                _Tr0_NMOSGateSpacing=params.get('_Tr0_NMOSGateSpacing'),
                _Tr0_NMOSSDWidth	= params.get('_Tr0_NMOSSDWidth'),
                _Tr0_NMOSXVT			= params.get('_Tr0_NMOSXVT'),
                _Tr0_NMOSPCCrit			= params.get('_Tr0_NMOSPCCrit'),

                # Source_node_ViaM1M2
                _Tr0_NMOSSource_Via_TF= params.get('_Tr0_NMOSSource_Via_TF'),

                # Drain_node_ViaM1M2
                _Tr0_NMOSDrain_Via_TF= params.get('_Tr0_NMOSDrain_Via_TF'),

                # POLY dummy setting
                _Tr0_NMOSDummy= params.get('_Tr0_NMOSDummy'), # TF
                # if _PMOSDummy == True
                _Tr0_NMOSDummy_length = params.get('_Tr0_NMOSDummy_length'), # None/Value
                _Tr0_NMOSDummy_placement = params.get('_Tr0_NMOSDummy_placement'), # None/'Up'/'Dn'/

                # NMOS Tr0
                _Tr1_NMOSNumberofGate=params.get('_Tr1_NMOSNumberofGate'),
                _Tr1_NMOSChannelWidth=params.get('_Tr1_NMOSChannelWidth'),
                _Tr1_NMOSChannellength=params.get('_Tr1_NMOSChannellength'),
                _Tr1_NMOSGateSpacing	= params.get('_Tr1_NMOSGateSpacing'),
                _Tr1_NMOSSDWidth			= params.get('_Tr1_NMOSSDWidth'),
                _Tr1_NMOSXVT				= params.get('_Tr1_NMOSXVT'),
                _Tr1_NMOSPCCrit				= params.get('_Tr1_NMOSPCCrit'),

                # Source_node_ViaM1M2
                _Tr1_NMOSSource_Via_TF = params.get('_Tr1_NMOSSource_Via_TF'),

                # Drain_node_ViaM1M2
                _Tr1_NMOSDrain_Via_TF = params.get('_Tr1_NMOSDrain_Via_TF'),

                # POLY dummy setting
                _Tr1_NMOSDummy = params.get('_Tr1_NMOSDummy'), # TF
                # if _PMOSDummy == True
                _Tr1_NMOSDummy_length = params.get('_Tr1_NMOSDummy_length'), # None/Value
                _Tr1_NMOSDummy_placement = params.get('_Tr1_NMOSDummy_placement'), # None/'Up'/'Dn'/

                # NMOS
                _Tr2_NMOSNumberofGate=params.get('_Tr2_NMOSNumberofGate'),
                _Tr2_NMOSChannelWidth=params.get('_Tr2_NMOSChannelWidth'),
                _Tr2_NMOSChannellength=params.get('_Tr2_NMOSChannellength'),
                _Tr2_NMOSGateSpacing=params.get('_Tr2_NMOSGateSpacing'),
                _Tr2_NMOSSDWidth	= params.get('_Tr2_NMOSSDWidth'),
                _Tr2_NMOSXVT			= params.get('_Tr2_NMOSXVT'),
                _Tr2_NMOSPCCrit			= params.get('_Tr2_NMOSPCCrit'),

                # Source_node_ViaM1M2
                _Tr2_NMOSSource_Via_TF= params.get('_Tr2_NMOSSource_Via_TF'),

                # Drain_node_ViaM1M2
                _Tr2_NMOSDrain_Via_TF= params.get('_Tr2_NMOSDrain_Via_TF'),

                # POLY dummy setting
                _Tr2_NMOSDummy= params.get('_Tr2_NMOSDummy'), # TF
                # if _PMOSDummy == True
                _Tr2_NMOSDummy_length = params.get('_Tr2_NMOSDummy_length'), # None/Value
                _Tr2_NMOSDummy_placement = params.get('_Tr2_NMOSDummy_placement'), # None/'Up'/'Dn'/

                # NMOS
                _Tr3_NMOSNumberofGate=params.get('_Tr3_NMOSNumberofGate'),
                _Tr3_NMOSChannelWidth=params.get('_Tr3_NMOSChannelWidth'),
                _Tr3_NMOSChannellength=params.get('_Tr3_NMOSChannellength'),
                _Tr3_NMOSGateSpacing	= params.get('_Tr3_NMOSGateSpacing'),
                _Tr3_NMOSSDWidth			= params.get('_Tr3_NMOSSDWidth'),
                _Tr3_NMOSXVT				= params.get('_Tr3_NMOSXVT'),
                _Tr3_NMOSPCCrit				= params.get('_Tr3_NMOSPCCrit'),

                # Source_node_ViaM1M2
                _Tr3_NMOSSource_Via_TF = params.get('_Tr3_NMOSSource_Via_TF'),

                # Drain_node_ViaM1M2
                _Tr3_NMOSDrain_Via_TF = params.get('_Tr3_NMOSDrain_Via_TF'),

                # POLY dummy setting
                _Tr3_NMOSDummy = params.get('_Tr3_NMOSDummy'), # TF
                # if _PMOSDummy == True
                _Tr3_NMOSDummy_length = params.get('_Tr3_NMOSDummy_length'), # None/Value
                _Tr3_NMOSDummy_placement = params.get('_Tr3_NMOSDummy_placement'), # None/'Up'/'Dn'/

                # NMOS Tr0
                _Tr4_NMOSNumberofGate=params.get('_Tr4_NMOSNumberofGate'),
                _Tr4_NMOSChannelWidth=params.get('_Tr4_NMOSChannelWidth'),
                _Tr4_NMOSChannellength=params.get('_Tr4_NMOSChannellength'),
                _Tr4_NMOSGateSpacing	= params.get('_Tr4_NMOSGateSpacing'),
                _Tr4_NMOSSDWidth			= params.get('_Tr4_NMOSSDWidth'),
                _Tr4_NMOSXVT				= params.get('_Tr4_NMOSXVT'),
                _Tr4_NMOSPCCrit				= params.get('_Tr4_NMOSPCCrit'),

                # Source_node_ViaM1M2
                _Tr4_NMOSSource_Via_TF = params.get('_Tr4_NMOSSource_Via_TF'),

                # Drain_node_ViaM1M2
                _Tr4_NMOSDrain_Via_TF = params.get('_Tr4_NMOSDrain_Via_TF'),

                # POLY dummy setting
                _Tr4_NMOSDummy = params.get('_Tr4_NMOSDummy'), # TF
                # if _PMOSDummy == True
                _Tr4_NMOSDummy_length = params.get('_Tr4_NMOSDummy_length'), # None/Value
                _Tr4_NMOSDummy_placement = params.get('_Tr4_NMOSDummy_placement'), # None/'Up'/'Dn'/

                _NumContTop_P1P2P4 = params.get('_NumContTop_P1P2P4'),
                _NumContBottom_P1P2P4 = params.get('_NumContBottom_P1P2P4'),
                _NumContLeft_P1P2P4 = params.get('_NumContLeft_P1P2P4'),
                _NumContRight_P1P2P4 = params.get('_NumContRight_P1P2P4'),

                # N body ring(P0P3)
                _NumContTop_P0P3=params.get('_NumContTop_P0P3'),
                _NumContLeft_P0P3=params.get('_NumContLeft_P0P3'),
                _NumContRight_P0P3=params.get('_NumContRight_P0P3'),

                # P body ring
                _NumContTop_Pbody=params.get('_NumContTop_Pbody'),
                _NumContBottom_Pbody=params.get('_NumContBottom_Pbody'),
                _NumContLeft_Pbody=params.get('_NumContLeft_Pbody'),
                _NumContRight_Pbody=params.get('_NumContRight_Pbody'),

                # Res0
                _ResWidth_res0=params.get('_ResWidth_res0'),
                _ResLength_res0=params.get('_ResLength_res0'),
                _CONUMX_res0=params.get('_CONUMX_res0'),
                _CONUMY_res0=params.get('_CONUMY_res0'),
                _SeriesStripes_res0=params.get('_SeriesStripes_res0'),
                _ParallelStripes_res0=params.get('_ParallelStripes_res0'),

                # Res0
                _ResWidth_res1=params.get('_ResWidth_res1'),
                _ResLength_res1=params.get('_ResLength_res1'),
                _CONUMX_res1=params.get('_CONUMX_res1'),
                _CONUMY_res1=params.get('_CONUMY_res1'),
                _SeriesStripes_res1=params.get('_SeriesStripes_res1'),
                _ParallelStripes_res1=params.get('_ParallelStripes_res1'),

                # Cap0
                _Length_cap0=params.get('_Length_cap0'),
                _LayoutOption_cap0=params.get('_LayoutOption_cap0'),
                _NumFigPair_cap0=params.get('_NumFigPair_cap0'),

                _Array_cap0=params.get('_Array_cap0'),  # number: 1xnumber
                _Cbot_Ctop_metalwidth_cap0=params.get('_Cbot_Ctop_metalwidth_cap0'),  # number

                # Cap1
                _Length_cap1=params.get('_Length_cap1'),
                _LayoutOption_cap1=params.get('_LayoutOption_cap1'),
                _NumFigPair_cap1=params.get('_NumFigPair_cap1'),

                _Array_cap1=params.get('_Array_cap1'),  # number: 1xnumber
                _Cbot_Ctop_metalwidth_cap1=params.get('_Cbot_Ctop_metalwidth_cap1'),  # number
            ...
            _2stageamp._UpdateDesignParameter2GDSStructure(
                _DesignParameterInDictionary=_2stageamp._DesignParameter
            )

            with open(out_gds, "wb") as f:
                gds_stream = _2stageamp._CreateGDSStream(
                    _2stageamp._DesignParameter['_GDSFile']['_GDSFile']
                )
                gds_stream.write_binary_gds_stream(f)
...
if __name__=="__main__":
    ...
    _TR3_PMOSNumberofGate_rd = (1,[2,5])
    ...
    _Cap_Length_rd = (1000,[5000,10000])
    _Cap_finger_rd = (10,[30,70])

    randgen = RandGen(cell_name='_2stageamp',
                      # PMOS
                      _Tr0_PMOSNumberofGate=_TR0_PMOSNumberofGate_rd,
                      _Tr0_PMOSChannelWidth=_TRP0_P3_N2_N3_ChannelWidth_rd,
                      ...
                      # PMOS
                      _Tr1_PMOSNumberofGate=_TR1_2_PMOSNumberofGate_rd,
                      _Tr1_PMOSChannelWidth=_TRP1_P2_P4_ChannelWidth_rd,
                      _Tr1_PMOSChannellength=150,
                      _Tr1_PMOSGateSpacing=None,
                      _Tr1_PMOSSDWith	= None,
                      _Tr1_PMOSXVT			= 'EG',
                      ...
                      # PMOS
                      _Tr2_PMOSNumberofGate	= (0, [0], "_Tr1_PMOSNumberofGate"),
                      _Tr2_PMOSChannelWidth	= (0, [0], "_Tr1_PMOSChannelWidth"),
                      ...
                      # PMOS
                      _Tr3_PMOSNumberofGate=_TR3_PMOSNumberofGate_rd,
                      _Tr3_PMOSChannelWidth=(0,[0],"_Tr0_PMOSChannelWidth"),
                      _Tr3_PMOSChannellength=150,
                      _Tr3_PMOSGateSpacing=None,
                      _Tr3_PMOSSDWith	= None,
                      _Tr3_PMOSXVT			= 'EG',
                      ...
                      # PMOS
                      _Tr4_PMOSNumberofGate=_TR4_PMOSNumberofGate_rd,
                      _Tr4_PMOSChannelWidth=(0, [0], "_Tr1_PMOSChannelWidth"),
                      ...
                      # NMOS Tr0
                      _Tr0_NMOSNumberofGate=_TR0_1_NMOSNumberofGate_rd,
                      _Tr0_NMOSChannelWidth=_TRN0_N1_N4_ChannelWidth_rd,
                      ...
                      # NMOS Tr1
                      _Tr1_NMOSNumberofGate=(0, [0], "_Tr0_NMOSNumberofGate"),
                      _Tr1_NMOSChannelWidth=(0, [0], "_Tr0_NMOSChannelWidth"),
                      ...
                      # NMOS
                      _Tr2_NMOSNumberofGate=_TR2_NMOSNumberofGate_rd,
                      _Tr2_NMOSChannelWidth=(0, [0], "_Tr0_PMOSChannelWidth"),
                      ...
                      # NMOS
                      _Tr3_NMOSNumberofGate=_TR3_NMOSNumberofGate_rd,
                      _Tr3_NMOSChannelWidth=(0, [0], "_Tr0_PMOSChannelWidth"),
                      ...
                      # NMOS Tr4
                      _Tr4_NMOSNumberofGate=_TR4_NMOSNumberofGate_rd,
                      _Tr4_NMOSChannelWidth=(0, [0], "_Tr0_NMOSChannelWidth"),
                      ...
                      # Res0
                      _ResWidth_res0 = _Res_Width_rd,
                      _ResLength_res0 = _Res_Length_rd,
                      _CONUMX_rs0 = None,
                      _CONUMY_rs0 = None,
                      ...
                      # Res1
                      _ResWidth_res1=(0, [0], "_ResWidth_res0"),
                      _ResLength_res1=(0, [0], "_ResLength_res0"),
                      _CONUMX_res1=None,
                      _CONUMY_res1=None,
                      ...
                      # Cap0
                      _Length_cap0=_Cap_Length_rd,
                      _LayoutOption_cap0 =[2, 3, 4, 5], # 고정
                      _NumFigPair_cap0=_Cap_finger_rd,

                      _Array_cap0=1,  # number: 1xnumber
                      _Cbot_Ctop_metalwidth_cap0=500,  # number

                      # Cap1
                      _Length_cap1=(0, [0], "_Length_cap0"),
                      _LayoutOption_cap1= [2, 3, 4, 5], # 고정
                      _NumFigPair_cap1=(0, [0], "_NumFigPair_cap0"),
    ...
    drc_result, lvs_result = randgen.run(20)
