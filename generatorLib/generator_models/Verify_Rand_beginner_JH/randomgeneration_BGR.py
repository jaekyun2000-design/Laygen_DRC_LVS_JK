...
from generatorLib.generator_models import B00_amp_v2_
# from generatorLib.generator_models import inverter_0305_2
from generatorLib.generator_models import BGR_V3_using_gui
...
class RandGen:
    ...
    def run(self, iteration=2):
        ...
        for i in tqdm(range(1,step+1), file=sys.stdout):
            ...
            commands = [(f"source {personal.TECHDIR}/setup.cshrc; cd {personal.RUNDIR}/{word}; "
                         f"setenv VIRTUAL_CONNECT VSS; " #virtual connect command 2025.07.25/seokhoon
    ...
    def create_layout(self, params, word='1'):
        ...
        if self.cell_name == 'BGR':
            ...
            BGR = BGR_V3_using_gui.BGR(_DesignParameter=None, _Name='BGR')
    ...
    def send_server(self, word='1'):
        ...
        self.ssh.send_file(rf'C:\Users\KJB\PycharmProjects\LayGenGUI\generatorLib\generator_models\Verify_Rand_beginner_JH\calibre_drc.run', f'{personal.RUNDIR}/{word}/calibre_drc.run')
    ...
    def retrieve_lvs(self, word='1'):
        ...
        with SCPClient(self.ssh.ssh.get_transport()) as scp:
            scp.get(f'{personal.RUNDIR}/{word}/{self.cell_name}.lvs.report', rf'C:\Users\KJB\PycharmProjects\LayGenGUI\generatorLib\generator_models\Verify_Rand_beginner_JH\report_DRC\lvs{word}.report')
        with open(rf'C:\Users\KJB\PycharmProjects\LayGenGUI\generatorLib\generator_models\Verify_Rand_beginner_JH\report_DRC\lvs{word}.report', 'r') as f:
...
if __name__=="__main__":
    ...
    randgen = RandGen(cell_name='BGR',
                      finger_N1=(1,[2,11]), finger_N2=(1,[1,11]), finger_N4=(1,[1,11]), finger_N5=(1,[1,11]), finger_P1=(1,[1,11]), finger_P3=(1,[1,11]),
                      finger_P4=(1,[1,11]),  finger_P5=(1,[1,11]), L1=(10,[160,451]),
                      finger_P6=(1,[1,5]), finger_P7=(1,[1,5]), finger_P8=(1,[1,5]),
                      finger_P9=(1,[1,11]), finger_P10=(1,[1,11]),
                      finger_N6=(1,[1,11]), finger_N7=(1,[1,11]), L2=(10,[160,601]), L3=(10,[160,601]), pnp_stack=(1,[0,2]),
                      Gate_cap=(1,[1,11]),RX_cap=(1,[1,4]),L_cap=(100,[1300,3000]),W_cap=(100,[1300,3000]),series_res1=(1,[1,4]),series_res2=(1,[1,11]),series_res3=(1,[1,11]),
                      L_res2=[500,(1000,10001)],L_Res3=[500,(1000,10001)],pnp_mid_num=[1,(6,11)],
                      W_res1=[500,(500,1501)],L_res1=[500,(500,3001)],W_res2=[500,(500,1501)],W_res3=[500,(500,1501)],
                      W_P1 = [100,(1000,2401)], W_N1 = [100,(1000,2401)], W_P2 = [100,(1000,2401)],W_P3 = [100,(1000,2401)],W_N3 = [100,(1000,2401)],
                      )
