...
from generatorLib.generator_models import CTLE_20250310_test5_json
...
class RandGen:
    ...
    def create_layout(self, params, word='1'):
        ...
        if self.cell_name == 'CTLE':
            ...
            # CTLE = CTLE_20250310_test5._CTLE_20250310_test5(_DesignParameter=None, _Name='CTLE')
            CTLE = CTLE_20250310_test5_json._CTLE_20250310_test5(_DesignParameter=None, _Name='CTLE')
            ...
            CTLE._CalculateDesignParameter(RL_Width=params.get('RL_Width'),
                                           RL_Length=params.get('RL_Length'),
                                           W1_num_finger = params.get('W1_num_finger'),
                                           W1_finger_width = params.get('W1_finger_width'),
                                           W2_num_finger = params.get('W2_num_finger'),
                                           W2_finger_width = params.get('W2_finger_width'),
                                           RS_Width = params.get('RS_Width'),
                                           RS_Length = params.get('RS_Length'),
                                           CS_Width = params.get('CS_Width'),
                                           CS_Length = params.get('CS_Length'))
            # inv._UpdateDesignParameter2GDSStructure(_DesignParameterInDictionary=inv._DesignParameter)
            CTLE._UpdateDesignParameter2GDSStructure(_DesignParameterInDictionary=CTLE._DesignParameter)
            ...
            with open(f'./CTLE/CTLE{word}.gds', 'wb') as f:
                gds_stream = CTLE._CreateGDSStream(CTLE._DesignParameter['_GDSFile']['_GDSFile'])
                gds_stream.write_binary_gds_stream(f)
...
if __name__=="__main__":
    try :
        ...
        from Project_ADC.Library_and_Engine.license_auth_obj import Verification
        ...
        # randgen = RandGen(cell_name='CTLE',
        #                   RL_Width=(10, [200, 3000]), RL_Length=(10, [600, 2000]),
        #                   W1_num_finger=(1, [3, 20]), W1_finger_width=(10, [500, 1200]),
        #                   W2_num_finger=(1, [3, 20]), W2_finger_width=(10, [500, 1200]),
        #                   # W1_num_finger=(1, [12, 15]), W1_finger_width=(10, [660, 700]),
        #                   # W2_num_finger=(1, [8, 12]), W2_finger_width=(10, [800, 900]),
        #                   # RS_Width=(10, [150, 2000]), RS_Length=(10, [400, 3000]),
        #                   RS_Width=(10, [200, 2000]), RS_Length=(10, [600, 3000]),
        #                   CS_Width=(280, [2774, 4500]), CS_Length=(10, [2200, 8500])
        #                   # CS_Width = (280, [2214, 6000]), CS_Length = (1, [2200, 8000])
        #
        #                   # RL_Width=(10,[2500,2510]), RL_Length=(10,[1800,1810]),
        #                   # W1_num_finger=(1,[12,13]), W1_finger_width=(10,[660,680]),
        #                   # W2_num_finger=(1, [8, 9]), W2_finger_width=(10, [800, 810]),
        #                   # RS_Width=(10,[1750,1760]), RS_Length=(10,[2500,2510]),
        #                   # CS_Width=(10,[4174,4184]), CS_Length=(10,[8000,8010])
        #
        #                   # RL_Width=(100,[2500,2600]), RL_Length=(100,[1800,1900]),
        #                   # W1_num_finger=(1, [12, 13]), W1_finger_width=(100, [666, 667]),
        #                   # W2_num_finger=(1, [7, 8]), W2_finger_width=(100, [800, 800+1]),
        #                   # RS_Width=(50, [1750, 1780]), RS_Length=(100, [2500, 2600]),
        #                   # CS_Width=(10, [4174, 4184]), CS_Length=(100, [8000, 8100])
        #                   )
        #
        ...
        veri = Verification.instance()
        veri.start()

        randgen = RandGen(cell_name='CTLE', **inputparams)

        drc_result, lvs_result, pex_result, posim_result = randgen.run(1)
