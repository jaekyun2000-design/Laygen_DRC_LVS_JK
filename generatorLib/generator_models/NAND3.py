...
class NAND3(StickDiagram._StickDiagram):
	...
	def _CalculateDesignParameter(self,gate_spacing=120,nmos_width1=270,nmos_width2=270,pmos_width1=360,pmos_width2=180,vss2nmos3=None,vss2nmos1=None,vdd2pmos3=None,vdd2pmos1=None,gate_a=5,gate_b=2,gate_c=3,vss2vdd_height=1800,sdwidth=66,length=30,XVT='RVT',gate_y=860,nmos_width3=270,pmos_width3=270,vss2nmos2=None,vdd2pmos2=None):
		...
		self._DesignParameter['nmos3']['_DesignObj']._CalculateNMOSDesignParameter(**dict(_NMOSNumberofGate=gate_c, _NMOSChannelWidth=nmos_width1, _NMOSChannellength=length, _NMOSDummy=True, _GateSpacing=gate_spacing, _SDWidth=sdwidth, _XVT=XVT))
		...
		self._DesignParameter['nmos2']['_DesignObj']._CalculateNMOSDesignParameter(**dict(_NMOSNumberofGate=gate_b, _NMOSChannelWidth=nmos_width3, _NMOSChannellength=length, _NMOSDummy=True, _GateSpacing=gate_spacing, _SDWidth=sdwidth, _XVT=XVT, _PCCrit=False))
		...
		self._DesignParameter['nmos1']['_DesignObj']._CalculateNMOSDesignParameter(**dict(_NMOSNumberofGate=gate_a, _NMOSChannelWidth=nmos_width2, _NMOSChannellength=length, _NMOSDummy=True, _GateSpacing=gate_spacing, _SDWidth=sdwidth, _XVT=XVT))
		...
		self._DesignParameter['pmos3']['_DesignObj']._CalculatePMOSDesignParameter(**dict(_PMOSNumberofGate=gate_c, _PMOSChannelWidth=pmos_width1, _PMOSChannellength=length, _PMOSDummy=True, _GateSpacing=gate_spacing, _SDWidth=sdwidth, _XVT=XVT, _PCCrit=False))
		...
		self._DesignParameter['pmos2']['_DesignObj']._CalculatePMOSDesignParameter(**dict(_PMOSNumberofGate=gate_b, _PMOSChannelWidth=pmos_width3, _PMOSChannellength=length, _PMOSDummy=True, _GateSpacing=gate_spacing, _SDWidth=sdwidth, _XVT=XVT, _PCCrit=False))
		...
		self._DesignParameter['pmos1']['_DesignObj']._CalculatePMOSDesignParameter(**dict(_PMOSNumberofGate=gate_a, _PMOSChannelWidth=pmos_width2, _PMOSChannellength=length, _PMOSDummy=True, _GateSpacing=gate_spacing, _SDWidth=sdwidth, _XVT=XVT))
		...
		if gate_a!=1:
			self._DesignParameter['poly_input_c']['_XYCoordinates'] = [[[max(((self._DesignParameter['gate_1']['_XYCoordinates'][0][0] + self._DesignParameter['gate_1']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0]) + (self._DesignParameter['gate_1']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2)),self._DesignParameter['nmos1']['_XYCoordinates'][0][0]+self._DesignParameter['nmos1']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][-1][0]+self._DesignParameter['nmos1']['_DesignObj']._DesignParameter['_POLayer']['_XWidth']/2), ((self._DesignParameter['gate_1']['_XYCoordinates'][0][1] + self._DesignParameter['gate_1']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][1]) - (self._DesignParameter['gate_1']['_DesignObj']._DesignParameter['_POLayer']['_YWidth'] / 2))], [((self._DesignParameter['nmos1']['_XYCoordinates'][0][0] + self._DesignParameter['nmos1']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['nmos1']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2)), ((self._DesignParameter['gate_1']['_XYCoordinates'][0][1] + self._DesignParameter['gate_1']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][1]) - (self._DesignParameter['gate_1']['_DesignObj']._DesignParameter['_POLayer']['_YWidth'] / 2))]], [[max(((self._DesignParameter['gate_1']['_XYCoordinates'][0][0] + self._DesignParameter['gate_1']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0]) + (self._DesignParameter['gate_1']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2)),self._DesignParameter['pmos1']['_XYCoordinates'][0][0]+self._DesignParameter['pmos1']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][-1][0]+self._DesignParameter['pmos1']['_DesignObj']._DesignParameter['_POLayer']['_XWidth']/2), ((self._DesignParameter['gate_1']['_XYCoordinates'][0][1] + self._DesignParameter['gate_1']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][1]) + (self._DesignParameter['gate_1']['_DesignObj']._DesignParameter['_POLayer']['_YWidth'] / 2))], [((self._DesignParameter['pmos1']['_XYCoordinates'][0][0] + self._DesignParameter['pmos1']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['pmos1']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2)), ((self._DesignParameter['gate_1']['_XYCoordinates'][0][1] + self._DesignParameter['gate_1']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][1]) + (self._DesignParameter['gate_1']['_DesignObj']._DesignParameter['_POLayer']['_YWidth'] / 2))]]]
		elif gate_a==1:
			self._DesignParameter['poly_input_c']['_XYCoordinates'] = [[[self._DesignParameter['gate_1']['_XYCoordinates'][0][0]+self._DesignParameter['gate_1']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0]-self._DesignParameter['gate_1']['_DesignObj']._DesignParameter['_POLayer']['_XWidth']/2, ((self._DesignParameter['gate_1']['_XYCoordinates'][0][1] + self._DesignParameter['gate_1']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][1]) - (self._DesignParameter['gate_1']['_DesignObj']._DesignParameter['_POLayer']['_YWidth'] / 2))], [self._DesignParameter['pmos1']['_XYCoordinates'][0][0]+self._DesignParameter['pmos1']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0]+self._DesignParameter['pmos1']['_DesignObj']._DesignParameter['_POLayer']['_XWidth']/2, ((self._DesignParameter['gate_1']['_XYCoordinates'][0][1] + self._DesignParameter['gate_1']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][1]) - (self._DesignParameter['gate_1']['_DesignObj']._DesignParameter['_POLayer']['_YWidth'] / 2))]], [[self._DesignParameter['gate_1']['_XYCoordinates'][0][0]+self._DesignParameter['gate_1']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0]-self._DesignParameter['gate_1']['_DesignObj']._DesignParameter['_POLayer']['_XWidth']/2, ((self._DesignParameter['gate_1']['_XYCoordinates'][0][1] + self._DesignParameter['gate_1']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][1]) + (self._DesignParameter['gate_1']['_DesignObj']._DesignParameter['_POLayer']['_YWidth'] / 2))], [self._DesignParameter['pmos1']['_XYCoordinates'][0][0]+self._DesignParameter['pmos1']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0]+self._DesignParameter['pmos1']['_DesignObj']._DesignParameter['_POLayer']['_XWidth']/2, ((self._DesignParameter['gate_1']['_XYCoordinates'][0][1] + self._DesignParameter['gate_1']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][1]) + (self._DesignParameter['gate_1']['_DesignObj']._DesignParameter['_POLayer']['_YWidth'] / 2))]]]
