...
class NAND3(StickDiagram._StickDiagram):
	...
	def _CalculateDesignParameter(self,gate_spacing=120,nmos_width1=270,nmos_width2=270,pmos_width1=360,pmos_width2=180,nmos1_y=375,nmos2_y=375,pmos1_y=410,pmos2_y=500,nmos_gate_a=2,pmos_gate_a=2,nmos_gate_b=2,pmos_gate_b=2,nmos_gate_c=3,pmos_gate_c=1,vss2vdd_height=1800,sdwidth=66,supply_xdistance=300,length=30,XVT='RVT',gate_y=860):
		...
		self._DesignParameter['gate_b_input']['_XYCoordinates'] = [[(self._DesignParameter['pmos1']['_XYCoordinates'][0][0] + self._DesignParameter['pmos1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][pmos_gate_c][0]), gate_y]]
		...
		self._DesignParameter['poly_input_a']['_XYCoordinates'] = [[[((self._DesignParameter['gate_a_input']['_XYCoordinates'][0][0] + self._DesignParameter['gate_a_input']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['gate_a_input']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2)), (((self._DesignParameter['nmos1']['_XYCoordinates'][0][1] + self._DesignParameter['nmos1']['_DesignObj']._DesignParameter['_PODummyLayer']['_XYCoordinates'][0][1]) + (self._DesignParameter['nmos1']['_DesignObj']._DesignParameter['_PODummyLayer']['_YWidth'] / 2)) + drc._PolygateMinSpace)], [((self._DesignParameter['nmos1']['_XYCoordinates'][0][0] + self._DesignParameter['nmos1']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][(nmos_gate_c - 1)][0]) + (self._DesignParameter['nmos1']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2)), (((self._DesignParameter['nmos1']['_XYCoordinates'][0][1] + self._DesignParameter['nmos1']['_DesignObj']._DesignParameter['_PODummyLayer']['_XYCoordinates'][0][1]) + (self._DesignParameter['nmos1']['_DesignObj']._DesignParameter['_PODummyLayer']['_YWidth'] / 2)) + drc._PolygateMinSpace)]], [[((self._DesignParameter['gate_a_input']['_XYCoordinates'][0][0] + self._DesignParameter['gate_a_input']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['gate_a_input']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2)), (((self._DesignParameter['pmos1']['_XYCoordinates'][0][1] + self._DesignParameter['pmos1']['_DesignObj']._DesignParameter['_PODummyLayer']['_XYCoordinates'][0][1]) - (self._DesignParameter['pmos1']['_DesignObj']._DesignParameter['_PODummyLayer']['_YWidth'] / 2)) - drc._PolygateMinSpace)], [((self._DesignParameter['pmos1']['_XYCoordinates'][0][0] + self._DesignParameter['pmos1']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][(pmos_gate_c - 1)][0]) + (self._DesignParameter['pmos1']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2)), (((self._DesignParameter['pmos1']['_XYCoordinates'][0][1] + self._DesignParameter['pmos1']['_DesignObj']._DesignParameter['_PODummyLayer']['_XYCoordinates'][0][1]) - (self._DesignParameter['pmos1']['_DesignObj']._DesignParameter['_PODummyLayer']['_YWidth'] / 2)) - drc._PolygateMinSpace)]]]
		...
		self._DesignParameter['poly_input_b']['_XYCoordinates'] = [[[((self._DesignParameter['gate_b_input']['_XYCoordinates'][0][0] + self._DesignParameter['gate_b_input']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['gate_b_input']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2)), ((self._DesignParameter['gate_b_input']['_XYCoordinates'][0][1] + self._DesignParameter['gate_b_input']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][1]) - (self._DesignParameter['gate_b_input']['_DesignObj']._DesignParameter['_POLayer']['_YWidth'] / 2))], [((self._DesignParameter['nmos1']['_XYCoordinates'][0][0] + self._DesignParameter['nmos1']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][(- 1)][0]) + (self._DesignParameter['nmos1']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2)), ((self._DesignParameter['gate_b_input']['_XYCoordinates'][0][1] + self._DesignParameter['gate_b_input']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][1]) - (self._DesignParameter['gate_b_input']['_DesignObj']._DesignParameter['_POLayer']['_YWidth'] / 2))]], [[((self._DesignParameter['gate_b_input']['_XYCoordinates'][0][0] + self._DesignParameter['gate_b_input']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['gate_b_input']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2)), ((self._DesignParameter['gate_b_input']['_XYCoordinates'][0][1] + self._DesignParameter['gate_b_input']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][1]) + (self._DesignParameter['gate_b_input']['_DesignObj']._DesignParameter['_POLayer']['_YWidth'] / 2))], [((self._DesignParameter['pmos1']['_XYCoordinates'][0][0] + self._DesignParameter['pmos1']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][(- 1)][0]) + (self._DesignParameter['pmos1']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2)), ((self._DesignParameter['gate_b_input']['_XYCoordinates'][0][1] + self._DesignParameter['gate_b_input']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][1]) + (self._DesignParameter['gate_b_input']['_DesignObj']._DesignParameter['_POLayer']['_YWidth'] / 2))]]]
		...
		if nmos_gate_b%2==0:
			for i in range(0,nmos_gate_b//2):
				tmp.append([[self._DesignParameter['nmos1']['_XYCoordinates'][0][0]+self._DesignParameter['nmos1']['_DesignObj']._DesignParameter['_XYCoordinateNMOSSupplyRouting']['_XYCoordinates'][(nmos_gate_c+1)//2+i][0], self._DesignParameter['nmos1']['_XYCoordinates'][0][1]+self._DesignParameter['nmos1']['_DesignObj']._DesignParameter['_XYCoordinateNMOSSupplyRouting']['_XYCoordinates'][(nmos_gate_c+1)//2+i][1]],[self._DesignParameter['nmos1']['_XYCoordinates'][0][0]+self._DesignParameter['nmos1']['_DesignObj']._DesignParameter['_XYCoordinateNMOSSupplyRouting']['_XYCoordinates'][(nmos_gate_c+1)//2+i][0], nmos1_series_y]])
