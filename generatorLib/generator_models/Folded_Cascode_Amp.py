...
class _Folded_Cascode_Amp(StickDiagram._StickDiagram):
    ...
    def _CalculateDesignParameter_folded_cascode_amp(self, pset_param={'pmos_pdn_single_sw_param':{'_PMOSNumberofGate':8, '_PMOSChannelWidth':2000, '_PMOSChannellength':30, '_PMOSDummy':True, '_GateSpacing':None, '_SDWidth':None, '_XVT':'LVT', '_PCCrit':None}, \
        ...
        self._DesignParameter['m2_drain_input']['_XYCoordinates']=[[[self._DesignParameter['via12_drain_inputn']['_XYCoordinates'][0][0], self._DesignParameter['via12_drain_inputn']['_XYCoordinates'][0][1]], [self._DesignParameter['pmos_pdn_single_sw']['_XYCoordinates'][0][0], self._DesignParameter['via12_drain_inputn']['_XYCoordinates'][-1][1]]], \
                                                                   [[self._DesignParameter['via12_drain_inputp']['_XYCoordinates'][0][0], self._DesignParameter['via12_drain_inputp']['_XYCoordinates'][0][1]], [self._DesignParameter['pmos_pdn_single_sw']['_XYCoordinates'][0][0], self._DesignParameter['via12_drain_inputp']['_XYCoordinates'][-1][1]]]]
        ...
        # self._DesignParameter['via12_gate_vbp2']=self._SrefElementDeclaration(_DesignObj=ViaMet12Met2._ViaMet12Met2(_Name='via12_gate_vbp21In{}'.format(_Name)))[0]
        # self._DesignParameter['via12_gate_vbp2']['_DesignObj']._CalculateDesignParameterSameEnclosure( _ViaMet12Met2NumberOfCOX=2, _ViaMet12Met2NumberOfCOY=2)
        # tmp=[]
        # for i in range(0, len(self._DesignParameter['pmos_vbp2']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'])):
        #     tmp.append([self._DesignParameter['pmos_vbp2']['_XYCoordinates'][0][0]+self._DesignParameter['pmos_vbp2']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][i][0], self._DesignParameter['pmos_vbp2']['_XYCoordinates'][0][1]+self._DesignParameter['pmos_vbp2']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][i][1]])
        #     tmp.append([self._DesignParameter['pmos_vbp2']['_XYCoordinates'][1][0]+self._DesignParameter['pmos_vbp2']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][i][0], self._DesignParameter['pmos_vbp2']['_XYCoordinates'][1][1]+self._DesignParameter['pmos_vbp2']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][i][1]])
        # self._DesignParameter['via12_gate_vbp2']['_XYCoordinates']=tmp
        # del tmp
        ...
        self._DesignParameter['m2_source_pdn_single']['_XYCoordinates']=[[self._DesignParameter['via12_source_pdn_single']['_XYCoordinates'][0], self._DesignParameter['via12_source_pdn_single']['_XYCoordinates'][-1]]]
        ...
        for i in range(0, len(self._DesignParameter['nmos_vbn1']['_DesignObj']._DesignParameter['_XYCoordinateNMOSOutputRouting']['_XYCoordinates'])):
            ...
            tmp.append([-(self._DesignParameter['nmos_vbn1']['_XYCoordinates'][0][0]+self._DesignParameter['nmos_vbn1']['_DesignObj']._DesignParameter['_XYCoordinateNMOSOutputRouting']['_XYCoordinates'][i][0]), self._DesignParameter['nmos_vbn1']['_XYCoordinates'][0][1]+self.getYWidth('via12_drain_vbn1','_Met2Layer')/2+drc._Metal1MinSpace3/2+self.getYWidth('via12_drain_vbn1','_Met2Layer')+drc._Metal1MinSpace3])
        ...
        self._DesignParameter['via12_drain_n0']['_DesignObj']._CalculateDesignParameterSameEnclosure( _ViaMet12Met2NumberOfCOX=1, _ViaMet12Met2NumberOfCOY=2)
        tmp=[]
        for i in range(0, len(self._DesignParameter['nmos_n0']['_DesignObj']._DesignParameter['_XYCoordinateNMOSOutputRouting']['_XYCoordinates'])):
            tmp.append([self._DesignParameter['nmos_n0']['_XYCoordinates'][0][0]+self._DesignParameter['nmos_n0']['_DesignObj']._DesignParameter['_XYCoordinateNMOSOutputRouting']['_XYCoordinates'][i][0], self._DesignParameter['nmos_n0']['_XYCoordinates'][0][1]+self._DesignParameter['nmos_n0']['_DesignObj']._DesignParameter['_XYCoordinateNMOSOutputRouting']['_XYCoordinates'][i][1]+self._DesignParameter['nmos_n0']['_DesignObj']._DesignParameter['_POLayer']['_YWidth']/3])
            tmp.append([-(self._DesignParameter['nmos_n0']['_XYCoordinates'][0][0]+self._DesignParameter['nmos_n0']['_DesignObj']._DesignParameter['_XYCoordinateNMOSOutputRouting']['_XYCoordinates'][i][0]), self._DesignParameter['nmos_n0']['_XYCoordinates'][0][1]+self._DesignParameter['nmos_n0']['_DesignObj']._DesignParameter['_XYCoordinateNMOSOutputRouting']['_XYCoordinates'][i][1]+self._DesignParameter['nmos_n0']['_DesignObj']._DesignParameter['_POLayer']['_YWidth']/3])
        ...
        self._DesignParameter['m2_source_vbn1']['_XYCoordinates']=[[self._DesignParameter['via12_source_vbn1']['_XYCoordinates'][0], self._DesignParameter['via12_source_vbn1']['_XYCoordinates'][-2]],\
                                                                [self._DesignParameter['via12_source_vbn1']['_XYCoordinates'][1], self._DesignParameter['via12_source_vbn1']['_XYCoordinates'][-1]]]
        ...
        self._DesignParameter['via23_gate_n0']['_DesignObj']._CalculateDesignParameterSameEnclosure( _ViaMet22Met3NumberOfCOX=ViaNumY, _ViaMet22Met3NumberOfCOY=ViaNumY)
        ...
        self._DesignParameter['via23_input_n0']['_XYCoordinates']=[[self._DesignParameter['via23_inputp']['_XYCoordinates'][0][0], self._DesignParameter['via12_gate_vbn1']['_XYCoordinates'][0][1]+self.getYWidth('via12_gate_vbn1','_Met2Layer')/2+self.getYWidth('via23_input_n0','_Met2Layer')/2+drc._MetalxMinSpace2], [self._DesignParameter['via23_inputn']['_XYCoordinates'][0][0], self._DesignParameter['via12_gate_vbp1']['_XYCoordinates'][0][1]+self.getYWidth('via12_gate_vbp1','_Met2Layer')/2+self.getYWidth('via23_input_n0','_Met2Layer')/2+drc._MetalxMinSpace2]]
        ...
        self._DesignParameter['via23_gate_n0']=self._SrefElementDeclaration(_DesignObj=ViaMet22Met3._ViaMet22Met3(_Name='via23_gate_n0In{}'.format(_Name)))[0]
        self._DesignParameter['via23_gate_n0']['_DesignObj']._CalculateDesignParameterSameEnclosure( _ViaMet22Met3NumberOfCOX=2, _ViaMet22Met3NumberOfCOY=2)
        self._DesignParameter['via23_gate_n0']['_XYCoordinates']=[[self._DesignParameter['via23_input_n0_2']['_XYCoordinates'][0][0], self._DesignParameter['m2_drain_n0']['_XYCoordinates'][0][0][1]], [self._DesignParameter['via23_input_n0_2']['_XYCoordinates'][1][0], self._DesignParameter['m2_drain_n0']['_XYCoordinates'][0][0][1]]]
        ...
        self._DesignParameter['m3_n0']['_XYCoordinates']=[[[self._DesignParameter['via23_input_n0_2']['_XYCoordinates'][0][0], self._DesignParameter['via23_input_n0_2']['_XYCoordinates'][0][1]], [self._DesignParameter['via23_gate_n0']['_XYCoordinates'][0][0], self._DesignParameter['via23_gate_n0']['_XYCoordinates'][0][1]]],\
                                                          [[self._DesignParameter['via23_input_n0_2']['_XYCoordinates'][1][0], self._DesignParameter['via23_input_n0_2']['_XYCoordinates'][1][1]], [self._DesignParameter['via23_gate_n0']['_XYCoordinates'][1][0], self._DesignParameter['via23_gate_n0']['_XYCoordinates'][1][1]]]]
        ...
        self._DesignParameter['via23_ninput_pdn_pair_sw']=self._SrefElementDeclaration(_DesignObj=ViaMet22Met3._ViaMet22Met3(_Name='via23_ninput_pdn_pair_swIn{}'.format(_Name)))[0]
        self._DesignParameter['via23_ninput_pdn_pair_sw']['_DesignObj']._CalculateDesignParameterSameEnclosure( _ViaMet22Met3NumberOfCOX=2, _ViaMet22Met3NumberOfCOY=2)
        self._DesignParameter['via23_ninput_pdn_pair_sw']['_XYCoordinates']=[[self._DesignParameter['via23_ninputn']['_XYCoordinates'][0][0], self._DesignParameter['via23_input_n0']['_XYCoordinates'][1][1]+self.getYWidth('via23_input_n0','_Met3Layer')/2+self.getYWidth('via23_ninput_pdn_pair_sw','_Met3Layer')/2+drc._MetalxMinSpace3], [self._DesignParameter['via23_ninputp']['_XYCoordinates'][0][0], self._DesignParameter['via23_input_n0']['_XYCoordinates'][0][1]+self.getYWidth('via23_input_n0','_Met2Layer')/2+self.getYWidth('via23_ninputp','_Met2Layer')/2+drc._MetalxMinSpace3]]
        ...
        self._DesignParameter['m3_ninput']['_Width']=self.getXWidth('via23_ninput_pdn_pair_sw','_Met3Layer')
        self._DesignParameter['m3_ninput']['_XYCoordinates']=[[[self._DesignParameter['via23_ninputn']['_XYCoordinates'][0][0], self._DesignParameter['via23_ninputn']['_XYCoordinates'][0][1]], [self._DesignParameter['via23_ninput_pdn_pair_sw']['_XYCoordinates'][0][0], self._DesignParameter['via23_ninput_pdn_pair_sw']['_XYCoordinates'][0][1]]],\
                                                              [[self._DesignParameter['via23_ninputp']['_XYCoordinates'][0][0], self._DesignParameter['via23_ninputp']['_XYCoordinates'][0][1]], [self._DesignParameter['via23_ninput_pdn_pair_sw']['_XYCoordinates'][1][0], self._DesignParameter['via23_ninput_pdn_pair_sw']['_XYCoordinates'][1][1]]]]

        self._DesignParameter['via23_ninput_pdn_pair_sw_2']=self._SrefElementDeclaration(_DesignObj=ViaMet22Met3._ViaMet22Met3(_Name='via23_ninput_pdn_pair_sw_2In{}'.format(_Name)))[0]
        self._DesignParameter['via23_ninput_pdn_pair_sw_2']['_DesignObj']._CalculateDesignParameterSameEnclosure( _ViaMet22Met3NumberOfCOX=2, _ViaMet22Met3NumberOfCOY=2)
        self._DesignParameter['via23_ninput_pdn_pair_sw_2']['_XYCoordinates']=[[self._DesignParameter['via23_input_n0_2']['_XYCoordinates'][0][0]-self.getXWidth('via23_input_n0_2','_Met3Layer')/2-self.getXWidth('via23_ninput_pdn_pair_sw_2','_Met3Layer')/2-drc._MetalxMinSpace3, self._DesignParameter['via23_ninput_pdn_pair_sw']['_XYCoordinates'][0][1]], [self._DesignParameter['via23_input_n0_2']['_XYCoordinates'][1][0]+self.getXWidth('via23_input_n0_2','_Met3Layer')/2+self.getXWidth('via23_ninput_pdn_pair_sw_2','_Met3Layer')/2+drc._MetalxMinSpace3, self._DesignParameter['via23_ninput_pdn_pair_sw']['_XYCoordinates'][1][1]]]

        self._DesignParameter['m2_ninput_pdn_pair_sw_2']=self._PathElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL2'][0],_Datatype=DesignParameters._LayerMapping['METAL2'][1], _XYCoordinates=[], _Width=None)
        self._DesignParameter['m2_ninput_pdn_pair_sw_2']['_Width']=self.getYWidth('via23_ninput_pdn_pair_sw_2','_Met2Layer')
