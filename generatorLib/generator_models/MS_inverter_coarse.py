...
class INVERTER_COARSE(StickDiagram._StickDiagram):
    ...
    def _CalculateDesignParameter(self,
                                  ...
                                  finger3=None, channel_width3=None,
                                  finger4=None, channel_width4=None,
                                  vdd2vss_height=None, gap_bw_mos_gates=None,
                                  supply_num_coy=None, supply_num_cox=None,
                                  distance_to_vdd = None, distance_to_vss = None
                                  ):
        ...
        tmp_top = self.getXYBot('nmos2','nmos_gate_via', '_Met1Layer')[0][1]
        tmp_bot = self.getXYTop('nmos2_output_via', '_Met1Layer')[0][1]
        ...
        if drc_test2 < drc._Metal1MinSpace2:
            ...
            calibre_for_input =\
                self._DesignParameter['nmos2']['_DesignObj']._DesignParameter['nmos_gate_via']['_XYCoordinates'][0][1] +\
                calibre_value - (self.getYWidth('nmos2', 'nmos', '_Met1Layer')/2 +
                self.getYWidth('nmos2', 'nmos_gate_via', '_Met1Layer')/2 + drc._Metal1MinSpace2)
            nmos1_inputs['space_bw_gate_nmos'] = calibre_for_input
            nmos2_inputs['space_bw_gate_nmos'] = calibre_for_input
            self._DesignParameter['nmos1']['_DesignObj']._CalculateDesignParameter(**nmos1_inputs)
            self._DesignParameter['nmos2']['_DesignObj']._CalculateDesignParameter(**nmos2_inputs)
            self._DesignParameter['nmos1']['_XYCoordinates'] = [[leftside_x_value, nmos1_y_value - calibre_value]]
            self._DesignParameter['nmos2']['_XYCoordinates'] = [[rightside_x_value, nmos2_y_value - calibre_value]]
            via_code_nmos2_output = utility.functions.create_output_via(self, _Name=_Name,
                                                                        via_name='nmos2_output_via',
                                                                        hierarchy_list=['nmos2', 'nmos'],
                                                                        mos_type='nmos',
        ...
        self._DesignParameter['vdd']['_XYCoordinates'] = [[rail_x_center, vdd_y_value]]
