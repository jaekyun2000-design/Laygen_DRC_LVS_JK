...
class EasyDebugModule(StickDiagram._StickDiagram):
	...
	def _CalculateDesignParameter(self,dummy=True,pccrit=True,xvt='SLVT',pmos1_gate=3,pmos1_width=400,pmos1_length=30,pmos1_gate_spacing=96,pmos1_sdwidth=50,pmos2_gate=4,pmos2_width=200,pmos2_length=40,pmos2_gate_spacing=96,pmos3_gate=1,pmos3_width=500,pmos3_length=30,pmos3_gate_spacing=96,pmos3_sdwidth=50,pmos4_gate=1,pmos4_width=700,pmos4_length=30,pmos4_gate_spacing=96,pmos4_sdwidth=50,pmos2_sdwidth=50,nguardring_co=2):
		...
		self._DesignParameter['m1_pmos_x']['_XYCoordinates'] = [[[((self._DesignParameter['PMOS1']['_XYCoordinates'][0][0] + self._DesignParameter['PMOS1']['_DesignObj']._DesignParameter['_XYCoordinatePMOSSupplyRouting']['_XYCoordinates'][0][0]) - (self._DesignParameter['PMOS1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XWidth'] / 2)), ((((self._DesignParameter['PMOS1']['_XYCoordinates'][0][1] + self._DesignParameter['PMOS1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) - (self._DesignParameter['PMOS1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)) - (self._DesignParameter['m1_pmos_x']['_Width'] / 2)) - 60)], [((self._DesignParameter['PMOS1']['_XYCoordinates'][0][0] + self._DesignParameter['PMOS1']['_DesignObj']._DesignParameter['_XYCoordinatePMOSSupplyRouting']['_XYCoordinates'][(- 1)][0]) + (self._DesignParameter['PMOS1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XWidth'] / 2)), ((((self._DesignParameter['PMOS1']['_XYCoordinates'][0][1] + self._DesignParameter['PMOS1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) - (self._DesignParameter['PMOS1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)) - (self._DesignParameter['m1_pmos_x']['_Width'] / 2)) - 60)]], [[((self._DesignParameter['PMOS1']['_XYCoordinates'][0][0] + self._DesignParameter['PMOS1']['_DesignObj']._DesignParameter['_XYCoordinatePMOSOutputRouting']['_XYCoordinates'][0][0]) - (self._DesignParameter['PMOS1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XWidth'] / 2)), ((((self._DesignParameter['PMOS1']['_XYCoordinates'][0][1] + self._DesignParameter['PMOS1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) + (self._DesignParameter['PMOS1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)) + (self._DesignParameter['m1_pmos_x']['_Width'] / 2)) + 60)], [((self._DesignParameter['PMOS1']['_XYCoordinates'][0][0] + self._DesignParameter['PMOS1']['_DesignObj']._DesignParameter['_XYCoordinatePMOSOutputRouting']['_XYCoordinates'][(- 1)][0]) + (self._DesignParameter['PMOS1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XWidth'] / 2)), ((((self._DesignParameter['PMOS1']['_XYCoordinates'][0][1] + self._DesignParameter['PMOS1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) + (self._DesignParameter['PMOS1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)) + (self._DesignParameter['m1_pmos_x']['_Width'] / 2)) + 60)]]]
		path_list = []
		...
		self._DesignParameter['via_m1_m3_pmos4'] = self._SrefElementDeclaration(_DesignObj=ViaStack._ViaStack(_Name='via_m1_m3_pmos4In{}'.format(_Name)))[0]
		self._DesignParameter['via_m1_m3_pmos4']['_DesignObj']._CalculateStackSameEnclosure(**dict(COX=1, COY=cont_pmos4, start_layer=1, end_layer=3))
		self._DesignParameter['via_m1_m3_pmos4']['_XYCoordinates'] = None
		XYList = []
		xy_offset = [0, 0]
		...
		self._DesignParameter['via_m1_m3_pmos4']['_XYCoordinates'] = XYList
		self._DesignParameter['via_m1_m3_pmos4_1'] = self._SrefElementDeclaration(_DesignObj=ViaStack._ViaStack(_Name='via_m1_m3_pmos4_1In{}'.format(_Name)))[0]
		self._DesignParameter['via_m1_m3_pmos4_1']['_DesignObj']._CalculateStackSameEnclosure(**dict(COX=1, COY=cont_pmos4, start_layer=1, end_layer=3))
		self._DesignParameter['via_m1_m3_pmos4_1']['_XYCoordinates'] = None
		XYList = []
		xy_offset = [0, 0]
		...
		self._DesignParameter['via_m1_m3_pmos4_1']['_XYCoordinates'] = XYList
		...
		self._DesignParameter['pmos2_gate']['_XYCoordinates'] = [[self._DesignParameter['PMOS2']['_XYCoordinates'][0][0], ((min(((self._DesignParameter['PMOS2']['_XYCoordinates'][0][1] + self._DesignParameter['PMOS2']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) - (self._DesignParameter['PMOS2']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)), (((self._DesignParameter['via_m1_m3_pmos2']['_XYCoordinates'][0][1] + self._DesignParameter['via_m1_m3_pmos2']['_DesignObj']._DesignParameter['ViaMet12Met2']['_XYCoordinates'][0][1]) + self._DesignParameter['via_m1_m3_pmos2']['_DesignObj']._DesignParameter['ViaMet12Met2']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][0][1]) - (self._DesignParameter['via_m1_m3_pmos2']['_DesignObj']._DesignParameter['ViaMet12Met2']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2))) - (self._DesignParameter['pmos2_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2)) - 60)], [self._DesignParameter['PMOS2']['_XYCoordinates'][(- 1)][0], ((min(((self._DesignParameter['PMOS2']['_XYCoordinates'][1][1] + self._DesignParameter['PMOS2']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) - (self._DesignParameter['PMOS2']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)), (((self._DesignParameter['via_m1_m3_pmos2_1']['_XYCoordinates'][0][1] + self._DesignParameter['via_m1_m3_pmos2_1']['_DesignObj']._DesignParameter['ViaMet12Met2']['_XYCoordinates'][0][1]) + self._DesignParameter['via_m1_m3_pmos2_1']['_DesignObj']._DesignParameter['ViaMet12Met2']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][0][1]) - (self._DesignParameter['via_m1_m3_pmos2_1']['_DesignObj']._DesignParameter['ViaMet12Met2']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2))) - (self._DesignParameter['pmos2_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2)) - 60)]]
		path_list = []
		...
		self._DesignParameter['pmos1_gate']['_XYCoordinates'] = [[self._DesignParameter['PMOS1']['_XYCoordinates'][0][0], (((self._DesignParameter['m1_pmos_x']['_XYCoordinates'][(- 1)][0][1] + (self._DesignParameter['m1_pmos_x']['_Width'] / 2)) + (self._DesignParameter['pmos1_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2)) + 60)]]
		...
		self._DesignParameter['pmos3_gate']['_XYCoordinates'] = [[self._DesignParameter['PMOS3']['_XYCoordinates'][0][0], ((((self._DesignParameter['PMOS3']['_XYCoordinates'][1][1] + self._DesignParameter['PMOS3']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) + (self._DesignParameter['PMOS3']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)) + (self._DesignParameter['pmos3_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2)) + 60)], [self._DesignParameter['PMOS3']['_XYCoordinates'][1][0], ((((self._DesignParameter['PMOS3']['_XYCoordinates'][1][1] + self._DesignParameter['PMOS3']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) + (self._DesignParameter['PMOS3']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)) + (self._DesignParameter['pmos3_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2)) + 60)]]
		...
		self._DesignParameter['pmos4_gate']['_XYCoordinates'] = [[self._DesignParameter['PMOS4']['_XYCoordinates'][0][0], ((((self._DesignParameter['PMOS4']['_XYCoordinates'][1][1] + self._DesignParameter['PMOS4']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) + (self._DesignParameter['PMOS4']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)) + (self._DesignParameter['pmos4_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2)) + 60)], [self._DesignParameter['PMOS4']['_XYCoordinates'][1][0], ((((self._DesignParameter['PMOS4']['_XYCoordinates'][1][1] + self._DesignParameter['PMOS4']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) + (self._DesignParameter['PMOS4']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)) + (self._DesignParameter['pmos4_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2)) + 60)]]
		path_list = []
		...
		self._DesignParameter['via_m1_m2_pmos2_gate']['_XYCoordinates'] = [[self._DesignParameter['pmos2_gate']['_XYCoordinates'][0][0], self._DesignParameter['pmos2_gate']['_XYCoordinates'][0][1]], [self._DesignParameter['pmos2_gate']['_XYCoordinates'][(- 1)][0], self._DesignParameter['pmos2_gate']['_XYCoordinates'][(- 1)][1]]]
		...
		self._DesignParameter['nguardring']['_DesignObj']._CalculateDesignParameter(**dict(height=5000, width=5000, contact=2))
		self._DesignParameter['nguardring']['_XYCoordinates'] = [[self._DesignParameter['PMOS1']['_XYCoordinates'][0][0], ((((self._DesignParameter['pmos1_gate']['_XYCoordinates'][0][1] + self._DesignParameter['pmos1_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][0][1]) + (self._DesignParameter['pmos1_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2)) + min(((self._DesignParameter['PMOS4']['_XYCoordinates'][1][1] + self._DesignParameter['PMOS4']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) - (self._DesignParameter['PMOS4']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)), ((self._DesignParameter['PMOS3']['_XYCoordinates'][1][1] + self._DesignParameter['PMOS3']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) - (self._DesignParameter['PMOS3']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)), ((self._DesignParameter['pmos2_gate']['_XYCoordinates'][1][1] + self._DesignParameter['pmos2_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][0][1]) - (self._DesignParameter['pmos2_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2)), (self._DesignParameter['m1_pmos_x']['_XYCoordinates'][0][0][1] - (self._DesignParameter['m1_pmos_x']['_Width'] / 2)))) / 2)]]
		self._DesignParameter['nguardring']['_DesignObj']._CalculateDesignParameter(**dict(height=(((((self._DesignParameter['pmos1_gate']['_XYCoordinates'][0][1] + self._DesignParameter['pmos1_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][0][1]) + (self._DesignParameter['pmos1_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2)) + (self._DesignParameter['nguardring']['_DesignObj']._DesignParameter['met_top']['_YWidth'] / 2)) + drc._Metal1MinSpace3) - ((min(((self._DesignParameter['PMOS4']['_XYCoordinates'][1][1] + self._DesignParameter['PMOS4']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) - (self._DesignParameter['PMOS4']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)), ((self._DesignParameter['PMOS3']['_XYCoordinates'][1][1] + self._DesignParameter['PMOS3']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) - (self._DesignParameter['PMOS3']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)), ((self._DesignParameter['pmos2_gate']['_XYCoordinates'][1][1] + self._DesignParameter['pmos2_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][0][1]) - (self._DesignParameter['pmos2_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2)), (self._DesignParameter['m1_pmos_x']['_XYCoordinates'][0][0][1] - (self._DesignParameter['m1_pmos_x']['_Width'] / 2))) - (self._DesignParameter['nguardring']['_DesignObj']._DesignParameter['met_bot']['_YWidth'] / 2)) - drc._Metal1MinSpace3)), width=(((((self._DesignParameter['PMOS4']['_XYCoordinates'][1][0] + self._DesignParameter['PMOS4']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][(- 1)][0]) + (self._DesignParameter['PMOS4']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XWidth'] / 2)) + (self._DesignParameter['nguardring']['_DesignObj']._DesignParameter['met_right']['_XWidth'] / 2)) + drc._Metal1MinSpace3) - ((((self._DesignParameter['PMOS4']['_XYCoordinates'][0][0] + self._DesignParameter['PMOS4']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][0]) - (self._DesignParameter['PMOS4']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XWidth'] / 2)) - (self._DesignParameter['nguardring']['_DesignObj']._DesignParameter['met_left']['_XWidth'] / 2)) - drc._Metal1MinSpace3)), contact=nguardring_co))
		self._DesignParameter['nguardring']['_XYCoordinates'] = [[self._DesignParameter['PMOS1']['_XYCoordinates'][0][0], ((((((self._DesignParameter['pmos1_gate']['_XYCoordinates'][0][1] + self._DesignParameter['pmos1_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][0][1]) + (self._DesignParameter['pmos1_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2)) + (self._DesignParameter['nguardring']['_DesignObj']._DesignParameter['met_top']['_YWidth'] / 2)) + drc._Metal1MinSpace3) + ((min(((self._DesignParameter['PMOS4']['_XYCoordinates'][1][1] + self._DesignParameter['PMOS4']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) - (self._DesignParameter['PMOS4']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)), ((self._DesignParameter['PMOS3']['_XYCoordinates'][1][1] + self._DesignParameter['PMOS3']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) - (self._DesignParameter['PMOS3']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)), ((self._DesignParameter['pmos2_gate']['_XYCoordinates'][1][1] + self._DesignParameter['pmos2_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][0][1]) - (self._DesignParameter['pmos2_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2)), (self._DesignParameter['m1_pmos_x']['_XYCoordinates'][0][0][1] - (self._DesignParameter['m1_pmos_x']['_Width'] / 2))) - (self._DesignParameter['nguardring']['_DesignObj']._DesignParameter['met_bot']['_YWidth'] / 2)) - drc._Metal1MinSpace3)) / 2)]]
		path_list = []
		...
		self._DesignParameter['via_m1_m3_gate4'] = self._SrefElementDeclaration(_DesignObj=ViaStack._ViaStack(_Name='via_m1_m3_gate4In{}'.format(_Name)))[0]
		self._DesignParameter['via_m1_m3_gate4']['_DesignObj']._CalculateStackMinimumEnclosureY(**dict(COX=max(2, max(1, (1 + int((((self._DesignParameter['pmos4_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_XWidth'] - drc._VIAxMinSpace) - (2 * drc._VIAxMinEnclosureByMetx)) / (drc._VIAxMinWidth + drc._VIAxMinSpace)))))), COY=1, start_layer=1, end_layer=3))
		self._DesignParameter['via_m1_m3_gate4']['_XYCoordinates'] = [[self._DesignParameter['pmos4_gate']['_XYCoordinates'][0][0], self._DesignParameter['pmos4_gate']['_XYCoordinates'][0][1]], [self._DesignParameter['pmos4_gate']['_XYCoordinates'][1][0], self._DesignParameter['pmos4_gate']['_XYCoordinates'][1][1]]]
		self._DesignParameter['via_m1_m3_gate3'] = self._SrefElementDeclaration(_DesignObj=ViaStack._ViaStack(_Name='via_m1_m3_gate3In{}'.format(_Name)))[0]
		self._DesignParameter['via_m1_m3_gate3']['_DesignObj']._CalculateStackMinimumEnclosureY(**dict(COX=max(2, max(1, (1 + int((((self._DesignParameter['pmos3_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_XWidth'] - drc._VIAxMinSpace) - (2 * drc._VIAxMinEnclosureByMetx)) / (drc._VIAxMinWidth + drc._VIAxMinSpace)))))), COY=1, start_layer=1, end_layer=3))
		self._DesignParameter['via_m1_m3_gate3']['_XYCoordinates'] = [[self._DesignParameter['pmos3_gate']['_XYCoordinates'][0][0], self._DesignParameter['pmos3_gate']['_XYCoordinates'][0][1]], [self._DesignParameter['pmos3_gate']['_XYCoordinates'][1][0], self._DesignParameter['pmos3_gate']['_XYCoordinates'][1][1]]]
		self._DesignParameter['via_m1_m3_gate1'] = self._SrefElementDeclaration(_DesignObj=ViaStack._ViaStack(_Name='via_m1_m3_gate1In{}'.format(_Name)))[0]
		self._DesignParameter['via_m1_m3_gate1']['_DesignObj']._CalculateStackMinimumEnclosureY(**dict(COX=max(2, max(1, (1 + int((((self._DesignParameter['pmos1_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_XWidth'] - drc._VIAxMinSpace) - (2 * drc._VIAxMinEnclosureByMetx)) / (drc._VIAxMinWidth + drc._VIAxMinSpace)))))), COY=1, start_layer=1, end_layer=3))
		self._DesignParameter['via_m1_m3_gate1']['_XYCoordinates'] = [[self._DesignParameter['pmos1_gate']['_XYCoordinates'][0][0], self._DesignParameter['pmos1_gate']['_XYCoordinates'][0][1]]]
		self._DesignParameter['m3_clk_routing_x'] = self._PathElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL3'][0], _Datatype=DesignParameters._LayerMapping['METAL3'][1], _Width=self._DesignParameter['via_m1_m3_gate1']['_DesignObj']._DesignParameter['ViaMet22Met3']['_DesignObj']._DesignParameter['_Met3Layer']['_YWidth'])
		self._DesignParameter['m3_clk_routing_x']['_XYCoordinates'] = [[[self._DesignParameter['via_m1_m3_gate4']['_XYCoordinates'][0][0], self._DesignParameter['via_m1_m3_gate4']['_XYCoordinates'][0][1]], [(((self._DesignParameter['PMOS4']['_XYCoordinates'][0][0] + self._DesignParameter['PMOS4']['_DesignObj']._DesignParameter['_PODummyLayer']['_XYCoordinates'][(- 1)][0]) + (self._DesignParameter['PMOS3']['_XYCoordinates'][0][0] + self._DesignParameter['PMOS3']['_DesignObj']._DesignParameter['_PODummyLayer']['_XYCoordinates'][0][0])) / 2), self._DesignParameter['via_m1_m3_gate4']['_XYCoordinates'][0][1]], [(((self._DesignParameter['PMOS4']['_XYCoordinates'][0][0] + self._DesignParameter['PMOS4']['_DesignObj']._DesignParameter['_PODummyLayer']['_XYCoordinates'][(- 1)][0]) + (self._DesignParameter['PMOS3']['_XYCoordinates'][0][0] + self._DesignParameter['PMOS3']['_DesignObj']._DesignParameter['_PODummyLayer']['_XYCoordinates'][0][0])) / 2), self._DesignParameter['via_m1_m3_gate3']['_XYCoordinates'][0][1]], [self._DesignParameter['via_m1_m3_gate3']['_XYCoordinates'][0][0], self._DesignParameter['via_m1_m3_gate3']['_XYCoordinates'][0][1]]], [[self._DesignParameter['via_m1_m3_gate4']['_XYCoordinates'][1][0], self._DesignParameter['via_m1_m3_gate4']['_XYCoordinates'][1][1]], [(((self._DesignParameter['PMOS4']['_XYCoordinates'][1][0] + self._DesignParameter['PMOS4']['_DesignObj']._DesignParameter['_PODummyLayer']['_XYCoordinates'][0][0]) + (self._DesignParameter['PMOS3']['_XYCoordinates'][1][0] + self._DesignParameter['PMOS3']['_DesignObj']._DesignParameter['_PODummyLayer']['_XYCoordinates'][(- 1)][0])) / 2), self._DesignParameter['via_m1_m3_gate4']['_XYCoordinates'][1][1]], [(((self._DesignParameter['PMOS4']['_XYCoordinates'][1][0] + self._DesignParameter['PMOS4']['_DesignObj']._DesignParameter['_PODummyLayer']['_XYCoordinates'][0][0]) + (self._DesignParameter['PMOS3']['_XYCoordinates'][1][0] + self._DesignParameter['PMOS3']['_DesignObj']._DesignParameter['_PODummyLayer']['_XYCoordinates'][(- 1)][0])) / 2), self._DesignParameter['via_m1_m3_gate3']['_XYCoordinates'][1][1]], [self._DesignParameter['via_m1_m3_gate3']['_XYCoordinates'][1][0], self._DesignParameter['via_m1_m3_gate3']['_XYCoordinates'][1][1]]], [[self._DesignParameter['via_m1_m3_gate3']['_XYCoordinates'][0][0], self._DesignParameter['via_m1_m3_gate3']['_XYCoordinates'][0][1]], [(((self._DesignParameter['PMOS3']['_XYCoordinates'][0][0] + self._DesignParameter['PMOS3']['_DesignObj']._DesignParameter['_PODummyLayer']['_XYCoordinates'][(- 1)][0]) + (self._DesignParameter['PMOS2']['_XYCoordinates'][0][0] + self._DesignParameter['PMOS2']['_DesignObj']._DesignParameter['_PODummyLayer']['_XYCoordinates'][0][0])) / 2), self._DesignParameter['via_m1_m3_gate3']['_XYCoordinates'][0][1]], [(((self._DesignParameter['PMOS3']['_XYCoordinates'][0][0] + self._DesignParameter['PMOS3']['_DesignObj']._DesignParameter['_PODummyLayer']['_XYCoordinates'][(- 1)][0]) + (self._DesignParameter['PMOS2']['_XYCoordinates'][0][0] + self._DesignParameter['PMOS2']['_DesignObj']._DesignParameter['_PODummyLayer']['_XYCoordinates'][0][0])) / 2), max((((((self._DesignParameter['via_m1_m3_pmos2']['_XYCoordinates'][0][1] + self._DesignParameter['via_m1_m3_pmos2']['_DesignObj']._DesignParameter['ViaMet22Met3']['_XYCoordinates'][0][1]) + self._DesignParameter['via_m1_m3_pmos2']['_DesignObj']._DesignParameter['ViaMet22Met3']['_DesignObj']._DesignParameter['_Met3Layer']['_XYCoordinates'][0][1]) + (self._DesignParameter['via_m1_m3_pmos2']['_DesignObj']._DesignParameter['ViaMet22Met3']['_DesignObj']._DesignParameter['_Met3Layer']['_YWidth'] / 2)) + (self._DesignParameter['m3_clk_routing_x']['_Width'] / 2)) + drc._MetalxMinSpace2), self._DesignParameter['via_m1_m3_gate1']['_XYCoordinates'][0][1])], [(((self._DesignParameter['PMOS2']['_XYCoordinates'][0][0] + self._DesignParameter['PMOS2']['_DesignObj']._DesignParameter['_PODummyLayer']['_XYCoordinates'][(- 1)][0]) + (self._DesignParameter['PMOS1']['_XYCoordinates'][0][0] + self._DesignParameter['PMOS1']['_DesignObj']._DesignParameter['_PODummyLayer']['_XYCoordinates'][0][0])) / 2), max((((((self._DesignParameter['via_m1_m3_pmos2']['_XYCoordinates'][0][1] + self._DesignParameter['via_m1_m3_pmos2']['_DesignObj']._DesignParameter['ViaMet22Met3']['_XYCoordinates'][0][1]) + self._DesignParameter['via_m1_m3_pmos2']['_DesignObj']._DesignParameter['ViaMet22Met3']['_DesignObj']._DesignParameter['_Met3Layer']['_XYCoordinates'][0][1]) + (self._DesignParameter['via_m1_m3_pmos2']['_DesignObj']._DesignParameter['ViaMet22Met3']['_DesignObj']._DesignParameter['_Met3Layer']['_YWidth'] / 2)) + (self._DesignParameter['m3_clk_routing_x']['_Width'] / 2)) + drc._MetalxMinSpace2), self._DesignParameter['via_m1_m3_gate1']['_XYCoordinates'][0][1])], [(((self._DesignParameter['PMOS2']['_XYCoordinates'][0][0] + self._DesignParameter['PMOS2']['_DesignObj']._DesignParameter['_PODummyLayer']['_XYCoordinates'][(- 1)][0]) + (self._DesignParameter['PMOS1']['_XYCoordinates'][0][0] + self._DesignParameter['PMOS1']['_DesignObj']._DesignParameter['_PODummyLayer']['_XYCoordinates'][0][0])) / 2), self._DesignParameter['via_m1_m3_gate1']['_XYCoordinates'][0][1]], [self._DesignParameter['via_m1_m3_gate1']['_XYCoordinates'][0][0], self._DesignParameter['via_m1_m3_gate1']['_XYCoordinates'][0][1]]], [[self._DesignParameter['via_m1_m3_gate3']['_XYCoordinates'][1][0], self._DesignParameter['via_m1_m3_gate3']['_XYCoordinates'][1][1]], [(((self._DesignParameter['PMOS2']['_XYCoordinates'][1][0] + self._DesignParameter['PMOS2']['_DesignObj']._DesignParameter['_PODummyLayer']['_XYCoordinates'][(- 1)][0]) + (self._DesignParameter['PMOS3']['_XYCoordinates'][1][0] + self._DesignParameter['PMOS3']['_DesignObj']._DesignParameter['_PODummyLayer']['_XYCoordinates'][0][0])) / 2), self._DesignParameter['via_m1_m3_gate3']['_XYCoordinates'][1][1]], [(((self._DesignParameter['PMOS2']['_XYCoordinates'][1][0] + self._DesignParameter['PMOS2']['_DesignObj']._DesignParameter['_PODummyLayer']['_XYCoordinates'][(- 1)][0]) + (self._DesignParameter['PMOS3']['_XYCoordinates'][1][0] + self._DesignParameter['PMOS3']['_DesignObj']._DesignParameter['_PODummyLayer']['_XYCoordinates'][0][0])) / 2), max((((((self._DesignParameter['via_m1_m3_pmos2_1']['_XYCoordinates'][0][1] + self._DesignParameter['via_m1_m3_pmos2_1']['_DesignObj']._DesignParameter['ViaMet22Met3']['_XYCoordinates'][0][1]) + self._DesignParameter['via_m1_m3_pmos2_1']['_DesignObj']._DesignParameter['ViaMet22Met3']['_DesignObj']._DesignParameter['_Met3Layer']['_XYCoordinates'][0][1]) + (self._DesignParameter['via_m1_m3_pmos2_1']['_DesignObj']._DesignParameter['ViaMet22Met3']['_DesignObj']._DesignParameter['_Met3Layer']['_YWidth'] / 2)) + (self._DesignParameter['m3_clk_routing_x']['_Width'] / 2)) + drc._MetalxMinSpace2), self._DesignParameter['via_m1_m3_gate1']['_XYCoordinates'][0][1])], [(((self._DesignParameter['PMOS2']['_XYCoordinates'][1][0] + self._DesignParameter['PMOS2']['_DesignObj']._DesignParameter['_PODummyLayer']['_XYCoordinates'][0][0]) + (self._DesignParameter['PMOS1']['_XYCoordinates'][0][0] + self._DesignParameter['PMOS1']['_DesignObj']._DesignParameter['_PODummyLayer']['_XYCoordinates'][(- 1)][0])) / 2), max((((((self._DesignParameter['via_m1_m3_pmos2_1']['_XYCoordinates'][0][1] + self._DesignParameter['via_m1_m3_pmos2_1']['_DesignObj']._DesignParameter['ViaMet22Met3']['_XYCoordinates'][0][1]) + self._DesignParameter['via_m1_m3_pmos2_1']['_DesignObj']._DesignParameter['ViaMet22Met3']['_DesignObj']._DesignParameter['_Met3Layer']['_XYCoordinates'][0][1]) + (self._DesignParameter['via_m1_m3_pmos2_1']['_DesignObj']._DesignParameter['ViaMet22Met3']['_DesignObj']._DesignParameter['_Met3Layer']['_YWidth'] / 2)) + (self._DesignParameter['m3_clk_routing_x']['_Width'] / 2)) + drc._MetalxMinSpace2), self._DesignParameter['via_m1_m3_gate1']['_XYCoordinates'][0][1])], [(((self._DesignParameter['PMOS2']['_XYCoordinates'][1][0] + self._DesignParameter['PMOS2']['_DesignObj']._DesignParameter['_PODummyLayer']['_XYCoordinates'][0][0]) + (self._DesignParameter['PMOS1']['_XYCoordinates'][0][0] + self._DesignParameter['PMOS1']['_DesignObj']._DesignParameter['_PODummyLayer']['_XYCoordinates'][(- 1)][0])) / 2), self._DesignParameter['via_m1_m3_gate1']['_XYCoordinates'][0][1]], [self._DesignParameter['via_m1_m3_gate1']['_XYCoordinates'][0][0], self._DesignParameter['via_m1_m3_gate1']['_XYCoordinates'][0][1]]]]
