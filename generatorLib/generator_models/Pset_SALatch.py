...
class _Pset_SALatch(StickDiagram._StickDiagram):
	...
	def _CalculateDesignParameter(self,dummy=True,pccrit=True,xvt='SLVT',pmos1_gate=3,pmos1_width=400,pmos1_length=30,pmos1_gate_spacing=96,pmos1_sdwidth=50,pmos2_gate=1,pmos2_width=200,pmos2_length=40,pmos2_gate_spacing=96,pmos3_gate=1,pmos3_width=500,pmos3_length=30,pmos3_gate_spacing=96,pmos3_sdwidth=50,pmos4_gate=1,pmos4_width=700,pmos4_length=30,pmos4_gate_spacing=96,pmos4_sdwidth=50,pmos2_sdwidth=50,pguardring_co_bot=2,pguardring_co_top=3,pguardring_co_right=6,pguardring_co_left=6):
		...
		if pmos1_gate < 3 :
			_Lengthbtwvia=(drc._VIAxMinSpace+drc._VIAxMinWidth)/4
			self._DesignParameter['via_m1_m3_pmos_output']['_XYCoordinates']=[[self._DesignParameter['via_m1_m3_pmos_output']['_XYCoordinates'][0][0], self._DesignParameter['via_m1_m3_pmos_output']['_XYCoordinates'][0][1]+_Lengthbtwvia]]
			self._DesignParameter['via_m1_m3_pmos_supply']['_XYCoordinates']=[[self._DesignParameter['via_m1_m3_pmos_supply']['_XYCoordinates'][0][0], self._DesignParameter['via_m1_m3_pmos_supply']['_XYCoordinates'][0][1]-_Lengthbtwvia]]
		...
		self._DesignParameter['m3_pmos32']['_XYCoordinates'] = [[[self._DesignParameter['via_m1_m3_pmos3']['_XYCoordinates'][0][0], self._DesignParameter['via_m1_m3_pmos3']['_XYCoordinates'][0][1]], [(self._DesignParameter['PMOS2']['_XYCoordinates'][0][0]+self._DesignParameter['PMOS2']['_DesignObj']._DesignParameter['_PODummyLayer']['_XYCoordinates'][1][0]+self._DesignParameter['PMOS1']['_XYCoordinates'][0][0]+self._DesignParameter['PMOS1']['_DesignObj']._DesignParameter['_PODummyLayer']['_XYCoordinates'][0][0])/2, self._DesignParameter['via_m1_m3_pmos2']['_XYCoordinates'][(- 1)][1]]], [[self._DesignParameter['via_m1_m3_pmos3_1']['_XYCoordinates'][0][0], self._DesignParameter['via_m1_m3_pmos3_1']['_XYCoordinates'][0][1]], [(self._DesignParameter['PMOS2']['_XYCoordinates'][1][0]+self._DesignParameter['PMOS2']['_DesignObj']._DesignParameter['_PODummyLayer']['_XYCoordinates'][0][0]+self._DesignParameter['PMOS1']['_XYCoordinates'][0][0]+self._DesignParameter['PMOS1']['_DesignObj']._DesignParameter['_PODummyLayer']['_XYCoordinates'][1][0])/2, self._DesignParameter['via_m1_m3_pmos2_1']['_XYCoordinates'][(- 1)][1]]]]
		...
		if pmos1_gate > 1 :
			self._DesignParameter['pmos1_gate']['_XYCoordinates'] = [[self._DesignParameter['PMOS1']['_XYCoordinates'][0][0], max(((self._DesignParameter['m1_pmos_x']['_XYCoordinates'][(- 1)][0][1] + (self._DesignParameter['m1_pmos_x']['_Width'] / 2)) + (self._DesignParameter['pmos1_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2)) + drc._Metal1MinSpace2, self._DesignParameter['PMOS1']['_XYCoordinates'][0][1]+self._DesignParameter['PMOS1']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth']/2+self._DesignParameter['pmos1_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth']/2+drc._Metal1MinSpace2, self._DesignParameter['PMOS1']['_XYCoordinates'][0][1]+self._DesignParameter['PMOS1']['_DesignObj']._DesignParameter['_ODLayer']['_YWidth']/2+self._DesignParameter['pmos1_gate']['_DesignObj']._DesignParameter['_POLayer']['_YWidth']/2+drc._PolygateMinSpace2OD2, self._DesignParameter['via_m1_m3_pmos_supply']['_XYCoordinates'][0][1]+self._DesignParameter['via_m1_m3_pmos_supply']['_DesignObj']._DesignParameter['ViaMet12Met2']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth']/2+self._DesignParameter['pmos1_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth']/2+drc._Metal1MinSpace2, self._DesignParameter['via_m1_m3_pmos_output']['_XYCoordinates'][0][1]+self._DesignParameter['via_m1_m3_pmos_output']['_DesignObj']._DesignParameter['ViaMet12Met2']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth']/2+self._DesignParameter['pmos1_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth']/2+drc._Metal1MinSpace2)]]
		elif pmos1_gate == 1 :
			self._DesignParameter['pmos1_gate']['_XYCoordinates'] = [[self._DesignParameter['PMOS1']['_XYCoordinates'][0][0], max(self._DesignParameter['PMOS1']['_XYCoordinates'][0][1]+self._DesignParameter['PMOS1']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth']/2+self._DesignParameter['pmos1_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth']/2+drc._Metal1MinSpace2, self._DesignParameter['PMOS1']['_XYCoordinates'][0][1]+self._DesignParameter['PMOS1']['_DesignObj']._DesignParameter['_ODLayer']['_YWidth']/2+self._DesignParameter['pmos1_gate']['_DesignObj']._DesignParameter['_POLayer']['_YWidth']/2+drc._PolygateMinSpace2OD2, self._DesignParameter['via_m1_m3_pmos_supply']['_XYCoordinates'][0][1]+self._DesignParameter['via_m1_m3_pmos_supply']['_DesignObj']._DesignParameter['ViaMet12Met2']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth']/2+self._DesignParameter['pmos1_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth']/2+drc._Metal1MinSpace2, self._DesignParameter['via_m1_m3_pmos_output']['_XYCoordinates'][0][1]+self._DesignParameter['via_m1_m3_pmos_output']['_DesignObj']._DesignParameter['ViaMet12Met2']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth']/2+self._DesignParameter['pmos1_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth']/2+drc._Metal1MinSpace2)]]
		...
		if pmos1_gate > 1:
			...
			self._DesignParameter['nguardring']['_DesignObj']._CalculateDesignParameter(**dict(height=((max((self._DesignParameter['pmos1_gate']['_XYCoordinates'][0][1] + self._DesignParameter['pmos1_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][0][1] + self._DesignParameter['pmos1_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2), (self._DesignParameter['pmos3_gate']['_XYCoordinates'][0][1] + self._DesignParameter['pmos3_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][0][1] + self._DesignParameter['pmos3_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2), (self._DesignParameter['pmos4_gate']['_XYCoordinates'][0][1] + self._DesignParameter['pmos4_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][0][1] + self._DesignParameter['pmos4_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2), (self._DesignParameter['PMOS2']['_XYCoordinates'][0][1]+self._DesignParameter['PMOS2']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth']/2)) + self._DesignParameter['nguardring']['_DesignObj']._DesignParameter['met_top']['_YWidth'] / 2 + drc._Metal1MinSpace3 - ((min(((self._DesignParameter['PMOS1']['_XYCoordinates'][0][1] + self._DesignParameter['PMOS1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) - (self._DesignParameter['PMOS1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)), ((self._DesignParameter['PMOS4']['_XYCoordinates'][1][1] + self._DesignParameter['PMOS4']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) - (self._DesignParameter['PMOS4']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)), ((self._DesignParameter['PMOS3']['_XYCoordinates'][1][1] + self._DesignParameter['PMOS3']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) - (self._DesignParameter['PMOS3']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)), ((self._DesignParameter['pmos2_gate']['_XYCoordinates'][1][1] + self._DesignParameter['pmos2_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][0][1]) - (self._DesignParameter['pmos2_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2))) - (self._DesignParameter['nguardring']['_DesignObj']._DesignParameter['met_bot']['_YWidth'] / 2)) - drc._Metal1MinSpace3))), width=(((((self._DesignParameter['PMOS4']['_XYCoordinates'][1][0] + self._DesignParameter['PMOS4']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][(- 1)][0]) + (self._DesignParameter['PMOS4']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XWidth'] / 2)) + (self._DesignParameter['nguardring']['_DesignObj']._DesignParameter['met_right']['_XWidth'] / 2)) + drc._Metal1MinSpace3 + drc._Metal1MinSpace) - ((((self._DesignParameter['PMOS4']['_XYCoordinates'][0][0] + self._DesignParameter['PMOS4']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][0]) - (self._DesignParameter['PMOS4']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XWidth'] / 2)) - (self._DesignParameter['nguardring']['_DesignObj']._DesignParameter['met_left']['_XWidth'] / 2)) - drc._Metal1MinSpace3 - drc._Metal1MinSpace)), contact_bottom=pguardring_co_bot, contact_top=pguardring_co_top, contact_left=pguardring_co_left, contact_right=pguardring_co_right))
			self._DesignParameter['nguardring']['_XYCoordinates'] = [[self._DesignParameter['PMOS1']['_XYCoordinates'][0][0], (((max((self._DesignParameter['pmos1_gate']['_XYCoordinates'][0][1] + self._DesignParameter['pmos1_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][0][1] + self._DesignParameter['pmos1_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2), (self._DesignParameter['pmos3_gate']['_XYCoordinates'][0][1] + self._DesignParameter['pmos3_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][0][1] + self._DesignParameter['pmos3_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2), (self._DesignParameter['pmos4_gate']['_XYCoordinates'][0][1] + self._DesignParameter['pmos4_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][0][1] + self._DesignParameter['pmos4_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2), (self._DesignParameter['PMOS2']['_XYCoordinates'][0][1]+self._DesignParameter['PMOS2']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth']/2)) + self._DesignParameter['nguardring']['_DesignObj']._DesignParameter['met_top']['_YWidth'] / 2 + drc._Metal1MinSpace3 + ((min(((self._DesignParameter['PMOS1']['_XYCoordinates'][0][1] + self._DesignParameter['PMOS1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) - (self._DesignParameter['PMOS1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)),((self._DesignParameter['PMOS4']['_XYCoordinates'][1][1] + self._DesignParameter['PMOS4']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) - (self._DesignParameter['PMOS4']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)), ((self._DesignParameter['PMOS3']['_XYCoordinates'][1][1] + self._DesignParameter['PMOS3']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) - (self._DesignParameter['PMOS3']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)), ((self._DesignParameter['pmos2_gate']['_XYCoordinates'][1][1] + self._DesignParameter['pmos2_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][0][1]) - (self._DesignParameter['pmos2_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2))) - (self._DesignParameter['nguardring']['_DesignObj']._DesignParameter['met_bot']['_YWidth'] / 2)) - drc._Metal1MinSpace3))))/2]]
