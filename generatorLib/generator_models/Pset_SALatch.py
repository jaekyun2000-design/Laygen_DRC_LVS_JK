...
class EasyDebugModule(StickDiagram._StickDiagram):
	...
	def _CalculateDesignParameter(self,dummy=True,pccrit=True,xvt='SLVT',pmos1_gate=3,pmos1_width=400,pmos1_length=30,pmos1_gate_spacing=96,pmos1_sdwidth=50,pmos2_gate=4,pmos2_width=200,pmos2_length=40,pmos2_gate_spacing=96,pmos3_gate=1,pmos3_width=500,pmos3_length=30,pmos3_gate_spacing=96,pmos3_sdwidth=50,pmos4_gate=1,pmos4_width=700,pmos4_length=30,pmos4_gate_spacing=96,pmos4_sdwidth=50,pmos2_sdwidth=50,nguardring_co=2):
		...
		self._DesignParameter['via_m1_m3_gate3']['_DesignObj']._CalculateStackMinimumEnclosureY(**dict(COX=max(2, max(1, (1 + int((((self._DesignParameter['pmos3_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_XWidth'] - drc._VIAxMinSpace) - (2 * drc._VIAxMinEnclosureByMetx)) / (drc._VIAxMinWidth + drc._VIAxMinSpace)))))), COY=1, start_layer=1, end_layer=2))
		...
		self._DesignParameter['via_m1_m3_gate1']['_DesignObj']._CalculateStackMinimumEnclosureY(**dict(COX=max(2, max(1, (1 + int((((self._DesignParameter['pmos1_gate']['_DesignObj']._DesignParameter['_Met1Layer']['_XWidth'] - drc._VIAxMinSpace) - (2 * drc._VIAxMinEnclosureByMetx)) / (drc._VIAxMinWidth + drc._VIAxMinSpace)))))), COY=1, start_layer=1, end_layer=5))
		...
		self._DesignParameter['m3_clk_routing_x'] = self._PathElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL2'][0], _Datatype=DesignParameters._LayerMapping['METAL2'][1], _Width=self._DesignParameter['via_m1_m3_gate1']['_DesignObj']._DesignParameter['ViaMet22Met3']['_DesignObj']._DesignParameter['_Met3Layer']['_YWidth'])
