    ...
    def _CalculateDesignParameter(self,
        ...
        if TSI3_Finger == 1:
            self._DesignParameter['TSI3'] = self._SrefElementDeclaration(
                _Reflect=[0, 0, 0], _Angle=0,
                _DesignObj=TristateInverter_ljw.TristateInverter(_Name='TSI3In{}'.format(_Name)))[0]
        ...
        self._DesignParameter['TG4']['_XYCoordinates'] = [
                [self.getXY('INV6')[0][0] + self._DesignParameter['INV6']['_DesignObj'].CellXWidth / 2 + 1 * UnitPitch + self._DesignParameter['TG4']['_DesignObj'].CellXWidth / 2, 0]
            ]
        if INV7_Finger >= 3:
        ...
        self._DesignParameter['VSSRail_Met2'] = self._BoundaryElementDeclaration(
            ...
            _YWidth=self.getYWidth('INV8', 'PbodyContact', '_Met2Layer'),
        ...
        self._DesignParameter['VSSRail_OD'] = self._BoundaryElementDeclaration(
            ...
            _XWidth=rightBoundary - leftBoundary,
            _YWidth=self.getYWidth('INV8', 'PbodyContact', '_ODLayer'),
            _XYCoordinates=[[(rightBoundary + leftBoundary) / 2, 0]]
        )
        # VSS PP(BP)
        ...
        self._DesignParameter['VSSRail_PP'] = self._BoundaryElementDeclaration(
            ...
            _XWidth=rightBoundary - leftBoundary,
            _YWidth=self.getYWidth('INV8', 'PbodyContact', '_PPLayer'),
            _XYCoordinates=[[(rightBoundary + leftBoundary) / 2, 0]]
        )
        ## VDD
        # VDD M2
        ...
        self._DesignParameter['VDDRail_Met2'] = self._BoundaryElementDeclaration(
            _Layer=DesignParameters._LayerMapping['METAL2'][0], _Datatype=DesignParameters._LayerMapping['METAL2'][1],
            _XWidth=rightBoundary - leftBoundary,
            _YWidth=self.getYWidth('INV8', 'NbodyContact', '_Met2Layer'),
            _XYCoordinates=[[(rightBoundary + leftBoundary) / 2, self.getXY('INV8', 'NbodyContact', '_Met2Layer')[0][1]]]
        )
        # VDD OD(RX)
        ...
        self._DesignParameter['VDDRail_OD'] = self._BoundaryElementDeclaration(
            _Layer=DesignParameters._LayerMapping['DIFF'][0], _Datatype=DesignParameters._LayerMapping['DIFF'][1],
            _XWidth=rightBoundary - leftBoundary,
            _YWidth=self.getYWidth('INV8', 'NbodyContact', '_ODLayer'),
            _XYCoordinates=[[(rightBoundary + leftBoundary) / 2, self.getXY('INV8', 'NbodyContact', '_ODLayer')[0][1]]]
        )
        ...
        self._DesignParameter['XVTLayer'] = self._BoundaryElementDeclaration(
            ...
            _XYCoordinates=[[(rightBoundary + leftBoundary) / 2, self.getXY('INV8', 'XVTLayer')[0][1]]]
        )
        ...
        if TSI4_Finger == 1:
            ...
            if INV7_Finger >= 3:
                ...
                YCoord_dib2 = self.getXYBot('TSI4', 'met1_output_5')[0][1] + tmpViaMet2Width - tmpMet2Width / 2
        elif TSI4_Finger >= 3:
        ...
        self._DesignParameter['_Met2_dib_latch_latch'] = self._BoundaryElementDeclaration(
            ...
            _XWidth=rightBoundary2 - leftBoundary,
            _YWidth=tmpMet2Width,
            _XYCoordinates=[[(rightBoundary2 + leftBoundary) / 2, YCoord_dib_upper3+size_edge_M2]]################### YCoord_dib3 ???
        )
        ...
        self._DesignParameter['_ViaMet12Met2dib_latch_latch']['_XYCoordinates'] = [[self.getXYLeft('_Met2_dib_latch_latch')[0][0] + tmpMet2Width / 2, YCoord_dib_upper3+size_edge_M2 + tmpViaMet2Width / 2 - tmpMet2Width / 2],
                                                                       [self.getXYRight('_Met2_dib_latch_latch')[0][0] - tmpMet2Width / 2, YCoord_dib_upper3+size_edge_M2 ]]##+ tmpViaMet2Width / 2 - tmpMet2Width / 2
        ...
        if INV7_Finger <= 2:
            ...
            self._DesignParameter['_ViaMet12Met2dib_latch']['_XYCoordinates'].append([self.getXY('INV7', '_VIAPoly2Met1_F1', '_Met1Layer')[0][0], self.getXY('_Met2_dib_latch_latch')[0][1] ])
        else:
            self._DesignParameter['_ViaMet12Met2dib_latch']['_XYCoordinates'].append([self.getXY('INV7')[0][0] + self._DesignParameter['INV7']['_DesignObj']._DesignParameter['_InputRouting']['_XYCoordinates'][0][0][0], dib_margin+tmpViaMet2Width / 2 + (self.getXYTop('INV7', '_ViaMet12Met2OnNMOSOutput', '_Met2Layer')[0][1] - drc._MetalxMinEnclosureVia3 + drc._VIAzMinEnclosureByMetxOrMety + drc._VIAyMinSpace - (self.getXYBot('_ViaMet12Met2dib_latch', '_COLayer')[0][1] - self.getXYBot('_ViaMet12Met2dib_latch_latch', '_Met2Layer')[0][1]))])
        ...
        self._DesignParameter['_ViaMet12Met2iclkb_latch']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] = tmpViaMet2Width
        ...
        if CellHeight >2000:
            YCoord_dib_upper4=YCoord_dib3++TG1_NMWidth/2
        else :
            YCoord_dib_upper4=YCoord_dib3
        ...
        self._DesignParameter['_Met2_inv4']['_XYCoordinates']=[[[self.getXY('INV4', '_PMOS', '_XYCoordinatePMOSOutputRouting')[-1][0] - tmpMet2Width/2, YCoord_dib_upper4],
                                                             [TG3in + tmpMet2Width/2, YCoord_dib_upper4]]]
        ...
        if TSI2_Finger ==1:
            self._DesignParameter['_ViaMet12Met2q']['_XYCoordinates'] = [[self.getXY('INV4', '_PMOS', '_XYCoordinatePMOSOutputRouting')[-1][0] + self.getWidth('INV4', '_OutputRouting') / 2- tmpMet2Width/2, YCoord_dib_upper4],[TG3in+ self.getWidth('INV4', '_OutputRouting') / 2- tmpMet2Width/2, YCoord_dib_upper4]]

        elif TSI2_Finger==2:
            self._DesignParameter['_ViaMet12Met2q']['_XYCoordinates'] = [[TG3in+ self.getWidth('INV4', '_OutputRouting') / 2- tmpMet2Width/2, YCoord_dib_upper4]]


        ###### TG4in to inv6out (added by jwlee)

        if INV6_Finger <= 2:
            Boundary=self.getXY('INV6', '_VIAPoly2Met1_F1', '_Met1Layer')[0][0]+ tmpMet2Width/2
        else:
            Boundary=self.getXY('INV6')[0][0] + self._DesignParameter['INV6']['_DesignObj']._DesignParameter['_InputRouting']['_XYCoordinates'][0][0][0]+ tmpMet2Width/2


        if INV6_Finger >= 3:
            YCoord_dib4 = self.getXYTop('INV6', '_ViaMet12Met2OnNMOSOutput', '_Met2Layer')[0][1] + tmpDRC_Met2Spacing + tmpMet2Width / 2
        elif INV6_Finger < 3:
            YCoord_dib4 =YCoord_dib2

        if CellHeight >2000:
            YCoord_dib_upper5=YCoord_dib4+TG1_NMWidth/2
        else :
            YCoord_dib_upper5=YCoord_dib4

        TG4in = self.getXY('TG4')[0][0] +self._DesignParameter['TG4']['_DesignObj']._DesignParameter['m1_source_routing_y']['_XYCoordinates'][0][0][0]
        self._DesignParameter['_Met2_inv6'] = self._PathElementDeclaration(
            _Layer=DesignParameters._LayerMapping['METAL2'][0], _Datatype=DesignParameters._LayerMapping['METAL2'][1],
            _Width=tmpMet2Width
        )

        self._DesignParameter['_Met2_inv6']['_XYCoordinates']=[[[Boundary - tmpMet2Width, YCoord_dib_upper5],
                                                             [TG4in + tmpMet2Width/2, YCoord_dib_upper5]]]

        self._DesignParameter['_Met1_in6'] = self._PathElementDeclaration(
            _Layer=DesignParameters._LayerMapping['METAL1'][0], _Datatype=DesignParameters._LayerMapping['METAL1'][1],
            _Width=tmpMet2Width
        )

        if INV6_Finger <= 2:
            self._DesignParameter['_Met1_in6']['_XYCoordinates']=[[[self.getXY('INV6', '_VIAPoly2Met1_F1', '_Met1Layer')[0][0], self.getXY('INV6', '_VIAPoly2Met1_F1', '_Met1Layer')[0][1]],
                                                             [self.getXY('INV6', '_VIAPoly2Met1_F1', '_Met1Layer')[0][0], YCoord_dib_upper5]]]
        ...
        if TSI3_Finger ==1:
            self._DesignParameter['_ViaMet12Met2q_latch']['_XYCoordinates'] = [[Boundary - tmpMet2Width/2, YCoord_dib_upper5+ tmpViaMet2Width / 2 - tmpMet2Width / 2],[TG4in+self.getWidth('INV6', '_OutputRouting') / 2- tmpMet2Width/2, YCoord_dib_upper5]]
        ...
        self._DesignParameter['_ViaMet12Met2iclk_latch']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] = tmpViaMet2Width
        ...
        ########################### inv6 revise ###########
        if INV6_Finger>=3:
            self._DesignParameter['INV6']['_DesignObj']._DesignParameter['_ViaMet12Met2OnNMOSOutput']['_XYCoordinates'] = []

            _ViaOnPMOSOutput = copy.deepcopy(ViaMet12Met2._ViaMet12Met2._ParametersForDesignCalculation)
            _ViaOnPMOSOutput['_ViaMet12Met2NumberOfCOX'] = 1
            _ViaOnPMOSOutput['_ViaMet12Met2NumberOfCOY'] = 1

            self._DesignParameter['inv6output']=self._SrefElementDeclaration(_DesignObj=ViaMet12Met2._ViaMet12Met2(_Name='inv6outputIn{}'.format(_Name)))[0]
            self._DesignParameter['inv6output']['_DesignObj']._CalculateViaMet12Met2DesignParameterMinimumEnclosureX(**_ViaOnPMOSOutput)
            self._DesignParameter['inv6output']['_XYCoordinates']= self.getXY('INV6', '_NMOS', '_XYCoordinateNMOSOutputRouting')
