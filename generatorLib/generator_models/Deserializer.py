...
class Deserializer1to32(StickDiagram._StickDiagram):
    ...
    def _CalculateDesignParameter(self,
        ...
        #
        # self._DesignParameter['Clk_Driver']['_XYCoordinates'] = [[
        #     self.getXY('DeMux1to2_3')[0][0] + self._DesignParameter['DeMux1to2_3']['_DesignObj'].CellXWidth + self._DesignParameter['Clk_Driver']['_DesignObj']._DesignParameter['DFFQb1']['_DesignObj']._DesignParameter['TG1']['_DesignObj'].CellXWidth/2 +UnitPitch ,
        #     self._DesignParameter['DeMux1to2_3']['_XYCoordinates'][0][1]]]
        #
        # self._DesignParameter['DeMux1to4_4']['_XYCoordinates'] = [[
        #     self.getXY('DeMux1to2_3')[0][0] + self._DesignParameter['DeMux1to2_3']['_DesignObj'].CellXWidth + self._DesignParameter['DeMux1to4_4']['_DesignObj']._DesignParameter['DFF_Latch_Latch']['_DesignObj']._DesignParameter['TG1']['_DesignObj'].CellXWidth/2 +UnitPitch ,
        #     self._DesignParameter['DeMux1to2_3']['_XYCoordinates'][0][1]+2*CellHeight]]
        # self._DesignParameter['DeMux1to4_3']['_XYCoordinates'] = [[
        #     self.getXY('DeMux1to2_3')[0][0] + self._DesignParameter['DeMux1to2_3']['_DesignObj'].CellXWidth + self._DesignParameter['DeMux1to4_3']['_DesignObj']._DesignParameter['DFF_Latch_Latch']['_DesignObj']._DesignParameter['TG1']['_DesignObj'].CellXWidth/2 +UnitPitch ,
        #     self._DesignParameter['DeMux1to2_3']['_XYCoordinates'][0][1]+2*CellHeight]]
        # self._DesignParameter['DeMux1to4_2']['_XYCoordinates'] = [[
        #     self.getXY('DeMux1to2_3')[0][0] + self._DesignParameter['DeMux1to2_3']['_DesignObj'].CellXWidth + self._DesignParameter['DeMux1to4_2']['_DesignObj']._DesignParameter['DFF_Latch_Latch']['_DesignObj']._DesignParameter['TG1']['_DesignObj'].CellXWidth/2 +UnitPitch ,
        #     self._DesignParameter['DeMux1to2_3']['_XYCoordinates'][0][1]+4*CellHeight]]
        # self._DesignParameter['DeMux1to4_1']['_XYCoordinates'] = [[
        #     self.getXY('DeMux1to2_3')[0][0] + self._DesignParameter['DeMux1to2_3']['_DesignObj'].CellXWidth + self._DesignParameter['DeMux1to4_1']['_DesignObj']._DesignParameter['DFF_Latch_Latch']['_DesignObj']._DesignParameter['TG1']['_DesignObj'].CellXWidth/2 +UnitPitch ,
        #     self._DesignParameter['DeMux1to2_3']['_XYCoordinates'][0][1]+4*CellHeight]]
        #
        # self._DesignParameter['DeMux1to4_5']['_XYCoordinates'] = [[
        #     self.getXY('DeMux1to2_3')[0][0] + self._DesignParameter['DeMux1to2_3']['_DesignObj'].CellXWidth + self._DesignParameter['DeMux1to4_5']['_DesignObj']._DesignParameter['DFF_Latch_Latch']['_DesignObj']._DesignParameter['TG1']['_DesignObj'].CellXWidth/2 +UnitPitch ,
        #     self._DesignParameter['DeMux1to2_3']['_XYCoordinates'][0][1]]]
        # self._DesignParameter['DeMux1to4_6']['_XYCoordinates'] = [[
        #     self.getXY('DeMux1to2_3')[0][0] + self._DesignParameter['DeMux1to2_3']['_DesignObj'].CellXWidth + self._DesignParameter['DeMux1to4_6']['_DesignObj']._DesignParameter['DFF_Latch_Latch']['_DesignObj']._DesignParameter['TG1']['_DesignObj'].CellXWidth/2 +UnitPitch ,
        #     self._DesignParameter['DeMux1to2_3']['_XYCoordinates'][0][1]-2*CellHeight]]
        # self._DesignParameter['DeMux1to4_7']['_XYCoordinates'] = [[
        #     self.getXY('DeMux1to2_3')[0][0] + self._DesignParameter['DeMux1to2_3']['_DesignObj'].CellXWidth + self._DesignParameter['DeMux1to4_7']['_DesignObj']._DesignParameter['DFF_Latch_Latch']['_DesignObj']._DesignParameter['TG1']['_DesignObj'].CellXWidth/2 +UnitPitch ,
        #     self._DesignParameter['DeMux1to2_3']['_XYCoordinates'][0][1]-2*CellHeight]]
        # self._DesignParameter['DeMux1to4_8']['_XYCoordinates'] = [[
        #     self.getXY('DeMux1to2_3')[0][0] + self._DesignParameter['DeMux1to2_3']['_DesignObj'].CellXWidth + self._DesignParameter['DeMux1to4_8']['_DesignObj']._DesignParameter['DFF_Latch_Latch']['_DesignObj']._DesignParameter['TG1']['_DesignObj'].CellXWidth/2 +UnitPitch ,
        #     self._DesignParameter['DeMux1to2_3']['_XYCoordinates'][0][1]-4*CellHeight]]
