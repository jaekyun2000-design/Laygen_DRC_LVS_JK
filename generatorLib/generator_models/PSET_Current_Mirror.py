...
class _PSET_Current_Mirror(StickDiagram._StickDiagram):
	...
	def _CalculateDesignParameter(self,pmos1_param={'finger': 2, 'width': 1500, 'length': 100, 'dummy': True, 'xvt': 'LVT', 'pccrit': False, 'guardring_co_right': 3, 'guardring_co_left': 3, 'guardring_co_top': 4, 'guardring_co_bottom': 2},\
								  pmos2_param={'finger': 2, 'width': 1500, 'length': 100, 'dummy': True, 'xvt': 'LVT', 'pccrit': False, 'guardring_co_right': 3, 'guardring_co_left': 3, 'guardring_co_top': 4, 'guardring_co_bottom': 2},\
								  pmos3_param={'finger': 2, 'width': 1500, 'length': 100, 'dummy': True, 'xvt': 'LVT', 'pccrit': 'False ', 'guardring_co_right': 3, 'guardring_co_left': 3, 'guardring_co_top': 4, 'guardring_co_bottom': 2},\
		...
		self._DesignParameter['pmos2'] = self._SrefElementDeclaration(_DesignObj=pmos_current_mirror.EasyDebugModule(_Name='pmos2In{}'.format(_Name)))[0]
		...
		self._DesignParameter['pmos1'] = self._SrefElementDeclaration(_DesignObj=pmos_current_mirror.EasyDebugModule(_Name='pmos1In{}'.format(_Name)))[0]
		...
		self._DesignParameter['pmos3'] = self._SrefElementDeclaration(_DesignObj=pmos_current_mirror.EasyDebugModule(_Name='pmos3In{}'.format(_Name)))[0]
		...
		self._DesignParameter['pmos_cap'] = self._SrefElementDeclaration(_DesignObj=pmos_cap_current_mirror.EasyDebugModule(_Name='pmos_capIn{}'.format(_Name)))[0]
