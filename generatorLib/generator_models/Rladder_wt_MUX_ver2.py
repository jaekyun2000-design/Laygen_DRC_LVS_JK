...
from generatorLib.generator_models import Two2TwentyEight_MUX
...
class Rladder_wt_MUX(StickDiagram._StickDiagram):
	...
	def _CalculateDesignParameter(self,Cell_height=1800,Num_of_Vref=8,UNITR_X_WIDTH=1500,UNITR_Y_LENGTH=1000,UNITR_CONT_X_NUM=None,UNITR_CONT_Y_NUM=1,Rladder_X_NUM=10,Rladder_Y_NUM=5,First_Vref_Point=8,VREF_STEP=5,MUX_INV_nmos_width=180,MUX_INV_finger=1,MUX_VDD2PMOS=410,MUX_gate_length=30,MUX_gate_spacing=100,MUX_XVT='\'RVT\'',MUX_nmos_y=375,MUX_cell_height=1800,MUX_TG_pmos_width=600,MUX_TG_nmos_width=300,MUX_TG_poly_y=760,MUX_nandin_y=860):
