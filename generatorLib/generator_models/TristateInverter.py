...
class TristateInverter(StickDiagram._StickDiagram):
    ...
    def _CalculateDesignParameterFinger1(self,
        ...
        self._DesignParameter['VSSRouting'] = self._BoundaryElementDeclaration(
            ...
            _XWidth=self._DesignParameter['CascodeNMOS']['_DesignObj']._DesignParameter['_Met1Layer']['_XWidth'],
            _YWidth=(((self._DesignParameter['CascodeNMOS']['_XYCoordinates'][0][1] + self._DesignParameter['CascodeNMOS']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][0][1]) + (self._DesignParameter['CascodeNMOS']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2)) - (self._DesignParameter['VSSRail']['_XYCoordinates'][0][1])))
        self._DesignParameter['VSSRouting']['_XYCoordinates'] = [[
            (self._DesignParameter['CascodeNMOS']['_XYCoordinates'][0][0] + self._DesignParameter['CascodeNMOS']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][1][0]),
            ((((self._DesignParameter['CascodeNMOS']['_XYCoordinates'][0][1] + self._DesignParameter['CascodeNMOS']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][0][1]) + (self._DesignParameter['CascodeNMOS']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2)) + (self._DesignParameter['VSSRail']['_XYCoordinates'][0][1])) / 2)]]
        self._DesignParameter['VDDRouting'] = self._BoundaryElementDeclaration(
            _Layer=DesignParameters._LayerMapping['METAL1'][0],
            _Datatype=DesignParameters._LayerMapping['METAL1'][1],
            _XWidth=self._DesignParameter['CascodePMOS']['_DesignObj']._DesignParameter['_Met1Layer']['_XWidth'],
            _YWidth=(self._DesignParameter['VDDRail']['_XYCoordinates'][0][1] - ((self._DesignParameter['CascodePMOS']['_XYCoordinates'][0][1] + self._DesignParameter['CascodePMOS']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][0][1]) - (self._DesignParameter['CascodePMOS']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2))))
        self._DesignParameter['VDDRouting']['_XYCoordinates'] = [[(self._DesignParameter['CascodePMOS']['_XYCoordinates'][0][0] + self._DesignParameter['CascodePMOS']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][1][0]), (((self._DesignParameter['VDDRail']['_XYCoordinates'][0][1]) + ((self._DesignParameter['CascodePMOS']['_XYCoordinates'][0][1] + self._DesignParameter['CascodePMOS']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][0][1]) - (self._DesignParameter['CascodePMOS']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2))) / 2)]]
        ...
        Xgap_InputContactPoly2DummyPoly = (-(GateSpacing + ChannelLength) - self.getXWidth('InputVia_EN', '_POLayer') / 2) \
                                          - (self.getXY('CascodeNMOS', '_PODummyLayer')[0][0] + self.getXWidth('CascodeNMOS', '_PODummyLayer') / 2)
        ...
        if YCoordOfInputEN == None:
            YCoordOfInputVia_EN = math.ceil(self.getXY('CascodeNMOS', '_PODummyLayer')[0][1] + self.getYWidth('CascodeNMOS', '_PODummyLayer') / 2 \
        ...
        if YCoordOfInputENb == None:
            YCoordOfInputVia_ENb = math.floor(self.getXY('CascodePMOS', '_PODummyLayer')[0][1] - self.getYWidth('CascodePMOS', '_PODummyLayer') / 2 \
                                              - Ygap_InputContactPoly2DummyPoly \
        ...
        if YCoordOfInputA == None:
            YCoordOfInputVia_A = math.ceil((self.getXY('CascodeNMOS')[0][1] + self.getXY('CascodePMOS')[0][1]) / 2)
        else:
            YCoordOfInputVia_A = YCoordOfInputA

        self._DesignParameter['InputVia_EN']['_XYCoordinates'] = [[int(self.getXY('CascodeNMOS', '_Met1Layer')[0][0]), YCoordOfInputVia_EN]]
        self._DesignParameter['InputVia_ENb']['_XYCoordinates'] = [[int(self.getXY('CascodeNMOS', '_Met1Layer')[0][0]), YCoordOfInputVia_ENb]]
        self._DesignParameter['InputVia_A']['_XYCoordinates'] = [[int(self.getXY('CascodeNMOS', '_Met1Layer')[-1][0]), YCoordOfInputVia_A]]
        ...
        self._DesignParameter['PIN_EN'] = self._TextElementDeclaration(
            ...
            _Datatype=DesignParameters._LayerMapping['METAL1PIN'][1],
            _Presentation=[0, 1, 1], _Reflect=[0, 0, 0], _Mag=0.01, _Angle=0, _TEXT='EN',
            _XYCoordinates=[[int(self.getXY('CascodeNMOS', '_Met1Layer')[0][0]), YCoordOfInputVia_EN]],
        )
