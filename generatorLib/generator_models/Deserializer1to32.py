    ...
    def _CalculateDesignParameter(self,
        ...
        if Deserialize1toN is 32:
            ...
            if dummy is True:
                ...
                self._DesignParameter['_PMOS1']['_XYCoordinates'] = [[
                    self.getXY('Clk_Driver_1')[0][0] + 2 * self._DesignParameter['Clk_Driver_1'][
                        '_DesignObj'].CellXWidth + UnitPitch + (self._DesignParameter['DeMux1to4_1'][
                                                                    '_DesignObj'].CellXWidth - 2 *
                                                                self._DesignParameter['Clk_Driver_1'][
                                                                    '_DesignObj'].CellXWidth - UnitPitch) / 2,
                    self._DesignParameter['DeMux1to2_3']['_XYCoordinates'][0][1] +
                    self.getXY('DeMux1to2_3', 'DFF_Latch', 'INV5', '_PMOS')[0][1]]]
                    ...
                    self.getXY('Clk_Driver_1')[0][0] + 2 * self._DesignParameter['Clk_Driver_1'][
                        '_DesignObj'].CellXWidth + UnitPitch + (self._DesignParameter['DeMux1to4_1'][
                                                                ...
                                                                self._DesignParameter['Clk_Driver_1'][
                                                                    '_DesignObj'].CellXWidth - UnitPitch) / 2,
                    self._DesignParameter['DeMux1to2_3']['_XYCoordinates'][0][1] +
                    self.getXY('DeMux1to2_3', 'DFF_Latch', 'INV6', '_NMOS')[0][1]]]

                dummy_ycoor = self._DesignParameter['DeMux1to2_3']['_XYCoordinates'][0][1] + \
                              self.getXY('DeMux1to2_3', 'DFF_Latch', 'INV6', '_NMOS')[0][1]
                polyspacing = 57
                gatepolyywidth = 60

                ############## add gate poly on dummy
                self._DesignParameter['_AdditionalPolyOnGate'] = self._BoundaryElementDeclaration(
                    _Layer=DesignParameters._LayerMapping['POLY'][0],
                    _Datatype=DesignParameters._LayerMapping['POLY'][1], _XYCoordinates=[], _XWidth=None, _YWidth=None,
                    _ElementName=None, )
                ...
                self._DesignParameter['_AdditionalPolyOnGate']['_XYCoordinates'] = [
                    [self._DesignParameter['_NMOS1']['_XYCoordinates'][0][0],
                     self._DesignParameter['_NMOS1']['_XYCoordinates'][0][
                         1] + INV5_NMWidth / 2 + polyspacing + gatepolyywidth / 2], \
                    [self._DesignParameter['_NMOS1']['_XYCoordinates'][0][0],
                     self._DesignParameter['_PMOS1']['_XYCoordinates'][0][
                         1] - INV5_PMWidth / 2 - polyspacing - gatepolyywidth / 2]]
                ...
                self._DesignParameter['_AdditionalPolyOnGate2']['_XYCoordinates'] = [
                    [self.getXY('Clk_Driver_1')[0][0] + 2 * self._DesignParameter['Clk_Driver_1'][
                        '_DesignObj'].CellXWidth + 2 * UnitPitch + totalwidth,
            ...
            self._DesignParameter['_Met3_clkin']['_XYCoordinates'] = [[[self.getXY('DeMux1to2_3')[0][0],
                                                                       ...
                                                                       [
                                                                           self._DesignParameter['DeMux1to2_3'][
                                                                               '_DesignObj'].clk[
                                                                               0] + 4 * tmpDSspace + tmpViaMet2Width / 2,
                                                                           self.getXY('DeMux1to2_3')[0][
                                                                               1] + 5 * CellHeight + tmpDSspace + 3 * clkrouting / 2 - tmpMet2Width / 2]], \
 \
            ...
            self._DesignParameter['_Met4_clkin']['_XYCoordinates'] = [
                ...
                [[self._DesignParameter['DeMux1to2_3']['_DesignObj'].clkb[0] - 4 * tmpDSspace,
                  self._DesignParameter['DeMux1to2_3']['_DesignObj'].clkb[1]], [
                     self._DesignParameter['DeMux1to2_3']['_DesignObj'].clkb[0] - 4 * tmpDSspace,
                     self.getXY('DeMux1to2_3')[0][
                         1] + 5 * CellHeight - tmpDSspace - 3 * clkrouting / 2 + tmpMet2Width / 2]]]  # clk_dividier signal
            ...
            self._DesignParameter['_ViaMet32Met4_clkin2']['_DesignObj']._CalculateDesignParameterSameEnclosure(
                **dict(_ViaMet32Met4NumberOfCOX=1, _ViaMet32Met4NumberOfCOY=1))
            self._DesignParameter['_ViaMet32Met4_clkin2']['_DesignObj']._DesignParameter['_Met4Layer'][
                '_XWidth'] = tmpViaMet2Width
            self._DesignParameter['_ViaMet32Met4_clkin2']['_DesignObj']._DesignParameter['_Met3Layer'][
                '_XWidth'] = tmpViaMet2Width
            self._DesignParameter['_ViaMet32Met4_clkin2']['_DesignObj']._DesignParameter['_COLayer'][
                '_XWidth'] = tmpVia1YWidth

            self._DesignParameter['_ViaMet32Met4_clkin2']['_XYCoordinates'] = [
                [self._DesignParameter['DeMux1to2_3']['_DesignObj'].clk[0] + 4 * tmpDSspace,
            ...
            self._DesignParameter['_Met3_clk_drc']['_XYCoordinates'] = [
                [[self.getXY('Clk_Driver_2')[0][0] + self._DesignParameter['Clk_Driver_2']['_DesignObj'].f[0],
                  self.getXY('Clk_Driver_2')[0][1] +
                  self._DesignParameter['Clk_Driver_2']['_DesignObj']._DesignParameter['DFFQb1']['_DesignObj'].iclkb], \
                 [self.getXY('Clk_Driver_2')[0][0] + self._DesignParameter['Clk_Driver_2']['_DesignObj'].f[0], \
                  self.getXY('Clk_Driver_2')[0][1] +
                  self._DesignParameter['Clk_Driver_2']['_DesignObj']._DesignParameter['DFFQb1'][
                      '_DesignObj'].iclkb + 70]]]
            ...
            self._DesignParameter['_ViaMet32Met4_clk1st_del'] = self._SrefElementDeclaration(
                _DesignObj=ViaMet32Met4._ViaMet32Met4(_Name='_ViaMet32Met4_clk1st_delIn{}'.format(_Name)))[0]
            self._DesignParameter['_ViaMet32Met4_clk1st_del']['_DesignObj']._CalculateDesignParameterSameEnclosure(
                **dict(_ViaMet32Met4NumberOfCOX=1, _ViaMet32Met4NumberOfCOY=1))
            self._DesignParameter['_ViaMet32Met4_clk1st_del']['_DesignObj']._DesignParameter['_Met4Layer'][
                '_YWidth'] = tmpViaMet2Width
            self._DesignParameter['_ViaMet32Met4_clk1st_del']['_DesignObj']._DesignParameter['_Met3Layer'][
                '_YWidth'] = tmpViaMet2Width
            self._DesignParameter['_ViaMet32Met4_clk1st_del']['_DesignObj']._DesignParameter['_COLayer'][
                '_YWidth'] = tmpVia1YWidth

            self._DesignParameter['_ViaMet32Met4_clk1st_2_del'] = self._SrefElementDeclaration(
                _DesignObj=ViaMet32Met4._ViaMet32Met4(_Name='_ViaMet32Met4_clk1st_2_delIn{}'.format(_Name)))[0]
            self._DesignParameter['_ViaMet32Met4_clk1st_2_del']['_DesignObj']._CalculateDesignParameterSameEnclosure(
                **dict(_ViaMet32Met4NumberOfCOX=1, _ViaMet32Met4NumberOfCOY=1))
            self._DesignParameter['_ViaMet32Met4_clk1st_2_del']['_DesignObj']._DesignParameter['_Met4Layer'][
                '_XWidth'] = tmpViaminWidth
            self._DesignParameter['_ViaMet32Met4_clk1st_2_del']['_DesignObj']._DesignParameter['_Met3Layer'][
                '_XWidth'] = tmpViaminWidth
            self._DesignParameter['_ViaMet32Met4_clk1st_2_del']['_DesignObj']._DesignParameter['_COLayer'][
                '_XWidth'] = tmpVia1YWidth

            self._DesignParameter['_ViaMet32Met4_clk1st_del']['_XYCoordinates'] = [
                [self.getXY('Clk_Driver_1', 'DFFQb1', '_qpin')[-1][0],
                 self.getXY('Clk_Driver_1', 'DFFQb1', '_qpin')[-1][1]]]
            self._DesignParameter['_ViaMet32Met4_clk1st_2_del']['_XYCoordinates'] = [
            ...
            self._DesignParameter['_ViaMet32Met4_clk1st_del']['_XYCoordinates'].append(
                [self.getXY('Clk_Driver_1', 'DFFQb2', '_qpin')[-1][0],
                 self.getXY('Clk_Driver_1', 'DFFQb2', '_qpin')[-1][1]])
            self._DesignParameter['_ViaMet32Met4_clk1st_2_del']['_XYCoordinates'].append(
            ...
            self._DesignParameter['_Met3_clk1st_via2']['_XYCoordinates'] = [[[self.getXY('Clk_Driver_1', 'DFFQb2',
                                                                                         '_qpin')[-1][0],
            ...
            self._DesignParameter['_Met4_clk1st']['_XYCoordinates'].append([[self.getXY('Clk_Driver_1', 'DFFQb1',
                                                                            ...
                                                                            [self.getXY('Clk_Driver_1', 'DFFQb1',
                                                                                        '_qbpin')[0][0],
                                                                             CellHeight - tmpDSspace - tmpDSspace-maxspacing]])  # qb
            ...
            self._DesignParameter['_Met4_clk1st']['_XYCoordinates'].append([[self._DesignParameter['DeMux1to2_1'][
                                                                            ...
                                                                            [self._DesignParameter['DeMux1to2_1'][
                                                                                 '_DesignObj'].clk[0],
                                                                             CellHeight + tmpDSspace + 2 * tmpDSspace]])  # q
            ...
            self._DesignParameter['_Met3_clk1st']['_XYCoordinates'] = [
                [[self._DesignParameter['DeMux1to2_1']['_DesignObj'].clk[0], CellHeight + tmpDSspace + 2 * tmpDSspace], \
                 [self.getXY('Clk_Driver_1', 'DFFQb1', '_qpin')[-1][0], CellHeight + tmpDSspace + 2 * tmpDSspace]]]  # q

            self._DesignParameter['_Met3_clk1st']['_XYCoordinates'].append(
                [[self.getXY('Clk_Driver_1', 'DFFQb1', '_qbpin')[0][0], CellHeight - tmpDSspace - tmpDSspace-maxspacing], \
                 [self._DesignParameter['DeMux1to2_1']['_DesignObj'].clkb[0],
                  CellHeight - tmpDSspace - tmpDSspace-maxspacing]])  # qb
            ...
            self._DesignParameter['_ViaMet32Met4_clk1st_2']['_XYCoordinates'].append(
                [self._DesignParameter['DeMux1to2_1']['_DesignObj'].clk[0] + tmpViaminWidth / 2 - tmpMet2Width / 2,
                 CellHeight + tmpDSspace + 2 * tmpDSspace])
            self._DesignParameter['_ViaMet32Met4_clk1st_2']['_XYCoordinates'].append(
                [self.getXY('Clk_Driver_1', 'DFFQb1', '_qpin')[-1][0] - tmpViaminWidth / 2 + tmpMet2Width / 2,
                 CellHeight + tmpDSspace + 2 * tmpDSspace])
            self._DesignParameter['_ViaMet32Met4_clk1st_2']['_XYCoordinates'].append(
                [self._DesignParameter['DeMux1to2_1']['_DesignObj'].clkb[0] + tmpViaminWidth / 2 - tmpMet2Width / 2,
                 CellHeight - tmpDSspace - tmpDSspace-maxspacing])

            self._DesignParameter['_ViaMet32Met4_clk1st_3'] = self._SrefElementDeclaration(
                _DesignObj=ViaMet32Met4._ViaMet32Met4(_Name='_ViaMet32Met4_clk1st_3In{}'.format(_Name)))[0]
            self._DesignParameter['_ViaMet32Met4_clk1st_3']['_DesignObj']._CalculateDesignParameterSameEnclosure(
                **dict(_ViaMet32Met4NumberOfCOX=1, _ViaMet32Met4NumberOfCOY=1))
            self._DesignParameter['_ViaMet32Met4_clk1st_3']['_DesignObj']._DesignParameter['_Met4Layer'][
                '_XWidth'] = 170
            self._DesignParameter['_ViaMet32Met4_clk1st_3']['_DesignObj']._DesignParameter['_Met3Layer'][
                '_XWidth'] = 170
            self._DesignParameter['_ViaMet32Met4_clk1st_3']['_DesignObj']._DesignParameter['_COLayer'][
                '_XWidth'] = tmpVia1YWidth

            self._DesignParameter['_ViaMet32Met4_clk1st_3']['_XYCoordinates']=[
                [self.getXY('Clk_Driver_1', 'DFFQb1', '_qbpin')[0][0] - tmpViaminWidth / 2 + tmpMet2Width / 2,
                 CellHeight - tmpDSspace - tmpDSspace-maxspacing]]
            ...
            self._DesignParameter['_Met4_clk1st']['_XYCoordinates'].append([[self.getXY('Clk_Driver_1', 'DFFQb1',
                                                                            ...
                                                                            [self.getXY('Clk_Driver_1', 'DFFQb1',
                                                                                        '_qbpin')[0][0],
                                                                             +tmpDSspace + tmpDSspace+maxspacing_2]])  # qb
            ...
            self._DesignParameter['_Met3_clk1st']['_XYCoordinates'].append(
                [[self._DesignParameter['DeMux1to2_5']['_DesignObj'].clk[0], -tmpDSspace - 2 * tmpDSspace], \
                 [self.getXY('Clk_Driver_1', 'DFFQb1', '_qpin')[-1][0], -tmpDSspace - 2 * tmpDSspace]])  # q

            self._DesignParameter['_Met3_clk1st']['_XYCoordinates'].append(
                [[self.getXY('Clk_Driver_1', 'DFFQb1', '_qbpin')[0][0], +tmpDSspace + tmpDSspace+maxspacing_2], \
                 [self._DesignParameter['DeMux1to2_5']['_DesignObj'].clkb[0], +tmpDSspace + tmpDSspace+maxspacing_2]])  # qb
            # Demux1to2_5 via
            self._DesignParameter['_ViaMet32Met4_clk1st_2']['_XYCoordinates'].append(
            ...
            self._DesignParameter['_ViaMet32Met4_clk1st_2']['_XYCoordinates'].append(
                [self._DesignParameter['DeMux1to2_5']['_DesignObj'].clk[0] + tmpViaminWidth / 2 - tmpMet2Width / 2,
                 -tmpDSspace - 2 * tmpDSspace])
            self._DesignParameter['_ViaMet32Met4_clk1st_2']['_XYCoordinates'].append(
                [self.getXY('Clk_Driver_1', 'DFFQb1', '_qpin')[-1][0] - tmpViaminWidth / 2 + tmpMet2Width / 2,
                 -tmpDSspace - 2 * tmpDSspace])
            self._DesignParameter['_ViaMet32Met4_clk1st_2']['_XYCoordinates'].append(
                [self.getXY('Clk_Driver_1', 'DFFQb1', '_qbpin')[0][0] - tmpViaminWidth / 2 + tmpMet2Width / 2,
                 tmpDSspace + tmpDSspace+maxspacing_2])
            self._DesignParameter['_ViaMet32Met4_clk1st_2']['_XYCoordinates'].append(
                [self._DesignParameter['DeMux1to2_5']['_DesignObj'].clkb[0] + tmpViaminWidth / 2 - tmpMet2Width / 2,
                 tmpDSspace + tmpDSspace+maxspacing_2])
            ...
            self._DesignParameter['_Met4_clk1st']['_XYCoordinates'].append(
                [self.getXY('Clk_Driver_1', 'DFFQb2', '_qpin')[-1], \
                 [self.getXY('Clk_Driver_1', 'DFFQb2', '_qpin')[-1][0], CellHeight + 2 * tmpDSspace+up_maxspacing]])  # q
            ...
            self._DesignParameter['_Met4_clk1st']['_XYCoordinates'].append([[self.getXY('Clk_Driver_1', 'DFFQb2',
                                                                            ...
                                                                            [self.getXY('Clk_Driver_1', 'DFFQb2',
                                                                                        '_qbpin')[0][0],
                                                                             CellHeight - 2 * tmpDSspace - tmpDSspace]])  # qb
            ...
            self._DesignParameter['_Met4_clk1st']['_XYCoordinates'].append([[self._DesignParameter['DeMux1to2_2'][
                                                                            ...
                                                                            [self._DesignParameter['DeMux1to2_2'][
                                                                                 '_DesignObj'].clk[0] - tmpDSspace,
                                                                             CellHeight + 2 * tmpDSspace+up_maxspacing]])  # q
            ...
            self._DesignParameter['_Met3_clk1st']['_XYCoordinates'].append(
                [[self._DesignParameter['DeMux1to2_2']['_DesignObj'].clk[0] - tmpDSspace, CellHeight + 2 * tmpDSspace+up_maxspacing], \
                 [self.getXY('Clk_Driver_1', 'DFFQb2', '_qpin')[-1][0], CellHeight + 2 * tmpDSspace+up_maxspacing]])  # q

            self._DesignParameter['_Met3_clk1st']['_XYCoordinates'].append(
                [[self.getXY('Clk_Driver_1', 'DFFQb2', '_qbpin')[0][0], CellHeight - 2 * tmpDSspace - tmpDSspace], \
            ...
            self._DesignParameter['_Met4_clk1st']['_XYCoordinates'].append(
                [self.getXY('Clk_Driver_1', 'DFFQb2', '_qpin')[-1], \
                 [self.getXY('Clk_Driver_1', 'DFFQb2', '_qpin')[-1][0], -2 * tmpDSspace-low_maxspacing]])  # q
            ...
            self._DesignParameter['_Met3_clk1st']['_XYCoordinates'].append(
                [[self._DesignParameter['DeMux1to2_4']['_DesignObj'].clk[0] - tmpDSspace, -2 * tmpDSspace-low_maxspacing], \
                 [self.getXY('Clk_Driver_1', 'DFFQb2', '_qpin')[-1][0], -2 * tmpDSspace-low_maxspacing]])  # q

            self._DesignParameter['_Met3_clk1st']['_XYCoordinates'].append(
                [[self.getXY('Clk_Driver_1', 'DFFQb2', '_qbpin')[0][0], 2 * tmpDSspace + tmpDSspace], \
                 [self._DesignParameter['DeMux1to2_4']['_DesignObj'].clkb[0] - tmpDSspace,
                  2 * tmpDSspace + tmpDSspace]])  # qb
            # Demux1to2_4 via
            self._DesignParameter['_ViaMet32Met4_clk1st_2']['_XYCoordinates'].append([self._DesignParameter[
                                                                                          'DeMux1to2_4'][
            ...
            self._DesignParameter['_ViaMet32Met4_clk1st_2']['_XYCoordinates'].append([self._DesignParameter[
                                                                                          ...
                                                                                          '_DesignObj'].clk[
                                                                                          0] - tmpViaminWidth / 2 + tmpMet2Width / 2 - tmpDSspace,
                                                                                      -2 * tmpDSspace-low_maxspacing])
            self._DesignParameter['_ViaMet32Met4_clk1st_2']['_XYCoordinates'].append(
                [self.getXY('Clk_Driver_1', 'DFFQb2', '_qpin')[-1][0] - tmpViaminWidth / 2 + tmpMet2Width / 2,
                 -2 * tmpDSspace-low_maxspacing])
            self._DesignParameter['_ViaMet32Met4_clk1st_2']['_XYCoordinates'].append(
                [self.getXY('Clk_Driver_1', 'DFFQb2', '_qbpin')[0][0] - tmpViaminWidth / 2 + tmpMet2Width / 2,
                 2 * tmpDSspace + tmpDSspace])
            self._DesignParameter['_ViaMet32Met4_clk1st_2']['_XYCoordinates'].append([self._DesignParameter[
                                                                                          'DeMux1to2_4'][
                                                                                          '_DesignObj'].clkb[
                                                                                          0] - tmpViaminWidth / 2 + tmpMet2Width / 2 - tmpDSspace,
            ...
            if a > b or a < (b - 10 * tmpDSspace):
                ...
                self._DesignParameter['_Met4_clk2nd_del']['_XYCoordinates'].append(
                    [[self.getXY('Clk_Driver_2', 'DFFQb2',
                                 '_qbpin')[0][
                          0] + 10 * tmpDSspace,
                      self._DesignParameter['Clk_Driver_2'][
                ...
                self._DesignParameter['_Met4_clk2nd']['_XYCoordinates'].append(
                    [self.getXY('Clk_Driver_2', 'DFFQb1', '_qpin')[-1], \
                     [self.getXY('Clk_Driver_2', 'DFFQb1', '_qpin')[-1][0],
                      1 * CellHeight + tmpDSspace + tmpDSspace]])  # f16
                self._DesignParameter['_Met4_clk2nd']['_XYCoordinates'].append([[self._DesignParameter['DeMux1to4_1'][
                                                                                     '_XYCoordinates'][0][0] +
                                                                                 self._DesignParameter['DeMux1to4_1'][
                                                                                     '_DesignObj'].clkb[
                ...
                self._DesignParameter['_ViaMet32Met4_clk2nd']['_XYCoordinates'].append(
                    [self.getXY('Clk_Driver_2', 'DFFQb2', '_qbpin')[0][0] + 12 * tmpDSspace,
                     -2 * tmpDSspace - tmpViaMet2Width / 2 + tmpMet2Width / 2])  # f16_90
                self._DesignParameter['_ViaMet32Met4_clk2nd']['_XYCoordinates'].append(
                    [self.getXY('Clk_Driver_2', 'DFFQb2', '_qbpin')[0][0] + 10 * tmpDSspace,
                ...
                self._DesignParameter['_Met3_clk1st_via']['_XYCoordinates'] = [
                    [[self.getXY('Clk_Driver_2', 'DFFQb2', '_qbpin')[0][0] + 12 * tmpDSspace,
                     ...
                     [self._DesignParameter['DeMux1to4_1']['_XYCoordinates'][0][0] +
                      self._DesignParameter['DeMux1to4_1']['_DesignObj'].clk90[2][0] + 4 * tmpDSspace,
                      1 * CellHeight + 2 * tmpDSspace + 30]]]
            ...
            self._DesignParameter['_Met3_clk2nd']['_XYCoordinates'] = [[[self._DesignParameter['DeMux1to4_1'][
                                                                         ...
                                                                         self._DesignParameter['DeMux1to4_1'][
                                                                             '_DesignObj'].clk[0],
                                                                         3 * CellHeight + tmpDSspace + tmpDSspace+30], \
                                                                        [self._DesignParameter['DeMux1to4_1'][
                                                                             '_XYCoordinates'][0][0] +
                                                                         self._DesignParameter['DeMux1to4_1'][
                                                                             '_DesignObj'].clkb[0] + 4 * tmpDSspace,
            ...
            self._DesignParameter['_Met3_clk2nd']['_XYCoordinates'].append([[self._DesignParameter['DeMux1to4_8'][
                                                                             ...
                                                                             self._DesignParameter['DeMux1to4_8'][
                                                                                 '_DesignObj'].clk[0],
                                                                             -2 * CellHeight - tmpDSspace - tmpDSspace-30], \
                                                                            [self._DesignParameter['DeMux1to4_1'][
                                                                                 '_XYCoordinates'][0][0] +
                                                                             self._DesignParameter['DeMux1to4_1'][
                                                                                 '_DesignObj'].clkb[0] + 4 * tmpDSspace,
            ...
            self._DesignParameter['_clkpin']['_XYCoordinates'] = [
                [self.getXY('DeMux1to2_3')[0][0] + tmpDSspace, self.getXY('Clk_Driver_1')[0][
                    1] + 5 * CellHeight + tmpDSspace + 3 * clkrouting / 2 - tmpMet2Width / 2]]
