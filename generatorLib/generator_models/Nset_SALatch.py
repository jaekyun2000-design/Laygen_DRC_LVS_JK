...
class EasyDebugModule(StickDiagram._StickDiagram):
	...
	def _CalculateDesignParameter(self,nmos1_gate=4,nmos1_width=1000,nmos1_length=30,nmos1_gate_spacing=96,nmos1_sdwidth=50,dummy=True,pccrit=True,xvt='SLVT',nmos2_gate=4,nmos2_width=1000,nmos2_length=40,nmos2_gate_spacing=96,nmos2_sdwidth=50,nmos3_gate=4,nmos3_width=500,nmos3_length=40,nmos3_gate_spacing=96,nmos3_sdwidth=50,pguardring_co=2):
		...
		self._DesignParameter['nmos2_input']['_XYCoordinates'] = [[self._DesignParameter['NMOS2']['_XYCoordinates'][0][0], ((max((((self._DesignParameter['via_nmos2_m1_m2_supply']['_XYCoordinates'][0][1] + self._DesignParameter['via_nmos2_m1_m2_supply']['_DesignObj']._DesignParameter['ViaMet12Met2']['_XYCoordinates'][0][1]) + self._DesignParameter['via_nmos2_m1_m2_supply']['_DesignObj']._DesignParameter['ViaMet12Met2']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][0][1]) + (self._DesignParameter['via_nmos2_m1_m2_supply']['_DesignObj']._DesignParameter['ViaMet12Met2']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2)), ((self._DesignParameter['via_nmos2_m1_m2_drain']['_XYCoordinates'][0][1] + self._DesignParameter['via_nmos2_m1_m2_drain']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][0][1]) + (self._DesignParameter['via_nmos2_m1_m2_drain']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2)), ((self._DesignParameter['NMOS2']['_XYCoordinates'][0][1] + self._DesignParameter['NMOS2']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) + (self._DesignParameter['NMOS2']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2))) + (self._DesignParameter['nmos2_input']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2)) + 60)], [self._DesignParameter['NMOS2']['_XYCoordinates'][1][0], ((max((((self._DesignParameter['via_nmos2_1_m1_m2_supply']['_XYCoordinates'][0][1] + self._DesignParameter['via_nmos2_1_m1_m2_supply']['_DesignObj']._DesignParameter['ViaMet12Met2']['_XYCoordinates'][0][1]) + self._DesignParameter['via_nmos2_1_m1_m2_supply']['_DesignObj']._DesignParameter['ViaMet12Met2']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][0][1]) + (self._DesignParameter['via_nmos2_1_m1_m2_supply']['_DesignObj']._DesignParameter['ViaMet12Met2']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2)), ((self._DesignParameter['via_nmos2_1_m1_m2_drain']['_XYCoordinates'][0][1] + self._DesignParameter['via_nmos2_1_m1_m2_drain']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][0][1]) + (self._DesignParameter['via_nmos2_1_m1_m2_drain']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2)), ((self._DesignParameter['NMOS2']['_XYCoordinates'][1][1] + self._DesignParameter['NMOS2']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) + (self._DesignParameter['NMOS2']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2))) + (self._DesignParameter['nmos2_input']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2)) + 60)]]
		path_list = []
		...
		self._DesignParameter['nmos3_gate_input']['_XYCoordinates'] = [[self._DesignParameter['NMOS1']['_XYCoordinates'][0][0], ((max((((self._DesignParameter['via_nmos1_m1_m2_supply']['_XYCoordinates'][0][1] + self._DesignParameter['via_nmos1_m1_m2_supply']['_DesignObj']._DesignParameter['ViaMet12Met2']['_XYCoordinates'][0][1]) + self._DesignParameter['via_nmos1_m1_m2_supply']['_DesignObj']._DesignParameter['ViaMet12Met2']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][0][1]) + (self._DesignParameter['via_nmos1_m1_m2_supply']['_DesignObj']._DesignParameter['ViaMet12Met2']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2)), ((self._DesignParameter['NMOS1']['_XYCoordinates'][0][1] + self._DesignParameter['NMOS1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) + (self._DesignParameter['NMOS1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2))) + (self._DesignParameter['nmos3_gate_input']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2)) + 60)]]
		path_list = []
		...
		self._DesignParameter['via_nmos3_gate']['_DesignObj']._CalculateStackMinimumEnclosureY(**dict(COX=max(1, max(1, (1 + int((((self._DesignParameter['nmos3_input']['_DesignObj']._DesignParameter['_Met1Layer']['_XWidth'] - drc._VIAxMinSpace) - (2 * drc._VIAxMinEnclosureByMetx)) / (drc._VIAxMinWidth + drc._VIAxMinSpace)))))), COY=1, start_layer=1, end_layer=3))
		self._DesignParameter['via_nmos3_gate']['_XYCoordinates'] = [[self._DesignParameter['nmos3_input']['_XYCoordinates'][0][0], self._DesignParameter['nmos3_input']['_XYCoordinates'][0][1]], [self._DesignParameter['nmos3_input']['_XYCoordinates'][1][0], self._DesignParameter['nmos3_input']['_XYCoordinates'][1][1]]]
		...
		self._DesignParameter['via_nmos2_gate']['_DesignObj']._CalculateStackMinimumEnclosureY(**dict(COX=max(1, max(1, (1 + int((((self._DesignParameter['nmos2_input']['_DesignObj']._DesignParameter['_Met1Layer']['_XWidth'] - drc._VIAxMinSpace) - (2 * drc._VIAxMinEnclosureByMetx)) / (drc._VIAxMinWidth + drc._VIAxMinSpace)))))), COY=1, start_layer=1, end_layer=3))
		self._DesignParameter['via_nmos2_gate']['_XYCoordinates'] = [[self._DesignParameter['nmos2_input']['_XYCoordinates'][0][0], self._DesignParameter['nmos2_input']['_XYCoordinates'][0][1]], [self._DesignParameter['nmos2_input']['_XYCoordinates'][1][0], self._DesignParameter['nmos2_input']['_XYCoordinates'][1][1]]]
		...
		self._DesignParameter['via_nmos1_gate']['_DesignObj']._CalculateStackMinimumEnclosureY(**dict(COX=max(1, max(1, (1 + int((((self._DesignParameter['nmos3_gate_input']['_DesignObj']._DesignParameter['_Met1Layer']['_XWidth'] - drc._VIAxMinSpace) - (2 * drc._VIAxMinEnclosureByMetx)) / (drc._VIAxMinWidth + drc._VIAxMinSpace)))))), COY=1, start_layer=1, end_layer=3))
		self._DesignParameter['via_nmos1_gate']['_XYCoordinates'] = [[self._DesignParameter['nmos3_gate_input']['_XYCoordinates'][0][0], self._DesignParameter['nmos3_gate_input']['_XYCoordinates'][0][1]]]
