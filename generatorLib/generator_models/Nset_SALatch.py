...
class EasyDebugModule(StickDiagram._StickDiagram):
	...
	def _CalculateDesignParameter(self,nmos1_gate=4,nmos1_width=500,nmos1_length=30,nmos1_gate_spacing=96,nmos1_sdwidth=50,dummy=True,pccrit=True,xvt='SLVT',nmos2_gate=4,nmos2_width=1000,nmos2_length=40,nmos2_gate_spacing=96,nmos2_sdwidth=50,nmos3_gate=4,nmos3_width=500,nmos3_length=40,nmos3_gate_spacing=96,nmos3_sdwidth=50,pguardring_co_bot=3,pguardring_co_top=2,pguardring_co_right=3,pguardring_co_left=3):
		...
		if (nmos3_gate == 1):
		    self._DesignParameter['nmos3_input']['_XYCoordinates'][0][1] += 6
		    self._DesignParameter['nmos3_input']['_XYCoordinates'][1][1] += 6
		path_list = []
		xy_offset = [0, 0]
		...
		if (nmos2_gate == 1):
		    self._DesignParameter['nmos2_input']['_XYCoordinates'][0][1] += 6
		    self._DesignParameter['nmos2_input']['_XYCoordinates'][1][1] += 6
		path_list = []
		xy_offset = [0, 0]
		...
		if (nmos1_gate == 1):
		    self._DesignParameter['nmos3_gate_input']['_XYCoordinates'][0][1] += 6
		self._DesignParameter['psubring'] = self._SrefElementDeclaration(_DesignObj=PSubRing.PSubRing(_Name='psubringIn{}'.format(_Name)))[0]
		self._DesignParameter['psubring']['_DesignObj']._CalculateDesignParameter(**dict(height=5000, width=3000, contact_bottom=3, contact_top=2, contact_left=3, contact_right=3))
		...
		self._DesignParameter['psubring']['_XYCoordinates'] = [[self._DesignParameter['NMOS1']['_XYCoordinates'][0][0], ((((((max(((self._DesignParameter['nmos3_input']['_XYCoordinates'][0][1] + self._DesignParameter['nmos3_input']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][0][1]) + (self._DesignParameter['nmos3_input']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2)), ((self._DesignParameter['nmos2_input']['_XYCoordinates'][0][1] + self._DesignParameter['nmos2_input']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][0][1]) + (self._DesignParameter['nmos2_input']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2)), ((self._DesignParameter['nmos3_gate_input']['_XYCoordinates'][0][1] + self._DesignParameter['nmos3_gate_input']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][0][1]) + (self._DesignParameter['nmos3_gate_input']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2))) + (self._DesignParameter['psubring']['_DesignObj']._DesignParameter['top']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2)) + drc._Metal1MinSpace3) + min(((self._DesignParameter['NMOS3']['_XYCoordinates'][0][1] + self._DesignParameter['NMOS3']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) - (self._DesignParameter['NMOS3']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)), ((self._DesignParameter['NMOS2']['_XYCoordinates'][0][1] + self._DesignParameter['NMOS2']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) - (self._DesignParameter['NMOS2']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)), ((self._DesignParameter['NMOS1']['_XYCoordinates'][0][1] + self._DesignParameter['NMOS1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) - (self._DesignParameter['NMOS1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)))) - (self._DesignParameter['psubring']['_DesignObj']._DesignParameter['bot']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2)) - drc._Metal1MinSpace3) / 2)]]
		path_list = []
		xy_offset = [0, 0]
