...
class EasyDebugModule(StickDiagram._StickDiagram):
	...
	def _CalculateDesignParameter(self,nmos1_gate=4,nmos1_width=1500,nmos1_length=30,nmos1_gate_spacing=96,nmos1_sdwidth=50,dummy=True,pccrit=True,xvt='SLVT',nmos2_gate=4,nmos2_width=1000,nmos2_length=40,nmos2_gate_spacing=96,nmos2_sdwidth=50,nmos3_gate=4,nmos3_width=500,nmos3_length=40,nmos3_gate_spacing=96,nmos3_sdwidth=50,pguardring_co=2):
		...
		cont_nmos3 = max(1, max(1, (1 + int(((((self._DesignParameter['NMOS3']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2) - drc._VIAxMinSpace) - (2 * drc._VIAxMinEnclosureByMetx)) / (drc._VIAxMinWidth + drc._VIAxMinSpace))))))
		...
		self._DesignParameter['via_nmos3_m1_m2_supply']['_DesignObj']._CalculateDesignParameterSameEnclosure(**dict(_ViaMet12Met2NumberOfCOX=1, _ViaMet12Met2NumberOfCOY=cont_nmos3))
		...
		self._DesignParameter['via_nmos3_1_m1_m2_supply']['_DesignObj']._CalculateDesignParameterSameEnclosure(**dict(_ViaMet12Met2NumberOfCOX=1, _ViaMet12Met2NumberOfCOY=cont_nmos3))
		...
		XYList = []
		xy_offset = (0, (((- self._DesignParameter['NMOS3']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth']) / 2) + (self._DesignParameter['via_nmos3_m1_m2_drain']['_DesignObj']._DesignParameter['_Met2Layer']['_YWidth'] / 2)))
		for i in range(len(self._DesignParameter['NMOS3']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'])):
		    if ((i % 2) == 1):
		        xy = (self._DesignParameter['NMOS3']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][i][0] if (type(self._DesignParameter['NMOS3']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][i][0]) == list) else self._DesignParameter['NMOS3']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][i])
		        XYList.append([((x + y) + z) for (x, y, z) in zip([(0 + self._DesignParameter['NMOS3']['_XYCoordinates'][0][0]), (0 + self._DesignParameter['NMOS3']['_XYCoordinates'][0][1])], xy, xy_offset)])
		...
		self._DesignParameter['nmos3_input']['_XYCoordinates'] = [[self._DesignParameter['NMOS3']['_XYCoordinates'][0][0], ((max(((self._DesignParameter['NMOS3']['_XYCoordinates'][1][1] + self._DesignParameter['NMOS3']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) + (self._DesignParameter['NMOS3']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)), ((self._DesignParameter['via_nmos3_m1_m2_supply']['_XYCoordinates'][0][1] + self._DesignParameter['via_nmos3_m1_m2_supply']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][0][1]) + (self._DesignParameter['via_nmos3_m1_m2_supply']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2))) + (self._DesignParameter['nmos3_input']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2)) + 60)], [self._DesignParameter['NMOS3']['_XYCoordinates'][1][0], ((max(((self._DesignParameter['NMOS3']['_XYCoordinates'][1][1] + self._DesignParameter['NMOS3']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) + (self._DesignParameter['NMOS3']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)), ((self._DesignParameter['via_nmos3_1_m1_m2_supply']['_XYCoordinates'][0][1] + self._DesignParameter['via_nmos3_1_m1_m2_supply']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][0][1]) + (self._DesignParameter['via_nmos3_1_m1_m2_supply']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2))) + (self._DesignParameter['nmos3_input']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2)) + 60)]]
		path_list = []
		...
		self._DesignParameter['via_nmos3_m2_m3_supply']['_DesignObj']._CalculateDesignParameterSameEnclosure(**dict(_ViaMet22Met3NumberOfCOX=1, _ViaMet22Met3NumberOfCOY=cont_nmos3))
		...
		self._DesignParameter['via_nmos3_1_m2_m3_supply']['_DesignObj']._CalculateDesignParameterSameEnclosure(**dict(_ViaMet22Met3NumberOfCOX=1, _ViaMet22Met3NumberOfCOY=cont_nmos3))
		...
		self._DesignParameter['via_nmos3_m2_m3_drain'] = self._SrefElementDeclaration(_DesignObj=ViaMet22Met3._ViaMet22Met3(_Name='via_nmos3_m2_m3_drainIn{}'.format(_Name)))[0]
		self._DesignParameter['via_nmos3_m2_m3_drain']['_DesignObj']._CalculateDesignParameterSameEnclosure(**dict(_ViaMet22Met3NumberOfCOX=1, _ViaMet22Met3NumberOfCOY=cont_nmos3))
		self._DesignParameter['via_nmos3_m2_m3_drain']['_XYCoordinates'] = None
		XYList = []
		xy_offset = [0, 0]
		for i in range(len(self._DesignParameter['via_nmos3_m1_m2_drain']['_XYCoordinates'])):
		    xy = (self._DesignParameter['via_nmos3_m1_m2_drain']['_XYCoordinates'][i][0] if (type(self._DesignParameter['via_nmos3_m1_m2_drain']['_XYCoordinates'][i][0]) == list) else self._DesignParameter['via_nmos3_m1_m2_drain']['_XYCoordinates'][i])
		    XYList.append([((x + y) + z) for (x, y, z) in zip([0, 0], xy, xy_offset)])
		self._DesignParameter['via_nmos3_m2_m3_drain']['_XYCoordinates'] = XYList
		self._DesignParameter['via_nmos3_1_m2_m3_drain'] = self._SrefElementDeclaration(_DesignObj=ViaMet22Met3._ViaMet22Met3(_Name='via_nmos3_1_m2_m3_drainIn{}'.format(_Name)))[0]
		self._DesignParameter['via_nmos3_1_m2_m3_drain']['_DesignObj']._CalculateDesignParameterSameEnclosure(**dict(_ViaMet22Met3NumberOfCOX=1, _ViaMet22Met3NumberOfCOY=cont_nmos3))
		self._DesignParameter['via_nmos3_1_m2_m3_drain']['_XYCoordinates'] = None
		XYList = []
		xy_offset = [0, 0]
		for i in range(len(self._DesignParameter['via_nmos3_1_m1_m2_drain']['_XYCoordinates'])):
		    xy = (self._DesignParameter['via_nmos3_1_m1_m2_drain']['_XYCoordinates'][i][0] if (type(self._DesignParameter['via_nmos3_1_m1_m2_drain']['_XYCoordinates'][i][0]) == list) else self._DesignParameter['via_nmos3_1_m1_m2_drain']['_XYCoordinates'][i])
		    XYList.append([((x + y) + z) for (x, y, z) in zip([0, 0], xy, xy_offset)])
		self._DesignParameter['via_nmos3_1_m2_m3_drain']['_XYCoordinates'] = XYList
		...
		self._DesignParameter['m3_nmos3_source']['_XYCoordinates'] = [[[self._DesignParameter['via_nmos3_m2_m3_supply']['_XYCoordinates'][0][0], self._DesignParameter['via_nmos3_m2_m3_supply']['_XYCoordinates'][0][1]], [self._DesignParameter['via_nmos3_m2_m3_supply']['_XYCoordinates'][(- 1)][0], self._DesignParameter['via_nmos3_m2_m3_supply']['_XYCoordinates'][(- 1)][1]]], [[self._DesignParameter['via_nmos3_1_m2_m3_supply']['_XYCoordinates'][0][0], self._DesignParameter['via_nmos3_1_m2_m3_supply']['_XYCoordinates'][0][1]], [self._DesignParameter['via_nmos3_1_m2_m3_supply']['_XYCoordinates'][(- 1)][0], self._DesignParameter['via_nmos3_1_m2_m3_supply']['_XYCoordinates'][(- 1)][1]]]]
		...
		XYList = []
		xy_offset = (0, ((- (self._DesignParameter['NMOS2']['_XYCoordinates'][0][1] + self._DesignParameter['NMOS2']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1])) + self._DesignParameter['via_nmos3_m2_m3_drain']['_XYCoordinates'][0][1]))
		...
		XYList = []
		xy_offset = (0, ((- (self._DesignParameter['NMOS2']['_XYCoordinates'][1][1] + self._DesignParameter['NMOS2']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1])) + self._DesignParameter['via_nmos3_1_m2_m3_drain']['_XYCoordinates'][0][1]))
		...
		self._DesignParameter['via_nmos2_m2_m3_drain'] = self._SrefElementDeclaration(_DesignObj=ViaMet22Met3._ViaMet22Met3(_Name='via_nmos2_m2_m3_drainIn{}'.format(_Name)))[0]
		self._DesignParameter['via_nmos2_m2_m3_drain']['_DesignObj']._CalculateDesignParameterSameEnclosure(**dict(_ViaMet22Met3NumberOfCOX=1, _ViaMet22Met3NumberOfCOY=cont_nmos3))
		self._DesignParameter['via_nmos2_m2_m3_drain']['_XYCoordinates'] = None
		XYList = []
		xy_offset = [0, 0]
		for i in range(len(self._DesignParameter['via_nmos2_m1_m2_drain']['_XYCoordinates'])):
		    xy = (self._DesignParameter['via_nmos2_m1_m2_drain']['_XYCoordinates'][i][0] if (type(self._DesignParameter['via_nmos2_m1_m2_drain']['_XYCoordinates'][i][0]) == list) else self._DesignParameter['via_nmos2_m1_m2_drain']['_XYCoordinates'][i])
		    XYList.append([((x + y) + z) for (x, y, z) in zip([0, 0], xy, xy_offset)])
		self._DesignParameter['via_nmos2_m2_m3_drain']['_XYCoordinates'] = XYList
		self._DesignParameter['via_nmos2_1_m2_m3_drain'] = self._SrefElementDeclaration(_DesignObj=ViaMet22Met3._ViaMet22Met3(_Name='via_nmos2_1_m2_m3_drainIn{}'.format(_Name)))[0]
		self._DesignParameter['via_nmos2_1_m2_m3_drain']['_DesignObj']._CalculateDesignParameterSameEnclosure(**dict(_ViaMet22Met3NumberOfCOX=1, _ViaMet22Met3NumberOfCOY=cont_nmos3))
		self._DesignParameter['via_nmos2_1_m2_m3_drain']['_XYCoordinates'] = None
		XYList = []
		xy_offset = [0, 0]
		for i in range(len(self._DesignParameter['via_nmos2_1_m1_m2_drain']['_XYCoordinates'])):
		    xy = (self._DesignParameter['via_nmos2_1_m1_m2_drain']['_XYCoordinates'][i][0] if (type(self._DesignParameter['via_nmos2_1_m1_m2_drain']['_XYCoordinates'][i][0]) == list) else self._DesignParameter['via_nmos2_1_m1_m2_drain']['_XYCoordinates'][i])
		    XYList.append([((x + y) + z) for (x, y, z) in zip([0, 0], xy, xy_offset)])
		self._DesignParameter['via_nmos2_1_m2_m3_drain']['_XYCoordinates'] = XYList
		self._DesignParameter['m3_nmos3_drain'] = self._PathElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL3'][0], _Datatype=DesignParameters._LayerMapping['METAL3'][1], _Width=min(self._DesignParameter['via_nmos3_m2_m3_drain']['_DesignObj']._DesignParameter['_Met3Layer']['_YWidth'], (4 * drc._MetalxMinWidth)))
		self._DesignParameter['m3_nmos3_drain']['_XYCoordinates'] = [[[self._DesignParameter['via_nmos3_m2_m3_drain']['_XYCoordinates'][0][0], self._DesignParameter['via_nmos3_m2_m3_drain']['_XYCoordinates'][0][1]], [self._DesignParameter['via_nmos2_m2_m3_drain']['_XYCoordinates'][(- 1)][0], self._DesignParameter['via_nmos3_m2_m3_drain']['_XYCoordinates'][(- 1)][1]]], [[self._DesignParameter['via_nmos2_1_m2_m3_drain']['_XYCoordinates'][(- 1)][0], self._DesignParameter['via_nmos3_1_m2_m3_drain']['_XYCoordinates'][0][1]], [self._DesignParameter['via_nmos3_1_m2_m3_drain']['_XYCoordinates'][0][0], self._DesignParameter['via_nmos3_1_m2_m3_drain']['_XYCoordinates'][(- 1)][1]]]]
		self._DesignParameter['via_nmos2_m1_m3_supply'] = self._SrefElementDeclaration(_DesignObj=ViaStack._ViaStack(_Name='via_nmos2_m1_m3_supplyIn{}'.format(_Name)))[0]
		self._DesignParameter['via_nmos2_m1_m3_supply']['_DesignObj']._CalculateStackSameEnclosure(**dict(COX=1, COY=3, start_layer=1, end_layer=3))
		self._DesignParameter['via_nmos2_m1_m3_supply']['_XYCoordinates'] = None
		XYList = []
		xy_offset = (0, min((((((- (self._DesignParameter['NMOS2']['_XYCoordinates'][0][1] + self._DesignParameter['NMOS2']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1])) + self._DesignParameter['m3_nmos3_drain']['_XYCoordinates'][0][0][1]) - (self._DesignParameter['m3_nmos3_drain']['_Width'] / 2)) - (self._DesignParameter['via_nmos2_m1_m3_supply']['_DesignObj']._DesignParameter['ViaMet22Met3']['_DesignObj']._DesignParameter['_Met3Layer']['_YWidth'] / 2)) - drc._MetalxMinSpace3), (((- self._DesignParameter['NMOS2']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth']) / 2) + (self._DesignParameter['via_nmos2_m1_m3_supply']['_DesignObj']._DesignParameter['ViaMet22Met3']['_DesignObj']._DesignParameter['_Met3Layer']['_YWidth'] / 2))))
		for i in range(len(self._DesignParameter['NMOS2']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'])):
		    if ((i % 2) == 0):
		        xy = (self._DesignParameter['NMOS2']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][i][0] if (type(self._DesignParameter['NMOS2']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][i][0]) == list) else self._DesignParameter['NMOS2']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][i])
		        XYList.append([((x + y) + z) for (x, y, z) in zip([(0 + self._DesignParameter['NMOS2']['_XYCoordinates'][0][0]), (0 + self._DesignParameter['NMOS2']['_XYCoordinates'][0][1])], xy, xy_offset)])
		self._DesignParameter['via_nmos2_m1_m3_supply']['_XYCoordinates'] = XYList
		self._DesignParameter['via_nmos2_1_m1_m3_supply'] = self._SrefElementDeclaration(_DesignObj=ViaStack._ViaStack(_Name='via_nmos2_1_m1_m3_supplyIn{}'.format(_Name)))[0]
		self._DesignParameter['via_nmos2_1_m1_m3_supply']['_DesignObj']._CalculateStackSameEnclosure(**dict(COX=1, COY=3, start_layer=1, end_layer=3))
		self._DesignParameter['via_nmos2_1_m1_m3_supply']['_XYCoordinates'] = None
		XYList = []
		xy_offset = (0, min((((((- (self._DesignParameter['NMOS2']['_XYCoordinates'][1][1] + self._DesignParameter['NMOS2']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1])) + self._DesignParameter['m3_nmos3_drain']['_XYCoordinates'][1][0][1]) - (self._DesignParameter['m3_nmos3_drain']['_Width'] / 2)) - (self._DesignParameter['via_nmos2_1_m1_m3_supply']['_DesignObj']._DesignParameter['ViaMet22Met3']['_DesignObj']._DesignParameter['_Met3Layer']['_YWidth'] / 2)) - drc._MetalxMinSpace3), (((- self._DesignParameter['NMOS2']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth']) / 2) + (self._DesignParameter['via_nmos2_m1_m3_supply']['_DesignObj']._DesignParameter['ViaMet22Met3']['_DesignObj']._DesignParameter['_Met3Layer']['_YWidth'] / 2))))
		for element in self._DesignParameter['NMOS2']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][(- 1)::(- 2)]:
		    element = (element[0] if (type(element[0]) == list) else element)
		    XYList.append([((x + y) + z) for (x, y, z) in zip([(0 + self._DesignParameter['NMOS2']['_XYCoordinates'][1][0]), (0 + self._DesignParameter['NMOS2']['_XYCoordinates'][1][1])], element, xy_offset)])
		self._DesignParameter['via_nmos2_1_m1_m3_supply']['_XYCoordinates'] = XYList
		self._DesignParameter['via_nmos1_m1_m3_supply'] = self._SrefElementDeclaration(_DesignObj=ViaStack._ViaStack(_Name='via_nmos1_m1_m3_supplyIn{}'.format(_Name)))[0]
		self._DesignParameter['via_nmos1_m1_m3_supply']['_DesignObj']._CalculateStackSameEnclosure(**dict(COX=1, COY=3, start_layer=1, end_layer=3))
		self._DesignParameter['via_nmos1_m1_m3_supply']['_XYCoordinates'] = None
		XYList = []
		xy_offset = (0, ((- (self._DesignParameter['NMOS1']['_XYCoordinates'][0][1] + self._DesignParameter['NMOS1']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][0][1])) + self._DesignParameter['via_nmos2_m1_m3_supply']['_XYCoordinates'][0][1]))
		...
		self._DesignParameter['via_nmos1_m1_m3_supply']['_XYCoordinates'] = XYList
		self._DesignParameter['m2_nmos2_nmo3'] = self._PathElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL3'][0], _Datatype=DesignParameters._LayerMapping['METAL3'][1], _Width=min(self._DesignParameter['via_nmos2_m1_m3_supply']['_DesignObj']._DesignParameter['ViaMet22Met3']['_DesignObj']._DesignParameter['_Met3Layer']['_YWidth'], (4 * drc._MetalxMinWidth)))
		self._DesignParameter['m2_nmos2_nmo3']['_XYCoordinates'] = [[[self._DesignParameter['via_nmos2_m1_m3_supply']['_XYCoordinates'][0][0], self._DesignParameter['via_nmos2_m1_m3_supply']['_XYCoordinates'][0][1]], [self._DesignParameter['via_nmos2_1_m1_m3_supply']['_XYCoordinates'][0][0], self._DesignParameter['via_nmos2_1_m1_m3_supply']['_XYCoordinates'][0][1]]]]
		...
		self._DesignParameter['nmos2_input']['_XYCoordinates'] = [[self._DesignParameter['NMOS2']['_XYCoordinates'][0][0], ((max((((self._DesignParameter['via_nmos2_m1_m3_supply']['_XYCoordinates'][0][1] + self._DesignParameter['via_nmos2_m1_m3_supply']['_DesignObj']._DesignParameter['ViaMet12Met2']['_XYCoordinates'][0][1]) + self._DesignParameter['via_nmos2_m1_m3_supply']['_DesignObj']._DesignParameter['ViaMet12Met2']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][0][1]) + (self._DesignParameter['via_nmos2_m1_m3_supply']['_DesignObj']._DesignParameter['ViaMet12Met2']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2)), ((self._DesignParameter['via_nmos2_m1_m2_drain']['_XYCoordinates'][0][1] + self._DesignParameter['via_nmos2_m1_m2_drain']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][0][1]) + (self._DesignParameter['via_nmos2_m1_m2_drain']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2)), ((self._DesignParameter['NMOS2']['_XYCoordinates'][0][1] + self._DesignParameter['NMOS2']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) + (self._DesignParameter['NMOS2']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2))) + (self._DesignParameter['nmos2_input']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2)) + 60)], [self._DesignParameter['NMOS2']['_XYCoordinates'][1][0], ((max((((self._DesignParameter['via_nmos2_1_m1_m3_supply']['_XYCoordinates'][0][1] + self._DesignParameter['via_nmos2_1_m1_m3_supply']['_DesignObj']._DesignParameter['ViaMet12Met2']['_XYCoordinates'][0][1]) + self._DesignParameter['via_nmos2_1_m1_m3_supply']['_DesignObj']._DesignParameter['ViaMet12Met2']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][0][1]) + (self._DesignParameter['via_nmos2_1_m1_m3_supply']['_DesignObj']._DesignParameter['ViaMet12Met2']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2)), ((self._DesignParameter['via_nmos2_1_m1_m2_drain']['_XYCoordinates'][0][1] + self._DesignParameter['via_nmos2_1_m1_m2_drain']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][0][1]) + (self._DesignParameter['via_nmos2_1_m1_m2_drain']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2)), ((self._DesignParameter['NMOS2']['_XYCoordinates'][1][1] + self._DesignParameter['NMOS2']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) + (self._DesignParameter['NMOS2']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2))) + (self._DesignParameter['nmos2_input']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2)) + 60)]]
		path_list = []
		...
		self._DesignParameter['nmos3_gate_input'] = self._SrefElementDeclaration(_DesignObj=ViaPoly2Met1._ViaPoly2Met1(_Name='nmos3_gate_inputIn{}'.format(_Name)))[0]
		self._DesignParameter['nmos3_gate_input']['_DesignObj']._CalculateViaPoly2Met1DesignParameter(**dict(_ViaPoly2Met1NumberOfCOX=max(1, (1 + int(((((((self._DesignParameter['NMOS1']['_XYCoordinates'][0][0] + self._DesignParameter['NMOS1']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][(- 1)][0]) - (self._DesignParameter['NMOS1']['_XYCoordinates'][0][0] + self._DesignParameter['NMOS1']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0])) + self._DesignParameter['NMOS1']['_DesignObj']._DesignParameter['_POLayer']['_XWidth']) - drc._CoMinSpace) - (2 * drc._CoMinEnclosureByPO)) / (drc._CoMinWidth + drc._CoMinSpace))))), _ViaPoly2Met1NumberOfCOY=1))
		self._DesignParameter['nmos3_gate_input']['_XYCoordinates'] = [[self._DesignParameter['NMOS1']['_XYCoordinates'][0][0], ((max((((self._DesignParameter['via_nmos1_m1_m3_supply']['_XYCoordinates'][0][1] + self._DesignParameter['via_nmos1_m1_m3_supply']['_DesignObj']._DesignParameter['ViaMet12Met2']['_XYCoordinates'][0][1]) + self._DesignParameter['via_nmos1_m1_m3_supply']['_DesignObj']._DesignParameter['ViaMet12Met2']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][0][1]) + (self._DesignParameter['via_nmos1_m1_m3_supply']['_DesignObj']._DesignParameter['ViaMet12Met2']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2)), ((self._DesignParameter['NMOS1']['_XYCoordinates'][0][1] + self._DesignParameter['NMOS1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) + (self._DesignParameter['NMOS1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2))) + (self._DesignParameter['nmos3_gate_input']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2)) + 60)]]
		path_list = []
		...
		if (mode == 'vertical'):
		    xy_with_offset = []
		    target_y_value = [[(+ (self._DesignParameter['nmos3_gate_input']['_XYCoordinates'][0][0] + self._DesignParameter['nmos3_gate_input']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0])), (+ ((self._DesignParameter['nmos3_gate_input']['_XYCoordinates'][0][1] + self._DesignParameter['nmos3_gate_input']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][1]) + (self._DesignParameter['nmos3_gate_input']['_DesignObj']._DesignParameter['_POLayer']['_YWidth'] / 2)))]][0][1]
		    ...
		    xy_with_offset = []
		    target_x_value = [[(+ (self._DesignParameter['nmos3_gate_input']['_XYCoordinates'][0][0] + self._DesignParameter['nmos3_gate_input']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0])), (+ ((self._DesignParameter['nmos3_gate_input']['_XYCoordinates'][0][1] + self._DesignParameter['nmos3_gate_input']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][1]) + (self._DesignParameter['nmos3_gate_input']['_DesignObj']._DesignParameter['_POLayer']['_YWidth'] / 2)))]][0][0]
		    for i in range(len(self._DesignParameter['NMOS1']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'])):
		        xy_with_offset.append([(x + y) for (x, y) in zip([(0 + self._DesignParameter['NMOS1']['_XYCoordinates'][0][0]), (0 + self._DesignParameter['NMOS1']['_XYCoordinates'][0][1])], self._DesignParameter['NMOS1']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][i])])
		    for i in range(len(xy_with_offset)):
		        path_list.append([xy_with_offset[i], [target_x_value, xy_with_offset[i][1]]])
		...
		self._DesignParameter['poly_nmos2_gate'] = self._PathElementDeclaration(_Layer=DesignParameters._LayerMapping['POLY'][0], _Datatype=DesignParameters._LayerMapping['POLY'][1], _Width=self._DesignParameter['nmos3_gate_input']['_DesignObj']._DesignParameter['_POLayer']['_YWidth'])
		self._DesignParameter['poly_nmos2_gate']['_XYCoordinates'] = [[[((self._DesignParameter['NMOS1']['_XYCoordinates'][0][0] + self._DesignParameter['NMOS1']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['NMOS1']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2)), self._DesignParameter['nmos3_gate_input']['_XYCoordinates'][0][1]], [((self._DesignParameter['NMOS1']['_XYCoordinates'][0][0] + self._DesignParameter['NMOS1']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][(- 1)][0]) + (self._DesignParameter['NMOS1']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2)), self._DesignParameter['nmos3_gate_input']['_XYCoordinates'][0][1]]]]
		self._DesignParameter['psubring'] = self._SrefElementDeclaration(_DesignObj=PSubRing.PSubRing(_Name='psubringIn{}'.format(_Name)))[0]
		self._DesignParameter['psubring']['_DesignObj']._CalculateDesignParameter(**dict(height=5000, width=3000, contact=pguardring_co))
		self._DesignParameter['psubring']['_XYCoordinates'] = [[self._DesignParameter['NMOS1']['_XYCoordinates'][0][0], ((((((self._DesignParameter['nmos3_gate_input']['_XYCoordinates'][0][1] + self._DesignParameter['nmos3_gate_input']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][0][1]) + (self._DesignParameter['nmos3_gate_input']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2)) + drc._Metal1MinSpace3) + ((self._DesignParameter['NMOS1']['_XYCoordinates'][0][1] + self._DesignParameter['NMOS1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) - (self._DesignParameter['NMOS1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2))) - drc._Metal1MinSpace3) / 2)]]
		self._DesignParameter['psubring']['_DesignObj']._CalculateDesignParameter(**dict(height=(((max(((self._DesignParameter['nmos3_gate_input']['_XYCoordinates'][0][1] + self._DesignParameter['nmos3_gate_input']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][0][1]) + (self._DesignParameter['nmos3_gate_input']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2)), ((self._DesignParameter['nmos2_input']['_XYCoordinates'][1][1] + self._DesignParameter['nmos2_input']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][0][1]) + (self._DesignParameter['nmos2_input']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2)), ((self._DesignParameter['nmos3_input']['_XYCoordinates'][1][1] + self._DesignParameter['nmos3_input']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][0][1]) + (self._DesignParameter['nmos3_input']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] / 2))) + (self._DesignParameter['psubring']['_DesignObj']._DesignParameter['met_top']['_YWidth'] / 2)) + drc._Metal1MinSpace3) - ((min(((self._DesignParameter['NMOS1']['_XYCoordinates'][0][1] + self._DesignParameter['NMOS1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) - (self._DesignParameter['NMOS1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)), ((self._DesignParameter['NMOS2']['_XYCoordinates'][1][1] + self._DesignParameter['NMOS2']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) - (self._DesignParameter['NMOS2']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)), ((self._DesignParameter['NMOS3']['_XYCoordinates'][1][1] + self._DesignParameter['NMOS3']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) - (self._DesignParameter['NMOS3']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2))) - (self._DesignParameter['psubring']['_DesignObj']._DesignParameter['met_bot']['_YWidth'] / 2)) - drc._Metal1MinSpace3)), width=(((((self._DesignParameter['NMOS3']['_XYCoordinates'][1][0] + self._DesignParameter['NMOS3']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][(- 1)][0]) + (self._DesignParameter['NMOS3']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XWidth'] / 2)) + (self._DesignParameter['psubring']['_DesignObj']._DesignParameter['met_right']['_XWidth'] / 2)) + drc._Metal1MinSpace3) - ((((self._DesignParameter['NMOS3']['_XYCoordinates'][0][0] + self._DesignParameter['NMOS3']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][0]) - (self._DesignParameter['NMOS3']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XWidth'] / 2)) - (self._DesignParameter['psubring']['_DesignObj']._DesignParameter['met_left']['_XWidth'] / 2)) - drc._Metal1MinSpace3)), contact=pguardring_co))
		path_list = []
