...
class B00_amp_v2(StickDiagram._StickDiagram):
	...
	def _CalculateDesignParameter(self,finger_N1=4,W_N=2400,Dummy=True,XVT='RVT',finger_N2=8,W_P=2400,finger_P1=4,finger_P5=5,finger_N5=2,finger_N4=2,finger_P3=1,finger_P4=1,Guad_via=2,res_compensation_W=1000,res_compensation_L=3500,res_compensation_series=2,NumofGate_res_com=5,NumofRX_res_com=2,L_cap=2600,W_cap=2600,L=450):
		...
		self._DesignParameter['METAL1_boundary_N4'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL1'][0], _Datatype=DesignParameters._LayerMapping['METAL1'][1], _XWidth=((((self._DesignParameter['N4']['_XYCoordinates'][0][0] + self._DesignParameter['N4']['_DesignObj']._DesignParameter['_ODLayer']['_XYCoordinates'][0][0]) + (self._DesignParameter['N4']['_DesignObj']._DesignParameter['_ODLayer']['_XWidth'] / 2)) - ((self._DesignParameter['N4']['_XYCoordinates'][0][0] + self._DesignParameter['N4']['_DesignObj']._DesignParameter['_ODLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['N4']['_DesignObj']._DesignParameter['_ODLayer']['_XWidth'] / 2))) - (85 * 2)), _YWidth=50)
		self._DesignParameter['METAL1_boundary_N4']['_XYCoordinates'] = [[self._DesignParameter['N4']['_XYCoordinates'][0][0], (((self._DesignParameter['N4']['_XYCoordinates'][0][1] + self._DesignParameter['N4']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) + (self._DesignParameter['N4']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)) + 94)]]
		...
		self._DesignParameter['M1V1M2_P5']['_DesignObj']._CalculateViaMet12Met2DesignParameterMinimumEnclosureY(**dict(_ViaMet12Met2NumberOfCOX=max(1, max(1, (1 + int(((((((self._DesignParameter['P5']['_XYCoordinates'][0][0] + self._DesignParameter['P5']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][(- 1)][0]) + (self._DesignParameter['P5']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2)) - ((self._DesignParameter['P5']['_XYCoordinates'][0][0] + self._DesignParameter['P5']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['P5']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2))) - drc._VIAxMinSpace) - (2 * drc._VIAxMinEnclosureByMetx)) / (drc._VIAxMinWidth + drc._VIAxMinSpace)))))), _ViaMet12Met2NumberOfCOY=1))
		...
		self._DesignParameter['M2V2M3_P5']['_DesignObj']._CalculateViaMet22Met3DesignParameterMinimumEnclosureY(**dict(_ViaMet22Met3NumberOfCOX=max(1, max(1, (1 + int(((((((self._DesignParameter['P5']['_XYCoordinates'][0][0] + self._DesignParameter['P5']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][(- 1)][0]) + (self._DesignParameter['P5']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2)) - ((self._DesignParameter['P5']['_XYCoordinates'][0][0] + self._DesignParameter['P5']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['P5']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2))) - drc._VIAxMinSpace) - (2 * drc._VIAxMinEnclosureByMetx)) / (drc._VIAxMinWidth + drc._VIAxMinSpace)))))), _ViaMet22Met3NumberOfCOY=1))
		...
		self._DesignParameter['N4_P4_path'] = self._PathElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL2'][0], _Datatype=DesignParameters._LayerMapping['METAL2'][1], _Width=150)
		...
		self._DesignParameter['N5_path'] = self._PathElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL2'][0], _Datatype=DesignParameters._LayerMapping['METAL2'][1], _Width=150)
		self._DesignParameter['N5_path']['_XYCoordinates'] = [[[self._DesignParameter['N5']['_XYCoordinates'][0][0], (((self._DesignParameter['N1']['_XYCoordinates'][0][1] + self._DesignParameter['N1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) + (self._DesignParameter['N1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)) + 69)], [self._DesignParameter['N5']['_XYCoordinates'][0][0], ((((self._DesignParameter['N5']['_XYCoordinates'][0][1] + self._DesignParameter['N5']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][1]) + (self._DesignParameter['N5']['_DesignObj']._DesignParameter['_POLayer']['_YWidth'] / 2)) + 200) + (Guad_W / 2))]]]
		self._DesignParameter['N1_path'] = self._PathElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL2'][0], _Datatype=DesignParameters._LayerMapping['METAL2'][1], _Width=150)
		self._DesignParameter['N1_path']['_XYCoordinates'] = [[[self._DesignParameter['N1']['_XYCoordinates'][0][0], (((self._DesignParameter['N1']['_XYCoordinates'][0][1] + self._DesignParameter['N1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) + (self._DesignParameter['N1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)) + 69)], [self._DesignParameter['N1']['_XYCoordinates'][0][0], ((((self._DesignParameter['N2']['_XYCoordinates'][0][1] + self._DesignParameter['N2']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][1]) + (self._DesignParameter['N2']['_DesignObj']._DesignParameter['_POLayer']['_YWidth'] / 2)) + 200) + (Guad_W / 2))]]]
		...
		self._DesignParameter['N1_N4_N5_path']['_XYCoordinates'] = [[[(self._DesignParameter['N4_P4_path']['_XYCoordinates'][0][0][0] - 75), ((((self._DesignParameter['N4']['_XYCoordinates'][0][1] + self._DesignParameter['N4']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][1]) + (self._DesignParameter['N4']['_DesignObj']._DesignParameter['_POLayer']['_YWidth'] / 2)) + 200) + (Guad_W / 2))], [(self._DesignParameter['N5']['_XYCoordinates'][0][0] + 75), ((((self._DesignParameter['N4']['_XYCoordinates'][0][1] + self._DesignParameter['N4']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][1]) + (self._DesignParameter['N4']['_DesignObj']._DesignParameter['_POLayer']['_YWidth'] / 2)) + 200) + (Guad_W / 2))]]]
		...
		self._DesignParameter['M3V3M4_P5'] = self._SrefElementDeclaration(_DesignObj=ViaMet32Met4._ViaMet32Met4(_Name='M3V3M4_P5In{}'.format(_Name)))[0]
		self._DesignParameter['M3V3M4_P5']['_DesignObj']._CalculateViaMet32Met4DesignParameterMinimumEnclosureX(**dict(_ViaMet32Met4NumberOfCOX=1, _ViaMet32Met4NumberOfCOY=2))
		self._DesignParameter['M3V3M4_P5']['_XYCoordinates'] = [[(+ self._DesignParameter['M1V1M2_P5_drain']['_XYCoordinates'][(- 1)][0]), (+ self._DesignParameter['M1V1M2_P5_drain']['_XYCoordinates'][(- 1)][1])]]
		...
		self._DesignParameter['P3_P4']['_XYCoordinates'] = [[[(+ self._DesignParameter['M1V1M2_P4_source']['_XYCoordinates'][0][0]), (+ self._DesignParameter['M1V1M2_P4_source']['_XYCoordinates'][0][1])], [(self._DesignParameter['M1V1M2_P3_drain']['_XYCoordinates'][(- 1)][0] + 25), self._DesignParameter['M1V1M2_P4_source']['_XYCoordinates'][0][1]]]]
		...
		self._DesignParameter['VOUT'] = self._TextElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL4PIN'][0], _Datatype=DesignParameters._LayerMapping['METAL4PIN'][1], _Presentation=[0, 1, 2], _Reflect=[0, 0, 0], _XYCoordinates=[[(+ self._DesignParameter['P5_M2V2M3']['_XYCoordinates'][0][0]), (+ self._DesignParameter['P5_M2V2M3']['_XYCoordinates'][0][1])]], _Mag=0.3, _Angle=0, _TEXT='VOUT')
		...
		self._DesignParameter['N5_P5_res'] = self._PathElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL4'][0], _Datatype=DesignParameters._LayerMapping['METAL4'][1], _Width=150)
		...
		self._DesignParameter['M3V3M4res_com_in'] = self._SrefElementDeclaration(_DesignObj=ViaMet32Met4._ViaMet32Met4(_Name='M3V3M4res_com_inIn{}'.format(_Name)))[0]
		self._DesignParameter['M3V3M4res_com_in']['_DesignObj']._CalculateViaMet32Met4DesignParameterMinimumEnclosureY(**dict(_ViaMet32Met4NumberOfCOX=max(1, (1 + int(((((res_compensation_W - 36) - drc._VIAxMinSpace) - (2 * drc._VIAxMinEnclosureByMetx)) / (drc._VIAxMinWidth + drc._VIAxMinSpace))))), _ViaMet32Met4NumberOfCOY=1))
		self._DesignParameter['M3V3M4res_com_in']['_XYCoordinates'] = [[(+ (self._DesignParameter['res_compensation']['_XYCoordinates'][0][0] + self._DesignParameter['res_compensation']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][1][0])), (+ (self._DesignParameter['res_compensation']['_XYCoordinates'][0][1] + self._DesignParameter['res_compensation']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][1][1]))]]
		XYList = []
		xy_offset = [0, 0]
		...
		self._DesignParameter['N3_cap_path'] = self._PathElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL3'][0], _Datatype=DesignParameters._LayerMapping['METAL3'][1], _Width=150)
		...
		self._DesignParameter['N2_cap_path2']['_XYCoordinates'] = [[[(self._DesignParameter['N3_cap_path']['_XYCoordinates'][0][0][0] - 75), self._DesignParameter['M2V2M3_cap_N3']['_XYCoordinates'][0][1]], [(+ self._DesignParameter['M2V2M3_cap_N3']['_XYCoordinates'][0][0]), (+ self._DesignParameter['M2V2M3_cap_N3']['_XYCoordinates'][0][1])]]]
		...
		self._DesignParameter['res_path2'] = self._PathElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL4'][0], _Datatype=DesignParameters._LayerMapping['METAL4'][1], _Width=50)
		...
		self._DesignParameter['N4_M1_drain_path'] = self._PathElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL1'][0], _Datatype=DesignParameters._LayerMapping['METAL1'][1], _Width=50)
		self._DesignParameter['N4_M1_drain_path']['_XYCoordinates'] = [[[max((self._DesignParameter['N4_drain_path']['_XYCoordinates'][(- 1)][0][0] + 25), (((self._DesignParameter['N4']['_XYCoordinates'][0][0] + self._DesignParameter['N4']['_DesignObj']._DesignParameter['_ODLayer']['_XYCoordinates'][0][0]) + (self._DesignParameter['N4']['_DesignObj']._DesignParameter['_ODLayer']['_XWidth'] / 2)) - 85)), (((self._DesignParameter['N4']['_XYCoordinates'][0][1] + self._DesignParameter['N4']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) + (self._DesignParameter['N4']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)) + 94)], [min((self._DesignParameter['N4_drain_path']['_XYCoordinates'][0][0][0] - 25), (((self._DesignParameter['N4']['_XYCoordinates'][0][0] + self._DesignParameter['N4']['_DesignObj']._DesignParameter['_ODLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['N4']['_DesignObj']._DesignParameter['_ODLayer']['_XWidth'] / 2)) + 85)), (((self._DesignParameter['N4']['_XYCoordinates'][0][1] + self._DesignParameter['N4']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) + (self._DesignParameter['N4']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)) + 94)]]]
		self._DesignParameter['P1_P2_gate_copy'] = self._PathElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL1'][0], _Datatype=DesignParameters._LayerMapping['METAL1'][1], _Width=50)
		self._DesignParameter['P1_P2_gate_copy']['_XYCoordinates'] = [[[min(((self._DesignParameter['P1']['_XYCoordinates'][0][0] + self._DesignParameter['P1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][0]) - 25), (((self._DesignParameter['P1']['_XYCoordinates'][0][0] + self._DesignParameter['P1']['_DesignObj']._DesignParameter['_ODLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['P1']['_DesignObj']._DesignParameter['_ODLayer']['_XWidth'] / 2)) + 85)), (((self._DesignParameter['P2']['_XYCoordinates'][0][1] + self._DesignParameter['P2']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) - (self._DesignParameter['P2']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)) - 94)], [max(((self._DesignParameter['P1']['_XYCoordinates'][0][0] + self._DesignParameter['P1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][(- 1)][0]) + 25), (((self._DesignParameter['P2']['_XYCoordinates'][0][0] + self._DesignParameter['P2']['_DesignObj']._DesignParameter['_ODLayer']['_XYCoordinates'][0][0]) + (self._DesignParameter['P2']['_DesignObj']._DesignParameter['_ODLayer']['_XWidth'] / 2)) - 85)), (((self._DesignParameter['P1']['_XYCoordinates'][0][1] + self._DesignParameter['P1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) - (self._DesignParameter['P1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)) - 94)]]]
		path_list = []
		xy_offset = [0, 0]
		if (len(self._DesignParameter['M1V1M2_N1_drain']['_XYCoordinates']) == 1):
		    mode = 'vertical'
		    _width = 50
		elif (self._DesignParameter['M1V1M2_N1_drain']['_XYCoordinates'][0][0] == self._DesignParameter['M1V1M2_N1_drain']['_XYCoordinates'][(- 1)][0]):
		    mode = 'horizontal'
		    _width = 50
		elif (self._DesignParameter['M1V1M2_N1_drain']['_XYCoordinates'][0][1] == self._DesignParameter['M1V1M2_N1_drain']['_XYCoordinates'][(- 1)][1]):
		    mode = 'vertical'
		    _width = 50
		else:
		    print('Invalid Target Input')
		if (mode == 'vertical'):
		    xy_with_offset = []
		    target_y_value = [[(+ self._DesignParameter['N1_N2_N3_path']['_XYCoordinates'][0][0][0]), (+ self._DesignParameter['N1_N2_N3_path']['_XYCoordinates'][0][0][1])]][0][1]
		    for i in range(len(self._DesignParameter['M1V1M2_N1_drain']['_XYCoordinates'])):
		        xy_with_offset.append([(x + y) for (x, y) in zip([0, 0], self._DesignParameter['M1V1M2_N1_drain']['_XYCoordinates'][i])])
		    for i in range(len(xy_with_offset)):
		        path_list.append([xy_with_offset[i], [xy_with_offset[i][0], target_y_value]])
		elif (mode == 'horizontal'):
		    xy_with_offset = []
		    target_x_value = [[(+ self._DesignParameter['N1_N2_N3_path']['_XYCoordinates'][0][0][0]), (+ self._DesignParameter['N1_N2_N3_path']['_XYCoordinates'][0][0][1])]][0][0]
		    for i in range(len(self._DesignParameter['M1V1M2_N1_drain']['_XYCoordinates'])):
		        xy_with_offset.append([(x + y) for (x, y) in zip([0, 0], self._DesignParameter['M1V1M2_N1_drain']['_XYCoordinates'][i])])
		    for i in range(len(xy_with_offset)):
		        path_list.append([xy_with_offset[i], [target_x_value, xy_with_offset[i][1]]])
		for i in range(len(path_list)):
		    path_list[i][0] = [(xy + offset) for (xy, offset) in zip(path_list[i][0], xy_offset)]
		self._DesignParameter['N1_M2_drain_dummy'] = self._PathElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL2'][0], _Datatype=DesignParameters._LayerMapping['METAL2'][1], _Width=_width)
		self._DesignParameter['N1_M2_drain_dummy']['_XYCoordinates'] = path_list
		path_list = []
		xy_offset = [0, 0]
		if (len(self._DesignParameter['M1V1M2_P3_drain']['_XYCoordinates']) == 1):
		    mode = 'vertical'
		    _width = 50
		elif (self._DesignParameter['M1V1M2_P3_drain']['_XYCoordinates'][0][0] == self._DesignParameter['M1V1M2_P3_drain']['_XYCoordinates'][(- 1)][0]):
		    mode = 'horizontal'
		    _width = 50
		elif (self._DesignParameter['M1V1M2_P3_drain']['_XYCoordinates'][0][1] == self._DesignParameter['M1V1M2_P3_drain']['_XYCoordinates'][(- 1)][1]):
		    mode = 'vertical'
		    _width = 50
		else:
		    print('Invalid Target Input')
		if (mode == 'vertical'):
		    xy_with_offset = []
		    target_y_value = [[(+ self._DesignParameter['P3_P4']['_XYCoordinates'][0][0][0]), (+ self._DesignParameter['P3_P4']['_XYCoordinates'][0][0][1])]][0][1]
		    for i in range(len(self._DesignParameter['M1V1M2_P3_drain']['_XYCoordinates'])):
		        xy_with_offset.append([(x + y) for (x, y) in zip([0, 0], self._DesignParameter['M1V1M2_P3_drain']['_XYCoordinates'][i])])
		    for i in range(len(xy_with_offset)):
		        path_list.append([xy_with_offset[i], [xy_with_offset[i][0], target_y_value]])
		elif (mode == 'horizontal'):
		    xy_with_offset = []
		    target_x_value = [[(+ self._DesignParameter['P3_P4']['_XYCoordinates'][0][0][0]), (+ self._DesignParameter['P3_P4']['_XYCoordinates'][0][0][1])]][0][0]
		    for i in range(len(self._DesignParameter['M1V1M2_P3_drain']['_XYCoordinates'])):
		        xy_with_offset.append([(x + y) for (x, y) in zip([0, 0], self._DesignParameter['M1V1M2_P3_drain']['_XYCoordinates'][i])])
		    for i in range(len(xy_with_offset)):
		        path_list.append([xy_with_offset[i], [target_x_value, xy_with_offset[i][1]]])
		for i in range(len(path_list)):
		    path_list[i][0] = [(xy + offset) for (xy, offset) in zip(path_list[i][0], xy_offset)]
		self._DesignParameter['P3_M2_dummy'] = self._PathElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL2'][0], _Datatype=DesignParameters._LayerMapping['METAL2'][1], _Width=_width)
		self._DesignParameter['P3_M2_dummy']['_XYCoordinates'] = path_list
		while (((self._DesignParameter['ncap']['_DesignObj']._DesignParameter['NCAPLayer']['_XWidth'] + 500) + Guad_W) > (self._DesignParameter['N_guad_res_compensation']['_XYCoordinates'][0][0] - (self._DesignParameter['Psubring_bottom']['_XYCoordinates'][0][0] + self._DesignParameter['Psubring_bottom']['_DesignObj']._DesignParameter['met_left']['_XYCoordinates'][0][0]))):
		    finger_N_Dummy2 += 1
		    finger_P_Dummy1 += 1
		    finger_N_Dummy1 += 1
		    finger_P_Dummy2 += 1
		    ...
		    self._DesignParameter['Dummy_M1_1'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL1'][0], _Datatype=DesignParameters._LayerMapping['METAL1'][1], _XWidth=((((self._DesignParameter['N_Dummy1']['_XYCoordinates'][0][0] + self._DesignParameter['N_Dummy1']['_DesignObj']._DesignParameter['_ODLayer']['_XYCoordinates'][0][0]) + (self._DesignParameter['N_Dummy1']['_DesignObj']._DesignParameter['_ODLayer']['_XWidth'] / 2)) - ((self._DesignParameter['N_Dummy1']['_XYCoordinates'][0][0] + self._DesignParameter['N_Dummy1']['_DesignObj']._DesignParameter['_ODLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['N_Dummy1']['_DesignObj']._DesignParameter['_ODLayer']['_XWidth'] / 2))) - 6), _YWidth=Dummy_M1_H)
		    self._DesignParameter['Dummy_M1_1']['_XYCoordinates'] = [[self._DesignParameter['N_Dummy1']['_XYCoordinates'][0][0], (((self._DesignParameter['N_Dummy1']['_XYCoordinates'][0][1] + self._DesignParameter['N_Dummy1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) - (self._DesignParameter['N_Dummy1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)) - (Dummy_M1_H / 2))]]
		    self._DesignParameter['Dummy_M1_2_copy'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL1'][0], _Datatype=DesignParameters._LayerMapping['METAL1'][1], _XWidth=((((self._DesignParameter['N_Dummy2']['_XYCoordinates'][0][0] + self._DesignParameter['N_Dummy2']['_DesignObj']._DesignParameter['_ODLayer']['_XYCoordinates'][0][0]) + (self._DesignParameter['N_Dummy2']['_DesignObj']._DesignParameter['_ODLayer']['_XWidth'] / 2)) - ((self._DesignParameter['N_Dummy2']['_XYCoordinates'][0][0] + self._DesignParameter['N_Dummy2']['_DesignObj']._DesignParameter['_ODLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['N_Dummy2']['_DesignObj']._DesignParameter['_ODLayer']['_XWidth'] / 2))) - 6), _YWidth=Dummy_M1_H)
		    self._DesignParameter['Dummy_M1_2_copy']['_XYCoordinates'] = [[self._DesignParameter['N_Dummy2']['_XYCoordinates'][0][0], (((self._DesignParameter['N_Dummy2']['_XYCoordinates'][0][1] + self._DesignParameter['N_Dummy2']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) - (self._DesignParameter['N_Dummy2']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)) - (Dummy_M1_H / 2))]]
		    self._DesignParameter['Dummy_M1_3'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL1'][0], _Datatype=DesignParameters._LayerMapping['METAL1'][1], _XWidth=((((self._DesignParameter['P_Dummy2']['_XYCoordinates'][0][0] + self._DesignParameter['P_Dummy2']['_DesignObj']._DesignParameter['_ODLayer']['_XYCoordinates'][0][0]) + (self._DesignParameter['P_Dummy2']['_DesignObj']._DesignParameter['_ODLayer']['_XWidth'] / 2)) - ((self._DesignParameter['P_Dummy2']['_XYCoordinates'][0][0] + self._DesignParameter['P_Dummy2']['_DesignObj']._DesignParameter['_ODLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['P_Dummy2']['_DesignObj']._DesignParameter['_ODLayer']['_XWidth'] / 2))) - 6), _YWidth=Dummy_M1_H)
		    self._DesignParameter['Dummy_M1_3']['_XYCoordinates'] = [[self._DesignParameter['P_Dummy2']['_XYCoordinates'][0][0], (((self._DesignParameter['P_Dummy2']['_XYCoordinates'][0][1] + self._DesignParameter['P_Dummy2']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) + (self._DesignParameter['P_Dummy2']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)) + (Dummy_M1_H / 2))]]
		    self._DesignParameter['Dummy_M1_5'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL1'][0], _Datatype=DesignParameters._LayerMapping['METAL1'][1], _XWidth=((((self._DesignParameter['P_Dummy1']['_XYCoordinates'][0][0] + self._DesignParameter['P_Dummy1']['_DesignObj']._DesignParameter['_ODLayer']['_XYCoordinates'][0][0]) + (self._DesignParameter['P_Dummy1']['_DesignObj']._DesignParameter['_ODLayer']['_XWidth'] / 2)) - ((self._DesignParameter['P_Dummy1']['_XYCoordinates'][0][0] + self._DesignParameter['P_Dummy1']['_DesignObj']._DesignParameter['_ODLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['P_Dummy1']['_DesignObj']._DesignParameter['_ODLayer']['_XWidth'] / 2))) - 6), _YWidth=Dummy_M1_H)
		    self._DesignParameter['Dummy_M1_5']['_XYCoordinates'] = [[self._DesignParameter['P_Dummy1']['_XYCoordinates'][0][0], (((self._DesignParameter['P_Dummy1']['_XYCoordinates'][0][1] + self._DesignParameter['P_Dummy1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) + (self._DesignParameter['P_Dummy1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)) + (Dummy_M1_H / 2))]]
		    ...
		    if ((((finger_N1 + finger_P2) + finger_P_Dummy1) % 2) == 0):
		        ...
		        for i in range(len(self._DesignParameter['P5']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'])):
		            if ((i % 2) == 0):
		                ...
		                XYList.append([((x + y) + z) for (x, y, z) in zip([(0 + self._DesignParameter['P5']['_XYCoordinates'][0][0]), (0 + self._DesignParameter['P5']['_XYCoordinates'][0][1])], xy, xy_offset)])
		        self._DesignParameter['M1V1M2_P5_drain']['_XYCoordinates'] = XYList
		    self._DesignParameter['P5_drain_path_copy'] = self._PathElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL2'][0], _Datatype=DesignParameters._LayerMapping['METAL2'][1], _Width=50)
		    self._DesignParameter['P5_drain_path_copy']['_XYCoordinates'] = [[[(+ self._DesignParameter['M1V1M2_P5_drain']['_XYCoordinates'][0][0]), (+ self._DesignParameter['M1V1M2_P5_drain']['_XYCoordinates'][0][1])], [(+ self._DesignParameter['M1V1M2_P5_drain']['_XYCoordinates'][(- 1)][0]), (+ self._DesignParameter['M1V1M2_P5_drain']['_XYCoordinates'][(- 1)][1])]]]
		    self._DesignParameter['P5_M2V2M3'] = self._SrefElementDeclaration(_DesignObj=ViaMet22Met3._ViaMet22Met3(_Name='P5_M2V2M3In{}'.format(_Name)))[0]
		    self._DesignParameter['P5_M2V2M3']['_DesignObj']._CalculateViaMet22Met3DesignParameterMinimumEnclosureX(**dict(_ViaMet22Met3NumberOfCOX=1, _ViaMet22Met3NumberOfCOY=2))
		    self._DesignParameter['P5_M2V2M3']['_XYCoordinates'] = [[(+ self._DesignParameter['M1V1M2_P5_drain']['_XYCoordinates'][(- 1)][0]), (+ self._DesignParameter['M1V1M2_P5_drain']['_XYCoordinates'][(- 1)][1])]]
		    self._DesignParameter['M3V3M4_P5'] = self._SrefElementDeclaration(_DesignObj=ViaMet32Met4._ViaMet32Met4(_Name='M3V3M4_P5In{}'.format(_Name)))[0]
		    ...
		    self._DesignParameter['VINn'] = self._TextElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL1PIN'][0], _Datatype=DesignParameters._LayerMapping['METAL1PIN'][1], _Presentation=[0, 1, 2], _Reflect=[0, 0, 0], _XYCoordinates=[[(+ self._DesignParameter['PCCAM1_VINn']['_XYCoordinates'][0][0]), (+ self._DesignParameter['PCCAM1_VINn']['_XYCoordinates'][0][1])]], _Mag=0.3, _Angle=0, _TEXT='VINn')
		    self._DesignParameter['VINp'] = self._TextElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL1PIN'][0], _Datatype=DesignParameters._LayerMapping['METAL1PIN'][1], _Presentation=[0, 1, 2], _Reflect=[0, 0, 0], _XYCoordinates=[[(+ self._DesignParameter['PCCAM1_VINp']['_XYCoordinates'][0][0]), (+ self._DesignParameter['PCCAM1_VINp']['_XYCoordinates'][0][1])]], _Mag=0.3, _Angle=0, _TEXT='VINp')
		    self._DesignParameter['VOUT'] = self._TextElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL3PIN'][0], _Datatype=DesignParameters._LayerMapping['METAL3PIN'][1], _Presentation=[0, 1, 2], _Reflect=[0, 0, 0], _XYCoordinates=[[(+ self._DesignParameter['P5_M2V2M3']['_XYCoordinates'][0][0]), (+ self._DesignParameter['P5_M2V2M3']['_XYCoordinates'][0][1])]], _Mag=0.3, _Angle=0, _TEXT='VOUT')
		    self._DesignParameter['VDD'] = self._TextElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL1PIN'][0], _Datatype=DesignParameters._LayerMapping['METAL1PIN'][1], _Presentation=[0, 1, 2], _Reflect=[0, 0, 0], _XYCoordinates=[[(+ (self._DesignParameter['P_guad']['_XYCoordinates'][0][0] + self._DesignParameter['P_guad']['_DesignObj']._DesignParameter['od_left']['_XYCoordinates'][0][0])), (+ (self._DesignParameter['P_guad']['_XYCoordinates'][0][1] + self._DesignParameter['P_guad']['_DesignObj']._DesignParameter['od_left']['_XYCoordinates'][0][1]))]], _Mag=0.3, _Angle=0, _TEXT='VDD')
		    self._DesignParameter['VSS'] = self._TextElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL1PIN'][0], _Datatype=DesignParameters._LayerMapping['METAL1PIN'][1], _Presentation=[0, 1, 2], _Reflect=[0, 0, 0], _XYCoordinates=[[(+ (self._DesignParameter['N_guad']['_XYCoordinates'][0][0] + self._DesignParameter['N_guad']['_DesignObj']._DesignParameter['od_left']['_XYCoordinates'][0][0])), (+ (self._DesignParameter['N_guad']['_XYCoordinates'][0][1] + self._DesignParameter['N_guad']['_DesignObj']._DesignParameter['od_left']['_XYCoordinates'][0][1]))]], _Mag=0.3, _Angle=0, _TEXT='VSS')
		    self._DesignParameter['res_compensation'] = self._SrefElementDeclaration(_DesignObj=opppcres_b_v2._Opppcres(_Name='res_compensationIn{}'.format(_Name)))[0]
		    self._DesignParameter['res_compensation']['_DesignObj']._CalculateOpppcresDesignParameter(**dict(_ResWidth=res_compensation_W, _ResLength=res_compensation_L, _CONUMX=None, _CONUMY=1, _SeriesStripes=res_compensation_series, _ParallelStripes=1))
		    ...
		    self._DesignParameter['res_compensation']['_Reflect'] = [1, 0, 0]
		    self._DesignParameter['res_compensation']['_Angle'] = 180
		    self._DesignParameter['N5_P5_res'] = self._PathElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL4'][0], _Datatype=DesignParameters._LayerMapping['METAL4'][1], _Width=200)
		    self._DesignParameter['N5_P5_res']['_XYCoordinates'] = [[[(+ self._DesignParameter['P5_M2V2M3']['_XYCoordinates'][0][0]), (+ self._DesignParameter['P5_M2V2M3']['_XYCoordinates'][0][1])], [self._DesignParameter['P5_M2V2M3']['_XYCoordinates'][0][0], ((self._DesignParameter['res_compensation']['_XYCoordinates'][0][1] + self._DesignParameter['res_compensation']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][1][1]) - 25)]]]
		    self._DesignParameter['M1V1M2res_com_in'] = self._SrefElementDeclaration(_DesignObj=ViaMet12Met2._ViaMet12Met2(_Name='M1V1M2res_com_inIn{}'.format(_Name)))[0]
		    self._DesignParameter['M1V1M2res_com_in']['_DesignObj']._CalculateViaMet12Met2DesignParameterMinimumEnclosureY(**dict(_ViaMet12Met2NumberOfCOX=max(1, (1 + int(((((res_compensation_W - 36) - drc._VIAxMinSpace) - (2 * drc._VIAxMinEnclosureByMetx)) / (drc._VIAxMinWidth + drc._VIAxMinSpace))))), _ViaMet12Met2NumberOfCOY=1))
		    self._DesignParameter['M1V1M2res_com_in']['_XYCoordinates'] = [[(+ (self._DesignParameter['res_compensation']['_XYCoordinates'][0][0] + self._DesignParameter['res_compensation']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][1][0])), (+ (self._DesignParameter['res_compensation']['_XYCoordinates'][0][1] + self._DesignParameter['res_compensation']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][1][1]))]]
		    ...
		    self._DesignParameter['res_path2'] = self._PathElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL4'][0], _Datatype=DesignParameters._LayerMapping['METAL4'][1], _Width=50)
		    self._DesignParameter['res_path2']['_XYCoordinates'] = [[[(+ self._DesignParameter['M2V2M3res_com_in']['_XYCoordinates'][0][0]), (+ self._DesignParameter['M2V2M3res_com_in']['_XYCoordinates'][0][1])], [self._DesignParameter['N5_P5_res']['_XYCoordinates'][0][0][0], self._DesignParameter['M2V2M3res_com_in']['_XYCoordinates'][0][1]]]]
		    self._DesignParameter['N4_path2_copy'] = self._PathElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL2'][0], _Datatype=DesignParameters._LayerMapping['METAL2'][1], _Width=50)
		    self._DesignParameter['N4_path2_copy']['_XYCoordinates'] = [[[(+ self._DesignParameter['M1V1M2_N4']['_XYCoordinates'][0][0]), (+ self._DesignParameter['M1V1M2_N4']['_XYCoordinates'][0][1])], [self._DesignParameter['N4_P4_path']['_XYCoordinates'][0][0][0], self._DesignParameter['M1V1M2_N4']['_XYCoordinates'][0][1]]]]
		    self._DesignParameter['N4_M1_drain_path'] = self._PathElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL1'][0], _Datatype=DesignParameters._LayerMapping['METAL1'][1], _Width=50)
		    self._DesignParameter['N4_M1_drain_path']['_XYCoordinates'] = [[[max((self._DesignParameter['N4_drain_path']['_XYCoordinates'][(- 1)][0][0] + 25), (((self._DesignParameter['N4']['_XYCoordinates'][0][0] + self._DesignParameter['N4']['_DesignObj']._DesignParameter['_ODLayer']['_XYCoordinates'][0][0]) + (self._DesignParameter['N4']['_DesignObj']._DesignParameter['_ODLayer']['_XWidth'] / 2)) - 85)), (((self._DesignParameter['N4']['_XYCoordinates'][0][1] + self._DesignParameter['N4']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) + (self._DesignParameter['N4']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)) + 94)], [min((self._DesignParameter['N4_drain_path']['_XYCoordinates'][0][0][0] - 25), (((self._DesignParameter['N4']['_XYCoordinates'][0][0] + self._DesignParameter['N4']['_DesignObj']._DesignParameter['_ODLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['N4']['_DesignObj']._DesignParameter['_ODLayer']['_XWidth'] / 2)) + 85)), (((self._DesignParameter['N4']['_XYCoordinates'][0][1] + self._DesignParameter['N4']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) + (self._DesignParameter['N4']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)) + 94)]]]
		    self._DesignParameter['P1_P2_gate_copy'] = self._PathElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL1'][0], _Datatype=DesignParameters._LayerMapping['METAL1'][1], _Width=50)
		    self._DesignParameter['P1_P2_gate_copy']['_XYCoordinates'] = [[[min(((self._DesignParameter['P1']['_XYCoordinates'][0][0] + self._DesignParameter['P1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][0]) - 25), (((self._DesignParameter['P1']['_XYCoordinates'][0][0] + self._DesignParameter['P1']['_DesignObj']._DesignParameter['_ODLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['P1']['_DesignObj']._DesignParameter['_ODLayer']['_XWidth'] / 2)) + 85)), (((self._DesignParameter['P2']['_XYCoordinates'][0][1] + self._DesignParameter['P2']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) - (self._DesignParameter['P2']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)) - 94)], [max(((self._DesignParameter['P1']['_XYCoordinates'][0][0] + self._DesignParameter['P1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][(- 1)][0]) + 25), (((self._DesignParameter['P2']['_XYCoordinates'][0][0] + self._DesignParameter['P2']['_DesignObj']._DesignParameter['_ODLayer']['_XYCoordinates'][0][0]) + (self._DesignParameter['P2']['_DesignObj']._DesignParameter['_ODLayer']['_XWidth'] / 2)) - 85)), (((self._DesignParameter['P1']['_XYCoordinates'][0][1] + self._DesignParameter['P1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][0][1]) - (self._DesignParameter['P1']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_YWidth'] / 2)) - 94)]]]
		    ...
		    self._DesignParameter['P3_M2_dummy']['_XYCoordinates'] = path_list
		if (XVT == 'RVT'):
		    self._DesignParameter['VT'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['RVT'][0], _Datatype=DesignParameters._LayerMapping['RVT'][1], _XWidth=(((self._DesignParameter['N5']['_XYCoordinates'][0][0] + self._DesignParameter['N5']['_DesignObj']._DesignParameter['_RVTLayer']['_XYCoordinates'][0][0]) + (self._DesignParameter['N5']['_DesignObj']._DesignParameter['_RVTLayer']['_XWidth'] / 2)) - ((self._DesignParameter['N4']['_XYCoordinates'][0][0] + self._DesignParameter['N4']['_DesignObj']._DesignParameter['_RVTLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['N4']['_DesignObj']._DesignParameter['_RVTLayer']['_XWidth'] / 2))), _YWidth=self._DesignParameter['N1']['_DesignObj']._DesignParameter['_RVTLayer']['_YWidth'])
		    self._DesignParameter['VT']['_XYCoordinates'] = [[(+ self._DesignParameter['N1']['_XYCoordinates'][0][0]), (+ self._DesignParameter['N1']['_XYCoordinates'][0][1])]]
		    self._DesignParameter['VT2'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['RVT'][0], _Datatype=DesignParameters._LayerMapping['RVT'][1], _XWidth=(((self._DesignParameter['P5']['_XYCoordinates'][0][0] + self._DesignParameter['P5']['_DesignObj']._DesignParameter['_RVTLayer']['_XYCoordinates'][0][0]) + (self._DesignParameter['P5']['_DesignObj']._DesignParameter['_RVTLayer']['_XWidth'] / 2)) - ((self._DesignParameter['P4']['_XYCoordinates'][0][0] + self._DesignParameter['P4']['_DesignObj']._DesignParameter['_RVTLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['P4']['_DesignObj']._DesignParameter['_RVTLayer']['_XWidth'] / 2))), _YWidth=self._DesignParameter['P_Dummy0']['_DesignObj']._DesignParameter['_RVTLayer']['_YWidth'])
		    self._DesignParameter['VT2']['_XYCoordinates'] = [[(+ self._DesignParameter['P_Dummy0']['_XYCoordinates'][0][0]), (+ self._DesignParameter['P_Dummy0']['_XYCoordinates'][0][1])]]
		if (XVT == 'SLVT'):
		    self._DesignParameter['VT'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['SLVT'][0], _Datatype=DesignParameters._LayerMapping['SLVT'][1], _XWidth=(((self._DesignParameter['N5']['_XYCoordinates'][0][0] + self._DesignParameter['N5']['_DesignObj']._DesignParameter['_SLVTLayer']['_XYCoordinates'][0][0]) + (self._DesignParameter['N5']['_DesignObj']._DesignParameter['_SLVTLayer']['_XWidth'] / 2)) - ((self._DesignParameter['N4']['_XYCoordinates'][0][0] + self._DesignParameter['N4']['_DesignObj']._DesignParameter['_SLVTLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['N4']['_DesignObj']._DesignParameter['_SLVTLayer']['_XWidth'] / 2))), _YWidth=self._DesignParameter['N1']['_DesignObj']._DesignParameter['_SLVTLayer']['_YWidth'])
		    self._DesignParameter['VT']['_XYCoordinates'] = [[(+ self._DesignParameter['N1']['_XYCoordinates'][0][0]), (+ self._DesignParameter['N1']['_XYCoordinates'][0][1])]]
		    self._DesignParameter['VT2'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['SLVT'][0], _Datatype=DesignParameters._LayerMapping['SLVT'][1], _XWidth=(((self._DesignParameter['P5']['_XYCoordinates'][0][0] + self._DesignParameter['P5']['_DesignObj']._DesignParameter['_SLVTLayer']['_XYCoordinates'][0][0]) + (self._DesignParameter['P5']['_DesignObj']._DesignParameter['_SLVTLayer']['_XWidth'] / 2)) - ((self._DesignParameter['P4']['_XYCoordinates'][0][0] + self._DesignParameter['P4']['_DesignObj']._DesignParameter['_SLVTLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['P4']['_DesignObj']._DesignParameter['_SLVTLayer']['_XWidth'] / 2))), _YWidth=self._DesignParameter['P_Dummy0']['_DesignObj']._DesignParameter['_SLVTLayer']['_YWidth'])
		    self._DesignParameter['VT2']['_XYCoordinates'] = [[(+ self._DesignParameter['P_Dummy0']['_XYCoordinates'][0][0]), (+ self._DesignParameter['P_Dummy0']['_XYCoordinates'][0][1])]]
		if (XVT == 'LVT'):
		    self._DesignParameter['VT'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['LVT'][0], _Datatype=DesignParameters._LayerMapping['LVT'][1], _XWidth=(((self._DesignParameter['N5']['_XYCoordinates'][0][0] + self._DesignParameter['N5']['_DesignObj']._DesignParameter['_LVTLayer']['_XYCoordinates'][0][0]) + (self._DesignParameter['N5']['_DesignObj']._DesignParameter['_LVTLayer']['_XWidth'] / 2)) - ((self._DesignParameter['N4']['_XYCoordinates'][0][0] + self._DesignParameter['N4']['_DesignObj']._DesignParameter['_LVTLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['N4']['_DesignObj']._DesignParameter['_LVTLayer']['_XWidth'] / 2))), _YWidth=self._DesignParameter['N1']['_DesignObj']._DesignParameter['_LVTLayer']['_YWidth'])
		    self._DesignParameter['VT']['_XYCoordinates'] = [[(+ self._DesignParameter['N1']['_XYCoordinates'][0][0]), (+ self._DesignParameter['N1']['_XYCoordinates'][0][1])]]
		    self._DesignParameter['VT2'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['LVT'][0], _Datatype=DesignParameters._LayerMapping['LVT'][1], _XWidth=(((self._DesignParameter['P5']['_XYCoordinates'][0][0] + self._DesignParameter['P5']['_DesignObj']._DesignParameter['_LVTLayer']['_XYCoordinates'][0][0]) + (self._DesignParameter['P5']['_DesignObj']._DesignParameter['_LVTLayer']['_XWidth'] / 2)) - ((self._DesignParameter['P4']['_XYCoordinates'][0][0] + self._DesignParameter['P4']['_DesignObj']._DesignParameter['_LVTLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['P4']['_DesignObj']._DesignParameter['_LVTLayer']['_XWidth'] / 2))), _YWidth=self._DesignParameter['P_Dummy0']['_DesignObj']._DesignParameter['_LVTLayer']['_YWidth'])
		    self._DesignParameter['VT2']['_XYCoordinates'] = [[(+ self._DesignParameter['P_Dummy0']['_XYCoordinates'][0][0]), (+ self._DesignParameter['P_Dummy0']['_XYCoordinates'][0][1])]]
		if (XVT == 'HVT'):
		    self._DesignParameter['VT'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['HVT'][0], _Datatype=DesignParameters._LayerMapping['HVT'][1], _XWidth=(((self._DesignParameter['N5']['_XYCoordinates'][0][0] + self._DesignParameter['N5']['_DesignObj']._DesignParameter['_HVTLayer']['_XYCoordinates'][0][0]) + (self._DesignParameter['N5']['_DesignObj']._DesignParameter['_HVTLayer']['_XWidth'] / 2)) - ((self._DesignParameter['N4']['_XYCoordinates'][0][0] + self._DesignParameter['N4']['_DesignObj']._DesignParameter['_HVTLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['N4']['_DesignObj']._DesignParameter['_HVTLayer']['_XWidth'] / 2))), _YWidth=self._DesignParameter['N1']['_DesignObj']._DesignParameter['_HVTLayer']['_YWidth'])
		    self._DesignParameter['VT']['_XYCoordinates'] = [[(+ self._DesignParameter['N1']['_XYCoordinates'][0][0]), (+ self._DesignParameter['N1']['_XYCoordinates'][0][1])]]
		    self._DesignParameter['VT2'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['HVT'][0], _Datatype=DesignParameters._LayerMapping['HVT'][1], _XWidth=(((self._DesignParameter['P5']['_XYCoordinates'][0][0] + self._DesignParameter['P5']['_DesignObj']._DesignParameter['_HVTLayer']['_XYCoordinates'][0][0]) + (self._DesignParameter['P5']['_DesignObj']._DesignParameter['_HVTLayer']['_XWidth'] / 2)) - ((self._DesignParameter['P4']['_XYCoordinates'][0][0] + self._DesignParameter['P4']['_DesignObj']._DesignParameter['_HVTLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['P4']['_DesignObj']._DesignParameter['_HVTLayer']['_XWidth'] / 2))), _YWidth=self._DesignParameter['P_Dummy0']['_DesignObj']._DesignParameter['_HVTLayer']['_YWidth'])
		    self._DesignParameter['VT2']['_XYCoordinates'] = [[(+ self._DesignParameter['P_Dummy0']['_XYCoordinates'][0][0]), (+ self._DesignParameter['P_Dummy0']['_XYCoordinates'][0][1])]]
		self._DesignParameter['N5_M3V4M4'] = self._SrefElementDeclaration(_DesignObj=ViaMet32Met4._ViaMet32Met4(_Name='N5_M3V4M4In{}'.format(_Name)))[0]
		self._DesignParameter['N5_M3V4M4']['_DesignObj']._CalculateViaMet32Met4DesignParameterMinimumEnclosureX(**dict(_ViaMet32Met4NumberOfCOX=1, _ViaMet32Met4NumberOfCOY=2))
		self._DesignParameter['N5_M3V4M4']['_XYCoordinates'] = [[(+ self._DesignParameter['N5_M2V2M3']['_XYCoordinates'][0][0]), (+ self._DesignParameter['N5_M2V2M3']['_XYCoordinates'][0][1])]]
		self._DesignParameter['M1_N1_dummy'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL1'][0], _Datatype=DesignParameters._LayerMapping['METAL1'][1], _XWidth=200, _YWidth=50)
		self._DesignParameter['M1_N1_dummy']['_XYCoordinates'] = [[(+ self._DesignParameter['M1V1M2_N1']['_XYCoordinates'][0][0]), (+ self._DesignParameter['M1V1M2_N1']['_XYCoordinates'][0][1])]]
		self._DesignParameter['M2_N1_dummy'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL2'][0], _Datatype=DesignParameters._LayerMapping['METAL2'][1], _XWidth=220, _YWidth=50.0)
		self._DesignParameter['M2_N1_dummy']['_XYCoordinates'] = [[(+ self._DesignParameter['M1V1M2_N1']['_XYCoordinates'][0][0]), (+ self._DesignParameter['M1V1M2_N1']['_XYCoordinates'][0][1])]]
		self._DesignParameter['M1_N2_dummy'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL1'][0], _Datatype=DesignParameters._LayerMapping['METAL1'][1], _XWidth=200, _YWidth=50)
		self._DesignParameter['M1_N2_dummy']['_XYCoordinates'] = [[(+ self._DesignParameter['PCCAM1_VINn']['_XYCoordinates'][0][0]), (+ self._DesignParameter['PCCAM1_VINn']['_XYCoordinates'][0][1])]]
		self._DesignParameter['M1_N3_dummy'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL1'][0], _Datatype=DesignParameters._LayerMapping['METAL1'][1], _XWidth=200, _YWidth=50)
		self._DesignParameter['M1_N3_dummy']['_XYCoordinates'] = [[(+ self._DesignParameter['PCCAM1_VINp']['_XYCoordinates'][0][0]), (+ self._DesignParameter['PCCAM1_VINp']['_XYCoordinates'][0][1])]]
		self._DesignParameter['M1_N4_dummy'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL1'][0], _Datatype=DesignParameters._LayerMapping['METAL1'][1], _XWidth=200, _YWidth=50)
		self._DesignParameter['M1_N4_dummy']['_XYCoordinates'] = [[(+ self._DesignParameter['PCCAM1_N4']['_XYCoordinates'][0][0]), (+ self._DesignParameter['PCCAM1_N4']['_XYCoordinates'][0][1])]]
		self._DesignParameter['M2_N4_dummy'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL2'][0], _Datatype=DesignParameters._LayerMapping['METAL2'][1], _XWidth=220, _YWidth=50)
		self._DesignParameter['M2_N4_dummy']['_XYCoordinates'] = [[(+ self._DesignParameter['PCCAM1_N4']['_XYCoordinates'][0][0]), (+ self._DesignParameter['PCCAM1_N4']['_XYCoordinates'][0][1])]]
		self._DesignParameter['M1_N5_dummy'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL1'][0], _Datatype=DesignParameters._LayerMapping['METAL1'][1], _XWidth=200, _YWidth=50)
		self._DesignParameter['M1_N5_dummy']['_XYCoordinates'] = [[(+ self._DesignParameter['PCCAM1_N5']['_XYCoordinates'][0][0]), (+ self._DesignParameter['PCCAM1_N5']['_XYCoordinates'][0][1])]]
		self._DesignParameter['M2_N5_dummy'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL2'][0], _Datatype=DesignParameters._LayerMapping['METAL2'][1], _XWidth=220, _YWidth=50)
		self._DesignParameter['M2_N5_dummy']['_XYCoordinates'] = [[(+ self._DesignParameter['PCCAM1_N5']['_XYCoordinates'][0][0]), (+ self._DesignParameter['PCCAM1_N5']['_XYCoordinates'][0][1])]]
		...
		self._DesignParameter['M1_P1_dummy']['_XYCoordinates'] = [[(+ self._DesignParameter['PCCAM1_P1']['_XYCoordinates'][0][0]), (+ self._DesignParameter['PCCAM1_P1']['_XYCoordinates'][0][1])]]
		self._DesignParameter['M1_P2_dummy'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL1'][0], _Datatype=DesignParameters._LayerMapping['METAL1'][1], _XWidth=200, _YWidth=50)
		self._DesignParameter['M1_P2_dummy']['_XYCoordinates'] = [[(+ self._DesignParameter['PCCAM1_P2']['_XYCoordinates'][0][0]), (+ self._DesignParameter['PCCAM1_P2']['_XYCoordinates'][0][1])]]
		self._DesignParameter['M1_P3_dummy'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL1'][0], _Datatype=DesignParameters._LayerMapping['METAL1'][1], _XWidth=176, _YWidth=50)
		self._DesignParameter['M1_P3_dummy']['_XYCoordinates'] = [[(+ self._DesignParameter['PCCAM1_P3']['_XYCoordinates'][0][0]), (+ self._DesignParameter['PCCAM1_P3']['_XYCoordinates'][0][1])]]
		self._DesignParameter['M1_P4_dummy'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL1'][0], _Datatype=DesignParameters._LayerMapping['METAL1'][1], _XWidth=176, _YWidth=50)
		self._DesignParameter['M1_P4_dummy']['_XYCoordinates'] = [[(+ self._DesignParameter['PCCAM1_P4']['_XYCoordinates'][0][0]), (+ self._DesignParameter['PCCAM1_P4']['_XYCoordinates'][0][1])]]
		self._DesignParameter['M2_P4_dummy'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL2'][0], _Datatype=DesignParameters._LayerMapping['METAL2'][1], _XWidth=220, _YWidth=50)
		self._DesignParameter['M2_P4_dummy']['_XYCoordinates'] = [[(+ self._DesignParameter['PCCAM1_P4']['_XYCoordinates'][0][0]), (+ self._DesignParameter['PCCAM1_P4']['_XYCoordinates'][0][1])]]
		self._DesignParameter['M1_P5_dummy'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL1'][0], _Datatype=DesignParameters._LayerMapping['METAL1'][1], _XWidth=200, _YWidth=50)
		self._DesignParameter['M1_P5_dummy']['_XYCoordinates'] = [[(+ self._DesignParameter['PCCAM1_P5']['_XYCoordinates'][0][0]), (+ self._DesignParameter['PCCAM1_P5']['_XYCoordinates'][0][1])]]
		self._DesignParameter['M2_P5_dummy'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL2'][0], _Datatype=DesignParameters._LayerMapping['METAL2'][1], _XWidth=220, _YWidth=50)
		self._DesignParameter['M2_P5_dummy']['_XYCoordinates'] = [[(+ self._DesignParameter['PCCAM1_P5']['_XYCoordinates'][0][0]), (+ self._DesignParameter['PCCAM1_P5']['_XYCoordinates'][0][1])]]
		self._DesignParameter['M3_P5_dummy'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL3'][0], _Datatype=DesignParameters._LayerMapping['METAL3'][1], _XWidth=220, _YWidth=50)
		self._DesignParameter['M3_P5_dummy']['_XYCoordinates'] = [[(+ self._DesignParameter['PCCAM1_P5']['_XYCoordinates'][0][0]), (+ self._DesignParameter['PCCAM1_P5']['_XYCoordinates'][0][1])]]
		self._DesignParameter['N1_poly_dummy'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['POLY'][0], _Datatype=DesignParameters._LayerMapping['POLY'][1], _XWidth=(((self._DesignParameter['N1']['_XYCoordinates'][0][0] + self._DesignParameter['N1']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][(- 1)][0]) + (self._DesignParameter['N1']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2)) - ((self._DesignParameter['N1']['_XYCoordinates'][0][0] + self._DesignParameter['N1']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['N1']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2))), _YWidth=76)
		self._DesignParameter['N1_poly_dummy']['_XYCoordinates'] = [[self._DesignParameter['PCCAM1_N1']['_XYCoordinates'][0][0], (self._DesignParameter['PCCAM1_N1']['_XYCoordinates'][0][1] + 13)]]
		self._DesignParameter['N2_poly_dummy'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['POLY'][0], _Datatype=DesignParameters._LayerMapping['POLY'][1], _XWidth=(((self._DesignParameter['N2']['_XYCoordinates'][0][0] + self._DesignParameter['N2']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][(- 1)][0]) + (self._DesignParameter['N2']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2)) - ((self._DesignParameter['N2']['_XYCoordinates'][0][0] + self._DesignParameter['N2']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['N2']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2))), _YWidth=76)
		self._DesignParameter['N2_poly_dummy']['_XYCoordinates'] = [[self._DesignParameter['PCCAM1_VINn']['_XYCoordinates'][0][0], (self._DesignParameter['PCCAM1_VINn']['_XYCoordinates'][0][1] + 13)]]
		self._DesignParameter['N3_poly_dummy'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['POLY'][0], _Datatype=DesignParameters._LayerMapping['POLY'][1], _XWidth=(((self._DesignParameter['N3']['_XYCoordinates'][0][0] + self._DesignParameter['N3']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][(- 1)][0]) + (self._DesignParameter['N3']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2)) - ((self._DesignParameter['N3']['_XYCoordinates'][0][0] + self._DesignParameter['N3']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['N3']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2))), _YWidth=76)
		self._DesignParameter['N3_poly_dummy']['_XYCoordinates'] = [[self._DesignParameter['PCCAM1_VINp']['_XYCoordinates'][0][0], (self._DesignParameter['PCCAM1_VINp']['_XYCoordinates'][0][1] + 13)]]
		self._DesignParameter['N4_poly_dummy'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['POLY'][0], _Datatype=DesignParameters._LayerMapping['POLY'][1], _XWidth=(((self._DesignParameter['N4']['_XYCoordinates'][0][0] + self._DesignParameter['N4']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][(- 1)][0]) + (self._DesignParameter['N4']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2)) - ((self._DesignParameter['N4']['_XYCoordinates'][0][0] + self._DesignParameter['N4']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['N4']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2))), _YWidth=76)
		self._DesignParameter['N4_poly_dummy']['_XYCoordinates'] = [[self._DesignParameter['PCCAM1_N4']['_XYCoordinates'][0][0], (self._DesignParameter['PCCAM1_N4']['_XYCoordinates'][0][1] + 13)]]
		self._DesignParameter['N5_poly_dummy'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['POLY'][0], _Datatype=DesignParameters._LayerMapping['POLY'][1], _XWidth=(((self._DesignParameter['N5']['_XYCoordinates'][0][0] + self._DesignParameter['N5']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][(- 1)][0]) + (self._DesignParameter['N5']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2)) - ((self._DesignParameter['N5']['_XYCoordinates'][0][0] + self._DesignParameter['N5']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['N5']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2))), _YWidth=76)
		self._DesignParameter['N5_poly_dummy']['_XYCoordinates'] = [[self._DesignParameter['PCCAM1_N5']['_XYCoordinates'][0][0], (self._DesignParameter['PCCAM1_N5']['_XYCoordinates'][0][1] + 13)]]
		self._DesignParameter['N_Dummy1_poly_dummy'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['POLY'][0], _Datatype=DesignParameters._LayerMapping['POLY'][1], _XWidth=(((self._DesignParameter['N_Dummy1']['_XYCoordinates'][0][0] + self._DesignParameter['N_Dummy1']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][(- 1)][0]) + (self._DesignParameter['N_Dummy1']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2)) - ((self._DesignParameter['N_Dummy1']['_XYCoordinates'][0][0] + self._DesignParameter['N_Dummy1']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['N_Dummy1']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2))), _YWidth=76)
		self._DesignParameter['N_Dummy1_poly_dummy']['_XYCoordinates'] = [[self._DesignParameter['PCCAM1_N_Dummy1']['_XYCoordinates'][0][0], (self._DesignParameter['PCCAM1_N_Dummy1']['_XYCoordinates'][0][1] - 13)]]
		self._DesignParameter['N_Dummy2_poly_dummy'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['POLY'][0], _Datatype=DesignParameters._LayerMapping['POLY'][1], _XWidth=(((self._DesignParameter['N_Dummy2']['_XYCoordinates'][0][0] + self._DesignParameter['N_Dummy2']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][(- 1)][0]) + (self._DesignParameter['N_Dummy2']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2)) - ((self._DesignParameter['N_Dummy2']['_XYCoordinates'][0][0] + self._DesignParameter['N_Dummy2']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['N_Dummy2']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2))), _YWidth=76)
		self._DesignParameter['N_Dummy2_poly_dummy']['_XYCoordinates'] = [[self._DesignParameter['PCCAM1_N_Dummy2']['_XYCoordinates'][0][0], (self._DesignParameter['PCCAM1_N_Dummy2']['_XYCoordinates'][0][1] - 13)]]
		self._DesignParameter['P1_poly_dummy'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['POLY'][0], _Datatype=DesignParameters._LayerMapping['POLY'][1], _XWidth=(((self._DesignParameter['P1']['_XYCoordinates'][0][0] + self._DesignParameter['P1']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][(- 1)][0]) + (self._DesignParameter['P1']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2)) - ((self._DesignParameter['P1']['_XYCoordinates'][0][0] + self._DesignParameter['P1']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['P1']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2))), _YWidth=76)
		self._DesignParameter['P1_poly_dummy']['_XYCoordinates'] = [[self._DesignParameter['PCCAM1_P1']['_XYCoordinates'][0][0], (self._DesignParameter['PCCAM1_P1']['_XYCoordinates'][0][1] - 13)]]
		self._DesignParameter['P2_poly_dummy'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['POLY'][0], _Datatype=DesignParameters._LayerMapping['POLY'][1], _XWidth=(((self._DesignParameter['P2']['_XYCoordinates'][0][0] + self._DesignParameter['P2']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][(- 1)][0]) + (self._DesignParameter['P2']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2)) - ((self._DesignParameter['P2']['_XYCoordinates'][0][0] + self._DesignParameter['P2']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['P2']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2))), _YWidth=76)
		self._DesignParameter['P2_poly_dummy']['_XYCoordinates'] = [[self._DesignParameter['PCCAM1_P2']['_XYCoordinates'][0][0], (self._DesignParameter['PCCAM1_P2']['_XYCoordinates'][0][1] - 13)]]
		self._DesignParameter['P3_poly_dummy'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['POLY'][0], _Datatype=DesignParameters._LayerMapping['POLY'][1], _XWidth=(((self._DesignParameter['P3']['_XYCoordinates'][0][0] + self._DesignParameter['P3']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][(- 1)][0]) + (self._DesignParameter['P3']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2)) - ((self._DesignParameter['P3']['_XYCoordinates'][0][0] + self._DesignParameter['P3']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['P3']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2))), _YWidth=76)
		self._DesignParameter['P3_poly_dummy']['_XYCoordinates'] = [[self._DesignParameter['PCCAM1_P3']['_XYCoordinates'][0][0], (self._DesignParameter['PCCAM1_P3']['_XYCoordinates'][0][1] - 13)]]
		self._DesignParameter['P4_poly_dummy'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['POLY'][0], _Datatype=DesignParameters._LayerMapping['POLY'][1], _XWidth=(((self._DesignParameter['P4']['_XYCoordinates'][0][0] + self._DesignParameter['P4']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][(- 1)][0]) + (self._DesignParameter['P4']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2)) - ((self._DesignParameter['P4']['_XYCoordinates'][0][0] + self._DesignParameter['P4']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['P4']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2))), _YWidth=76)
		self._DesignParameter['P4_poly_dummy']['_XYCoordinates'] = [[self._DesignParameter['PCCAM1_P4']['_XYCoordinates'][0][0], (self._DesignParameter['PCCAM1_P4']['_XYCoordinates'][0][1] - 13)]]
		self._DesignParameter['P5_poly_dummy'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['POLY'][0], _Datatype=DesignParameters._LayerMapping['POLY'][1], _XWidth=(((self._DesignParameter['P5']['_XYCoordinates'][0][0] + self._DesignParameter['P5']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][(- 1)][0]) + (self._DesignParameter['P5']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2)) - ((self._DesignParameter['P5']['_XYCoordinates'][0][0] + self._DesignParameter['P5']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['P5']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2))), _YWidth=76)
		self._DesignParameter['P5_poly_dummy']['_XYCoordinates'] = [[self._DesignParameter['PCCAM1_P5']['_XYCoordinates'][0][0], (self._DesignParameter['PCCAM1_P5']['_XYCoordinates'][0][1] - 13)]]
		self._DesignParameter['P_Dummy0_poly_dummy'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['POLY'][0], _Datatype=DesignParameters._LayerMapping['POLY'][1], _XWidth=(((self._DesignParameter['P_Dummy0']['_XYCoordinates'][0][0] + self._DesignParameter['P_Dummy0']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][(- 1)][0]) + (self._DesignParameter['P_Dummy0']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2)) - ((self._DesignParameter['P_Dummy0']['_XYCoordinates'][0][0] + self._DesignParameter['P_Dummy0']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['P_Dummy0']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2))), _YWidth=76)
		self._DesignParameter['P_Dummy0_poly_dummy']['_XYCoordinates'] = [[self._DesignParameter['PCCAM1_P_Dummy0']['_XYCoordinates'][0][0], (self._DesignParameter['PCCAM1_P_Dummy0']['_XYCoordinates'][0][1] + 13)]]
		self._DesignParameter['P_Dummy1_poly_dummy'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['POLY'][0], _Datatype=DesignParameters._LayerMapping['POLY'][1], _XWidth=(((self._DesignParameter['P_Dummy1']['_XYCoordinates'][0][0] + self._DesignParameter['P_Dummy1']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][(- 1)][0]) + (self._DesignParameter['P_Dummy1']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2)) - ((self._DesignParameter['P_Dummy1']['_XYCoordinates'][0][0] + self._DesignParameter['P_Dummy1']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['P_Dummy1']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2))), _YWidth=76)
		self._DesignParameter['P_Dummy1_poly_dummy']['_XYCoordinates'] = [[self._DesignParameter['PCCAM1_P_Dummy_1']['_XYCoordinates'][0][0], (self._DesignParameter['PCCAM1_P_Dummy_1']['_XYCoordinates'][0][1] + 13)]]
		self._DesignParameter['P_Dummy2_poly_dummy'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['POLY'][0], _Datatype=DesignParameters._LayerMapping['POLY'][1], _XWidth=(((self._DesignParameter['P_Dummy2']['_XYCoordinates'][0][0] + self._DesignParameter['P_Dummy2']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][(- 1)][0]) + (self._DesignParameter['P_Dummy2']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2)) - ((self._DesignParameter['P_Dummy2']['_XYCoordinates'][0][0] + self._DesignParameter['P_Dummy2']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['P_Dummy2']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2))), _YWidth=76)
		self._DesignParameter['P_Dummy2_poly_dummy']['_XYCoordinates'] = [[self._DesignParameter['PCCAM1_P_Dummy2']['_XYCoordinates'][0][0], (self._DesignParameter['PCCAM1_P_Dummy2']['_XYCoordinates'][0][1] + 13)]]
		self._DesignParameter['N3_M3_path_dummy'] = self._PathElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL3'][0], _Datatype=DesignParameters._LayerMapping['METAL3'][1], _Width=50)
		self._DesignParameter['N3_M3_path_dummy']['_XYCoordinates'] = [[[(+ self._DesignParameter['M2V2M3_N3_drain']['_XYCoordinates'][0][0]), (+ self._DesignParameter['M2V2M3_N3_drain']['_XYCoordinates'][0][1])], [(+ self._DesignParameter['M2V2M3_N3_drain']['_XYCoordinates'][(- 1)][0]), (+ self._DesignParameter['M2V2M3_N3_drain']['_XYCoordinates'][(- 1)][1])]]]
		self._DesignParameter['res1_M1_dummy1'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL1'][0], _Datatype=DesignParameters._LayerMapping['METAL1'][1], _XWidth=self._DesignParameter['M1V1M2res_com_in']['_DesignObj']._DesignParameter['_Met1Layer']['_XWidth'], _YWidth=64)
		self._DesignParameter['res1_M1_dummy1']['_XYCoordinates'] = [[(+ self._DesignParameter['M1V1M2res_com_in']['_XYCoordinates'][0][0]), (+ self._DesignParameter['M1V1M2res_com_in']['_XYCoordinates'][0][1])]]
		self._DesignParameter['res1_M1_dummy2'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['METAL1'][0], _Datatype=DesignParameters._LayerMapping['METAL1'][1], _XWidth=self._DesignParameter['M1V1M2_cap_res']['_DesignObj']._DesignParameter['_Met1Layer']['_XWidth'], _YWidth=64)
		self._DesignParameter['res1_M1_dummy2']['_XYCoordinates'] = [[(+ self._DesignParameter['M1V1M2_cap_res']['_XYCoordinates'][0][0]), (+ self._DesignParameter['M1V1M2_cap_res']['_XYCoordinates'][0][1])]]

		return finger_N_Dummy1, finger_N_Dummy2, finger_P_Dummy1, finger_P_Dummy2 #for random gen
...
if __name__ == '__main__':
	...
	InputParams = dict(
        # width=4174,
		finger_N1 = 4, W_N = 950, L = 110, Dummy = True, XVT = 'SLVT', finger_N2 = 8, W_P = 950,
		finger_P1 = 4, finger_P5 = 5, finger_N5 = 2, finger_N4 = 2, finger_P3 = 1, finger_P4 = 1,
		Guad_via = 2, res_compensation_W = 1000, res_compensation_L = 3500, res_compensation_series = 2,
		NumofGate_res_com = 10, NumofRX_res_com = 2, L_cap = 2600, W_cap = 2600
	)

	Mode_DRCCheck = True  # True | False
	Num_DRCCheck = 100

	LayoutObj =B00_amp_v2(_Name=cellname)
