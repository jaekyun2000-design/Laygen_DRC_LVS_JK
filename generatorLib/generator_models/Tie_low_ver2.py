...
class TIEH_2X_STD_v1(StickDiagram._StickDiagram):
	...
	def _CalculateDesignParameter(self,nmos_y=300,pmos_y=500,gate=3,sd_width=66,gate_spacing=110,vdd2vss_height=1800,nmos_width=200,pmos_width=400,length=40,nmos_gate=3,pmos_gate=3,XVT='RVT'):
