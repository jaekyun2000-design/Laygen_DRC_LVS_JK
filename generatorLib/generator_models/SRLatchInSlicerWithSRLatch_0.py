...
class SRLatchInSlicerWithSRLatch_0(StickDiagram._StickDiagram):
	...
	def _CalculateDesignParameter(self,supply_via=2,supply_height=2000,SLVT=None,cont_x=None):
		...
		self._DesignParameter['NMOS1InSRLatch_0']['_DesignObj']._CalculateNMOSDesignParameter(**dict(_NMOSNumberofGate=5, _NMOSChannelWidth=200, _NMOSChannellength=30, _NMOSDummy=True, _GateSpacing=None, _XVT='SLVT'))
		...
		self._DesignParameter['NMOS2InSRLatch_0']['_DesignObj']._CalculateNMOSDesignParameter(**dict(_NMOSNumberofGate=1, _NMOSChannelWidth=200, _NMOSChannellength=30, _NMOSDummy=True, _GateSpacing=None, _XVT='SLVT'))
		...
		self._DesignParameter['NMOS3InSRLatch_0']['_DesignObj']._CalculateNMOSDesignParameter(**dict(_NMOSNumberofGate=2, _NMOSChannelWidth=200, _NMOSChannellength=30, _NMOSDummy=True, _GateSpacing=None, _XVT='SLVT'))
		...
		self._DesignParameter['NMOS4InSRLatch_0']['_DesignObj']._CalculateNMOSDesignParameter(**dict(_NMOSNumberofGate=2, _NMOSChannelWidth=200, _NMOSChannellength=30, _NMOSDummy=True, _GateSpacing=None, _XVT='SLVT'))
		...
		self._DesignParameter['PMOS1InSRLatch_0']['_DesignObj']._CalculatePMOSDesignParameter(**dict(_PMOSNumberofGate=5, _PMOSChannelWidth=400, _PMOSChannellength=30, _PMOSDummy=True, _GateSpacing=None, _XVT='SLVT'))
		...
		self._DesignParameter['PMOS2InSRLatch_0']['_DesignObj']._CalculatePMOSDesignParameter(**dict(_PMOSNumberofGate=1, _PMOSChannelWidth=400, _PMOSChannellength=30, _PMOSDummy=True, _GateSpacing=None, _XVT='SLVT'))
		...
		self._DesignParameter['PMOS4InSRLatch_0']['_DesignObj']._CalculatePMOSDesignParameter(**dict(_PMOSNumberofGate=2, _PMOSChannelWidth=400, _PMOSChannellength=30, _PMOSDummy=True, _GateSpacing=None, _XVT='SLVT'))
		...
		self._DesignParameter['NMOS1_rInSRLatch_0']['_DesignObj']._CalculateNMOSDesignParameter(**dict(_NMOSNumberofGate=5, _NMOSChannelWidth=200, _NMOSChannellength=30, _NMOSDummy=True, _GateSpacing=None, _XVT='SLVT'))
		...
		self._DesignParameter['NMOS2_rInSRLatch_0']['_DesignObj']._CalculateNMOSDesignParameter(**dict(_NMOSNumberofGate=1, _NMOSChannelWidth=200, _NMOSChannellength=30, _NMOSDummy=True, _GateSpacing=None, _XVT='SLVT'))
		...
		self._DesignParameter['NMOS3_rInSRLatch_0']['_DesignObj']._CalculateNMOSDesignParameter(**dict(_NMOSNumberofGate=2, _NMOSChannelWidth=200, _NMOSChannellength=30, _NMOSDummy=True, _GateSpacing=None, _XVT='SLVT'))
		...
		self._DesignParameter['NMOS4_rInSRLatch_0']['_DesignObj']._CalculateNMOSDesignParameter(**dict(_NMOSNumberofGate=2, _NMOSChannelWidth=200, _NMOSChannellength=30, _NMOSDummy=True, _GateSpacing=None, _XVT='SLVT'))
		...
		self._DesignParameter['PMOS1_rInSRLatch_0']['_DesignObj']._CalculatePMOSDesignParameter(**dict(_PMOSNumberofGate=5, _PMOSChannelWidth=400, _PMOSChannellength=30, _PMOSDummy=True, _GateSpacing=None, _XVT='SLVT'))
		...
		self._DesignParameter['PMOS2_rInSRLatch_0']['_DesignObj']._CalculatePMOSDesignParameter(**dict(_PMOSNumberofGate=1, _PMOSChannelWidth=400, _PMOSChannellength=30, _PMOSDummy=True, _GateSpacing=None, _XVT='SLVT'))
		...
		self._DesignParameter['PMOS3_rInSRLatch_0']['_DesignObj']._CalculatePMOSDesignParameter(**dict(_PMOSNumberofGate=2, _PMOSChannelWidth=400, _PMOSChannellength=30, _PMOSDummy=True, _GateSpacing=None, _XVT='SLVT'))
		...
		self._DesignParameter['PMOS4_rInSRLatch_0']['_DesignObj']._CalculatePMOSDesignParameter(**dict(_PMOSNumberofGate=2, _PMOSChannelWidth=400, _PMOSChannellength=30, _PMOSDummy=True, _GateSpacing=None, _XVT='SLVT'))
		...
		self._DesignParameter['PMOS3InSRLatch_0']['_DesignObj']._CalculatePMOSDesignParameter(**dict(_PMOSNumberofGate=2, _PMOSChannelWidth=400, _PMOSChannellength=30, _PMOSDummy=True, _GateSpacing=None, _XVT='SLVT'))
		...
		self._DesignParameter['PCCAM1_nu1']['_DesignObj']._CalculateViaPoly2Met1DesignParameter(**dict(_ViaPoly2Met1NumberOfCOY=1, _ViaPoly2Met1NumberOfCOX=max(1, int(((((((self._DesignParameter['NMOS1InSRLatch_0']['_XYCoordinates'][0][0] + self._DesignParameter['NMOS1InSRLatch_0']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][(- 1)][0]) + (self._DesignParameter['NMOS1InSRLatch_0']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2)) - ((self._DesignParameter['NMOS1InSRLatch_0']['_XYCoordinates'][0][0] + self._DesignParameter['NMOS1InSRLatch_0']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['NMOS1InSRLatch_0']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2))) - drc._CoMinSpace) - (2 * drc._CoMinEnclosureByPO)) / (drc._CoMinWidth + drc._CoMinSpace))))))
		...
		self._DesignParameter['M1V1M2_nu_1']['_DesignObj']._CalculateViaMet12Met2DesignParameterMinimumEnclosureY(**dict(_ViaMet12Met2NumberOfCOX=max(1, int(((((((self._DesignParameter['NMOS1InSRLatch_0']['_XYCoordinates'][0][0] + self._DesignParameter['NMOS1InSRLatch_0']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][(- 1)][0]) + (self._DesignParameter['NMOS1InSRLatch_0']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2)) - ((self._DesignParameter['NMOS1InSRLatch_0']['_XYCoordinates'][0][0] + self._DesignParameter['NMOS1InSRLatch_0']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['NMOS1InSRLatch_0']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2))) - drc._VIAxMinSpace) - (2 * drc._VIAxMinEnclosureByMetx)) / (drc._VIAxMinWidth + drc._VIAxMinSpace)))), _ViaMet12Met2NumberOfCOY=1))
		...
		nmos_via = max(max(1, int((((self._DesignParameter['NMOS1InSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] - drc._VIAxMinSpace) - (2 * drc._VIAxMinEnclosureByMetx)) / (drc._VIAxMinWidth + drc._VIAxMinSpace)))), 2)
		XYList = []
		xy_offset = (0, (- int(((drc._VIAxMinWidth + drc._VIAxMinSpace) / 4))))
		for i in range(len(self._DesignParameter['NMOS1InSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'])):
		    if ((i % 2) == 1):
		        XYList.append([((x + y) + z) for (x, y, z) in zip([(0 + self._DesignParameter['NMOS1InSRLatch_0']['_XYCoordinates'][0][0]), (0 + self._DesignParameter['NMOS1InSRLatch_0']['_XYCoordinates'][0][1])], self._DesignParameter['NMOS1InSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][i], xy_offset)])
		...
		for i in range(len(self._DesignParameter['nu1_drain_via12']['_XYCoordinates'])):
		    XYList.append([((x + y) + z) for (x, y, z) in zip([0, 0], self._DesignParameter['nu1_drain_via12']['_XYCoordinates'][i], xy_offset)])
		...
		nmos_via = max(max(1, int((((self._DesignParameter['NMOS2InSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] - drc._VIAxMinSpace) - (2 * drc._VIAxMinEnclosureByMetx)) / (drc._VIAxMinWidth + drc._VIAxMinSpace)))), 2)
		XYList = []
		xy_offset = (0, (- int(((drc._VIAxMinWidth + drc._VIAxMinSpace) / 4))))
		for i in range(len(self._DesignParameter['NMOS2InSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'])):
		    if ((i % 2) == 1):
		        XYList.append([((x + y) + z) for (x, y, z) in zip([(0 + self._DesignParameter['NMOS2InSRLatch_0']['_XYCoordinates'][0][0]), (0 + self._DesignParameter['NMOS2InSRLatch_0']['_XYCoordinates'][0][1])], self._DesignParameter['NMOS2InSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][i], xy_offset)])
		...
		nmos_via = max(max(1, int((((self._DesignParameter['NMOS3InSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] - drc._VIAxMinSpace) - (2 * drc._VIAxMinEnclosureByMetx)) / (drc._VIAxMinWidth + drc._VIAxMinSpace)))), 2)
		XYList = []
		...
		for i in range(len(self._DesignParameter['NMOS3InSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'])):
		    if ((i % 2) == 0):
		        XYList.append([((x + y) + z) for (x, y, z) in zip([(0 + self._DesignParameter['NMOS3InSRLatch_0']['_XYCoordinates'][0][0]), (0 + self._DesignParameter['NMOS3InSRLatch_0']['_XYCoordinates'][0][1])], self._DesignParameter['NMOS3InSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][i], xy_offset)])
		...
		for i in range(len(self._DesignParameter['nu3_s_via12']['_XYCoordinates'])):
		    XYList.append([((x + y) + z) for (x, y, z) in zip([0, 0], self._DesignParameter['nu3_s_via12']['_XYCoordinates'][i], xy_offset)])
		...
		nmos_via = max(max(1, int((((self._DesignParameter['NMOS4InSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] - drc._VIAxMinSpace) - (2 * drc._VIAxMinEnclosureByMetx)) / (drc._VIAxMinWidth + drc._VIAxMinSpace)))), 2)
		XYList = []
		xy_offset = [0, 0]
		for i in range(len(self._DesignParameter['NMOS4InSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'])):
		    if ((i % 2) == 1):
		        XYList.append([((x + y) + z) for (x, y, z) in zip([(0 + self._DesignParameter['NMOS4InSRLatch_0']['_XYCoordinates'][0][0]), (0 + self._DesignParameter['NMOS4InSRLatch_0']['_XYCoordinates'][0][1])], self._DesignParameter['NMOS4InSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][i], xy_offset)])
		...
		self._DesignParameter['PCCAM1_nu_3']['_DesignObj']._CalculateViaPoly2Met1DesignParameter(**dict(_ViaPoly2Met1NumberOfCOX=max(max(1, int(((((((self._DesignParameter['NMOS3InSRLatch_0']['_XYCoordinates'][0][0] + self._DesignParameter['NMOS3InSRLatch_0']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0]) + (self._DesignParameter['NMOS3InSRLatch_0']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2)) - ((self._DesignParameter['NMOS3InSRLatch_0']['_XYCoordinates'][0][0] + self._DesignParameter['NMOS3InSRLatch_0']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['NMOS3InSRLatch_0']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2))) - drc._CoMinSpace) - (2 * drc._CoMinEnclosureByPO)) / (drc._CoMinWidth + drc._CoMinSpace)))), 1), _ViaPoly2Met1NumberOfCOY=1))
		...
		self._DesignParameter['nu3_gate_vias']['_XYCoordinates'] = [[self._DesignParameter['NMOS3InSRLatch_0']['_XYCoordinates'][0][0], self._DesignParameter['PCCAM1_nu_3']['_XYCoordinates'][0][1]]]
		...
		pmos_via = max(1, int((((self._DesignParameter['PMOS1InSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] - drc._VIAxMinSpace) - (2 * drc._VIAxMinEnclosureByMetx)) / (drc._VIAxMinWidth + drc._VIAxMinSpace))))
		XYList = []
		xy_offset = [0, 0]
		for i in range(len(self._DesignParameter['PMOS1InSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'])):
		    if ((i % 2) == 1):
		        XYList.append([((x + y) + z) for (x, y, z) in zip([(0 + self._DesignParameter['PMOS1InSRLatch_0']['_XYCoordinates'][0][0]), (0 + self._DesignParameter['PMOS1InSRLatch_0']['_XYCoordinates'][0][1])], self._DesignParameter['PMOS1InSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][i], xy_offset)])
		...
		self._DesignParameter['pu1_gate_vias']['_DesignObj']._CalculateStackMinimumEnclosureY(**dict(COX=max(1, int(((((((self._DesignParameter['PMOS1InSRLatch_0']['_XYCoordinates'][0][0] + self._DesignParameter['PMOS1InSRLatch_0']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][(- 1)][0]) + (self._DesignParameter['PMOS1InSRLatch_0']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2)) - ((self._DesignParameter['PMOS1InSRLatch_0']['_XYCoordinates'][0][0] + self._DesignParameter['PMOS1InSRLatch_0']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['PMOS1InSRLatch_0']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2))) - drc._VIAxMinSpace) - (2 * drc._VIAxMinEnclosureByMetx)) / (drc._VIAxMinWidth + drc._VIAxMinSpace)))), COY=1, start_layer=1, end_layer=3))
		...
		pmos_via = max(1, int((((self._DesignParameter['PMOS1_rInSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] - drc._VIAxMinSpace) - (2 * drc._VIAxMinEnclosureByMetx)) / (drc._VIAxMinWidth + drc._VIAxMinSpace))))
		XYList = []
		xy_offset = [0, 0]
		for i in range(len(self._DesignParameter['PMOS1_rInSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'])):
		    if ((i % 2) == 1):
		        XYList.append([((x + y) + z) for (x, y, z) in zip([(0 + self._DesignParameter['PMOS1_rInSRLatch_0']['_XYCoordinates'][0][0]), (0 + self._DesignParameter['PMOS1_rInSRLatch_0']['_XYCoordinates'][0][1])], self._DesignParameter['PMOS1_rInSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][i], xy_offset)])
		...
		for i in range(len(self._DesignParameter['NMOS1_rInSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'])):
		    if ((i % 2) == 1):
		        XYList.append([((x + y) + z) for (x, y, z) in zip([(0 + self._DesignParameter['NMOS1_rInSRLatch_0']['_XYCoordinates'][0][0]), (0 + self._DesignParameter['NMOS1_rInSRLatch_0']['_XYCoordinates'][0][1])], self._DesignParameter['NMOS1_rInSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][i], xy_offset)])
		...
		self._DesignParameter['PCCAM1_pd1']['_DesignObj']._CalculateViaPoly2Met1DesignParameter(**dict(_ViaPoly2Met1NumberOfCOX=max(1, int(((((((self._DesignParameter['PMOS1_rInSRLatch_0']['_XYCoordinates'][0][0] + self._DesignParameter['PMOS1_rInSRLatch_0']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][(- 1)][0]) + (self._DesignParameter['PMOS1_rInSRLatch_0']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2)) - ((self._DesignParameter['PMOS1_rInSRLatch_0']['_XYCoordinates'][0][0] + self._DesignParameter['PMOS1_rInSRLatch_0']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['PMOS1_rInSRLatch_0']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2))) - drc._CoMinSpace) - (2 * drc._CoMinEnclosureByPO)) / (drc._CoMinWidth + drc._CoMinSpace)))), _ViaPoly2Met1NumberOfCOY=1))
		...
		self._DesignParameter['pd1_gate_vias']['_DesignObj']._CalculateStackMinimumEnclosureY(**dict(COX=max(1, int(((((((self._DesignParameter['PMOS1_rInSRLatch_0']['_XYCoordinates'][0][0] + self._DesignParameter['PMOS1_rInSRLatch_0']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][(- 1)][0]) + (self._DesignParameter['PMOS1_rInSRLatch_0']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2)) - ((self._DesignParameter['PMOS1_rInSRLatch_0']['_XYCoordinates'][0][0] + self._DesignParameter['PMOS1_rInSRLatch_0']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['PMOS1_rInSRLatch_0']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2))) - drc._VIAxMinSpace) - (2 * drc._VIAxMinEnclosureByMetx)) / (drc._VIAxMinWidth + drc._VIAxMinSpace)))), COY=1, start_layer=1, end_layer=4))
		...
		self._DesignParameter['PCCAM1_nd1']['_DesignObj']._CalculateViaPoly2Met1DesignParameter(**dict(_ViaPoly2Met1NumberOfCOX=max(1, int(((((((self._DesignParameter['NMOS1_rInSRLatch_0']['_XYCoordinates'][0][0] + self._DesignParameter['NMOS1_rInSRLatch_0']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][(- 1)][0]) + (self._DesignParameter['NMOS1_rInSRLatch_0']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2)) - ((self._DesignParameter['NMOS1_rInSRLatch_0']['_XYCoordinates'][0][0] + self._DesignParameter['NMOS1_rInSRLatch_0']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['NMOS1_rInSRLatch_0']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2))) - drc._CoMinSpace) - (2 * drc._CoMinEnclosureByPO)) / (drc._CoMinWidth + drc._CoMinSpace)))), _ViaPoly2Met1NumberOfCOY=1))
		...
		self._DesignParameter['M1V1M2_nd1_gate']['_DesignObj']._CalculateViaMet12Met2DesignParameterMinimumEnclosureY(**dict(_ViaMet12Met2NumberOfCOX=max(1, int(((((((self._DesignParameter['NMOS1_rInSRLatch_0']['_XYCoordinates'][0][0] + self._DesignParameter['NMOS1_rInSRLatch_0']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][(- 1)][0]) + (self._DesignParameter['NMOS1_rInSRLatch_0']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2)) - ((self._DesignParameter['NMOS1_rInSRLatch_0']['_XYCoordinates'][0][0] + self._DesignParameter['NMOS1_rInSRLatch_0']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['NMOS1_rInSRLatch_0']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2))) - drc._VIAxMinSpace) - (2 * drc._VIAxMinEnclosureByMetx)) / (drc._VIAxMinWidth + drc._VIAxMinSpace)))), _ViaMet12Met2NumberOfCOY=1))
		...
		pmos_via = max(2, max(1, int((((self._DesignParameter['PMOS2InSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] - drc._VIAxMinSpace) - (2 * drc._VIAxMinEnclosureByMetx)) / (drc._VIAxMinWidth + drc._VIAxMinSpace)))))
		XYList = []
		xy_offset = [0, 0]
		for i in range(len(self._DesignParameter['PMOS2InSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'])):
		    if ((i % 2) == 1):
		        XYList.append([((x + y) + z) for (x, y, z) in zip([(0 + self._DesignParameter['PMOS2InSRLatch_0']['_XYCoordinates'][0][0]), (0 + self._DesignParameter['PMOS2InSRLatch_0']['_XYCoordinates'][0][1])], self._DesignParameter['PMOS2InSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][i], xy_offset)])
		...
		pmos_via = max(2, max(1, int((((self._DesignParameter['PMOS3InSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] - drc._VIAxMinSpace) - (2 * drc._VIAxMinEnclosureByMetx)) / (drc._VIAxMinWidth + drc._VIAxMinSpace)))))
		XYList = []
		xy_offset = (0, (int(((drc._VIAxMinWidth + drc._VIAxMinSpace) / 4)) * 2))
		for i in range(len(self._DesignParameter['PMOS3InSRLatch_0']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'])):
		    if ((i % 2) == 0):
		        XYList.append([((x + y) + z) for (x, y, z) in zip([(0 + self._DesignParameter['PMOS3InSRLatch_0']['_XYCoordinates'][0][0]), (0 + self._DesignParameter['PMOS3InSRLatch_0']['_XYCoordinates'][0][1])], self._DesignParameter['PMOS3InSRLatch_0']['_DesignObj']._DesignParameter['_METAL1PINDrawing']['_XYCoordinates'][i], xy_offset)])
		...
		for i in range(len(self._DesignParameter['PMOS3InSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'])):
		    if ((i % 2) == 1):
		        XYList.append([((x + y) + z) for (x, y, z) in zip([(0 + self._DesignParameter['PMOS3InSRLatch_0']['_XYCoordinates'][0][0]), (0 + self._DesignParameter['PMOS3InSRLatch_0']['_XYCoordinates'][0][1])], self._DesignParameter['PMOS3InSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][i], xy_offset)])
		...
		for i in range(len(self._DesignParameter['PMOS4InSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'])):
		    if ((i % 2) == 1):
		        XYList.append([((x + y) + z) for (x, y, z) in zip([(0 + self._DesignParameter['PMOS4InSRLatch_0']['_XYCoordinates'][0][0]), (0 + self._DesignParameter['PMOS4InSRLatch_0']['_XYCoordinates'][0][1])], self._DesignParameter['PMOS4InSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][i], xy_offset)])
		...
		pmos_via = max(1, int((((self._DesignParameter['PMOS3_rInSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] - drc._VIAxMinSpace) - (2 * drc._VIAxMinEnclosureByMetx)) / (drc._VIAxMinWidth + drc._VIAxMinSpace))))
		XYList = []
		xy_offset = (0, (- int(((drc._VIAxMinWidth + drc._VIAxMinSpace) / 4))))
		for i in range(len(self._DesignParameter['PMOS3_rInSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'])):
		    if ((i % 2) == 0):
		        XYList.append([((x + y) + z) for (x, y, z) in zip([(0 + self._DesignParameter['PMOS3_rInSRLatch_0']['_XYCoordinates'][0][0]), (0 + self._DesignParameter['PMOS3_rInSRLatch_0']['_XYCoordinates'][0][1])], self._DesignParameter['PMOS3_rInSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][i], xy_offset)])
		...
		nmos_via = max(1, int((((self._DesignParameter['PMOS3_rInSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] - drc._VIAxMinSpace) - (2 * drc._VIAxMinEnclosureByMetx)) / (drc._VIAxMinWidth + drc._VIAxMinSpace))))
		XYList = []
		xy_offset = (0, int(((drc._VIAxMinWidth + drc._VIAxMinSpace) / 4)))
		for i in range(len(self._DesignParameter['NMOS2_rInSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'])):
		    if ((i % 2) == 1):
		        XYList.append([((x + y) + z) for (x, y, z) in zip([(0 + self._DesignParameter['NMOS2_rInSRLatch_0']['_XYCoordinates'][0][0]), (0 + self._DesignParameter['NMOS2_rInSRLatch_0']['_XYCoordinates'][0][1])], self._DesignParameter['NMOS2_rInSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][i], xy_offset)])
		...
		pmos_via = max(1, int((((self._DesignParameter['NMOS3_rInSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] - drc._VIAxMinSpace) - (2 * drc._VIAxMinEnclosureByMetx)) / (drc._VIAxMinWidth + drc._VIAxMinSpace))))
		XYList = []
		xy_offset = (0, int(((drc._VIAxMinWidth + drc._VIAxMinSpace) / 4)))
		for i in range(len(self._DesignParameter['NMOS3_rInSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'])):
		    if ((i % 2) == 0):
		        XYList.append([((x + y) + z) for (x, y, z) in zip([(0 + self._DesignParameter['NMOS3_rInSRLatch_0']['_XYCoordinates'][0][0]), (0 + self._DesignParameter['NMOS3_rInSRLatch_0']['_XYCoordinates'][0][1])], self._DesignParameter['NMOS3_rInSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][i], xy_offset)])
		...
		for i in range(len(self._DesignParameter['PMOS4_rInSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'])):
		    if ((i % 2) == 1):
		        XYList.append([((x + y) + z) for (x, y, z) in zip([(0 + self._DesignParameter['PMOS4_rInSRLatch_0']['_XYCoordinates'][0][0]), (0 + self._DesignParameter['PMOS4_rInSRLatch_0']['_XYCoordinates'][0][1])], self._DesignParameter['PMOS4_rInSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][i], xy_offset)])
		...
		self._DesignParameter['PCCAM1_pd3']['_XYCoordinates'] = [[self._DesignParameter['PMOS3_rInSRLatch_0']['_XYCoordinates'][0][0], ((((self._DesignParameter['PMOS3_rInSRLatch_0']['_XYCoordinates'][0][1] + self._DesignParameter['PMOS3_rInSRLatch_0']['_DesignObj']._DesignParameter['_PODummyLayer']['_XYCoordinates'][0][1]) + (self._DesignParameter['PMOS3_rInSRLatch_0']['_DesignObj']._DesignParameter['_PODummyLayer']['_YWidth'] / 2)) + drc._PoDummyLengthToMove) + (self._DesignParameter['PCCAM1_pd3']['_DesignObj']._DesignParameter['_POLayer']['_YWidth'] / 2))]]
		...
		self._DesignParameter['M1V1M2_pd3_gate']['_XYCoordinates'] = [[(+ self._DesignParameter['PCCAM1_pd3']['_XYCoordinates'][0][0]), (+ self._DesignParameter['PCCAM1_pd3']['_XYCoordinates'][0][1])]]
		...
		nmos_via = max(2, max(1, int((((self._DesignParameter['NMOS3_rInSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_YWidth'] - drc._VIAxMinSpace) - (2 * drc._VIAxMinEnclosureByMetx)) / (drc._VIAxMinWidth + drc._VIAxMinSpace)))))
		XYList = []
		xy_offset = (0, (- int(((drc._VIAxMinWidth + drc._VIAxMinSpace) / 4))))
		for i in range(len(self._DesignParameter['NMOS3_rInSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'])):
		    if ((i % 2) == 1):
		...
		for i in range(len(self._DesignParameter['NMOS4_rInSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'])):
		    if ((i % 2) == 1):
		        XYList.append([((x + y) + z) for (x, y, z) in zip([(0 + self._DesignParameter['NMOS4_rInSRLatch_0']['_XYCoordinates'][0][0]), (0 + self._DesignParameter['NMOS4_rInSRLatch_0']['_XYCoordinates'][0][1])], self._DesignParameter['NMOS4_rInSRLatch_0']['_DesignObj']._DesignParameter['_Met1Layer']['_XYCoordinates'][i], xy_offset)])
		...
		self._DesignParameter['PCCAM1_nd3']['_DesignObj']._CalculateViaPoly2Met1DesignParameter(**dict(_ViaPoly2Met1NumberOfCOX=max(max(1, int(((((((self._DesignParameter['NMOS3_rInSRLatch_0']['_XYCoordinates'][0][0] + self._DesignParameter['NMOS3_rInSRLatch_0']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][(- 1)][0]) + (self._DesignParameter['NMOS3_rInSRLatch_0']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2)) - ((self._DesignParameter['NMOS3_rInSRLatch_0']['_XYCoordinates'][0][0] + self._DesignParameter['NMOS3_rInSRLatch_0']['_DesignObj']._DesignParameter['_POLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['NMOS3_rInSRLatch_0']['_DesignObj']._DesignParameter['_POLayer']['_XWidth'] / 2))) - drc._CoMinSpace) - (2 * drc._CoMinEnclosureByPO)) / (drc._CoMinWidth + drc._CoMinSpace)))), 1), _ViaPoly2Met1NumberOfCOY=1))
		...
		self._DesignParameter['nd3_gate_vias']['_XYCoordinates'] = [[(+ self._DesignParameter['PCCAM1_nd3']['_XYCoordinates'][0][0]), (+ self._DesignParameter['PCCAM1_nd3']['_XYCoordinates'][0][1])]]
		...
		self._DesignParameter['PCCAM1_pu2']['_XYCoordinates'] = [[self._DesignParameter['PMOS2InSRLatch_0']['_XYCoordinates'][0][0], ((((self._DesignParameter['PMOS2InSRLatch_0']['_XYCoordinates'][0][1] + self._DesignParameter['PMOS2InSRLatch_0']['_DesignObj']._DesignParameter['_PODummyLayer']['_XYCoordinates'][0][1]) - (self._DesignParameter['PMOS2InSRLatch_0']['_DesignObj']._DesignParameter['_PODummyLayer']['_YWidth'] / 2)) - drc._PoDummyLengthToMove) - (self._DesignParameter['PCCAM1_pu2']['_DesignObj']._DesignParameter['_POLayer']['_YWidth'] / 2))]]
		path_list = []
		...
		self._DesignParameter['M1V1M2_p3_gate_via']['_XYCoordinates'] = [[(+ self._DesignParameter['PCCAM1_pu3']['_XYCoordinates'][0][0]), (+ self._DesignParameter['PCCAM1_pu3']['_XYCoordinates'][0][1])]]
		...
		self._DesignParameter['M3V3M4_upupright']['_XYCoordinates'] = [[self._DesignParameter['nu3_gate_vias']['_XYCoordinates'][0][0], self._DesignParameter['pu1_gate_vias']['_XYCoordinates'][0][1]]]
		...
		self._DesignParameter['METAL3_path_24']['_XYCoordinates'] = [[[(+ self._DesignParameter['pu1_gate_vias']['_XYCoordinates'][0][0]), (+ self._DesignParameter['pu1_gate_vias']['_XYCoordinates'][0][1])], [(+ self._DesignParameter['M3V3M4_upupright']['_XYCoordinates'][0][0]), (+ self._DesignParameter['M3V3M4_upupright']['_XYCoordinates'][0][1])]]]
		...
		self._DesignParameter['via1to4_lu']['_XYCoordinates'] = [[self._DesignParameter['M1V1M2_nu_1']['_XYCoordinates'][0][0], ((self._DesignParameter['PCCAM1_nu2']['_XYCoordinates'][0][1] + self._DesignParameter['PCCAM1_pu2']['_XYCoordinates'][0][1]) / 2)]]
		...
		self._DesignParameter['via1to4_rd']['_XYCoordinates'] = [[self._DesignParameter['M3V3M4_upupright']['_XYCoordinates'][0][0], ((self._DesignParameter['PCCAM1_pd2']['_XYCoordinates'][0][1] + self._DesignParameter['PCCAM1_nd2']['_XYCoordinates'][0][1]) / 2)]]
		...
		self._DesignParameter['METAL4_path_9']['_XYCoordinates'] = [[[(+ self._DesignParameter['via1to4_rd']['_XYCoordinates'][0][0]), (+ self._DesignParameter['via1to4_rd']['_XYCoordinates'][0][1])], [(+ self._DesignParameter['M3V3M4_upupright']['_XYCoordinates'][0][0]), (+ self._DesignParameter['M3V3M4_upupright']['_XYCoordinates'][0][1])]]]
		...
		self._DesignParameter['PIMP_path_3'] = self._PathElementDeclaration(_Layer=DesignParameters._LayerMapping['PIMP'][0], _Datatype=DesignParameters._LayerMapping['PIMP'][1], _Width=self._DesignParameter['PMOS4InSRLatch_0']['_DesignObj']._DesignParameter['_SLVTLayer']['_YWidth'])
		...
		self._DesignParameter['PIMP_path_2'] = self._PathElementDeclaration(_Layer=DesignParameters._LayerMapping['PIMP'][0], _Datatype=DesignParameters._LayerMapping['PIMP'][1], _Width=self._DesignParameter['PMOS4_rInSRLatch_0']['_DesignObj']._DesignParameter['_SLVTLayer']['_YWidth'])
		...
		self._DesignParameter['slllt'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['SLVT'][0], _Datatype=DesignParameters._LayerMapping['SLVT'][1], _XWidth=(((self._DesignParameter['PMOS4_rInSRLatch_0']['_XYCoordinates'][0][0] + self._DesignParameter['PMOS4_rInSRLatch_0']['_DesignObj']._DesignParameter['_SLVTLayer']['_XYCoordinates'][0][0]) + (self._DesignParameter['PMOS4_rInSRLatch_0']['_DesignObj']._DesignParameter['_SLVTLayer']['_XWidth'] / 2)) - ((self._DesignParameter['PMOS1_rInSRLatch_0']['_XYCoordinates'][0][0] + self._DesignParameter['PMOS1_rInSRLatch_0']['_DesignObj']._DesignParameter['_SLVTLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['PMOS1_rInSRLatch_0']['_DesignObj']._DesignParameter['_SLVTLayer']['_XWidth'] / 2))), _YWidth=self._DesignParameter['PMOS4_rInSRLatch_0']['_DesignObj']._DesignParameter['_SLVTLayer']['_YWidth'])
		self._DesignParameter['slllt']['_XYCoordinates'] = [[((((self._DesignParameter['PMOS1_rInSRLatch_0']['_XYCoordinates'][0][0] + self._DesignParameter['PMOS1_rInSRLatch_0']['_DesignObj']._DesignParameter['_SLVTLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['PMOS1_rInSRLatch_0']['_DesignObj']._DesignParameter['_SLVTLayer']['_XWidth'] / 2)) + ((self._DesignParameter['PMOS4_rInSRLatch_0']['_XYCoordinates'][0][0] + self._DesignParameter['PMOS4_rInSRLatch_0']['_DesignObj']._DesignParameter['_SLVTLayer']['_XYCoordinates'][0][0]) + (self._DesignParameter['PMOS4_rInSRLatch_0']['_DesignObj']._DesignParameter['_SLVTLayer']['_XWidth'] / 2))) / 2), (self._DesignParameter['PMOS4_rInSRLatch_0']['_XYCoordinates'][0][1] + 300)]]
		self._DesignParameter['asdfer'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['PIMP'][0], _Datatype=DesignParameters._LayerMapping['PIMP'][1], _XWidth=576.0, _YWidth=2027.0)
		self._DesignParameter['asdfer']['_XYCoordinates'] = [[((((self._DesignParameter['PMOS1_rInSRLatch_0']['_XYCoordinates'][0][0] + self._DesignParameter['PMOS1_rInSRLatch_0']['_DesignObj']._DesignParameter['_SLVTLayer']['_XYCoordinates'][0][0]) - (self._DesignParameter['PMOS1_rInSRLatch_0']['_DesignObj']._DesignParameter['_SLVTLayer']['_XWidth'] / 2)) + ((self._DesignParameter['PMOS4_rInSRLatch_0']['_XYCoordinates'][0][0] + self._DesignParameter['PMOS4_rInSRLatch_0']['_DesignObj']._DesignParameter['_SLVTLayer']['_XYCoordinates'][0][0]) + (self._DesignParameter['PMOS4_rInSRLatch_0']['_DesignObj']._DesignParameter['_SLVTLayer']['_XWidth'] / 2))) / 2), (self._DesignParameter['PMOS4_rInSRLatch_0']['_XYCoordinates'][0][1] + 300)]]
