...
class NSubRing(StickDiagram._StickDiagram):
	...
	def _CalculateDesignParameter(self,height=5000,width=5000,contact=2):
		...
		self._DesignParameter['nw_bot'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['NWELL'][0], _Datatype=DesignParameters._LayerMapping['NWELL'][1], _XWidth=((((width + self._DesignParameter['right']['_DesignObj']._DesignParameter['_ODLayer']['_XWidth'])) + (drc._NwMinEnclosurePactive * 2)) + 0), _YWidth=(((self._DesignParameter['bot']['_DesignObj']._DesignParameter['_ODLayer']['_YWidth'] + (drc._NwMinEnclosurePactive * 2)) ) + 0))
		...
		self._DesignParameter['nw_right'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['NWELL'][0], _Datatype=DesignParameters._LayerMapping['NWELL'][1], _XWidth=(((self._DesignParameter['bot']['_DesignObj']._DesignParameter['_ODLayer']['_YWidth'] + (drc._NwMinEnclosurePactive * 2))) + 0), _YWidth=((((height + self._DesignParameter['right']['_DesignObj']._DesignParameter['_ODLayer']['_XWidth']) ) + (drc._NwMinEnclosurePactive * 2)) + 0))
		...
		self._DesignParameter['nw_top'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['NWELL'][0], _Datatype=DesignParameters._LayerMapping['NWELL'][1], _XWidth=((((width + self._DesignParameter['right']['_DesignObj']._DesignParameter['_ODLayer']['_XWidth']) + (drc._NwMinEnclosurePactive * 2))) + 0), _YWidth=(((self._DesignParameter['bot']['_DesignObj']._DesignParameter['_ODLayer']['_YWidth'] + (drc._NwMinEnclosurePactive * 2))) + 0))
		...
		self._DesignParameter['nw_left'] = self._BoundaryElementDeclaration(_Layer=DesignParameters._LayerMapping['NWELL'][0], _Datatype=DesignParameters._LayerMapping['NWELL'][1], _XWidth=(((self._DesignParameter['bot']['_DesignObj']._DesignParameter['_ODLayer']['_YWidth'] + (drc._NwMinEnclosurePactive * 2))) + 0), _YWidth=((((height + self._DesignParameter['right']['_DesignObj']._DesignParameter['_ODLayer']['_XWidth'])) + (drc._NwMinEnclosurePactive * 2)) + 0))
