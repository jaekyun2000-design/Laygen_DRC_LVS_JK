...
class _SARLogic(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    ## Slave Inv3 : Qb driver
        ...
        _Caculation_Parameters1 = copy.deepcopy(D04_01_SetRstDFF_Nor_Routing_KJH1._SetRstDFF_Nor_Routing._ParametersForDesignCalculation)
        ...
        ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## Dout Sampler Gen.
        ## Generate Sref: ex)self._DesignParameter['_NMOS_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_nmos_power_v2._NMOS_POWER( _DesignParameter=None, _Name='{}:NMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_Dout_Samp'] = self._SrefElementDeclaration(_DesignObj=D04_01_SetRstDFF_Nor_Routing_KJH1._SetRstDFF_Nor_Routing(_DesignParameter=None, _Name='{}:SRF_Dout_Samp'.format(_Name)))[0]
        ...
        for i in range(0,_NumofBit-1):
                            ## Calculate
                                ## Target_coord: _XY_type1
                                    ##X
            tmp1_1 = self.get_param_KJH4('SRF_Dout_Samp','SRF_SetRst_Placement','SRF_Slv_Inv3','SRF_NMOS','BND_PODummyLayer')
            tmp1_2 = self.get_param_KJH4('SRF_Dout_Samp','SRF_SetRst_Placement','SRF_Slv_Inv3','SRF_PMOS','BND_PODummyLayer')
            if tmp1_1[i][0][0][0][-1][0]['_XY_right'][0] > tmp1_2[i][0][0][0][-1][0]['_XY_right'][0]:
                target_coordx = tmp1_1[i][0][0][0][-1][0]['_XY_right'][0]
            else:
                target_coordx = tmp1_2[i][0][0][0][-1][0]['_XY_right'][0]
                                    ##Y
            tmp1_3 = self.get_param_KJH4('SRF_Dout_Samp','SRF_SetRst_Placement','SRF_Slv_Inv3','SRF_PMOS','BND_{}Layer'.format(_Slv_Inv3_PMOS_XVT))
            target_coordy = tmp1_3[i][0][0][0][0][0]['_XY_down'][1]

            target_coord = [target_coordx,target_coordy]
                                ## Approaching_coord: _XY_type2
                                    ##X
            tmp2_1 = self.get_param_KJH4('SRF_Dout_Samp','SRF_SetRst_Placement','SRF_Mst_Xgate1','SRF_NMOS','BND_PODummyLayer')
            tmp2_2 = self.get_param_KJH4('SRF_Dout_Samp','SRF_SetRst_Placement','SRF_Mst_Xgate1','SRF_PMOS','BND_PODummyLayer')
            if tmp2_1[0][0][0][0][0][0]['_XY_right'][0] > tmp2_2[0][0][0][0][0][0]['_XY_right'][0]:
                approaching_coordx = tmp2_1[0][0][0][0][0][0]['_XY_left'][0]
            else:
                approaching_coordx = tmp2_2[0][0][0][0][0][0]['_XY_left'][0]
                                    ##Y
            tmp2_3 = self.get_param_KJH4('SRF_Dout_Samp','SRF_SetRst_Placement','SRF_Mst_Xgate1','SRF_PMOS','BND_{}Layer'.format(_Mst_Xgate1_PMOS_XVT))
            approaching_coordy = tmp2_3[0][0][0][0][0][0]['_XY_down'][1]
            approaching_coord = [approaching_coordx,approaching_coordy]
                                ## Sref coord
            tmp3 = self.get_param_KJH4('SRF_Dout_Samp')
        ...
        _XYCoordinates=[],
                ...
                ## Define Boundary_element _YWidth
        tmp1 = self.get_param_KJH4('SRF_Dout_Samp','SRF_SetRst_Placement','SRF_Mst_Xgate1','SRF_Nbody','SRF_NbodyContactPhyLen','BND_Met1Layer')
        self._DesignParameter['BND_Nbody2_M1Exten']['_YWidth'] = tmp1[0][0][0][0][0][0][0]['_Ywidth']

                ## Define Boundary_element _XWidth
        tmp1 = self.get_param_KJH4('SRF_Dout_Samp','SRF_SetRst_Placement','SRF_Mst_Xgate1','SRF_Nbody','SRF_NbodyContactPhyLen','BND_Met1Layer')
        tmp2 = self.get_param_KJH4('SRF_Dout_Samp','SRF_SetRst_Placement','SRF_Slv_Inv3','SRF_Nbody','SRF_NbodyContactPhyLen','BND_Met1Layer')

        self._DesignParameter['BND_Nbody2_M1Exten']['_XWidth'] = abs( tmp2[-1][0][0][0][0][0][0]['_XY_right'][0]- tmp1[0][0][0][0][0][0][0]['_XY_left'][0])
        ...
        _XYCoordinates=[],
                ...
                ## Define Boundary_element _YWidth
        tmp1 = self.get_param_KJH4('SRF_Dout_Samp','SRF_SetRst_Placement','SRF_Mst_Xgate1','SRF_Nbody','SRF_NbodyContactPhyLen','BND_ODLayer')
        self._DesignParameter['BND_Nbody2_RXExten']['_YWidth'] = tmp1[0][0][0][0][0][0][0]['_Ywidth']

                ## Define Boundary_element _XWidth
        tmp1 = self.get_param_KJH4('SRF_Dout_Samp','SRF_SetRst_Placement','SRF_Mst_Xgate1','SRF_Nbody','SRF_NbodyContactPhyLen','BND_ODLayer')
        tmp2 = self.get_param_KJH4('SRF_Dout_Samp','SRF_SetRst_Placement','SRF_Slv_Inv3','SRF_Nbody','SRF_NbodyContactPhyLen','BND_ODLayer')

        self._DesignParameter['BND_Nbody2_RXExten']['_XWidth'] = abs( tmp2[-1][0][0][0][0][0][0]['_XY_right'][0]- tmp1[0][0][0][0][0][0][0]['_XY_left'][0])
        ...
        self._DesignParameter['BND_Nbody2_NwellExten']['_XWidth'] = abs( tmp2[-1][0][0][0][0]['_XY_right'][0]- tmp1[0][0][0][0][0]['_XY_left'][0])
        ...
        tmp1_2 = self.get_param_KJH4('SRF_DAC_Ctrl', 'SRF_SetRst_Placement', 'SRF_Mst_Xgate1', 'SRF_NMOS', 'BND_PODummyLayer')
        tmp1_3 = self.get_param_KJH4('SRF_DAC_Ctrl', 'SRF_SetRst_Placement', 'SRF_Mst_Xgate1', 'SRF_PMOS', 'BND_PODummyLayer')
        tmp1_4 = self.get_param_KJH4('SRF_DAC_Ctrl', 'SRF_SetRst_Placement', 'SRF_Slv_Inv3', 'SRF_NMOS','BND_PODummyLayer')
        tmp1_5 = self.get_param_KJH4('SRF_DAC_Ctrl', 'SRF_SetRst_Placement', 'SRF_Slv_Inv3', 'SRF_PMOS','BND_PODummyLayer')
        ...
        self._DesignParameter['BND_DACCtrl_QB_DoutSamp_D_Hrz_M2']['_XWidth'] = abs(  np.round(0.5*(tmp_left+tmp_right)) - tmp1_1[0][0][0][0][0]['_XY_right'][0])
        ...
        _Caculation_Parameters['_COY'] = 2
            ...
            ## Sref ViaX declaration
        self._DesignParameter['SRF_DACCtrl_QB_DoutSamp_D_ViaM2M4'] = self._SrefElementDeclaration(_DesignObj=A02_ViaStack_KJH3._ViaStack(_DesignParameter=None, _Name='{}:SRF_DACCtrl_QB_DoutSamp_D_ViaM2M4'.format(_Name)))[0]
        ...
        self._DesignParameter['SRF_DACCtrl_QB_DoutSamp_D_ViaM2M4']['_Angle'] = 0
            ...
            ## Generate Metal(x), Metal(x+1) and C0(Viax) layer:  Option: _CalculateDesignParameter, _CalculateDesignParameterXmin, _CalculateDesignParameterYmin, _CalculateDesignParameterXYsame
        self._DesignParameter['SRF_DACCtrl_QB_DoutSamp_D_ViaM2M4']['_DesignObj']._CalculateDesignParameterXmin(**_Caculation_Parameters)
        ...
        tmp2 = self.get_param_KJH4('SRF_DACCtrl_QB_DoutSamp_D_ViaM2M4','SRF_ViaM3M4','BND_Met4Layer')
        self._DesignParameter['SRF_DACCtrl_QB_DoutSamp_D_Vtc_M4']['_YWidth'] = (tmp2[0][0][0][0]['_XY_up'][1] - tmp1[0][0][0][0][0]['_XY_right'][1])
        ...
        _Caculation_Parameters['_COY'] = 2
            ...
            ## Sref ViaX declaration
        self._DesignParameter['SRF_DACCtrl_QB_DoutSamp_D_ViaM2M4_2'] = self._SrefElementDeclaration(_DesignObj=A02_ViaStack_KJH3._ViaStack(_DesignParameter=None, _Name='{}:SRF_DACCtrl_QB_DoutSamp_D_ViaM2M4_2'.format(_Name)))[0]
        ...
        self._DesignParameter['SRF_DACCtrl_QB_DoutSamp_D_ViaM2M4_2']['_Angle'] = 0
            ...
            ## Generate Metal(x), Metal(x+1) and C0(Viax) layer:  Option: _CalculateDesignParameter, _CalculateDesignParameterXmin, _CalculateDesignParameterYmin, _CalculateDesignParameterXYsame
        self._DesignParameter['SRF_DACCtrl_QB_DoutSamp_D_ViaM2M4_2']['_DesignObj']._CalculateDesignParameterXmin(**_Caculation_Parameters)
        ...
        self._DesignParameter['SRF_DACCtrl_QB_DoutSamp_D_Hrz_M2_2']['_XWidth'] = abs( tmp2[0][0][0][0][0]['_XY_right'][0] - tmp1[0][0][0][0]['_XY_left'][0])
        ...
        self._DesignParameter['BND_Dout_Samp_Set_Hrz_M1']['_YWidth'] = _Routing_width
                ...
                ## Define Boundary_element _XWidth
        tmp1 = self.get_param_KJH4('SRF_Dout_Samp','SRF_SetRst_Placement','SRF_Mst_Inv1','SRF_NMOS','BND_Gate_Hrz_Mx')
        tmp2 = self.get_param_KJH4('SRF_Dout_Samp','SRF_Net8_ViaM1M4','SRF_ViaM1M2','BND_Met2Layer')

        self._DesignParameter['BND_Dout_Samp_Set_Hrz_M1']['_XWidth'] = abs( tmp2[0][0][0][0][0]['_XY_cent'][0]- tmp1[0][0][0][0][0][0]['_XY_left'][0])
        ...
        tmp2 = self.get_param_KJH4('SRF_Dout_Samp','BND_Pbody_M1Exten')
        self._DesignParameter['BND_Dout_Samp_Set_Vtc_M1']['_YWidth'] = abs( tmp1[0][0]['_XY_down'][1] - tmp2[0][0][0]['_XY_up'][1])
        ...
        ## Define Boundary_element _XWidth
        tmp1 = self.get_param_KJH4('SRF_Dout_Samp', 'SRF_SetRst_Placement', 'SRF_Slv_Inv1', 'SRF_NMOS','BND_Gate_Hrz_Mx')
        tmp2 = self.get_param_KJH4('SRF_Dout_Samp', 'SRF_Net12_ViaM1M4', 'SRF_ViaM1M2', 'BND_Met2Layer')

        self._DesignParameter['BND_Dout_Samp_Rst_Hrz_M1']['_XWidth'] = abs( tmp2[0][0][0][0][0]['_XY_cent'][0] - tmp1[0][0][0][0][0][0]['_XY_left'][0])
        ...
        tmp2 = self.get_param_KJH4('SRF_Dout_Samp','BND_Pbody_M1Exten')
        self._DesignParameter['BND_Dout_Samp_Rst_Vtc_M1']['_YWidth'] = abs( tmp1[0][0]['_XY_down'][1] - tmp2[0][0][0]['_XY_up'][1])
        ...
        _Caculation_Parameters['_COY'] = 2
            ...
            ## Sref ViaX declaration
        self._DesignParameter['SRF_DACCtrl_D_ViaM2M4'] = self._SrefElementDeclaration(_DesignObj=A02_ViaStack_KJH3._ViaStack(_DesignParameter=None, _Name='{}:SRF_DACCtrl_D_ViaM2M4'.format(_Name)))[0]
        ...
        self._DesignParameter['SRF_DACCtrl_D_ViaM2M4']['_Angle'] = 0
            ...
            ## Generate Metal(x), Metal(x+1) and C0(Viax) layer:  Option: _CalculateDesignParameter, _CalculateDesignParameterXmin, _CalculateDesignParameterYmin, _CalculateDesignParameterXYsame
        self._DesignParameter['SRF_DACCtrl_D_ViaM2M4']['_DesignObj']._CalculateDesignParameterXmin(**_Caculation_Parameters)
        ...
        tmp2 = self.get_param_KJH4('BND_Nbody2_NwellExten')
        self._DesignParameter['BND_DACCtrl_D_Vtc_M4']['_YWidth'] = abs( tmp1[0][0][0][0]['_XY_up'][1] - tmp2[0][0]['_XY_down'][1] ) + Ylength1
        ...
        _Caculation_Parameters['_COY'] = 1
            ...
            ## Sref ViaX declaration
        self._DesignParameter['SRF_DACCtrl_D_ViaM3M4'] = self._SrefElementDeclaration(_DesignObj=A02_ViaStack_KJH3._ViaStack(_DesignParameter=None, _Name='{}:SRF_DACCtrl_D_ViaM3M4'.format(_Name)))[0]
        ...
        self._DesignParameter['SRF_DACCtrl_D_ViaM3M4']['_Angle'] = 0
            ...
            ## Generate Metal(x), Metal(x+1) and C0(Viax) layer:  Option: _CalculateDesignParameter, _CalculateDesignParameterXmin, _CalculateDesignParameterYmin, _CalculateDesignParameterXYsame
        self._DesignParameter['SRF_DACCtrl_D_ViaM3M4']['_DesignObj']._CalculateDesignParameterYmin(**_Caculation_Parameters)
        ...
        self._DesignParameter['BND_DACCtrl_D_Hrz_M3']['_XWidth'] = abs( tmp[-1][0]['_XY_right'][0] - tmp[0][0]['_XY_left'][0])
        ...
        tmp2 = self.get_param_KJH4('BND_DACCtrl_D_Hrz_M3')
        self._DesignParameter['BND_DoutSamp_Clk_Vtc_M4']['_YWidth'] = abs( tmp1[0][0][0][0][0]['_XY_up'][1] - tmp2[0][0]['_XY_down'][1] ) + Ylength1
        ...
        _Caculation_Parameters['_COY'] = 1
            ...
            ## Sref ViaX declaration
        self._DesignParameter['SRF_DoutSamp_Clk_ViaM3M4'] = self._SrefElementDeclaration(_DesignObj=A02_ViaStack_KJH3._ViaStack(_DesignParameter=None, _Name='{}:SRF_DoutSamp_Clk_ViaM3M4'.format(_Name)))[0]
        ...
        self._DesignParameter['SRF_DoutSamp_Clk_ViaM3M4']['_Angle'] = 0
            ...
            ## Generate Metal(x), Metal(x+1) and C0(Viax) layer:  Option: _CalculateDesignParameter, _CalculateDesignParameterXmin, _CalculateDesignParameterYmin, _CalculateDesignParameterXYsame
        self._DesignParameter['SRF_DoutSamp_Clk_ViaM3M4']['_DesignObj']._CalculateDesignParameterYmin(**_Caculation_Parameters)
        ...
        self._DesignParameter['BND_DoutSamp_Clk_Hrz_M3']['_XWidth'] = abs( tmp[-1][0]['_XY_right'][0] - tmp[0][0]['_XY_left'][0])
        ...
        tmp2 = self.get_param_KJH4('SRF_DAC_Ctrl','BND_Pbody_M1Exten')
        self._DesignParameter['BND_DACCtrlend_Clk_Vtc_M1']['_YWidth'] = abs( tmp1[0][0][0][0][0]['_XY_up'][1] - tmp2[0][0][0]['_XY_down'][1] )
...
if __name__ == '__main__':
    ...
    libname = 'Proj_Samsung_SARLOGIC'
    ## CellName: ex)C01_cap_array_v2_84l
    cellname = 'D05_00_SARLogic_v0_462'
    ...
    ## Master Xgate1
        ...
        ## Xgate NMOS
        _Mst_Xgate1_NMOS_NumberofGate           = 50,    #1
        _Mst_Xgate1_NMOS_ChannelWidth           = 400,  #100
        _Mst_Xgate1_NMOS_ChannelLength          = 30,
        _Mst_Xgate1_NMOS_XVT                    = 'SLVT',
        _Mst_Xgate1_NMOS_POGate_Comb_length     = 100,
        ...
        _Mst_Xgate1_PMOS_ChannelWidth           = 800,  #200
        _Mst_Xgate1_PMOS_ChannelLength          = 30,
        _Mst_Xgate1_PMOS_XVT                    = 'SLVT',
        _Mst_Xgate1_PMOS_POGate_Comb_length     = 100,
    ...
    ## Master Xgate2
        ...
        _Mst_Xgate2_NMOS_ChannelWidth           = 400,
        _Mst_Xgate2_NMOS_ChannelLength          = 30,
        _Mst_Xgate2_NMOS_XVT                    = 'SLVT',
        _Mst_Xgate2_NMOS_POGate_Comb_length     = 100,
        ...
        _Mst_Xgate2_PMOS_ChannelWidth           = 800,
        _Mst_Xgate2_PMOS_ChannelLength          = 30,
        _Mst_Xgate2_PMOS_XVT                    = 'SLVT',
        _Mst_Xgate2_PMOS_POGate_Comb_length     = 100,
    ...
    ## Master Nor1
        ...
        _Mst_Nor1_NMOS_XVT='SLVT',
            ...
            ## NMOSA
        _Mst_Nor1_NMOSA_NumberofGate           = 4,
        _Mst_Nor1_NMOSA_ChannelWidth           = 400,
        _Mst_Nor1_NMOSA_ChannelLength          = 30,
        _Mst_Nor1_NMOSA_POGate_Comb_length     = 100,

            ## NMOSB
        _Mst_Nor1_NMOSB_NumberofGate           = 4,
        ...
        _Mst_Nor1_PMOS_XVT='SLVT',
            ...
            ## PMOSA
        _Mst_Nor1_PMOSA_NumberofGate            = 8,
        _Mst_Nor1_PMOSA_ChannelWidth            = 800,
        _Mst_Nor1_PMOSA_ChannelLength           = 30,
        _Mst_Nor1_PMOSA_POGate_Comb_length      = 100,

            ## PMOSB
        _Mst_Nor1_PMOSB_NumberofGate            = 8,
    ...
    ## Master Nor2
        ...
        _Mst_Nor2_NMOSA_ChannelWidth           = 400,
        _Mst_Nor2_NMOSA_ChannelLength          = 30,
        _Mst_Nor2_NMOSA_POGate_Comb_length     = 100,

            ## NMOSB
        _Mst_Nor2_NMOSB_NumberofGate           = 1,
        _Mst_Nor2_NMOSB_ChannelWidth           = 400,
        _Mst_Nor2_NMOSB_ChannelLength          = 30,
        _Mst_Nor2_NMOSB_POGate_Comb_length     = 100,
        ...
        _Mst_Nor2_PMOSB_ChannelWidth            = 800,
        _Mst_Nor2_PMOSB_ChannelLength           = 30,
        _Mst_Nor2_PMOSB_POGate_Comb_length      = 100,
    ...
    ## Master Inv1 : Set pre-driver
        ...
        ## Inv1 NMOS
        _Mst_Inv1_NMOS_NumberofGate           = 1,
        _Mst_Inv1_NMOS_ChannelWidth           = 400,
        _Mst_Inv1_NMOS_ChannelLength          = 30,
        _Mst_Inv1_NMOS_XVT                    = 'SLVT',
        _Mst_Inv1_NMOS_POGate_Comb_length     = 100,
        ...
        _Mst_Inv1_PMOS_ChannelWidth           = 800,
        _Mst_Inv1_PMOS_ChannelLength          = 30,
        _Mst_Inv1_PMOS_XVT                    = 'SLVT',
        _Mst_Inv1_PMOS_POGate_Comb_length     = 100,
    ...
    ## Slave Xgate1
        ...
        ## Xgate NMOS
        _Slv_Xgate1_NMOS_NumberofGate           = 3,
    ...
    ## Slave Xgate2
        ...
        ## Xgate NMOS
        _Slv_Xgate2_NMOS_NumberofGate           = 2,
        _Slv_Xgate2_NMOS_ChannelWidth           = 400,
        _Slv_Xgate2_NMOS_ChannelLength          = 30,
        _Slv_Xgate2_NMOS_XVT                    = 'SLVT',
        _Slv_Xgate2_NMOS_POGate_Comb_length     = 100,
        ...
        _Slv_Xgate2_PMOS_ChannelWidth           = 800,
        _Slv_Xgate2_PMOS_ChannelLength          = 30,
        _Slv_Xgate2_PMOS_XVT                    = 'SLVT',
        _Slv_Xgate2_PMOS_POGate_Comb_length     = 100,
    ...
    ## Slave Nor1
        ...
        _Slv_Nor1_NMOS_XVT='SLVT',
            ...
            ## NMOSA
        _Slv_Nor1_NMOSA_NumberofGate           = 6,
        _Slv_Nor1_NMOSA_ChannelWidth           = 400,
        _Slv_Nor1_NMOSA_ChannelLength          = 30,
        _Slv_Nor1_NMOSA_POGate_Comb_length     = 100,

            ## NMOSB
        _Slv_Nor1_NMOSB_NumberofGate           = 6,
        ...
        _Slv_Nor1_PMOS_XVT='SLVT',
            ...
            ## PMOSA
        _Slv_Nor1_PMOSA_NumberofGate            = 12,
        _Slv_Nor1_PMOSA_ChannelWidth            = 800,
        _Slv_Nor1_PMOSA_ChannelLength           = 30,
        _Slv_Nor1_PMOSA_POGate_Comb_length      = 100,

            ## PMOSB
        _Slv_Nor1_PMOSB_NumberofGate            = 12,
    ...
    ## Slave Nor2
        ...
        _Slv_Nor2_NMOS_XVT='SLVT',
            ...
            ## NMOSA
        _Slv_Nor2_NMOSA_NumberofGate           = 2,
        _Slv_Nor2_NMOSA_ChannelWidth           = 400,
        _Slv_Nor2_NMOSA_ChannelLength          = 30,
        _Slv_Nor2_NMOSA_POGate_Comb_length     = 100,

            ## NMOSB
        _Slv_Nor2_NMOSB_NumberofGate           = 2,
        _Slv_Nor2_NMOSB_ChannelWidth           = 400,
        _Slv_Nor2_NMOSB_ChannelLength          = 30,
        _Slv_Nor2_NMOSB_POGate_Comb_length     = 100,
        ...
        _Slv_Nor2_PMOSB_ChannelWidth            = 800,
        _Slv_Nor2_PMOSB_ChannelLength           = 30,
        _Slv_Nor2_PMOSB_POGate_Comb_length      = 100,
    ...
    ## Slave Inv1 : ReSet pre-driver
        ...
        ## Inv1 NMOS
        _Slv_Inv1_NMOS_NumberofGate           = 1,
        _Slv_Inv1_NMOS_ChannelWidth           = 400,
        _Slv_Inv1_NMOS_ChannelLength          = 30,
        _Slv_Inv1_NMOS_XVT                    = 'SLVT',
        _Slv_Inv1_NMOS_POGate_Comb_length     = 100,
        ...
        _Slv_Inv1_PMOS_ChannelWidth           = 800,
        _Slv_Inv1_PMOS_ChannelLength          = 30,
        _Slv_Inv1_PMOS_XVT                    = 'SLVT',
        _Slv_Inv1_PMOS_POGate_Comb_length     = 100,
    ...
    ## Slave Inv3 : Qb driver
        ...
        ## Inv3 NMOS
        _Slv_Inv3_NMOS_NumberofGate           = 4, #1
        _Slv_Inv3_NMOS_ChannelWidth           = 400,
        _Slv_Inv3_NMOS_ChannelLength          = 30,
        _Slv_Inv3_NMOS_XVT                    = 'SLVT',
        _Slv_Inv3_NMOS_POGate_Comb_length     = 100,

        ## Inv3 PMOS
        _Slv_Inv3_PMOS_NumberofGate           = 4, #1
        _Slv_Inv3_PMOS_ChannelWidth           = 800,
        _Slv_Inv3_PMOS_ChannelLength          = 30,
        _Slv_Inv3_PMOS_XVT                    = 'SLVT',
        _Slv_Inv3_PMOS_POGate_Comb_length     = 100,
