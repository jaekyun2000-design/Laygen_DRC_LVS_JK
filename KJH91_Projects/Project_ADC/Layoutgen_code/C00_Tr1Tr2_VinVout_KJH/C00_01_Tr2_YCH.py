...
class _Tr2(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        self._DesignParameter['BND_Tr2_Drain_Vtc_M1']['_YWidth'] = _Inputnode_width + abs( outter_coord[0] - tmp1[0][0][0]['_XY_up'][1] )
        ...
        self._DesignParameter['SRF_Tr2_Drain_ViaM1Mx'] = self._SrefElementDeclaration(_DesignObj=A02_ViaStack_KJH2._ViaStack_KJH2(_DesignParameter=None, _Name='{}:SRF_Tr2_Drain_ViaM1Mx'.format(_Name)))[0]

            ## Define Sref Relection
        self._DesignParameter['SRF_Tr2_Drain_ViaM1Mx']['_Reflect'] = [0, 0, 0]

            ## Define Sref Angle
        self._DesignParameter['SRF_Tr2_Drain_ViaM1Mx']['_Angle'] = 0
        ...
        self._DesignParameter['SRF_Tr2_Drain_ViaM1Mx']['_DesignObj']._CalculateDesignParameterXmin(**_Caculation_Parameters)

            ## Calculate Sref XYcoord
        tmpXY = []
                ## initialized Sref coordinate
        self._DesignParameter['SRF_Tr2_Drain_ViaM1Mx']['_XYCoordinates'] = [[0, 0]]
        ...
        for i in range(0,len(tmp)):
            ...
            approaching_coord = tmp2[0][0][0][0]['_XY_up']
                        ## Sref coord
            tmp3 = self.get_param_KJH4('SRF_Tr2_Drain_ViaM1Mx')
            Scoord = tmp3[0][0]['_XY_origin']
                        ## Calculate
            New_Scoord = self.get_Scoord_KJH4(target_coord, approaching_coord, Scoord)
            tmpXY.append(New_Scoord)
                ## Define
        self._DesignParameter['SRF_Tr2_Drain_ViaM1Mx']['_XYCoordinates'] = tmpXY
...
if __name__ == '__main__':
    ...
    libname = 'Proj_ADC_C00_Tr1Tr2_Tr2_test_v1'
    ## CellName: ex)C01_cap_array_v2_84
    cellname = 'C00_01_Tr2_v0_95'
    ...
    InputParams = dict(
        ...
        # Tr2
        _Tr2_NMOSNumberofGate    =   2,  # number
