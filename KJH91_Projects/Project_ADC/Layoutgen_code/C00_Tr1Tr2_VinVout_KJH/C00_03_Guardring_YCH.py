...
from KJH91_Projects.Project_ADC.Layoutgen_code.A_Basic_Building_Block import A13_NbodyRingforDeepNwell_KJH
    ...
    ##
from KJH91_Projects.Project_ADC.Layoutgen_code.C00_Tr1Tr2_VinVout_KJH import C00_02_Tr1Tr2_YCH
...
class _Guardring(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        _Caculation_Parameters = copy.deepcopy(C00_02_Tr1Tr2_YCH._Tr1Tr2._ParametersForDesignCalculation)
        ...
        self._DesignParameter['SRF_Tr1Tr2'] = self._SrefElementDeclaration(_DesignObj=C00_02_Tr1Tr2_YCH._Tr1Tr2(_DesignParameter=None, _Name='{}:SRF_Tr1Tr2'.format(_Name)))[0]
        ...
        tmp2 = self.get_param_KJH4('SRF_Tr1Tr2', 'SRF_Tr2','SRF_Nmos', 'BND_Met1Layer_Source')
        self._DesignParameter['BND_Tr2_Source_Vtc_M1']['_YWidth'] = abs( tmp2[0][0][0][0][0]['_XY_down'][1] - tmp1[0][0][0][0][0]['_XY_up'][1])

        ## Define Boundary_element _XWidth
        tmp = self.get_param_KJH4('SRF_Tr1Tr2', 'SRF_Tr2', 'SRF_Nmos', 'BND_Met1Layer_Source')
        ...
        for i in range(0, len(tmp[0][0][0])):
            ...
            tmp1 = self.get_param_KJH4('SRF_Tr1Tr2', 'SRF_Tr2', 'SRF_Nmos','BND_Met1Layer_Source')
...
if __name__ == '__main__':
    ...
    libname = 'Proj_ADC_C00_Tr1Tr2_guardring_v2'
    ## CellName: ex)C01_cap_array_v2_84
    cellname = 'C00_03_Guardring_v0_99'
    ...
    InputParams = dict(
        ...
        # Tr1
        _Tr1_NMOSNumberofGate    =   1,     #number
        _Tr1_NMOSChannelWidth    =   100,   #number
        _Tr1_NMOSChannellength   =   30,     #number
        _Tr1_GateSpacing         =   222,   #None/number
        _Tr1_SDWidth             =   None,   #None/number
        _Tr1_XVT                 =   'HVT',  #'XVT' ex)SLVT LVT RVT HVT
        _Tr1_PCCrit              =   True,   #None/True
        ...
        # Tr2
        _Tr2_NMOSNumberofGate    =   1,  # number
        _Tr2_NMOSChannelWidth    =   100,  # number (ref 1000)
        _Tr2_NMOSChannellength   =   30,  # number
