...
## TIA
from KJH91_Projects.Project_ADC.Layoutgen_code.A_Basic_Building_Block import A55_TIA_v11_10bit_target
...
class _CDACWtSARLogic(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        _Caculation_Parameters = copy.deepcopy(
            A55_TIA_v11_10bit_target._TIA_YCH._ParametersForDesignCalculation)
        ...
        self._DesignParameter['SRF_TIA'] = self._SrefElementDeclaration(
            _DesignObj=A55_TIA_v11_10bit_target._TIA_YCH(
...
if __name__ == '__main__':
    ...
    libname = 'N00_00_Memory_Readout_10bit_target_ver2_v4'
    ## CellName: ex)C01_cap_array_v2_84
    cellname = 'N00_00_Memory_Readout_10bit_c'
    ...
    InputParams = dict(
        ...
        _Driver_DecimationIfDriverPlacedInCommonCentroid=True,
        _Driver_DecimationFactor=[4, 2, 0, 0, 0, 0],  # [MSB, MSB-1 ... MSB-x]: 단 X<MSB  # 위 옵션 True시 작동; MSB부터 벡터로 작성; [3,2,2] 시 MSB0 -> 3:1, MSB1 -> 2:1, MSB2 -> 2:1, ... 1은 불가
        ...
        # # Element CDAC
        _CDAC_LayoutOption=[3, 4, 5, 6],
        _CDAC_ShieldingLayer=1,  # Poly:0, M1:1, M2:2 ...
        _CDAC_MetalWidth=50,
        _CDAC_MetalLength=2800,  # (8bit size: 1414/ 10bit size: 2800/ 12bit size: 4200)
        _CDAC_MetalSpacing=50,
