...
## TIA
from KJH91_Projects.Project_ADC.Layoutgen_code.A_Basic_Building_Block import A55_TIA_v11_8bit_target
...
class _CDACWtSARLogic(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        _Caculation_Parameters = copy.deepcopy(
            A55_TIA_v11_8bit_target._TIA_YCH._ParametersForDesignCalculation)
        ...
        self._DesignParameter['SRF_TIA'] = self._SrefElementDeclaration(
            _DesignObj=A55_TIA_v11_8bit_target._TIA_YCH(
...
if __name__ == '__main__':
    ...
    libname = 'N00_00_Memory_Readout_8bit_target_ver2_v3'
    ## CellName: ex)C01_cap_array_v2_84
    cellname = 'N00_00_Memory_Readout_8bit_c'
    ...
    InputParams = dict(
        ...
        ## Inverter Chain
        ## Inv1 common
        _CDACPreDriver_NumberofGate=[8, 32],  # Vector
        _CDACPreDriver_ChannelLength=30,  # Scalar
        _CDACPreDriver_XVT='SLVT',  # 'SLVT'
        ...
        _Comp_SALatch_DATAinputNMOSFinger=8,  # random.randint(3, 15),  # 12
        _Comp_SALatch_NMOSFinger=3,  # random.randint(1, 15),  # 2
        _Comp_SALatch_CLKinputNMOSFinger=10,  # random.randint(1, 15),  # 8
        ...
        ## Inverter Chain
        ## Inv1 common
        _Buf_CLKSamp_NumberofGate=[1,4,16,32], # Vector
        _Buf_CLKSamp_ChannelLength=30,  # Scalar
        _Buf_CLKSamp_XVT='SLVT',  # 'SLVT'
        ...
        # Driver Sizing
        _Driver_SizeByBit=[1, 1, 1, 1, 1, 1, 1, 1],  # Drv.CCPlacement == False일때 사용됨.
        ...
        # Tr1 and Tr2
        # Tr1
        _Samp_Tr1Tr2_Tr1_NMOSNumberofGate=3,  # number
        _Samp_Tr1Tr2_Tr1_NMOSChannelWidth=1000,  # number
        _Samp_Tr1Tr2_Tr1_NMOSChannellength=30,  # number
        _Samp_Tr1Tr2_Tr1_GateSpacing=222,  # None/number
        _Samp_Tr1Tr2_Tr1_SDWidth=None,  # None/number
        _Samp_Tr1Tr2_Tr1_XVT='LVT',  # 'XVT' ex)SLVT LVT RVT HVT
        ...
        # Tr2
        _Samp_Tr1Tr2_Tr2_NMOSNumberofGate=1,  # number
        ...
        _Samp_HDVNCAP_NumFigPair=30,  # 9.55u M == 94개
