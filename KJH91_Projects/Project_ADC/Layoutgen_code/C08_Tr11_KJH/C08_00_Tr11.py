...
class _Tr11(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        _Caculation_Parameters['_PMOSNumberofGate']     = _Tr11_PMOSNumberofGate
        _Caculation_Parameters['_PMOSChannelWidth']     = _Tr11_PMOSChannelWidth
        _Caculation_Parameters['_PMOSChannellength']    = _Tr11_PMOSChannellength
        _Caculation_Parameters['_GateSpacing']          = _Tr11_GateSpacing
        _Caculation_Parameters['_SDWidth']              = _Tr11_SDWidth
        _Caculation_Parameters['_XVT']                  = _Tr11_XVT
        _Caculation_Parameters['_PCCrit']               = _Tr11_PCCrit
        _Caculation_Parameters['_Source_Via_TF']        = _Tr11_Source_Via_TF
        _Caculation_Parameters['_Drain_Via_TF']         = _Tr11_Drain_Via_TF
        _Caculation_Parameters['_PMOSDummy']            = _Tr11_PMOSDummy
        _Caculation_Parameters['_PMOSDummy_length']     = _Tr11_PMOSDummy_length
        _Caculation_Parameters['_PMOSDummy_placement']  = _Tr11_PMOSDummy_placement
        ...
        ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ##########  Tr11, pfet: Source M2 up connection
        ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## Tr11, pfet: Source M2 up connection: Vtc
        ...
        self._DesignParameter['BND_Pmos_Source_Vtc_M2']['_YWidth'] = _DRCobj._MetalxMinSpace41 + abs(tmp1[0][0][0][0][0]['_XY_up'][1] - outter_coord[1])

        ## Define Boundary_element _XWidth
        tmp = self.get_param_KJH4('SRF_Pmos','BND_Met1Layer_Source')
        self._DesignParameter['BND_Pmos_Source_Vtc_M2']['_XWidth'] = tmp[0][0][0]['_Xwidth']
        ...
        ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ##########  Tr11: Gate Poly up connection
        ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## Tr11: Gate Poly up connection: Vtc
        ## Pre-defined
        margin = 100
        ...
        ## Define Boundary_element _YWidth
        tmp1 = self.get_param_KJH4('BND_Pmos_Source_Hrz_M2')
        tmp2 = self.get_param_KJH4('SRF_Pmos','BND_POLayer')
        self._DesignParameter['BND_Pmos_Gate_Vtc_poly']['_YWidth'] = _DRCobj._MetalxMinSpace41 + abs(tmp1[0][0]['_XY_up'][1] - tmp2[0][0][0]['_XY_up'][1])
        ...
        ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## Tr11: Gate Poly up connection: Hrz
        ## Boundary_element Generation
        ## Generate Boundary_element: ex)LayerName: METAL1 / DIFF (_ODLayer) / POLY / PIMP (_PPLayer) / NWELL / SLVT LVT RVT HVT / OP(OPpress) / CONT (CA) / PCCRIT
        ...
        ## Define Boundary_element _XWidth
        tmp1 = self.get_param_KJH4('SRF_Pmos','BND_POLayer')
        self._DesignParameter['BND_Pmos_Gate_Hrz_poly']['_XWidth'] = max(abs(tmp1[0][0][0]['_XY_left'][0] - tmp1[0][-1][0]['_XY_right'][0]),260)
...
if __name__ == '__main__':
    ...
    libname = 'Proj_ADC_C08_Tr11'
    ## CellName: ex)C01_cap_array_v2_84
    cellname = 'C08_00_Tr11_v0_98'
