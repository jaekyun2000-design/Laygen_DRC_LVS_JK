...
if __name__ == '__main__':
    ...
    libname = 'Proj_ADC_E01_NAND_test'
    ## CellName: ex)C01_cap_array_v2_84
    cellname = 'E01_01_NAND'
    ...
    InputParams = dict(
        ...
        # NMOSA
        _NMOSA_NMOSNumberofGate=2,  # number
        ...
        # NMOSB
        _NMOSB_NMOSNumberofGate=2,  # number
        ...
        # PMOSA
        _PMOSA_PMOSNumberofGate=1,  # number
        ...
        # PMOSB
        _PMOSB_PMOSNumberofGate=1,  # number
