...
class _StrongArmWtSRLatch(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        ## Define Boundary_element _XWidth
        tmp3 = self.get_param_KJH4('BND_Pbody_Hrz_RX')
        self._DesignParameter['BND_NWellOnCLKInLogic']['_XWidth'] = tmp3[0][0]['_Xwidth'] + 3*_DRCobj._NwMinEnclosureNactive + 30 + 30 # 12/24 수정
        ## Define Boundary_element _XYCoordinates
...
if __name__ == '__main__':
    ...
    libname = 'Proj_ADC_E01_ComparatorWtLatch_v1'
    ...
    InputParams = dict(
        ## StrongARM Latch
        _SALatch_CLKinputPMOSFinger1=1,#random.randint(1, 15),  # 6
        _SALatch_CLKinputPMOSFinger2=1,#random.randint(1, 15),  # 3
        _SALatch_PMOSFinger=4,#random.randint(1, 15),  # 3
        _SALatch_PMOSChannelWidth=1000,#random.randrange(200, 1050, 2),  # 500
        _SALatch_DATAinputNMOSFinger=30,#random.randint(3, 15),  # 12
        _SALatch_NMOSFinger=30,#random.randint(1, 15),  # 2
        _SALatch_CLKinputNMOSFinger=1,#random.randint(1, 15),  # 8
        _SALatch_NMOSChannelWidth=1000,#random.randrange(200, 1050, 2),  # 500
        ...
        ## StrongARMLatch Output Buffer Sizing
        # Inverter1
        _SAOutBuf_Inv1_NMOS_ChannelWidth=1000,  # Number
        ...
        _SAOutBuf_Inv1_PMOS_ChannelWidth=2000,  # Number
        ...
        # Inverter2
        _SAOutBuf_Inv2_NMOS_ChannelWidth=1000,  # Number
        ...
        _SAOutBuf_Inv2_PMOS_ChannelWidth=2000,  # Number
        ...
        ## SR Latch Size
        _SRLatch_NAND_NMOS_ChannelWidth=1000,  # Number
        ...
        _SRLatch_NAND_PMOS_ChannelWidth=2000,  # Number
