...
if __name__ == '__main__':
    ...
    libname = 'Proj_ADC_E01_ComparatorWtLatch_v11'
    ...
    InputParams = dict(
        ## StrongARM Latch
        _SALatch_CLKinputPMOSFinger1=6,#random.randint(1, 15),  # 6
        _SALatch_CLKinputPMOSFinger2=6,#random.randint(1, 15),  # 3
        _SALatch_PMOSFinger=6,#random.randint(1, 15),  # 3
        _SALatch_PMOSChannelWidth=350,#random.randrange(200, 1050, 2),  # 500
        _SALatch_DATAinputNMOSFinger=3,#random.randint(3, 15),  # 12
        _SALatch_NMOSFinger=3,#random.randint(1, 15),  # 2
        _SALatch_CLKinputNMOSFinger=3,#random.randint(1, 15),  # 8
        _SALatch_NMOSChannelWidth=350,#random.randrange(200, 1050, 2),  # 500
        _SALatch_CLKinputNMOSChannelWidth=350,#random.randrange(200, 1050, 2),  # 800
        _SALatch_ChannelLength=30,#random.randrange(30, 60, 2),  # 30
        _SALatch_Dummy=True,
        _SALatch_XVT='HVT',
        _SALatch_GuardringWidth=150,
        _SALatch_Guardring=True,
        _SALatch_SlicerGuardringWidth=150,
        _SALatch_SlicerGuardring=None,
        _SALatch_NumSupplyCOY=None,
        _SALatch_NumSupplyCOX=None,
        _SALatch_SupplyMet1XWidth=None,
        ...
        _SAOutBuf_Inv2_PMOS_ChannelWidth=800,  # Number
        ...
        ## SR Latch Size
        _SRLatch_NAND_NMOS_ChannelWidth=400,  # Number
        ...
        _SRLatch_NAND_PMOS_ChannelWidth=800,  # Number
        ...
        _CLKSamp_Inv_NMOS_NumberofGate=1,
