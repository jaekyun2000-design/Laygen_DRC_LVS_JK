...
class _CDACWtDriverFold1(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    _ParametersForDesignCalculation = dict(
        ...
        _CDAC_MetalWidth=50,
        _CDAC_MetalLength=5770, # (8bit size: 1414/ 10bit size: 2800/ 12bit size: 4200)
...
if __name__ == '__main__':
    ...
    cellname = 'H02_00_CDACWDriver_Fold1_12bit_495'
    ...
    InputParams = dict(
        ...
        # # CommonCentroid With Driving node
        _CDAC_CapArrayWDrivingNodeDistance=2500,  # DRC Rule
        _CDAC_DriveNodeDistance=279,  #
        _CDAC_YWidth_Bottom_Hrz=50,

        # Driver Sizing
        _Driver_SizeByBit=[64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64, 64],  # Drv.CCPlacement == False일때 사용됨.
