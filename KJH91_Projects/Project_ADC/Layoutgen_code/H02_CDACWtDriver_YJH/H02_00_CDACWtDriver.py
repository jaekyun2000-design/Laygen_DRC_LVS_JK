...
if __name__ == '__main__':
    ...
    libname = 'Proj_ADC_H02_CDAC_Driver_v97'
    ## CellName: ex)C01_cap_array_v2_84
    cellname = 'H02_00_CDACWDriver_3Bit'
    ...
    InputParams = dict(
        ...
        # # Dummy Cap Option
        _CDAC_DummyCap_TopBottomShort=False,
        ...
        # Driver(Inverter) Sizing Option
        _Driver_SizeByBit=[4,2,1],    # [int, int, ...] (Drv. Arranged Version을 위한 옵션)
