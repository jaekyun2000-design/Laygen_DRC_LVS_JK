...
from KJH91_Projects.Project_ADC.Layoutgen_code.H01_CDAC_Driver_v2_YJH import H01_00_DriverCell
...
if __name__ == '__main__':
    ...
    libname = 'Proj_ADC_H01_CDACDriver_Arr'
    ...
    InputParams = dict(
        # NumOfDriverUnitsInDriverArray = 2^(_NumOfBits) - 1
        _NumOfBits=3,
        _Driver_SizeByBit=[4,2,1],

            # Driver(Inverter) NMOS
        _Driver_NMOS_NumberofGate = 1,  # number
        _Driver_NMOS_ChannelWidth = 400,  # number
        ...
        _Driver_NMOS_Source_Via_TF = True,  # True/False
            ...
            # Drain_node_ViaM1M2
        _Driver_NMOS_Drain_Via_TF = True,  # True/False
        ...
        _Driver_PMOS_ChannelWidth=800,  # number
        _Driver_PMOS_Channellength=30,  # number
        _Driver_PMOS_GateSpacing=None,  # None/number
        _Driver_PMOS_SDWidth=None,  # None/number
        _Driver_PMOS_XVT='SLVT',  # 'XVT' ex)SLVT LVT RVT HVT
        ...
        # Source_node_ViaM1M2
        _Driver_PMOS_Source_Via_TF=True,  # True/False

        # Drain_node_ViaM1M2
        _Driver_PMOS_Drain_Via_TF=True,  # True/False
