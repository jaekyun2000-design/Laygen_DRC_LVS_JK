...
from KJH91_Projects.Project_ADC.Layoutgen_code.A_Basic_Building_Block import A13_NbodyRingforDeepNwell_KJH
    ...
    ##
from KJH91_Projects.Project_ADC.Layoutgen_code.C03_Tr4 import C03_00_Tr4_YCH
...
class _Guardring(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        _Caculation_Parameters = copy.deepcopy(C03_00_Tr4_YCH._Tr4._ParametersForDesignCalculation)
        ...
        self._DesignParameter['SRF_Tr4'] = self._SrefElementDeclaration(_DesignObj=C03_00_Tr4_YCH._Tr4(_DesignParameter=None, _Name='{}:SRF_Tr4'.format(_Name)))[0]
        ...
        _XYCoordinates=[],
                ...
                ## Define Boundary_element _YWidth
        tmp1 = self.get_param_KJH4('SRF_Tr4','SRF_NMOS','BND_Met1Layer_Source')
        ...
        self._DesignParameter['BND_Tr4_Source_Vtc_M1']['_YWidth'] = abs(tmp1[0][0][0][0]['_XY_down'][1] - tmp2[0][0][0][0][0]['_XY_up'][1])
                ...
                ## Define Boundary_element _XWidth
        tmp = self.get_param_KJH4('SRF_Tr4','SRF_NMOS','BND_Met1Layer_Source')
