...
from KJH91_Projects.Project_ADC.Layoutgen_code.C03_Tr4 import C03_01_Guardring_YCH
...
class _Pin(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        _Caculation_Parameters = copy.deepcopy(C03_01_Guardring_YCH._Guardring._ParametersForDesignCalculation)
        ...
        self._DesignParameter['SRF_Guardring'] = self._SrefElementDeclaration(_DesignObj=C03_01_Guardring_YCH._Guardring(_DesignParameter=None, _Name='{}:SRF_Guardring'.format(_Name)))[0]
        ...
        tmp = self.get_param_KJH4('SRF_Guardring','SRF_Tr4','BND_NMOS_Gate_Hrz_poly')
        ...
        tmp1 = self.get_param_KJH4('SRF_Guardring','SRF_Tr4','BND_NMOS_Gate_Hrz_poly')
        ...
        tmp2 = self.get_param_KJH4('SRF_Guardring','SRF_Tr4','BND_NMOS_Gate_Hrz_poly')
        ...
        _XYCoordinates=[],
                ...
                ## Define Boundary_element _YWidth
        tmp = self.get_param_KJH4('SRF_Guardring','SRF_Tr4','BND_NMOS_Source_Hrz_M2')
        ...
        self._DesignParameter['BND_Source_Hrz_M3']['_XYCoordinates'] = [[0, 0]]
                        ## Calculate
                            ## Target_coord: _XY_type1
        tmp1 = self.get_param_KJH4('SRF_Guardring','SRF_Tr4','BND_NMOS_Source_Hrz_M2')
        target_coord = tmp1[0][0][0][0]['_XY_down_left']
                            ## Approaching_coord: _XY_type2
        ...
        tmp2 = self.get_param_KJH4('SRF_Guardring','SRF_Tr4','BND_NMOS_Source_Hrz_M2')
        Ovlpcoord = self.get_ovlp_KJH2(tmp1[0][0], tmp2[0][0][0][0])
        ...
        _XYCoordinates=[],
                ...
                ## Define Boundary_element _YWidth
        tmp = self.get_param_KJH4('SRF_Guardring','SRF_Tr4','BND_NMOS_Drain_Hrz_M2')
        ...
        self._DesignParameter['BND_Drain_Hrz_M4']['_XYCoordinates'] = [[0, 0]]
                        ## Calculate
                            ## Target_coord: _XY_type1
        tmp1 = self.get_param_KJH4('SRF_Guardring','SRF_Tr4','BND_NMOS_Drain_Hrz_M2')
        target_coord = tmp1[0][0][0][0]['_XY_down_left']
                            ## Approaching_coord: _XY_type2
        ...
        tmp2 = self.get_param_KJH4('SRF_Guardring','SRF_Tr4','BND_NMOS_Drain_Hrz_M2')
        Ovlpcoord = self.get_ovlp_KJH2(tmp1[0][0], tmp2[0][0][0][0])
...
if __name__ == '__main__':
    ...
    InputParams = dict(
        ...
        _Tr4_NMOSChannelWidth    =   1000,   #number (ref:500)
