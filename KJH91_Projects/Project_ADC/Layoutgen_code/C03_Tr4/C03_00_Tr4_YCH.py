...
class _Tr4(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        self._DesignParameter['BND_NMOS_Source_Vtc_M2']['_YWidth'] = _DRCobj._MetalxMinSpace41 + abs(tmp1[0][0][0][0][0]['_XY_up'][1] - outter_coord[0]) # 바꾼 부분
        ...
        self._DesignParameter['BND_NMOS_Drain_Vtc_M2']['_YWidth'] = _DRCobj._MetalxMinSpace41 + abs(tmp1[0][0][0][0][0]['_XY_down'][1] - outter_coord[0]) # 바꾼 부분
