...
## Define Class
class _Tr3(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    _ParametersForDesignCalculation = dict(
        ...
        _Tr3_GateSpacing         =   80,   #None/number
    ...
    def _CalculateDesignParameter(self,
        ...
        ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ##########  Tr3, nfet: Source M2 down connection
            ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## Tr3, nfet: Source M2 down connection: Vtc
        ...
        for i in range(0, len(tmp[0])):
            ...
            ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## Tr3, nfettw: Source M2 up connection: Hrz
        ## Boundary_element Generation
        ## Generate Boundary_element: ex)LayerName: METAL1 / DIFF (_ODLayer) / POLY / PIMP (_PPLayer) / NWELL / SLVT LVT RVT HVT / OP(OPpress) / CONT (CA) / PCCRIT
        ...
        ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ##########  Tr3, nfettw: Drain M2 up connection
            ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## Tr3, nfettw: Drain M2 up connection: Vtc
        ## Boundary_element Generation
        ## Generate Boundary_element: ex)LayerName: METAL1 / DIFF (_ODLayer) / POLY / PIMP (_PPLayer) / NWELL / SLVT LVT RVT HVT / OP(OPpress) / CONT (CA) / PCCRIT
        ...
        for i in range(0, len(tmp[0])):
            ...
            ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## Tr3, nfettw: Drain M2 up connection: Hrz
        ## Boundary_element Generation
        ## Generate Boundary_element: ex)LayerName: METAL1 / DIFF (_ODLayer) / POLY / PIMP (_PPLayer) / NWELL / SLVT LVT RVT HVT / OP(OPpress) / CONT (CA) / PCCRIT
        ...
        ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ##########  Tr3, nfettw: Gate Poly up connection
            ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## Tr3, nfettw: Gate Poly up connection: Vtc
        ## Pre-defined
        margin = 100
        ...
        self._DesignParameter['BND_NMOS_Gate_Vtc_poly']['_XYCoordinates'] = tmpXY
            ...
            ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## Tr3, nfettw: Gate Poly up connection: Hrz
        ## Boundary_element Generation
        ## Generate Boundary_element: ex)LayerName: METAL1 / DIFF (_ODLayer) / POLY / PIMP (_PPLayer) / NWELL / SLVT LVT RVT HVT / OP(OPpress) / CONT (CA) / PCCRIT
...
if __name__ == '__main__':
    ...
    ## Gen Object:
    LayoutObj = _Tr3(_DesignParameter=None, _Name=cellname)
