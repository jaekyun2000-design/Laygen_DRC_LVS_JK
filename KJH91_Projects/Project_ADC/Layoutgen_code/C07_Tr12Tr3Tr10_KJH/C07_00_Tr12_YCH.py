...
## Define Class
class _Tr12(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        _Caculation_Parameters['_NMOSNumberofGate']     =   _Tr12_NMOSNumberofGate
        _Caculation_Parameters['_NMOSChannelWidth']     =   _Tr12_NMOSChannelWidth
        _Caculation_Parameters['_NMOSChannellength']    =   _Tr12_NMOSChannellength
        _Caculation_Parameters['_GateSpacing']          =   _Tr12_GateSpacing
        _Caculation_Parameters['_SDWidth']              =   _Tr12_SDWidth
        _Caculation_Parameters['_XVT']                  =   _Tr12_XVT
        _Caculation_Parameters['_PCCrit']               =   _Tr12_PCCrit
        _Caculation_Parameters['_Source_Via_TF']        =   _Tr12_Source_Via_TF
        _Caculation_Parameters['_Drain_Via_TF']         =   _Tr12_Drain_Via_TF
        _Caculation_Parameters['_NMOSDummy']            =   _Tr12_NMOSDummy
        _Caculation_Parameters['_NMOSDummy_length']     =   _Tr12_NMOSDummy_length
        _Caculation_Parameters['_NMOSDummy_placement']  =   _Tr12_NMOSDummy_placement
        ...
        ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ##########  Tr12, nfet: Source M2 down connection
            ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## Tr12, nfet: Source M2 down connection: Vtc
        ...
        for i in range(0, len(tmp[0])):
            ...
            ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## Tr12, nfettw: Source M2 up connection: Hrz
        ## Boundary_element Generation
        ## Generate Boundary_element: ex)LayerName: METAL1 / DIFF (_ODLayer) / POLY / PIMP (_PPLayer) / NWELL / SLVT LVT RVT HVT / OP(OPpress) / CONT (CA) / PCCRIT
        ...
        ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ##########  Tr12, nfettw: Drain M2 up connection
            ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## Tr12, nfettw: Drain M2 up connection: Vtc
        ## Boundary_element Generation
        ## Generate Boundary_element: ex)LayerName: METAL1 / DIFF (_ODLayer) / POLY / PIMP (_PPLayer) / NWELL / SLVT LVT RVT HVT / OP(OPpress) / CONT (CA) / PCCRIT
        ...
        for i in range(0, len(tmp[0])):
            ...
            ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## Tr12, nfettw: Drain M2 up connection: Hrz
        ## Boundary_element Generation
        ## Generate Boundary_element: ex)LayerName: METAL1 / DIFF (_ODLayer) / POLY / PIMP (_PPLayer) / NWELL / SLVT LVT RVT HVT / OP(OPpress) / CONT (CA) / PCCRIT
        ...
        ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ##########  Tr12, nfettw: Gate Poly up connection
            ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## Tr12, nfettw: Gate Poly up connection: Vtc
        ## Pre-defined
        margin = 100
...
if __name__ == '__main__':
    ...
    ## Gen Object:
    LayoutObj = _Tr12(_DesignParameter=None, _Name=cellname)
