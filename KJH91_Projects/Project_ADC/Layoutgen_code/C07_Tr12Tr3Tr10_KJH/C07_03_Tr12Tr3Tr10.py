...
## KJH91 Basic Building Blocks
from KJH91_Projects.Project_ADC.Layoutgen_code.C07_Tr12Tr3Tr10_KJH import C07_00_Tr12
from KJH91_Projects.Project_ADC.Layoutgen_code.C07_Tr12Tr3Tr10_KJH import C07_01_Tr3
from KJH91_Projects.Project_ADC.Layoutgen_code.C07_Tr12Tr3Tr10_KJH import C07_02_Tr10
...
class _Tr12Tr3Tr10(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        _Caculation_Parameters = copy.deepcopy(C07_00_Tr12._Tr12._ParametersForDesignCalculation)
        ...
        self._DesignParameter['SRF_Tr12'] = self._SrefElementDeclaration(_DesignObj=C07_00_Tr12._Tr12(_DesignParameter=None, _Name='{}:SRF_Tr12'.format(_Name)))[0]
        ...
        ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## Tr3, nfet
                ## Copy Calculation_Parameters from low-level-block ex)copy.deepcopy(B16_nmos_power_v2._NMOS_POWER._ParametersForDesignCalculation)
        _Caculation_Parameters = copy.deepcopy(C07_01_Tr3._Tr3._ParametersForDesignCalculation)
                ## Define Calculation_Parameters ex) _Caculation_Parameters['_NMOSPOWER_PbodyContact_1_Length']  = _NMOSPOWER_PbodyContact_1_Length
        ...
        _Caculation_Parameters['_Tr3_NMOSDummy_placement']  =   _Tr3_NMOSDummy_placement
                ...
                ## Generate Sref: ex)self._DesignParameter['_NMOS_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_nmos_power_v2._NMOS_POWER( _DesignParameter=None, _Name='{}:NMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_Tr3'] = self._SrefElementDeclaration(_DesignObj=C07_01_Tr3._Tr3(_DesignParameter=None, _Name='{}:SRF_Tr3'.format(_Name)))[0]
        ...
        tmp1 = self.get_param_KJH4('SRF_Tr12','SRF_NMOS','BND_PODummyLayer')
        target_coord = tmp1[0][0][-1][0]['_XY_up_right']
                            ## Approaching_coord: _XY_type2
        tmp2 = self.get_param_KJH4('SRF_Tr3','SRF_NMOS','BND_PODummyLayer')
        ...
        ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## Tr10, nfet
                ## Copy Calculation_Parameters from low-level-block ex)copy.deepcopy(B16_nmos_power_v2._NMOS_POWER._ParametersForDesignCalculation)
        _Caculation_Parameters = copy.deepcopy(C07_02_Tr10._Tr10._ParametersForDesignCalculation)
                ## Define Calculation_Parameters ex) _Caculation_Parameters['_NMOSPOWER_PbodyContact_1_Length']  = _NMOSPOWER_PbodyContact_1_Length
        ...
        _Caculation_Parameters['_Tr10_NMOSDummy_placement']  =   _Tr10_NMOSDummy_placement
                ...
                ## Generate Sref: ex)self._DesignParameter['_NMOS_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_nmos_power_v2._NMOS_POWER( _DesignParameter=None, _Name='{}:NMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_Tr10'] = self._SrefElementDeclaration(_DesignObj=C07_02_Tr10._Tr10(_DesignParameter=None, _Name='{}:SRF_Tr10'.format(_Name)))[0]
        ...
        self._DesignParameter['SRF_Tr10']['_XYCoordinates'] = [[0, 0]]
                        ## Calculate
                            ## Target_coord: _XY_type1
        tmp1 = self.get_param_KJH4('SRF_Tr3','SRF_NMOS','BND_PODummyLayer')
        target_coord = tmp1[0][0][-1][0]['_XY_up_right']
                            ## Approaching_coord: _XY_type2
        tmp2 = self.get_param_KJH4('SRF_Tr10','SRF_NMOS','BND_PODummyLayer')
        approaching_coord = tmp2[0][0][0][0]['_XY_up_left']
                            ## Sref coord
        ...
        self._DesignParameter['BND_Tr12Tr3Tr10_Gate_Hrz_M4'] = self._BoundaryElementDeclaration(
        ...
        tmp = self.get_param_KJH4('SRF_Tr12','BND_NMOS_Gate_Hrz_poly')
        self._DesignParameter['BND_Tr12Tr3Tr10_Gate_Hrz_M4']['_YWidth'] = tmp[0][0][0]['_Ywidth']

                ## Define Boundary_element _XWidth
        tmp1 = self.get_param_KJH4('SRF_Tr12','BND_NMOS_Gate_Hrz_poly')
        tmp2 = self.get_param_KJH4('SRF_Tr10','BND_NMOS_Gate_Hrz_poly')
        self._DesignParameter['BND_Tr12Tr3Tr10_Gate_Hrz_M4']['_XWidth'] = abs( tmp1[0][0][0]['_XY_left'][0] - tmp2[0][0][0]['_XY_right'][0] )

                ## Define Boundary_element _XYCoordinates
        self._DesignParameter['BND_Tr12Tr3Tr10_Gate_Hrz_M4']['_XYCoordinates'] = [[0, 0]]
        ...
        target_coord = tmp1[0][0][0]['_XY_down_left']
                            ## Approaching_coord: _XY_type2
        tmp2 = self.get_param_KJH4('BND_Tr12Tr3Tr10_Gate_Hrz_M4')
        approaching_coord = tmp2[0][0]['_XY_down_left']
                            ## Sref coord
        tmp3 = self.get_param_KJH4('BND_Tr12Tr3Tr10_Gate_Hrz_M4')
        Scoord = tmp3[0][0]['_XY_origin']
                            ## Cal
        New_Scoord = self.get_Scoord_KJH4(target_coord, approaching_coord, Scoord)
        tmpXY.append(New_Scoord)
                            ## Define coordinates
        self._DesignParameter['BND_Tr12Tr3Tr10_Gate_Hrz_M4']['_XYCoordinates'] = tmpXY

        ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## Gate combine: Tr12 ViaM0M4
        ...
        self._DesignParameter['SRF_Tr12_Gate_ViaM0M4'] = self._SrefElementDeclaration(
            _DesignObj=A02_ViaStack_KJH2._ViaStack_KJH2(_DesignParameter=None,
                                                        _Name='{}:SRF_Tr12_Gate_ViaM0M4'.format(_Name)))[0]

        ## Define Sref Relection
        self._DesignParameter['SRF_Tr12_Gate_ViaM0M4']['_Reflect'] = [0, 0, 0]

        ## Define Sref Angle
        self._DesignParameter['SRF_Tr12_Gate_ViaM0M4']['_Angle'] = 0

        ## Calcuate Overlapped XYcoord
        tmp1 = self.get_param_KJH4('BND_Tr12Tr3Tr10_Gate_Hrz_M4')
        tmp2 = self.get_param_KJH4('SRF_Tr12','BND_NMOS_Gate_Hrz_poly')
        ...
        self._DesignParameter['SRF_Tr12_Gate_ViaM0M4']['_DesignObj']._CalculateDesignParameterYmin(**_Caculation_Parameters)

        ## Calculate Sref XYcoord
        tmpXY = []
        ## initialized Sref coordinate
        self._DesignParameter['SRF_Tr12_Gate_ViaM0M4']['_XYCoordinates'] = [[0, 0]]
        ## Calculate
        ## Target_coord
        tmp1 = self.get_param_KJH4('SRF_Tr12','BND_NMOS_Gate_Hrz_poly')
        target_coord = tmp1[0][0][0]['_XY_cent']
        ## Approaching_coord
        tmp2 = self.get_param_KJH4('SRF_Tr12_Gate_ViaM0M4', 'SRF_ViaM0M1', 'BND_POLayer')
        approaching_coord = tmp2[0][0][0][0]['_XY_cent']
        ## Sref coord
        tmp3 = self.get_param_KJH4('SRF_Tr12_Gate_ViaM0M4')
        Scoord = tmp3[0][0]['_XY_origin']
        ## Calculate
        New_Scoord = self.get_Scoord_KJH4(target_coord, approaching_coord, Scoord)
        tmpXY.append(New_Scoord)
        ## Define
        self._DesignParameter['SRF_Tr12_Gate_ViaM0M4']['_XYCoordinates'] = tmpXY

        ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## Gate combine: Tr3 ViaM0M4
        ## Sref generation: ViaX
        ## Define ViaX Parameter
        _Caculation_Parameters = copy.deepcopy(A02_ViaStack_KJH2._ViaStack_KJH2._ParametersForDesignCalculation)
        _Caculation_Parameters['_Layer1'] = 0
        ...
        ## Sref ViaX declaration
        self._DesignParameter['SRF_Tr3_Gate_ViaM0M4'] = self._SrefElementDeclaration(
            _DesignObj=A02_ViaStack_KJH2._ViaStack_KJH2(_DesignParameter=None,
                                                        _Name='{}:SRF_Tr3_Gate_ViaM0M4'.format(_Name)))[0]

        ## Define Sref Relection
        self._DesignParameter['SRF_Tr3_Gate_ViaM0M4']['_Reflect'] = [0, 0, 0]

        ## Define Sref Angle
        self._DesignParameter['SRF_Tr3_Gate_ViaM0M4']['_Angle'] = 0

        ## Calcuate Overlapped XYcoord
        tmp1 = self.get_param_KJH4('BND_Tr12Tr3Tr10_Gate_Hrz_M4')
        tmp2 = self.get_param_KJH4('SRF_Tr3','BND_NMOS_Gate_Hrz_poly')
        Ovlpcoord = self.get_ovlp_KJH2(tmp1[0][0], tmp2[0][0][0])
        ...
        ## Generate Metal(x), Metal(x+1) and C0(Viax) layer:  Option: _CalculateDesignParameter, _CalculateDesignParameterXmin, _CalculateDesignParameterYmin, _CalculateDesignParameterXYsame
        self._DesignParameter['SRF_Tr3_Gate_ViaM0M4']['_DesignObj']._CalculateDesignParameterYmin(**_Caculation_Parameters)

        ## Calculate Sref XYcoord
        tmpXY = []
        ## initialized Sref coordinate
        self._DesignParameter['SRF_Tr3_Gate_ViaM0M4']['_XYCoordinates'] = [[0, 0]]
        ## Calculate
        ## Target_coord
        tmp1 = self.get_param_KJH4('SRF_Tr3','BND_NMOS_Gate_Hrz_poly')
        target_coord = tmp1[0][0][0]['_XY_cent']
        ## Approaching_coord
        tmp2 = self.get_param_KJH4('SRF_Tr3_Gate_ViaM0M4', 'SRF_ViaM0M1', 'BND_POLayer')
        approaching_coord = tmp2[0][0][0][0]['_XY_cent']
        ## Sref coord
        tmp3 = self.get_param_KJH4('SRF_Tr3_Gate_ViaM0M4')
        Scoord = tmp3[0][0]['_XY_origin']
        ## Calculate
        New_Scoord = self.get_Scoord_KJH4(target_coord, approaching_coord, Scoord)
        tmpXY.append(New_Scoord)
        ## Define
        self._DesignParameter['SRF_Tr3_Gate_ViaM0M4']['_XYCoordinates'] = tmpXY

        ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## Gate combine: Tr10 ViaM0M4
        ## Sref generation: ViaX
        ## Define ViaX Parameter
        _Caculation_Parameters = copy.deepcopy(A02_ViaStack_KJH2._ViaStack_KJH2._ParametersForDesignCalculation)
        _Caculation_Parameters['_Layer1'] = 0
        ...
        ## Sref ViaX declaration
        self._DesignParameter['SRF_Tr10_Gate_ViaM0M4'] = self._SrefElementDeclaration(_DesignObj=A02_ViaStack_KJH2._ViaStack_KJH2(_DesignParameter=None,_Name='{}:SRF_Tr10_Gate_ViaM0M4'.format(_Name)))[0]

        ## Define Sref Relection
        self._DesignParameter['SRF_Tr10_Gate_ViaM0M4']['_Reflect'] = [0, 0, 0]

        ## Define Sref Angle
        self._DesignParameter['SRF_Tr10_Gate_ViaM0M4']['_Angle'] = 0
        ...
        ## Generate Metal(x), Metal(x+1) and C0(Viax) layer:  Option: _CalculateDesignParameter, _CalculateDesignParameterXmin, _CalculateDesignParameterYmin, _CalculateDesignParameterXYsame
        self._DesignParameter['SRF_Tr10_Gate_ViaM0M4']['_DesignObj']._CalculateDesignParameterYmin(**_Caculation_Parameters)

        ## Calculate Sref XYcoord
        tmpXY = []
        ## initialized Sref coordinate
        self._DesignParameter['SRF_Tr10_Gate_ViaM0M4']['_XYCoordinates'] = [[0, 0]]
        ## Calculate
        ## Target_coord
        tmp1 = self.get_param_KJH4('SRF_Tr10','BND_NMOS_Gate_Hrz_poly')
        target_coord = tmp1[0][0][0]['_XY_cent']
        ## Approaching_coord
        tmp2 = self.get_param_KJH4('SRF_Tr10_Gate_ViaM0M4', 'SRF_ViaM0M1', 'BND_POLayer')
        approaching_coord = tmp2[0][0][0][0]['_XY_cent']
        ## Sref coord
        tmp3 = self.get_param_KJH4('SRF_Tr10_Gate_ViaM0M4')
        Scoord = tmp3[0][0]['_XY_origin']
        ## Calculate
        New_Scoord = self.get_Scoord_KJH4(target_coord, approaching_coord, Scoord)
        tmpXY.append(New_Scoord)
        ## Define
        self._DesignParameter['SRF_Tr10_Gate_ViaM0M4']['_XYCoordinates'] = tmpXY
...
if __name__ == '__main__':
    ...
    libname = 'Proj_ADC_C07_Tr12Tr3Tr10'
    ## CellName: ex)C01_cap_array_v2_84
    cellname = 'C07_03_Tr12Tr3Tr10_v0_88'
