...
from KJH91_Projects.Project_ADC.Layoutgen_code.A_Basic_Building_Block import A03_NmosWithDummy_KJH4
from KJH91_Projects.Project_ADC.Layoutgen_code.A_Basic_Building_Block import A04_PmosWithDummy_KJH2


## Define Class
class _Tr10(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    _ParametersForDesignCalculation = dict(
        ...
        _Tr10_GateSpacing         =   80,   #None/number
    ...
    def _CalculateDesignParameter(self,
        ...
        _Caculation_Parameters = copy.deepcopy(A03_NmosWithDummy_KJH4._NmosWithDummy_KJH3._ParametersForDesignCalculation)
                ## Define Calculation_Parameters ex) _Caculation_Parameters['_NMOSPOWER_PbodyContact_1_Length']  = _NMOSPOWER_PbodyContact_1_Length
        _Caculation_Parameters['_NMOSNumberofGate']     =   _Tr10_NMOSNumberofGate
        _Caculation_Parameters['_NMOSChannelWidth']     =   _Tr10_NMOSChannelWidth
        _Caculation_Parameters['_NMOSChannellength']    =   _Tr10_NMOSChannellength
        _Caculation_Parameters['_GateSpacing']          =   _Tr10_GateSpacing
        _Caculation_Parameters['_SDWidth']              =   _Tr10_SDWidth
        _Caculation_Parameters['_XVT']                  =   _Tr10_XVT
        _Caculation_Parameters['_PCCrit']               =   _Tr10_PCCrit
        _Caculation_Parameters['_Source_Via_TF']        =   _Tr10_Source_Via_TF
        _Caculation_Parameters['_Drain_Via_TF']         =   _Tr10_Drain_Via_TF
        _Caculation_Parameters['_NMOSDummy']            =   _Tr10_NMOSDummy
        _Caculation_Parameters['_NMOSDummy_length']     =   _Tr10_NMOSDummy_length
        _Caculation_Parameters['_NMOSDummy_placement']  =   _Tr10_NMOSDummy_placement

                ## Generate Sref: ex)self._DesignParameter['_NMOS_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_nmos_power_v2._NMOS_POWER( _DesignParameter=None, _Name='{}:NMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_NMOS'] = self._SrefElementDeclaration(_DesignObj=A03_NmosWithDummy_KJH4._NmosWithDummy_KJH3(_DesignParameter=None, _Name='{}:SRF_NMOS'.format(_Name)))[0]
        ...
        ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ##########  Tr10, nfet: Source M2 down connection
            ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## Tr10, nfet: Source M2 down connection: Vtc
        ...
        self._DesignParameter['BND_NMOS_Source_Vtc_M2']['_YWidth'] = _DRCobj._MetalxMinSpace41 + abs(tmp1[0][0][0][0][0]['_XY_down'][1] - outter_coord[1])
        ...
        for i in range(0, len(tmp[0])):
            ...
            ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## Tr10, nfettw: Source M2 up connection: Hrz
        ## Boundary_element Generation
        ## Generate Boundary_element: ex)LayerName: METAL1 / DIFF (_ODLayer) / POLY / PIMP (_PPLayer) / NWELL / SLVT LVT RVT HVT / OP(OPpress) / CONT (CA) / PCCRIT
        ...
        ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ##########  Tr10, nfettw: Drain M2 up connection
            ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## Tr10, nfettw: Drain M2 up connection: Vtc
        ## Boundary_element Generation
        ## Generate Boundary_element: ex)LayerName: METAL1 / DIFF (_ODLayer) / POLY / PIMP (_PPLayer) / NWELL / SLVT LVT RVT HVT / OP(OPpress) / CONT (CA) / PCCRIT
        ...
        self._DesignParameter['BND_NMOS_Drain_Vtc_M2']['_YWidth'] = _DRCobj._MetalxMinSpace41 + abs(tmp1[0][0][0][0][0]['_XY_up'][1] - outter_coord[0])
        ...
        for i in range(0, len(tmp[0])):
            ...
            ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## Tr10, nfettw: Drain M2 up connection: Hrz
        ## Boundary_element Generation
        ## Generate Boundary_element: ex)LayerName: METAL1 / DIFF (_ODLayer) / POLY / PIMP (_PPLayer) / NWELL / SLVT LVT RVT HVT / OP(OPpress) / CONT (CA) / PCCRIT
        ...
        ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ##########  Tr10, nfettw: Gate Poly up connection
            ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## Tr10, nfettw: Gate Poly up connection: Vtc
        ## Pre-defined
        margin = 100
        ...
        ## Define Boundary_element _YWidth
        tmp1 = self.get_param_KJH4('BND_NMOS_Drain_Hrz_M2')
        ...
        self._DesignParameter['BND_NMOS_Gate_Vtc_poly']['_XYCoordinates'] = tmpXY
            ...
            ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## Tr10, nfettw: Gate Poly up connection: Hrz
        ## Boundary_element Generation
        ## Generate Boundary_element: ex)LayerName: METAL1 / DIFF (_ODLayer) / POLY / PIMP (_PPLayer) / NWELL / SLVT LVT RVT HVT / OP(OPpress) / CONT (CA) / PCCRIT
...
if __name__ == '__main__':
    ...
    ## Gen Object:
    LayoutObj = _Tr10(_DesignParameter=None, _Name=cellname)
