...
class _Slicer(StickDiagram_KJH1._StickDiagram_KJH):
...
if __name__ == '__main__':
	...
	InputParams = dict(
		## StrongARM Latch
		_CLKinputPMOSFinger1=6,  # 6
		_CLKinputPMOSFinger2=6,  # 3
		_PMOSFinger=6,  # 3
		_PMOSChannelWidth=350,  # 500
		_DATAinputNMOSFinger=3,  # 12
		_NMOSFinger=3,  # 2
		_CLKinputNMOSFinger=3,  # 8
		_NMOSChannelWidth=350,  # 500
		_CLKinputNMOSChannelWidth=350,  # 800
		_ChannelLength=30,  # 30
		_Dummy=True,
		_XVT='HVT',
		_GuardringWidth=150,
		_Guardring=True,
		_SlicerGuardringWidth=150,
		_SlicerGuardring=None,
		_NumSupplyCOY=None,
		_NumSupplyCOX=None,
		_SupplyMet1XWidth=None,
