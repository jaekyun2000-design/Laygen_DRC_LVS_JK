...
from KJH91_Projects.Project_ADC.Layoutgen_code.C08_Tr11_KJH import C08_01_Guardring_YCH
from KJH91_Projects.Project_ADC.Layoutgen_code.C09_Tr6_KJH import C09_01_Guardring_YCH
...
class _Tr4Tr6Routed(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        _Caculation_Parameters = copy.deepcopy(C08_01_Guardring_YCH._Guardring._ParametersForDesignCalculation)
        ...
        self._DesignParameter['SRF_Tr11'] = self._SrefElementDeclaration(_DesignObj=C08_01_Guardring_YCH._Guardring(_DesignParameter=None, _Name='{}:SRF_Tr11'.format(_Name)))[0]
        ...
        ## TR6 SREF Generation
                ## Copy Calculation_Parameters from low-level-block ex)copy.deepcopy(B16_nmos_power_v2._NMOS_POWER._ParametersForDesignCalculation)
        _Caculation_Parameters = copy.deepcopy(C09_01_Guardring_YCH._Guardring._ParametersForDesignCalculation)
                ## Define Calculation_Parameters ex) _Caculation_Parameters['_NMOSPOWER_PbodyContact_1_Length']  = _NMOSPOWER_PbodyContact_1_Length
        ...
        _Caculation_Parameters['_NwellWidth'] = _Tr6_NwellWidth
                ...
                ## Generate Sref: ex)self._DesignParameter['_NMOS_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_nmos_power_v2._NMOS_POWER( _DesignParameter=None, _Name='{}:NMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_Tr6'] = self._SrefElementDeclaration(_DesignObj=C09_01_Guardring_YCH._Guardring(_DesignParameter=None, _Name='{}:SRF_Tr6'.format(_Name)))[0]
...
if __name__ == '__main__':
    ...
    libname = 'Proj_ADC_C11_01_Tr6Tr11_YJH'
    cellname = 'C11_01_Tr6Tr11Routed_YJ_v02_94'
