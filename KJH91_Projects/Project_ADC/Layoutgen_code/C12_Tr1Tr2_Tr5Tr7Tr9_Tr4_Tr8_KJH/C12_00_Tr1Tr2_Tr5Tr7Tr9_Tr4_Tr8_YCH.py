...
##
from KJH91_Projects.Project_ADC.Layoutgen_code.C00_Tr1Tr2_VinVout_KJH import C00_03_Guardring_YCH
from KJH91_Projects.Project_ADC.Layoutgen_code.C02_Tr5Tr7Tr9_Ctop_KJH import C02_04_Guardring_YCH
from KJH91_Projects.Project_ADC.Layoutgen_code.C03_Tr4 import C03_02_Pin_YCH
from KJH91_Projects.Project_ADC.Layoutgen_code.C05_Tr8 import C05_02_Pin_YCH
...
class _Tr1Tr2_Tr5Tr7Tr9_Tr4_Tr8(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        _Caculation_Parameters = copy.deepcopy(C03_02_Pin_YCH._Pin._ParametersForDesignCalculation)
        ...
        self._DesignParameter['SRF_C03_02_Pin'] = self._SrefElementDeclaration(_DesignObj=C03_02_Pin_YCH._Pin(_DesignParameter=None, _Name='{}:SRF_C03_02_Pin'.format(_Name)))[0]
        ...
        ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## Tr5Tr7Tr9
            ...
            ## SREF Generation
                ## Copy Calculation_Parameters from low-level-block ex)copy.deepcopy(B16_nmos_power_v2._NMOS_POWER._ParametersForDesignCalculation)
        _Caculation_Parameters = copy.deepcopy(C02_04_Guardring_YCH._Guardring._ParametersForDesignCalculation)
                ## Define Calculation_Parameters ex) _Caculation_Parameters['_NMOSPOWER_PbodyContact_1_Length']  = _NMOSPOWER_PbodyContact_1_Length
        ...
        _Caculation_Parameters['_Tr9_PMOSDummy_placement']  = _Tr9_PMOSDummy_placement
                ...
                ## Generate Sref: ex)self._DesignParameter['_NMOS_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_nmos_power_v2._NMOS_POWER( _DesignParameter=None, _Name='{}:NMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_C02_04_Guardring'] = self._SrefElementDeclaration(_DesignObj=C02_04_Guardring_YCH._Guardring(_DesignParameter=None, _Name='{}:SRF_C02_04_Guardring'.format(_Name)))[0]
        ...
        ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## Tr8
            ...
            ## SREF Generation
                ## Copy Calculation_Parameters from low-level-block ex)copy.deepcopy(B16_nmos_power_v2._NMOS_POWER._ParametersForDesignCalculation)
        _Caculation_Parameters = copy.deepcopy(C05_02_Pin_YCH._Pin._ParametersForDesignCalculation)
                ## Define Calculation_Parameters ex) _Caculation_Parameters['_NMOSPOWER_PbodyContact_1_Length']  = _NMOSPOWER_PbodyContact_1_Length
        ...
        _Caculation_Parameters['_Tr8_NMOSDummy_placement']  = _Tr8_NMOSDummy_placement
                ...
                ## Generate Sref: ex)self._DesignParameter['_NMOS_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_nmos_power_v2._NMOS_POWER( _DesignParameter=None, _Name='{}:NMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_C05_02_Pin'] = self._SrefElementDeclaration(_DesignObj=C05_02_Pin_YCH._Pin(_DesignParameter=None, _Name='{}:SRF_C05_02_Pin'.format(_Name)))[0]
        ...
        ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## Tr1Tr2
            ...
            ## SREF Generation
                ## Copy Calculation_Parameters from low-level-block ex)copy.deepcopy(B16_nmos_power_v2._NMOS_POWER._ParametersForDesignCalculation)
        _Caculation_Parameters = copy.deepcopy(C00_03_Guardring_YCH._Guardring._ParametersForDesignCalculation)
                ## Define Calculation_Parameters ex) _Caculation_Parameters['_NMOSPOWER_PbodyContact_1_Length']  = _NMOSPOWER_PbodyContact_1_Length
        ...
        _Caculation_Parameters['_NwellWidth']               = _Tr1Tr2_NwellWidth
                ...
                ## Generate Sref: ex)self._DesignParameter['_NMOS_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_nmos_power_v2._NMOS_POWER( _DesignParameter=None, _Name='{}:NMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_C00_03_Guardring'] = self._SrefElementDeclaration(_DesignObj=C00_03_Guardring_YCH._Guardring(_DesignParameter=None, _Name='{}:SRF_C00_03_Guardring'.format(_Name)))[0]
...
if __name__ == '__main__':
    ...
    libname = 'Proj_ADC_C12_00_Tr1Tr2_Tr5Tr7Tr9_Tr4_Tr8_YCH_v4'
    ## CellName: ex)C01_cap_array_v2_84
    cellname = 'C12_00_Tr1Tr2_Tr5Tr7Tr9_Tr4_Tr8_YCH'
    ...
    InputParams = dict(
        ...
        _Tr1Tr2_Tr1_PCCrit              =   True,   #None/True
                ...
                # Source_node_ViaM1M2
        _Tr1Tr2_Tr1_Source_Via_TF       =   True,  #True/False

                # Drain_node_ViaM1M2
        _Tr1Tr2_Tr1_Drain_Via_TF        =   True,  #True/False
        ...
        # Tr4
        _Tr4_NMOSNumberofGate    =   2,     #number (ref:4)
        _Tr4_NMOSChannelWidth    =   100,   #number (ref:500)
        ...
        _Tr7_PMOSChannelWidth=200, #Ref = 1000
        _Tr7_PMOSChannellength=30,
        _Tr7_GateSpacing=None,
        _Tr7_SDWidth=None,
        _Tr7_XVT='SLVT',
