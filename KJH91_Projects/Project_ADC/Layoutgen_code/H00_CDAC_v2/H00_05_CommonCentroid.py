...
from KJH91_Projects.Project_ADC.Layoutgen_code.H00_CDAC_v2 import H00_04_CommonArray
...
class _CommonCentroid(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        if _LayoutOption[0] <= _BotNodeVtcExtensionMetalLayer or  _BotNodeVtcExtensionMetalLayer <= _ShieldingLayer:
            raise Exception(f" '쉴딩 메탈 < 캡 바텀 노드 메탈 < 캡 메탈'을 만족해야 합니다.")
...
### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ### ###
    def _CalculateDesignParameterFold1(self,
        ...
        self._DesignParameter['SRF_CommonArray'] = self._SrefElementDeclaration(
            _DesignObj=H00_04_CommonArray._CommonArray(_DesignParameter=None,
...
if __name__ == '__main__':
    ...
    libname = 'Proj_ADC_H00_CDAC_CommonCentroidArray2'
    cellname = 'H00_00_CommonCentroid_v5'
    ...
    InputParams = dict(
	    ...
	    _BotNodeVtcExtensionMetalLayer=2,
        _MetalWidth=50,
        _MetalLength=1410,  # (8bit size: 1414/ 10bit size: 2800/ 12bit size: 4200)
        _MetalSpacing=50,
	    # # CommonCentroid Array
	    _Bitsize=4,  # Total bit size of CDAC
        # #Unit Cap
        ...
        # # CommonCentroid With Driving node
        _CapArrayWDrivingNodeDistance=1500,
        _DriveNodeDistance=279,  #
