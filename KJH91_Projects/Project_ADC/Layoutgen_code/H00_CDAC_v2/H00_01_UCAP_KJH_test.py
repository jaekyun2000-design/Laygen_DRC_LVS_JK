...
import time
    ...
    ## Building blocks
from KJH91_Projects.Project_ADC.Layoutgen_code.H00_CDAC_v2 import H00_00_ECAP_KJH_test
...
class _UCAP(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        _Caculation_Parameters = copy.deepcopy(H00_00_ECAP_KJH_test._ECAP._ParametersForDesignCalculation)
        ...
        self._DesignParameter['SRF_ECAP'] = self._SrefElementDeclaration(_DesignObj=H00_00_ECAP_KJH_test._ECAP(_DesignParameter=None, _Name='{}:SRF_ECAP'.format(_Name)))[0]
...
if __name__ == '__main__':
    ...
    cellname = 'H00_00_UCAP7_23456_1414_50'
