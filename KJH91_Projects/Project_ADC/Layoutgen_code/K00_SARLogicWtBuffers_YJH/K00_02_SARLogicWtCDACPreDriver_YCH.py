...
class _SARLogicWtCDACPreDriver(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        ## Calculate Sref Layer by using Calculation_Parameter: ex)'_NMOS_POWER'
        self._DesignParameter['SRF_LowerCDACPreDriver']['_DesignObj']._CalculateDesignParameter(
            **_Caculation_Parameters)
...
if __name__ == '__main__':
    ...
    libname = 'Proj_ADC_K00_SARLogicWtCLKBufTree_v3'
    ...
    InputParams = dict(
        ...
        # Top Clock  Tree Size
        _CLKBufTreeTop_NumOfStage=4,
        _CLKBufTreeTop_CLKSampBuf_SizeByStage=[1,1,1,1],
        _CLKBufTreeTop_CLKSrcBuf_SizeByStage=[1,1,1,1],  # 스테이지에 따른 버퍼 사이즈(UnitBuffer의 배수로 각 스테이지의 크기가 결정 됨.)
        _CLKBufTreeTop_XOffSet=-0,
        ...
        # Bottom Clock  Tree Size
        _CLKBufTreeBot_NumOfStage=4,
        _CLKBufTreeBot_CompOutBuf_SizeByStage=[1,1,1,1],
        _CLKBufTreeBot_CLKDoutBuf_SizeByStage=[1,1,1,1],  # 스테이지에 따른 버퍼 사이즈(UnitBuffer의 배수로 각 스테이지의 크기가 결정 됨.)
        _CLKBufTreeBot_XOffSet=0,
