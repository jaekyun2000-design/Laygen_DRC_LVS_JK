...
from KJH91_Projects.Project_ADC.Layoutgen_code.C04_Tiecell import C04_00_PmosRoute_YCH
from KJH91_Projects.Project_ADC.Layoutgen_code.C04_Tiecell import C04_01_NmosRoute_YCH
...
class _TieCell8(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        SpacingODBtwPmosAndNBody = 200
        SpacingODBtwNmosAndPBody = 200
        SpacingHrzPolyBtwNmosRouteAndPmosRoute = 200


        ## C04_01_NMOSRoute(SREF) Generation
                ## Copy Calculation_Parameters from low-level-block ex)copy.deepcopy(B16_nmos_power_v2._NMOS_POWER._ParametersForDesignCalculation)
        _Caculation_Parameters = copy.deepcopy(C04_01_NmosRoute_YCH._NmosRoute._ParametersForDesignCalculation)
        ...
        self._DesignParameter['SRF_TieCellNMOSRouted'] = self._SrefElementDeclaration(_DesignObj=C04_01_NmosRoute_YCH._NmosRoute(_DesignParameter=None, _Name='{}:SRF_TieCellNMOSRouted'.format(_Name)))[0]
        ...
        _Caculation_Parameters = copy.deepcopy(C04_00_PmosRoute_YCH._PmosRoute._ParametersForDesignCalculation)
        ...
        _Caculation_Parameters['_TieP_PMOSDummy_placement'] = _TieP_PMOSDummy_placement
                ...
                ## Generate Sref: ex)self._DesignParameter['_NMOS_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_nmos_power_v2._NMOS_POWER( _DesignParameter=None, _Name='{}:NMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_TieCellPMOSRouted'] = self._SrefElementDeclaration(_DesignObj=C04_00_PmosRoute_YCH._PmosRoute(_DesignParameter=None, _Name='{}:SRF_TieCellPMOSRouted'.format(_Name)))[0]
...
if __name__ == '__main__':
    ...
    libname = 'C10_01_VddTieCell8_YJ'
    cellname = 'C10_01_VddTieCell8_YJ_v01'
