...
class _BoundaryTest(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        self._DesignParameter['M1_test'] = self._BoundaryElementDeclaration(
        ...
        self._DesignParameter['M1_test']['_YWidth'] = 21

        # Define Boundary_element _XWidth
        self._DesignParameter['M1_test']['_XWidth'] = 19

        # Define Boundary_element _XYCoordinates
        self._DesignParameter['M1_test']['_XYCoordinates'] = [[0, 0]]
