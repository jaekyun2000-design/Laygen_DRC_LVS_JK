...
class _Pullup(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        ## Define Boundary_element _YWidth : ViaYmin 기준
        tmp1 = self.get_param_KJH4('SRF_PMOSB','SRF_Source_ViaM1M2','SRF_ViaM1M2','BND_Met2Layer')
        tmp2 = self.get_param_KJH4('SRF_PMOSB','SRF_Drain_ViaM1M2','SRF_ViaM1M2','BND_Met2Layer')
        self._DesignParameter['BND_PMOSB_Drain_Vtc_M2']['_YWidth'] = _DRCobj._MetalxMinSpace41 + abs( tmp1[0][0][0][0][0]['_XY_down'][1] - tmp2[0][0][0][0][0]['_XY_down'][1] )
        ...
        ## Boundary_element Generation
        ## Generate Boundary_element: ex)LayerName: METAL1 / DIFF (_ODLayer) / POLY / PIMP (_PPLayer) / NWELL / SLVT LVT RVT HVT / OP(OPpress) / CONT (CA) / PCCRIT
        self._DesignParameter['BND_PMOSB_Source_Vtc_M2'] = self._BoundaryElementDeclaration(
            _Layer=DesignParameters._LayerMapping['METAL2'][0],
            _Datatype=DesignParameters._LayerMapping['METAL2'][1],
            _XWidth=None,
            _YWidth=None,
        ...
        tmp1 = self.get_param_KJH4('SRF_PMOSB', 'SRF_Source_ViaM1M2', 'SRF_ViaM1M2', 'BND_Met2Layer')
        tmp2 = self.get_param_KJH4('SRF_PMOSB', 'SRF_Drain_ViaM1M2', 'SRF_ViaM1M2', 'BND_Met2Layer')
        self._DesignParameter['BND_PMOSB_Source_Vtc_M2']['_YWidth'] = _DRCobj._MetalxMinSpace41 + abs( tmp1[0][0][0][0][0]['_XY_up'][1] - tmp2[0][0][0][0][0]['_XY_up'][1])

        ## Define Boundary_element _XWidth
        tmp = self.get_param_KJH4('SRF_PMOSB', 'SRF_Source_ViaM1M2', 'SRF_ViaM1M2', 'BND_Met2Layer')
        self._DesignParameter['BND_PMOSB_Source_Vtc_M2']['_XWidth'] = tmp[0][0][0][0][0]['_Xwidth']

        ## Define Boundary_element _XYCoordinates
        self._DesignParameter['BND_PMOSB_Source_Vtc_M2']['_XYCoordinates'] = [[0, 0]]

        tmpXY = []
        tmp = self.get_param_KJH4('SRF_PMOSB', 'BND_Met1Layer_Source')
        for i in range(0, len(tmp[0])):
            ## Calculate Sref XYcoord
            ## Calculate
            ## Target_coord: _XY_type1
            ...
            ## Approaching_coord: _XY_type2
            tmp2 = self.get_param_KJH4('BND_PMOSB_Source_Vtc_M2')
            approaching_coord = tmp2[0][0]['_XY_down_left']
            ## Sref coord
            tmp3 = self.get_param_KJH4('BND_PMOSB_Source_Vtc_M2')
            Scoord = tmp3[0][0]['_XY_origin']
            ## Cal
            New_Scoord = self.get_Scoord_KJH4(target_coord, approaching_coord, Scoord)
            tmpXY.append(New_Scoord)
        ## Define coordinates
        self._DesignParameter['BND_PMOSB_Source_Vtc_M2']['_XYCoordinates'] = tmpXY

        ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## PMOS: Source Hrz M2
        ## Boundary_element Generation
        ## Generate Boundary_element: ex)LayerName: METAL1 / DIFF (_ODLayer) / POLY / PIMP (_PPLayer) / NWELL / SLVT LVT RVT HVT / OP(OPpress) / CONT (CA) / PCCRIT
        self._DesignParameter['BND_PMOSB_Source_Hrz_M2'] = self._BoundaryElementDeclaration(
            _Layer=DesignParameters._LayerMapping['METAL2'][0],
            _Datatype=DesignParameters._LayerMapping['METAL2'][1],
            _XWidth=None,
            _YWidth=None,
        ...
        ## Define Boundary_element _YWidth : ViaYmin 기준
        self._DesignParameter['BND_PMOSB_Source_Hrz_M2']['_YWidth'] = _DRCobj._VIAxMinWidth + + 2 * max( [_DRCobj._Metal1MinEnclosureVia1, _DRCobj._MetalxMinEnclosureCO])

        ## Define Boundary_element _XWidth
        tmp = self.get_param_KJH4('SRF_PMOSB', 'BND_Met1Layer_Source')
        self._DesignParameter['BND_PMOSB_Source_Hrz_M2']['_XWidth'] = abs( tmp[0][-1][0]['_XY_right'][0] - tmp[0][0][0]['_XY_left'][0])

        ## Define Boundary_element _XYCoordinates
        self._DesignParameter['BND_PMOSB_Source_Hrz_M2']['_XYCoordinates'] = [[0, 0]]

        tmpXY = []
        ## Calculate Sref XYcoord
        ## Calculate
        ## Target_coord: _XY_type1
        tmp1 = self.get_param_KJH4('BND_PMOSB_Source_Vtc_M2')
        target_coord = tmp1[0][0]['_XY_up_left']
        ## Approaching_coord: _XY_type2
        tmp2 = self.get_param_KJH4('BND_PMOSB_Source_Hrz_M2')
        approaching_coord = tmp2[0][0]['_XY_down_left']
        ## Sref coord
        tmp3 = self.get_param_KJH4('BND_PMOSB_Source_Hrz_M2')
        Scoord = tmp3[0][0]['_XY_origin']
        ## Cal
        New_Scoord = self.get_Scoord_KJH4(target_coord, approaching_coord, Scoord)
        tmpXY.append(New_Scoord)
        ## Define coordinates
        self._DesignParameter['BND_PMOSB_Source_Hrz_M2']['_XYCoordinates'] = tmpXY
        ...
        ## Define Boundary_element _YWidth
        tmp = self.get_param_KJH4('BND_PMOSA_Drain_Hrz_M2')
        self._DesignParameter['BND_PMOSADrain_PMOSBSource_Hrz_M2']['_YWidth'] = tmp[0][0]['_Ywidth']

        ## Define Boundary_element _XWidth
        tmp1 = self.get_param_KJH4('BND_PMOSA_Drain_Hrz_M2')
        tmp2 = self.get_param_KJH4('SRF_PMOSB','SRF_Source_ViaM1M2','SRF_ViaM1M2','BND_Met2Layer')
        self._DesignParameter['BND_PMOSADrain_PMOSBSource_Hrz_M2']['_XWidth'] = abs( tmp2[0][0][0][0][0]['_XY_right'][0] - tmp1[0][0]['_XY_left'][0])
...
if __name__ == '__main__':
    ...
    libname = 'Proj_ADC_D02_SARLogic_Nor_KJH'
    ## CellName: ex)C01_cap_array_v2_84
    cellname = 'D02_01_Pullup_v0_91'
    ...
    InputParams = dict(
        ...
        # NMOSA
        _PMOSA_PMOSNumberofGate=4,  # number
        _PMOSA_PMOSChannelWidth=700,  # number
        _PMOSA_PMOSChannellength=30,  # number
        _PMOSA_GateSpacing=None,  # None/number
        _PMOSA_SDWidth=None,  # None/number
        ...
        # PMOSB
        _PMOSB_PMOSNumberofGate=4,  # number
