...
class _Xmission(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        _Caculation_Parameters['_Source_Via_TF'] =_Xmission_NMOS_Source_Via_TF #default
        _Caculation_Parameters['_Drain_Via_TF'] =_Xmission_NMOS_Drain_Via_TF
        ...
        self._DesignParameter['SRF_Xmission_NMOS_Source_ViaM0M2'] = self._SrefElementDeclaration(
            _DesignObj=A02_ViaStack_KJH2._ViaStack_KJH2(_DesignParameter=None, _Name='{}:SRF_Xmission_NMOS_Source_ViaM0M2'.format(_Name)))[0]

        ## Define Sref Relection
        self._DesignParameter['SRF_Xmission_NMOS_Source_ViaM0M2']['_Reflect'] = [0, 0, 0]

        ## Define Sref Angle
        self._DesignParameter['SRF_Xmission_NMOS_Source_ViaM0M2']['_Angle'] = 0

        tmp = self.get_param_KJH4('SRF_Xmission_NMOS','SRF_Source_ViaM1M2','SRF_ViaM1M2','BND_Met1Layer')
        NmosViaYWidth= abs(tmp[0][0][0][0][0]['_XY_up'][1]-tmp[0][0][0][0][0]['_XY_down'][1])


        ## Calcuate _COX and _COY:  None or 'MinEnclosureX' or 'MinEnclosureY'
        _COX, _COY = self._CalculateNumViaByXYWidth(50, NmosViaYWidth, 'MinEnclosureX')
        ...
        self._DesignParameter['SRF_Xmission_NMOS_Source_ViaM0M2']['_DesignObj']._CalculateDesignParameterXmin(**_Caculation_Parameters)
        ...
        for i in range(tmpnum) :
            ...
            self._DesignParameter['SRF_Xmission_NMOS_Source_ViaM0M2']['_XYCoordinates'] = [[0, 0]]
            ## Calculate
            ## Target_coord
            tmp1 = self.get_param_KJH4('SRF_Xmission_NMOS','BND_Met1Layer')
            target_coord = tmp1[0][2*i][0]['_XY_down']
            ## Approaching_coord
            tmp2 = self.get_param_KJH4('SRF_Xmission_NMOS_Source_ViaM0M2','SRF_ViaM1M2','BND_Met1Layer')
            approaching_coord = tmp2[0][0][0][0]['_XY_origin']
            ## Sref coord
            tmp3 = self.get_param_KJH4('SRF_Xmission_NMOS_Source_ViaM0M2','SRF_ViaM1M2','BND_Met1Layer')
            Scoord = tmp3[0][0][0][0]['_XY_origin']
            ## Calculate
            New_Scoord = self.get_Scoord_KJH4(target_coord, approaching_coord, Scoord)
            New_Scoord[1]= New_Scoord[1] + NmosViaYWidth/2
            tmpXY.append(New_Scoord)
            ## Define
        self._DesignParameter['SRF_Xmission_NMOS_Source_ViaM0M2']['_XYCoordinates'] = tmpXY
        ...
        ## Sref ViaX declaration
        self._DesignParameter['SRF_Xmission_NMOS_Drain_ViaM0M2'] = self._SrefElementDeclaration(
            _DesignObj=A02_ViaStack_KJH2._ViaStack_KJH2(_DesignParameter=None,
                                                        _Name='{}:SRF_Xmission_NMOS_Drain_ViaM0M2'.format(_Name)))[0]

        ## Define Sref Relection
        self._DesignParameter['SRF_Xmission_NMOS_Drain_ViaM0M2']['_Reflect'] = [0, 0, 0]

        ## Define Sref Angle
        self._DesignParameter['SRF_Xmission_NMOS_Drain_ViaM0M2']['_Angle'] = 0
        ...
        ## Generate Metal(x), Metal(x+1) and C0(Viax) layer:  Option: _CalculateDesignParameter, _CalculateDesignParameterXmin, _CalculateDesignParameterYmin, _CalculateDesignParameterXYsame
        self._DesignParameter['SRF_Xmission_NMOS_Drain_ViaM0M2']['_DesignObj']._CalculateDesignParameterXmin(
            **_Caculation_Parameters)
        ...
        for i in range(tmpnum):
            ## initialized Sref coordinate
            self._DesignParameter['SRF_Xmission_NMOS_Drain_ViaM0M2']['_XYCoordinates'] = [[0, 0]]
            ## Calculate
            ## Target_coord
            tmp1 = self.get_param_KJH4('SRF_Xmission_NMOS_Source_ViaM0M2', 'SRF_ViaM1M2','BND_Met1Layer')
            target_coord = tmp1[0][i][0][0]['_XY_cent']
            ## Approaching_coord
            # tmp2= self.get_param_KJH4('SRF_Xmission_NMOS_Source_ViaM0M2', 'SRF_ViaM1M2','BND_COLayer')
            # test = tmp2[0][i][1][0]['_XY_cent']
            tmp2 = self.get_param_KJH4('SRF_Xmission_NMOS_Drain_ViaM0M2', 'SRF_ViaM1M2','BND_COLayer')
            approaching_coord = tmp2[0][0][1][0]['_XY_cent']
            ## Sref coord
            tmp3 = self.get_param_KJH4('SRF_Xmission_NMOS_Drain_ViaM0M2', 'SRF_ViaM1M2','BND_COLayer')
            Scoord = tmp3[0][0][1][0]['_XY_cent']
            ## Calculate
            New_Scoord = self.get_Scoord_KJH4(target_coord, approaching_coord, Scoord)

            tmpx = self.get_param_KJH4('SRF_Xmission_NMOS', 'BND_Met1Layer')
            tmpxx= abs(tmpx[0][1][0]['_XY_left'][0]-tmpx[0][0][0]['_XY_right'][0])

            New_Scoord[0] = New_Scoord[0] + tmpxx +50
            New_Scoord[1] = New_Scoord[1] + 80
            tmpXY.append(New_Scoord)
            ## Define
        self._DesignParameter['SRF_Xmission_NMOS_Drain_ViaM0M2']['_XYCoordinates'] = tmpXY
        ...
        _Caculation_Parameters['_Source_Via_TF'] =_Xmission_PMOS_Source_Via_TF #default
        _Caculation_Parameters['_Drain_Via_TF'] =_Xmission_PMOS_Drain_Via_TF
        ...
        ### ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## N, PMOS Gate roughting :
                ...
                ## NMOS, PMOS Drain vertical roughting Path M2

        ## Boundary_element Generation
        self._DesignParameter['BND_Xmission_Drain_Vtc_M2'] = self._BoundaryElementDeclaration(
        ...
        # tmp2 = self.get_param_KJH4('SRF_Xmission_NMOS_Gate_ViaM0M1', 'SRF_ViaM0M1', 'BND_Met1Layer')
        self._DesignParameter['BND_Xmission_Drain_Vtc_M2']['_YWidth'] = 50

        ## Define Boundary_element _XWidth
        tmp1=self.get_param_KJH4('SRF_Xmission_PMOS','BND_Met1Layer')
        GateVtcPathWidth = abs(tmp1[0][-1][0]['_XY_right'][0]-tmp1[0][0][0]['_XY_left'][0])
        self._DesignParameter['BND_Xmission_Drain_Vtc_M2']['_XWidth'] = GateVtcPathWidth

        ## Define Boundary_element _XYCoordinates
        self._DesignParameter['BND_Xmission_Drain_Vtc_M2']['_XYCoordinates'] = [[0, 0]]
        ...
        ## Approaching_coord: _XY_type2
        tmp2 = self.get_param_KJH4('BND_Xmission_Drain_Vtc_M2')
        approaching_coord = tmp2[0][0]['_XY_down_left']

        ## Sref coord
        tmp3 = self.get_param_KJH4('BND_Xmission_Drain_Vtc_M2')
        Scoord = tmp3[0][0]['_XY_origin']
        New_Scoord = self.get_Scoord_KJH4(target_coord, approaching_coord, Scoord)
        tmpXY.append(New_Scoord)

        ## Define coordinates
        self._DesignParameter['BND_Xmission_Drain_Vtc_M2']['_XYCoordinates'] = tmpXY

        #         ## NMOS, PMOS Drain roughting Path M2
        tmp2 = self._DesignParameter['SRF_Xmission_NMOS']['_DesignObj']
        del tmp2._DesignParameter['SRF_Drain_ViaM1M2']
        del tmp2._DesignParameter['SRF_Source_ViaM1M2']
...
if __name__ == '__main__':
    ...
    libname = 'Proj_ADC_D00_SARLogic_Xmissionerter'
    ## CellName: ex)C01_cap_array_v2_84
    cellname = 'D00_00_Xmissionerter_v0_99'
    _fileName = cellname + '.gds'

    ''' Input Parameters for Layout Object '''
    InputParams = dict(
            # Driver(Inverter) NMOS
        _Xmission_NMOS_NumberofGate = 2,  # number
