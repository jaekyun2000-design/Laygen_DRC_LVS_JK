...
class _SetRstDFF_Nor(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        tmp2 = self.get_param_KJH4('SRF_Mst_Xgate1','SRF_Pbody','SRF_PbodyContactPhyLen','BND_Met1Layer')
        XvtTop2Pbody = abs( tmp2[0][0][0][0][0]['_XY_down'][1] - tmp1[0][0][0][0][0]['_XY_down'][1] )

        tmp3 =  self.get_param_KJH4('SRF_Mst_Xgate1','SRF_NMOS','SRF_NMOS','BND_{}Layer'.format(_Mst_Xgate1_NMOS_XVT))
        tmp4 =  self.get_param_KJH4('SRF_Mst_Xgate1','SRF_Nbody', 'SRF_NbodyContactPhyLen', 'BND_Met1Layer')
        XvtDown2Nbody = abs( tmp3[0][0][0][0][0]['_XY_up'] - tmp4[0][0][0][0][0]['_XY_up'][1]  )
        ...
        ## Find XvtTop2Pbody_tmp and XvtDown2Nbody_tmp
        tmp1 = self.get_param_KJH4('SRF_Mst_Xgate2','SRF_PMOS','SRF_PMOS','BND_{}Layer'.format(_Mst_Xgate1_PMOS_XVT))
        tmp2 = self.get_param_KJH4('SRF_Mst_Xgate2','SRF_Pbody','SRF_PbodyContactPhyLen','BND_Met1Layer')
        XvtTop2Pbody_tmp = abs( tmp2[0][0][0][0][0]['_XY_down'][1] - tmp1[0][0][0][0][0]['_XY_down'][1] )

        if XvtTop2Pbody_tmp > XvtTop2Pbody:
            XvtTop2Pbody = XvtTop2Pbody_tmp

        tmp3 =  self.get_param_KJH4('SRF_Mst_Xgate2','SRF_NMOS','SRF_NMOS','BND_{}Layer'.format(_Mst_Xgate1_NMOS_XVT))
        tmp4 =  self.get_param_KJH4('SRF_Mst_Xgate2','SRF_Nbody', 'SRF_NbodyContactPhyLen', 'BND_Met1Layer')
        XvtDown2Nbody_tmp = abs( tmp3[0][0][0][0][0]['_XY_up'] - tmp4[0][0][0][0][0]['_XY_up'][1]  )
        ...
        tmp2 = self.get_param_KJH4('SRF_Mst_Nor1','SRF_Pbody','SRF_PbodyContactPhyLen','BND_Met1Layer')
        XvtTop2Pbody_tmp = abs( tmp2[0][0][0][0][0]['_XY_down'][1] - tmp1[0][0][0][0][0]['_XY_down'][1] )
        ...
        tmp4 =  self.get_param_KJH4('SRF_Mst_Nor1','SRF_Nbody', 'SRF_NbodyContactPhyLen', 'BND_Met1Layer')
        XvtDown2Nbody_tmp = abs( tmp3[0][0][0][0][0]['_XY_up'] - tmp4[0][0][0][0][0]['_XY_up'][1]  )
        ...
        tmp2 = self.get_param_KJH4('SRF_Mst_Nor2','SRF_Pbody','SRF_PbodyContactPhyLen','BND_Met1Layer')
        XvtTop2Pbody_tmp = abs( tmp2[0][0][0][0][0]['_XY_down'][1] - tmp1[0][0][0][0][0]['_XY_down'][1] )
        ...
        tmp4 =  self.get_param_KJH4('SRF_Mst_Nor2','SRF_Nbody', 'SRF_NbodyContactPhyLen', 'BND_Met1Layer')
        XvtDown2Nbody_tmp = abs( tmp3[0][0][0][0][0]['_XY_up'] - tmp4[0][0][0][0][0]['_XY_up'][1]  )
        ...
        tmp2 = self.get_param_KJH4('SRF_Mst_Inv1','SRF_Pbody','SRF_PbodyContactPhyLen','BND_Met1Layer')
        XvtTop2Pbody_tmp = abs( tmp2[0][0][0][0][0]['_XY_down'][1] - tmp1[0][0][0][0][0]['_XY_down'][1] )
        ...
        tmp4 =  self.get_param_KJH4('SRF_Mst_Inv1','SRF_Nbody', 'SRF_NbodyContactPhyLen', 'BND_Met1Layer')
        XvtDown2Nbody_tmp = abs( tmp3[0][0][0][0][0]['_XY_up'] - tmp4[0][0][0][0][0]['_XY_up'][1]  )
        ...
        tmp2 = self.get_param_KJH4('SRF_Mst_Inv2','SRF_Pbody','SRF_PbodyContactPhyLen','BND_Met1Layer')
        XvtTop2Pbody_tmp = abs( tmp2[0][0][0][0][0]['_XY_down'][1] - tmp1[0][0][0][0][0]['_XY_down'][1] )
        ...
        tmp4 =  self.get_param_KJH4('SRF_Mst_Inv2','SRF_Nbody', 'SRF_NbodyContactPhyLen', 'BND_Met1Layer')
        XvtDown2Nbody_tmp = abs( tmp3[0][0][0][0][0]['_XY_up'] - tmp4[0][0][0][0][0]['_XY_up'][1]  )
        ...
        tmp2 = self.get_param_KJH4('SRF_Clk_Inv3','SRF_Pbody','SRF_PbodyContactPhyLen','BND_Met1Layer')
        XvtTop2Pbody_tmp = abs( tmp2[0][0][0][0][0]['_XY_down'][1] - tmp1[0][0][0][0][0]['_XY_down'][1] )
        ...
        tmp4 =  self.get_param_KJH4('SRF_Clk_Inv3','SRF_Nbody', 'SRF_NbodyContactPhyLen', 'BND_Met1Layer')
        XvtDown2Nbody_tmp = abs( tmp3[0][0][0][0][0]['_XY_up'] - tmp4[0][0][0][0][0]['_XY_up'][1]  )
        ...
        tmp2 = self.get_param_KJH4('SRF_Slv_Xgate1','SRF_Pbody','SRF_PbodyContactPhyLen','BND_Met1Layer')
        XvtTop2Pbody_tmp = abs( tmp2[0][0][0][0][0]['_XY_down'][1] - tmp1[0][0][0][0][0]['_XY_down'][1] )
        ...
        tmp4 =  self.get_param_KJH4('SRF_Slv_Xgate1','SRF_Nbody', 'SRF_NbodyContactPhyLen', 'BND_Met1Layer')
        XvtDown2Nbody_tmp = abs( tmp3[0][0][0][0][0]['_XY_up'] - tmp4[0][0][0][0][0]['_XY_up'][1]  )
        ...
        tmp2 = self.get_param_KJH4('SRF_Slv_Xgate2','SRF_Pbody','SRF_PbodyContactPhyLen','BND_Met1Layer')
        XvtTop2Pbody_tmp = abs( tmp2[0][0][0][0][0]['_XY_down'][1] - tmp1[0][0][0][0][0]['_XY_down'][1] )
        ...
        tmp4 =  self.get_param_KJH4('SRF_Slv_Xgate2','SRF_Nbody', 'SRF_NbodyContactPhyLen', 'BND_Met1Layer')
        XvtDown2Nbody_tmp = abs( tmp3[0][0][0][0][0]['_XY_up'] - tmp4[0][0][0][0][0]['_XY_up'][1]  )
        ...
        ## Find XvtTop2Pbody_tmp and XvtDown2Nbody_tmp
        tmp1 = self.get_param_KJH4('Slv_Mst_Nor1','SRF_Pullup','SRF_PMOSA','BND_{}Layer'.format(_Slv_Nor1_PMOS_XVT))
        tmp2 = self.get_param_KJH4('Slv_Mst_Nor1','SRF_Pbody','SRF_PbodyContactPhyLen','BND_Met1Layer')
        XvtTop2Pbody_tmp = abs( tmp2[0][0][0][0][0]['_XY_down'][1] - tmp1[0][0][0][0][0]['_XY_down'][1] )

        if XvtTop2Pbody_tmp > XvtTop2Pbody:
            XvtTop2Pbody = XvtTop2Pbody_tmp

        tmp3 =  self.get_param_KJH4('Slv_Mst_Nor1','SRF_Pulldown','SRF_NMOSA','BND_{}Layer'.format(_Slv_Nor1_NMOS_XVT))
        tmp4 =  self.get_param_KJH4('Slv_Mst_Nor1','SRF_Nbody', 'SRF_NbodyContactPhyLen', 'BND_Met1Layer')
        XvtDown2Nbody_tmp = abs( tmp3[0][0][0][0][0]['_XY_up'] - tmp4[0][0][0][0][0]['_XY_up'][1]  )
        ...
        tmp2 = self.get_param_KJH4('SRF_Slv_Nor2','SRF_Pbody','SRF_PbodyContactPhyLen','BND_Met1Layer')
        XvtTop2Pbody_tmp = abs( tmp2[0][0][0][0][0]['_XY_down'][1] - tmp1[0][0][0][0][0]['_XY_down'][1] )
        ...
        tmp4 =  self.get_param_KJH4('SRF_Slv_Nor2','SRF_Nbody', 'SRF_NbodyContactPhyLen', 'BND_Met1Layer')
        XvtDown2Nbody_tmp = abs( tmp3[0][0][0][0][0]['_XY_up'] - tmp4[0][0][0][0][0]['_XY_up'][1]  )
        ...
        tmp2 = self.get_param_KJH4('SRF_Slv_Inv1','SRF_Pbody','SRF_PbodyContactPhyLen','BND_Met1Layer')
        XvtTop2Pbody_tmp = abs( tmp2[0][0][0][0][0]['_XY_down'][1] - tmp1[0][0][0][0][0]['_XY_down'][1] )
        ...
        tmp4 =  self.get_param_KJH4('SRF_Slv_Inv1','SRF_Nbody', 'SRF_NbodyContactPhyLen', 'BND_Met1Layer')
        XvtDown2Nbody_tmp = abs( tmp3[0][0][0][0][0]['_XY_up'] - tmp4[0][0][0][0][0]['_XY_up'][1]  )
        ...
        tmp2 = self.get_param_KJH4('SRF_Slv_Inv2','SRF_Pbody','SRF_PbodyContactPhyLen','BND_Met1Layer')
        XvtTop2Pbody_tmp = abs( tmp2[0][0][0][0][0]['_XY_down'][1] - tmp1[0][0][0][0][0]['_XY_down'][1] )
        ...
        tmp4 =  self.get_param_KJH4('SRF_Slv_Inv2','SRF_Nbody', 'SRF_NbodyContactPhyLen', 'BND_Met1Layer')
        XvtDown2Nbody_tmp = abs( tmp3[0][0][0][0][0]['_XY_up'] - tmp4[0][0][0][0][0]['_XY_up'][1]  )
        ...
        tmp2 = self.get_param_KJH4('SRF_Qb_Inv3','SRF_Pbody','SRF_PbodyContactPhyLen','BND_Met1Layer')
        XvtTop2Pbody_tmp = abs( tmp2[0][0][0][0][0]['_XY_down'][1] - tmp1[0][0][0][0][0]['_XY_down'][1] )
        ...
        tmp4 =  self.get_param_KJH4('SRF_Qb_Inv3','SRF_Nbody', 'SRF_NbodyContactPhyLen', 'BND_Met1Layer')
        XvtDown2Nbody_tmp = abs( tmp3[0][0][0][0][0]['_XY_up'] - tmp4[0][0][0][0][0]['_XY_up'][1]  )
...
if __name__ == '__main__':
    ...
    cellname = 'D04_00_SetRstDFF_v0_76'
