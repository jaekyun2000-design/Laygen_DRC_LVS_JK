...
class _SetRstDFF_Nor(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## Fake Sref Gen for PMOS XvtTop2Pbody and NMOS XvtDown2Nbody
        ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## Master Xgate1
        ## Pre-defined
        XvtTop2Pbody = 0
        XvtDown2Nbody = 0
        ...
        tmp1 = self.get_param_KJH4('SRF_Mst_Xgate1','SRF_PMOS','SRF_PMOS','BND_{}Layer'.format(_Mst_Xgate1_PMOS_XVT))
        tmp2 = self.get_param_KJH4('SRF_Mst_Xgate1','SRF_Nbody','SRF_NbodyContactPhyLen', 'BND_Met1Layer')
        XvtDown2Nbody = abs( tmp2[0][0][0][0][0]['_XY_down'][1] - tmp1[0][0][0][0][0]['_XY_down'][1] )

        tmp3 =  self.get_param_KJH4('SRF_Mst_Xgate1','SRF_NMOS','SRF_NMOS','BND_{}Layer'.format(_Mst_Xgate1_NMOS_XVT))
        tmp4 =  self.get_param_KJH4('SRF_Mst_Xgate1','SRF_Pbody','SRF_PbodyContactPhyLen', 'BND_Met1Layer')
        XvtTop2Pbody = abs( tmp3[0][0][0][0][0]['_XY_up'][1] - tmp4[0][0][0][0][0]['_XY_up'][1]  )
        ...
        ## Find XvtTop2Pbody_tmp and XvtDown2Nbody_tmp
        tmp1 = self.get_param_KJH4('SRF_Mst_Xgate2','SRF_PMOS','SRF_PMOS','BND_{}Layer'.format(_Mst_Xgate2_PMOS_XVT))
        ...
        tmp3 =  self.get_param_KJH4('SRF_Mst_Xgate2','SRF_NMOS','SRF_NMOS','BND_{}Layer'.format(_Mst_Xgate2_NMOS_XVT))
        ...
        ## Find XvtTop2Pbody_tmp and XvtDown2Nbody_tmp
        tmp1 = self.get_param_KJH4('SRF_Clk_Inv3','SRF_PMOS','BND_{}Layer'.format(_Clk_Inv3_PMOS_XVT))
        tmp2 = self.get_param_KJH4('SRF_Clk_Inv3','SRF_Nbody', 'SRF_NbodyContactPhyLen', 'BND_Met1Layer')
        XvtDown2Nbody_tmp = abs( tmp2[0][0][0][0][0]['_XY_down'][1] - tmp1[0][0][0][0]['_XY_down'][1] )

        if XvtDown2Nbody_tmp > XvtDown2Nbody:
            XvtDown2Nbody = XvtDown2Nbody_tmp

        tmp3 =  self.get_param_KJH4('SRF_Clk_Inv3','SRF_NMOS','BND_{}Layer'.format(_Clk_Inv3_NMOS_XVT))
        tmp4 =  self.get_param_KJH4('SRF_Clk_Inv3', 'SRF_Pbody', 'SRF_PbodyContactPhyLen', 'BND_Met1Layer')
        XvtTop2Pbody_tmp = abs( tmp3[0][0][0][0]['_XY_up'][1] - tmp4[0][0][0][0][0]['_XY_up'][1]  )
        ...
        _Caculation_Parameters = copy.deepcopy(D01_02_Xgate_KJH1._Xgate._ParametersForDesignCalculation)
        ## Define Calculation_Parameters ex) _Caculation_Parameters['_PMOSAPOWER_PbodyContact_1_Length']  = _PMOSAPOWER_PbodyContact_1_Length
        _Caculation_Parameters['_NMOS_NMOSNumberofGate']    = _Slv_Xgate1_NumberofGate
        _Caculation_Parameters['_NMOS_NMOSChannelWidth']    = _Slv_Xgate1_NMOSChannel_Width
        _Caculation_Parameters['_NMOS_NMOSChannellength']   = _Slv_Xgate1_Channel_Length
        _Caculation_Parameters['_NMOS_GateSpacing']         = _Slv_Xgate1_GateSpacing
        _Caculation_Parameters['_NMOS_SDWidth']             = _Slv_Xgate1_SDWidth
        _Caculation_Parameters['_NMOS_XVT']                 = _Slv_Xgate1_NMOS_XVT
        _Caculation_Parameters['_NMOS_PCCrit']              = _Slv_Xgate1_PCCrit
        _Caculation_Parameters['_NMOS_Source_Via_TF']       = True
        _Caculation_Parameters['_NMOS_Drain_Via_TF']        = True
        _Caculation_Parameters['_NMOS_NMOSDummy']           = True
        _Caculation_Parameters['_NMOS_NMOSDummy_length']    = _Slv_Xgate1_NMOSDummy_Length
        _Caculation_Parameters['_NMOS_NMOSDummy_placement'] = _Slv_Xgate1_NMOSDummy_Placement
        _Caculation_Parameters['_NMOS_Pbody_NumCont']       = _DFF_Pbody_NumCont
        _Caculation_Parameters['_NMOS_Pbody_XlvtTop2Pdoby'] = _DFF_XlvtTop2Pdoby

        _Caculation_Parameters['_PMOS_PMOSNumberofGate']    = _Slv_Xgate1_NumberofGate
        _Caculation_Parameters['_PMOS_PMOSChannelWidth']    = _Slv_Xgate1_PMOSChannel_Width
        _Caculation_Parameters['_PMOS_PMOSChannellength']   = _Slv_Xgate1_Channel_Length
        _Caculation_Parameters['_PMOS_GateSpacing']         = _Slv_Xgate1_GateSpacing
        _Caculation_Parameters['_PMOS_SDWidth']             = _Slv_Xgate1_SDWidth
        _Caculation_Parameters['_PMOS_XVT']                 = _Slv_Xgate1_PMOS_XVT
        _Caculation_Parameters['_PMOS_PCCrit']              = _Slv_Xgate1_PCCrit
        _Caculation_Parameters['_PMOS_Source_Via_TF']       = True
        _Caculation_Parameters['_PMOS_Drain_Via_TF']        = True
        _Caculation_Parameters['_PMOS_PMOSDummy']           = True
        _Caculation_Parameters['_PMOS_PMOSDummy_length']    = _Slv_Xgate1_PMOSDummy_Length
        _Caculation_Parameters['_PMOS_PMOSDummy_placement'] = _Slv_Xgate1_PMOSDummy_Placement
        _Caculation_Parameters['_PMOS_Nbody_NumCont']       = _DFF_Nbody_NumCont
        _Caculation_Parameters['_PMOS_Nbody_Xlvtdown2Ndoby']= _DFF_Xlvtdown2Ndoby
        ...
        ## Generate Sref: ex)self._DesignParameter['_PMOSA_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_PMOSA_power_v2._PMOSA_POWER( _DesignParameter=None, _Name='{}:PMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_Slv_Xgate1'] = self._SrefElementDeclaration(_DesignObj=D01_02_Xgate_KJH1._Xgate(_DesignParameter=None, _Name='{}:SRF_Slv_Xgate1'.format(_Name)))[0]
        ...
        self._DesignParameter['SRF_Slv_Xgate1']['_XYCoordinates'] = [[0, 0]]
                        ## Calculate
                            ## Target_coord: _XY_type1
                                ##X
        tmp1_1 = self.get_param_KJH4('SRF_Clk_Inv3','SRF_PMOS','BND_PODummyLayer')
        target_coordx = tmp1_1[0][0][-1][0]['_XY_right'][0]
                                ##y
        tmp1_2 = self.get_param_KJH4('SRF_Clk_Inv3','SRF_PMOS','BND_{}Layer'.format(_Clk_Inv3_PMOS_XVT))
        target_coordy = tmp1_2[0][0][0][0]['_XY_down'][1]

        target_coord = [target_coordx,target_coordy]
                            ## Approaching_coord: _XY_type2
                                ##X
        tmp2_1 = self.get_param_KJH4('SRF_Slv_Xgate1','SRF_PMOS','SRF_PMOS','BND_PODummyLayer')
        approaching_coordx = tmp2_1[0][0][0][0][0]['_XY_left'][0]
                                ##Y
        tmp2_2 = self.get_param_KJH4('SRF_Slv_Xgate1','SRF_PMOS','SRF_PMOS','BND_{}Layer'.format(_Slv_Xgate1_PMOS_XVT))
        approaching_coordy = tmp2_2[0][0][0][0][0]['_XY_down'][1]
        ...
        ## Find XvtTop2Pbody_tmp and XvtDown2Nbody_tmp
        tmp1 = self.get_param_KJH4('SRF_Slv_Xgate1','SRF_PMOS','SRF_PMOS','BND_{}Layer'.format(_Slv_Xgate1_PMOS_XVT))
        ...
        tmp3 =  self.get_param_KJH4('SRF_Slv_Xgate1','SRF_NMOS','SRF_NMOS','BND_{}Layer'.format(_Slv_Xgate1_NMOS_XVT))
        ...
        _Caculation_Parameters = copy.deepcopy(D01_02_Xgate_KJH1._Xgate._ParametersForDesignCalculation)
        ## Define Calculation_Parameters ex) _Caculation_Parameters['_PMOSAPOWER_PbodyContact_1_Length']  = _PMOSAPOWER_PbodyContact_1_Length
        _Caculation_Parameters['_NMOS_NMOSNumberofGate']        = _Slv_Xgate2_NumberofGate
        _Caculation_Parameters['_NMOS_NMOSChannelWidth']        = _Slv_Xgate2_NMOSChannel_Width
        _Caculation_Parameters['_NMOS_NMOSChannellength']       = _Slv_Xgate2_Channel_Length
        _Caculation_Parameters['_NMOS_GateSpacing']             = _Slv_Xgate2_GateSpacing
        _Caculation_Parameters['_NMOS_SDWidth']                 = _Slv_Xgate2_SDWidth
        _Caculation_Parameters['_NMOS_XVT']                     = _Slv_Xgate2_NMOS_XVT
        _Caculation_Parameters['_NMOS_PCCrit']                  = _Slv_Xgate2_PCCrit
        _Caculation_Parameters['_NMOS_Source_Via_TF']           = True
        _Caculation_Parameters['_NMOS_Drain_Via_TF']            = True
        _Caculation_Parameters['_NMOS_NMOSDummy']               = True
        _Caculation_Parameters['_NMOS_NMOSDummy_length']        = _Slv_Xgate2_NMOSDummy_Length
        _Caculation_Parameters['_NMOS_NMOSDummy_placement']     = _Slv_Xgate2_NMOSDummy_Placement
        _Caculation_Parameters['_NMOS_Pbody_NumCont']           = _DFF_Pbody_NumCont
        _Caculation_Parameters['_NMOS_Pbody_XlvtTop2Pdoby']     = _DFF_XlvtTop2Pdoby

        _Caculation_Parameters['_PMOS_PMOSNumberofGate']        = _Slv_Xgate2_NumberofGate
        _Caculation_Parameters['_PMOS_PMOSChannelWidth']        = _Slv_Xgate2_PMOSChannel_Width
        _Caculation_Parameters['_PMOS_PMOSChannellength']       = _Slv_Xgate2_Channel_Length
        _Caculation_Parameters['_PMOS_GateSpacing']             = _Slv_Xgate2_GateSpacing
        _Caculation_Parameters['_PMOS_SDWidth']                 = _Slv_Xgate2_SDWidth
        _Caculation_Parameters['_PMOS_XVT']                     = _Slv_Xgate2_PMOS_XVT
        _Caculation_Parameters['_PMOS_PCCrit']                  = _Slv_Xgate2_PCCrit
        _Caculation_Parameters['_PMOS_Source_Via_TF']           = True
        _Caculation_Parameters['_PMOS_Drain_Via_TF']            = True
        _Caculation_Parameters['_PMOS_PMOSDummy']               = True
        _Caculation_Parameters['_PMOS_PMOSDummy_length']        = _Slv_Xgate2_PMOSDummy_Length
        _Caculation_Parameters['_PMOS_PMOSDummy_placement']     = _Slv_Xgate2_PMOSDummy_Placement
        _Caculation_Parameters['_PMOS_Nbody_NumCont']           = _DFF_Nbody_NumCont
        _Caculation_Parameters['_PMOS_Nbody_Xlvtdown2Ndoby']    = _DFF_Xlvtdown2Ndoby
        ...
        ## Generate Sref: ex)self._DesignParameter['_PMOSA_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_PMOSA_power_v2._PMOSA_POWER( _DesignParameter=None, _Name='{}:PMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_Slv_Xgate2'] = self._SrefElementDeclaration(_DesignObj=D01_02_Xgate_KJH1._Xgate(_DesignParameter=None, _Name='{}:SRF_Slv_Xgate2'.format(_Name)))[0]
        ...
        self._DesignParameter['SRF_Slv_Xgate2']['_XYCoordinates'] = [[0, 0]]
                        ## Calculate
                            ## Target_coord: _XY_type1
                                ##X
        tmp1_1 = self.get_param_KJH4('SRF_Slv_Xgate1','SRF_PMOS','SRF_PMOS','BND_PODummyLayer')
        target_coordx = tmp1_1[0][0][0][-1][0]['_XY_right'][0]
                                ##y
        tmp1_2 = self.get_param_KJH4('SRF_Slv_Xgate1','SRF_PMOS','SRF_PMOS','BND_{}Layer'.format(_Slv_Xgate1_PMOS_XVT))
        target_coordy = tmp1_2[0][0][0][0][0]['_XY_down'][1]

        target_coord = [target_coordx,target_coordy]
                            ## Approaching_coord: _XY_type2
                                ##X
        tmp2_1 = self.get_param_KJH4('SRF_Slv_Xgate2','SRF_PMOS','SRF_PMOS','BND_PODummyLayer')
        approaching_coordx = tmp2_1[0][0][0][-1][0]['_XY_right'][0]
                                ##Y
        tmp2_2 = self.get_param_KJH4('SRF_Slv_Xgate2','SRF_PMOS','SRF_PMOS','BND_{}Layer'.format(_Slv_Xgate2_PMOS_XVT))
        approaching_coordy = tmp2_2[0][0][0][0][0]['_XY_down'][1]
        ...
        ## Find XvtTop2Pbody_tmp and XvtDown2Nbody_tmp
        tmp1 = self.get_param_KJH4('SRF_Slv_Xgate2','SRF_PMOS','SRF_PMOS','BND_{}Layer'.format(_Slv_Xgate1_PMOS_XVT))
        ...
        tmp3 =  self.get_param_KJH4('SRF_Slv_Xgate2','SRF_NMOS','SRF_NMOS','BND_{}Layer'.format(_Slv_Xgate1_NMOS_XVT))
        ...
        _Caculation_Parameters = copy.deepcopy(D02_02_Nor_KJH0._Nor._ParametersForDesignCalculation)
        ## Define Calculation_Parameters ex) _Caculation_Parameters['_PMOSAPOWER_PbodyContact_1_Length']  = _PMOSAPOWER_PbodyContact_1_Length
        _Caculation_Parameters['_NMOSA_NMOSNumberofGate']        = _Slv_Nor1_NMOSA_NumberofGate
        _Caculation_Parameters['_NMOSA_NMOSChannelWidth']        = _Slv_Nor1_NMOSA_Channel_Width
        _Caculation_Parameters['_NMOSA_NMOSChannellength']       = _Slv_Nor1_Channel_Length
        _Caculation_Parameters['_NMOSA_GateSpacing']             = _Slv_Nor1_GateSpacing
        _Caculation_Parameters['_NMOSA_SDWidth']                 = _Slv_Nor1_SDWidth
        _Caculation_Parameters['_NMOSA_XVT']                     = _Slv_Nor1_NMOS_XVT
        _Caculation_Parameters['_NMOSA_PCCrit']                  = _Slv_Nor1_PCCrit
        _Caculation_Parameters['_NMOSA_Source_Via_TF']           = False
        _Caculation_Parameters['_NMOSA_Drain_Via_TF']            = True
        _Caculation_Parameters['_NMOSA_NMOSDummy']               = True
        _Caculation_Parameters['_NMOSA_NMOSDummy_length']        = _Slv_Nor1_NMOSA_Dummy_Length
        _Caculation_Parameters['_NMOSA_NMOSDummy_placement']     = _Slv_Nor1_NMOSA_Dummy_Placement

        _Caculation_Parameters['_NMOSB_NMOSNumberofGate']        = _Slv_Nor1_NMOSB_NumberofGate
        _Caculation_Parameters['_NMOSB_NMOSChannelWidth']        = _Slv_Nor1_NMOSB_Channel_Width
        _Caculation_Parameters['_NMOSB_NMOSChannellength']       = _Slv_Nor1_Channel_Length
        _Caculation_Parameters['_NMOSB_GateSpacing']             = _Slv_Nor1_GateSpacing
        _Caculation_Parameters['_NMOSB_SDWidth']                 = _Slv_Nor1_SDWidth
        _Caculation_Parameters['_NMOSB_XVT']                     = _Slv_Nor1_NMOS_XVT
        _Caculation_Parameters['_NMOSB_PCCrit']                  = _Slv_Nor1_PCCrit
        _Caculation_Parameters['_NMOSB_Source_Via_TF']           = False
        _Caculation_Parameters['_NMOSB_Drain_Via_TF']            = True
        _Caculation_Parameters['_NMOSB_NMOSDummy']               = True
        _Caculation_Parameters['_NMOSB_NMOSDummy_length']        = _Slv_Nor1_NMOSB_Dummy_Length
        _Caculation_Parameters['_NMOSB_NMOSDummy_placement']     = _Slv_Nor1_NMOSB_Dummy_Placement

        _Caculation_Parameters['_NMOSAB_Pbody_NumCont']           = _DFF_Pbody_NumCont
        _Caculation_Parameters['_NMOSAB_Pbody_XlvtTop2Pdoby']     = _DFF_XlvtTop2Pdoby

        _Caculation_Parameters['_PMOSA_PMOSNumberofGate']        = _Slv_Nor1_PMOSA_NumberofGate
        _Caculation_Parameters['_PMOSA_PMOSChannelWidth']        = _Slv_Nor1_PMOSA_Channel_Width
        _Caculation_Parameters['_PMOSA_PMOSChannellength']       = _Slv_Nor1_Channel_Length
        _Caculation_Parameters['_PMOSA_GateSpacing']             = _Slv_Nor1_GateSpacing
        _Caculation_Parameters['_PMOSA_SDWidth']                 = _Slv_Nor1_SDWidth
        _Caculation_Parameters['_PMOSA_XVT']                     = _Slv_Nor1_PMOS_XVT
        _Caculation_Parameters['_PMOSA_PCCrit']                  = _Slv_Nor1_PCCrit
        _Caculation_Parameters['_PMOSA_Source_Via_TF']           = False
        _Caculation_Parameters['_PMOSA_Drain_Via_TF']            = True
        _Caculation_Parameters['_PMOSA_PMOSDummy']               = True
        _Caculation_Parameters['_PMOSA_PMOSDummy_length']        = _Slv_Nor1_PMOSA_Dummy_Length
        _Caculation_Parameters['_PMOSA_PMOSDummy_placement']     = _Slv_Nor1_PMOSA_Dummy_Placement

        _Caculation_Parameters['_PMOSB_PMOSNumberofGate']        = _Slv_Nor1_PMOSB_NumberofGate
        _Caculation_Parameters['_PMOSB_PMOSChannelWidth']        = _Slv_Nor1_PMOSB_Channel_Width
        _Caculation_Parameters['_PMOSB_PMOSChannellength']       = _Slv_Nor1_Channel_Length
        _Caculation_Parameters['_PMOSB_GateSpacing']             = _Slv_Nor1_GateSpacing
        _Caculation_Parameters['_PMOSB_SDWidth']                 = _Slv_Nor1_SDWidth
        _Caculation_Parameters['_PMOSB_XVT']                     = _Slv_Nor1_PMOS_XVT
        _Caculation_Parameters['_PMOSB_PCCrit']                  = _Slv_Nor1_PCCrit
        _Caculation_Parameters['_PMOSB_Source_Via_TF']           = True
        _Caculation_Parameters['_PMOSB_Drain_Via_TF']            = True
        _Caculation_Parameters['_PMOSB_PMOSDummy']               = True
        _Caculation_Parameters['_PMOSB_PMOSDummy_length']        = _Slv_Nor1_PMOSB_Dummy_Length
        _Caculation_Parameters['_PMOSB_PMOSDummy_placement']     = _Slv_Nor1_PMOSB_Dummy_Placement
        ...
        self._DesignParameter['SRF_Slv_Nor1']['_XYCoordinates'] = [[0, 0]]
                        ## Calculate
                            ## Target_coord: _XY_type1
                                ##X
        tmp1_1 = self.get_param_KJH4('SRF_Slv_Xgate2','SRF_PMOS','SRF_PMOS','BND_PODummyLayer')
        target_coordx = tmp1_1[0][0][0][0][0]['_XY_left'][0]
                                ##y
        tmp1_2 = self.get_param_KJH4('SRF_Slv_Xgate2','SRF_PMOS','SRF_PMOS','BND_{}Layer'.format(_Slv_Xgate2_PMOS_XVT))
        target_coordy = tmp1_2[0][0][0][0][0]['_XY_down'][1]
        ...
        _Caculation_Parameters = copy.deepcopy(D02_02_Nor_KJH0._Nor._ParametersForDesignCalculation)
        ## Define Calculation_Parameters ex) _Caculation_Parameters['_PMOSAPOWER_PbodyContact_1_Length']  = _PMOSAPOWER_PbodyContact_1_Length
        _Caculation_Parameters['_NMOSA_NMOSNumberofGate'] = _Slv_Nor2_NMOSA_NumberofGate
        _Caculation_Parameters['_NMOSA_NMOSChannelWidth'] = _Slv_Nor2_NMOSA_Channel_Width
        _Caculation_Parameters['_NMOSA_NMOSChannellength'] = _Slv_Nor2_Channel_Length
        _Caculation_Parameters['_NMOSA_GateSpacing'] = _Slv_Nor2_GateSpacing
        _Caculation_Parameters['_NMOSA_SDWidth'] = _Slv_Nor2_SDWidth
        _Caculation_Parameters['_NMOSA_XVT'] = _Slv_Nor2_NMOS_XVT
        _Caculation_Parameters['_NMOSA_PCCrit'] = _Slv_Nor2_PCCrit
        _Caculation_Parameters['_NMOSA_Source_Via_TF'] = False
        _Caculation_Parameters['_NMOSA_Drain_Via_TF'] = True
        _Caculation_Parameters['_NMOSA_NMOSDummy'] = True
        _Caculation_Parameters['_NMOSA_NMOSDummy_length'] = _Slv_Nor2_NMOSA_Dummy_Length
        _Caculation_Parameters['_NMOSA_NMOSDummy_placement'] = _Slv_Nor2_NMOSA_Dummy_Placement

        _Caculation_Parameters['_NMOSB_NMOSNumberofGate'] = _Slv_Nor2_NMOSB_NumberofGate
        _Caculation_Parameters['_NMOSB_NMOSChannelWidth'] = _Slv_Nor2_NMOSB_Channel_Width
        _Caculation_Parameters['_NMOSB_NMOSChannellength'] = _Slv_Nor2_Channel_Length
        _Caculation_Parameters['_NMOSB_GateSpacing'] = _Slv_Nor2_GateSpacing
        _Caculation_Parameters['_NMOSB_SDWidth'] = _Slv_Nor2_SDWidth
        _Caculation_Parameters['_NMOSB_XVT'] = _Slv_Nor2_NMOS_XVT
        _Caculation_Parameters['_NMOSB_PCCrit'] = _Slv_Nor2_PCCrit
        _Caculation_Parameters['_NMOSB_Source_Via_TF'] = False
        _Caculation_Parameters['_NMOSB_Drain_Via_TF'] = True
        _Caculation_Parameters['_NMOSB_NMOSDummy'] = True
        _Caculation_Parameters['_NMOSB_NMOSDummy_length'] = _Slv_Nor2_NMOSB_Dummy_Length
        _Caculation_Parameters['_NMOSB_NMOSDummy_placement'] = _Slv_Nor2_NMOSB_Dummy_Placement

        _Caculation_Parameters['_NMOSAB_Pbody_NumCont'] = _DFF_Pbody_NumCont
        _Caculation_Parameters['_NMOSAB_Pbody_XlvtTop2Pdoby'] = _DFF_XlvtTop2Pdoby

        _Caculation_Parameters['_PMOSA_PMOSNumberofGate'] = _Slv_Nor2_PMOSA_NumberofGate
        _Caculation_Parameters['_PMOSA_PMOSChannelWidth'] = _Slv_Nor2_PMOSA_Channel_Width
        _Caculation_Parameters['_PMOSA_PMOSChannellength'] = _Slv_Nor2_Channel_Length
        _Caculation_Parameters['_PMOSA_GateSpacing'] = _Slv_Nor2_GateSpacing
        _Caculation_Parameters['_PMOSA_SDWidth'] = _Slv_Nor2_SDWidth
        _Caculation_Parameters['_PMOSA_XVT'] = _Slv_Nor2_PMOS_XVT
        _Caculation_Parameters['_PMOSA_PCCrit'] = _Slv_Nor2_PCCrit
        _Caculation_Parameters['_PMOSA_Source_Via_TF'] = False
        _Caculation_Parameters['_PMOSA_Drain_Via_TF'] = True
        _Caculation_Parameters['_PMOSA_PMOSDummy'] = True
        _Caculation_Parameters['_PMOSA_PMOSDummy_length'] = _Slv_Nor2_PMOSA_Dummy_Length
        _Caculation_Parameters['_PMOSA_PMOSDummy_placement'] = _Slv_Nor2_PMOSA_Dummy_Placement

        _Caculation_Parameters['_PMOSB_PMOSNumberofGate'] = _Slv_Nor2_PMOSB_NumberofGate
        _Caculation_Parameters['_PMOSB_PMOSChannelWidth'] = _Slv_Nor2_PMOSB_Channel_Width
        _Caculation_Parameters['_PMOSB_PMOSChannellength'] = _Slv_Nor2_Channel_Length
        _Caculation_Parameters['_PMOSB_GateSpacing'] = _Slv_Nor2_GateSpacing
        _Caculation_Parameters['_PMOSB_SDWidth'] = _Slv_Nor2_SDWidth
        _Caculation_Parameters['_PMOSB_XVT'] = _Slv_Nor2_PMOS_XVT
        _Caculation_Parameters['_PMOSB_PCCrit'] = _Slv_Nor2_PCCrit
        _Caculation_Parameters['_PMOSB_Source_Via_TF'] = True
        _Caculation_Parameters['_PMOSB_Drain_Via_TF'] = True
        _Caculation_Parameters['_PMOSB_PMOSDummy'] = True
        _Caculation_Parameters['_PMOSB_PMOSDummy_length'] = _Slv_Nor2_PMOSB_Dummy_Length
        _Caculation_Parameters['_PMOSB_PMOSDummy_placement'] = _Slv_Nor2_PMOSB_Dummy_Placement
        ...
        ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## Inv1: ReSet pre-driver
        ## Copy Calculation_Parameters from low-level-block ex)copy.deepcopy(B16_PMOSA_power_v2._PMOSA_POWER._ParametersForDesignCalculation)
        _Caculation_Parameters = copy.deepcopy(D00_00_Inverter_KJH1._Inverter._ParametersForDesignCalculation)
        ## Define Calculation_Parameters ex) _Caculation_Parameters['_PMOSAPOWER_PbodyContact_1_Length']  = _PMOSAPOWER_PbodyContact_1_Length
        _Caculation_Parameters['_NMOS_NMOSNumberofGate']        = _Slv_Inv1_NumberofGate
        _Caculation_Parameters['_NMOS_NMOSChannelWidth']        = _Slv_Inv1_NMOS_Channel_Width
        _Caculation_Parameters['_NMOS_NMOSChannellength']       = _Slv_Inv1_Channel_Length
        _Caculation_Parameters['_NMOS_GateSpacing']             = _Slv_Inv1_GateSpacing
        _Caculation_Parameters['_NMOS_SDWidth']                 = _Slv_Inv1_SDWidth
        _Caculation_Parameters['_NMOS_XVT']                     = _Slv_Inv1_NMOS_XVT
        _Caculation_Parameters['_NMOS_PCCrit']                  = _Slv_Inv1_PCCrit
        _Caculation_Parameters['_NMOS_Source_Via_TF']           = False
        _Caculation_Parameters['_NMOS_Drain_Via_TF']            = True
        _Caculation_Parameters['_NMOS_NMOSDummy']               = True
        _Caculation_Parameters['_NMOS_NMOSDummy_length']        = _Slv_Inv1_NMOS_Dummy_Length
        _Caculation_Parameters['_NMOS_NMOSDummy_placement']     = _Slv_Inv1_NMOS_Dummy_Placement

        _Caculation_Parameters['_NMOS_Pbody_NumCont']           = _DFF_Pbody_NumCont
        _Caculation_Parameters['_NMOS_Pbody_XlvtTop2Pdoby']     = _DFF_XlvtTop2Pdoby

        _Caculation_Parameters['_PMOS_NMOSNumberofGate']        = _Slv_Inv1_NumberofGate
        _Caculation_Parameters['_PMOS_NMOSChannelWidth']        = _Slv_Inv1_PMOS_Channel_Width
        _Caculation_Parameters['_PMOS_NMOSChannellength']       = _Slv_Inv1_Channel_Length
        _Caculation_Parameters['_PMOS_GateSpacing']             = _Slv_Inv1_GateSpacing
        _Caculation_Parameters['_PMOS_SDWidth']                 = _Slv_Inv1_SDWidth
        _Caculation_Parameters['_PMOS_XVT']                     = _Slv_Inv1_PMOS_XVT
        _Caculation_Parameters['_PMOS_PCCrit']                  = _Slv_Inv1_PCCrit
        _Caculation_Parameters['_PMOS_Source_Via_TF']           = False
        _Caculation_Parameters['_PMOS_Drain_Via_TF']            = True
        _Caculation_Parameters['_PMOS_NMOSDummy']               = True
        _Caculation_Parameters['_PMOS_NMOSDummy_length']        = _Slv_Inv1_PMOS_Dummy_Length
        _Caculation_Parameters['_PMOS_NMOSDummy_placement']     = _Slv_Inv1_PMOS_Dummy_Placement
        ...
        ## Generate Sref: ex)self._DesignParameter['_PMOSA_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_PMOSA_power_v2._PMOSA_POWER( _DesignParameter=None, _Name='{}:PMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_Slv_Inv1'] = self._SrefElementDeclaration(_DesignObj=D00_00_Inverter_KJH1._Inverter(_DesignParameter=None, _Name='{}:SRF_Slv_Inv1'.format(_Name)))[0]
        ...
        _Caculation_Parameters = copy.deepcopy(D00_00_Inverter_KJH1._Inverter._ParametersForDesignCalculation)
        ## Define Calculation_Parameters ex) _Caculation_Parameters['_PMOSAPOWER_PbodyContact_1_Length']  = _PMOSAPOWER_PbodyContact_1_Length
        _Caculation_Parameters['_NMOS_NMOSNumberofGate']        = _Slv_Inv2_NumberofGate
        _Caculation_Parameters['_NMOS_NMOSChannelWidth']        = _Slv_Inv2_NMOS_Channel_Width
        _Caculation_Parameters['_NMOS_NMOSChannellength']       = _Slv_Inv2_Channel_Length
        _Caculation_Parameters['_NMOS_GateSpacing']             = _Slv_Inv2_GateSpacing
        _Caculation_Parameters['_NMOS_SDWidth']                 = _Slv_Inv2_SDWidth
        _Caculation_Parameters['_NMOS_XVT']                     = _Slv_Inv2_NMOS_XVT
        _Caculation_Parameters['_NMOS_PCCrit']                  = _Slv_Inv2_PCCrit
        _Caculation_Parameters['_NMOS_Source_Via_TF']           = False
        _Caculation_Parameters['_NMOS_Drain_Via_TF']            = True
        _Caculation_Parameters['_NMOS_NMOSDummy']               = True
        _Caculation_Parameters['_NMOS_NMOSDummy_length']        = _Slv_Inv2_NMOS_Dummy_Length
        _Caculation_Parameters['_NMOS_NMOSDummy_placement']     = _Slv_Inv2_NMOS_Dummy_Placement

        _Caculation_Parameters['_NMOS_Pbody_NumCont']           = _DFF_Pbody_NumCont
        _Caculation_Parameters['_NMOS_Pbody_XlvtTop2Pdoby']     = _DFF_XlvtTop2Pdoby

        _Caculation_Parameters['_PMOS_NMOSNumberofGate']        = _Slv_Inv2_NumberofGate
        _Caculation_Parameters['_PMOS_NMOSChannelWidth']        = _Slv_Inv2_PMOS_Channel_Width
        _Caculation_Parameters['_PMOS_NMOSChannellength']       = _Slv_Inv2_Channel_Length
        _Caculation_Parameters['_PMOS_GateSpacing']             = _Slv_Inv2_GateSpacing
        _Caculation_Parameters['_PMOS_SDWidth']                 = _Slv_Inv2_SDWidth
        _Caculation_Parameters['_PMOS_XVT']                     = _Slv_Inv2_PMOS_XVT
        _Caculation_Parameters['_PMOS_PCCrit']                  = _Slv_Inv2_PCCrit
        _Caculation_Parameters['_PMOS_Source_Via_TF']           = False
        _Caculation_Parameters['_PMOS_Drain_Via_TF']            = True
        _Caculation_Parameters['_PMOS_NMOSDummy']               = True
        _Caculation_Parameters['_PMOS_NMOSDummy_length']        = _Slv_Inv2_PMOS_Dummy_Length
        _Caculation_Parameters['_PMOS_NMOSDummy_placement']     = _Slv_Inv2_PMOS_Dummy_Placement
        ...
        ## Generate Sref: ex)self._DesignParameter['_PMOSA_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_PMOSA_power_v2._PMOSA_POWER( _DesignParameter=None, _Name='{}:PMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_Slv_Inv2'] = self._SrefElementDeclaration(_DesignObj=D00_00_Inverter_KJH1._Inverter(_DesignParameter=None, _Name='{}:SRF_Slv_Inv2'.format(_Name)))[0]
        ...
        _Caculation_Parameters = copy.deepcopy(D00_00_Inverter_KJH1._Inverter._ParametersForDesignCalculation)
        ## Define Calculation_Parameters ex) _Caculation_Parameters['_PMOSAPOWER_PbodyContact_1_Length']  = _PMOSAPOWER_PbodyContact_1_Length
        _Caculation_Parameters['_NMOS_NMOSNumberofGate']        = _Qb_Inv3_NumberofGate
        _Caculation_Parameters['_NMOS_NMOSChannelWidth']        = _Qb_Inv3_NMOS_Channel_Width
        _Caculation_Parameters['_NMOS_NMOSChannellength']       = _Qb_Inv3_Channel_Length
        _Caculation_Parameters['_NMOS_GateSpacing']             = _Qb_Inv3_GateSpacing
        _Caculation_Parameters['_NMOS_SDWidth']                 = _Qb_Inv3_SDWidth
        _Caculation_Parameters['_NMOS_XVT']                     = _Qb_Inv3_NMOS_XVT
        _Caculation_Parameters['_NMOS_PCCrit']                  = _Qb_Inv3_PCCrit
        _Caculation_Parameters['_NMOS_Source_Via_TF']           = False
        _Caculation_Parameters['_NMOS_Drain_Via_TF']            = True
        _Caculation_Parameters['_NMOS_NMOSDummy']               = True
        _Caculation_Parameters['_NMOS_NMOSDummy_length']        = _Qb_Inv3_NMOS_Dummy_Length
        _Caculation_Parameters['_NMOS_NMOSDummy_placement']     = _Qb_Inv3_NMOS_Dummy_Placement

        _Caculation_Parameters['_NMOS_Pbody_NumCont']           = _DFF_Pbody_NumCont
        _Caculation_Parameters['_NMOS_Pbody_XlvtTop2Pdoby']     = _DFF_XlvtTop2Pdoby

        _Caculation_Parameters['_PMOS_NMOSNumberofGate']        = _Qb_Inv3_NumberofGate
        _Caculation_Parameters['_PMOS_NMOSChannelWidth']        = _Qb_Inv3_PMOS_Channel_Width
        _Caculation_Parameters['_PMOS_NMOSChannellength']       = _Qb_Inv3_Channel_Length
        _Caculation_Parameters['_PMOS_GateSpacing']             = _Qb_Inv3_GateSpacing
        _Caculation_Parameters['_PMOS_SDWidth']                 = _Qb_Inv3_SDWidth
        _Caculation_Parameters['_PMOS_XVT']                     = _Qb_Inv3_PMOS_XVT
        _Caculation_Parameters['_PMOS_PCCrit']                  = _Qb_Inv3_PCCrit
        _Caculation_Parameters['_PMOS_Source_Via_TF']           = False
        _Caculation_Parameters['_PMOS_Drain_Via_TF']            = True
        _Caculation_Parameters['_PMOS_NMOSDummy']               = True
        _Caculation_Parameters['_PMOS_NMOSDummy_length']        = _Qb_Inv3_PMOS_Dummy_Length
        _Caculation_Parameters['_PMOS_NMOSDummy_placement']     = _Qb_Inv3_PMOS_Dummy_Placement
        ...
        ## Generate Sref: ex)self._DesignParameter['_PMOSA_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_PMOSA_power_v2._PMOSA_POWER( _DesignParameter=None, _Name='{}:PMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_Qb_Inv3'] = self._SrefElementDeclaration(_DesignObj=D00_00_Inverter_KJH1._Inverter(_DesignParameter=None, _Name='{}:SRF_Qb_Inv3'.format(_Name)))[0]

        ## Define Sref Reflection: ex)self._DesignParameter['_PMOSA_POWER']['_Reflect'] = [0, 0, 0]
        self._DesignParameter['SRF_Qb_Inv3']['_Reflect'] = [0, 0, 0]

        ## Define Sref Angle: ex)'_PMOSA_POWER'
        self._DesignParameter['SRF_Qb_Inv3']['_Angle'] = 0

        ## Calculate Sref Layer by using Calculation_Parameter: ex)'_PMOSA_POWER'
        self._DesignParameter['SRF_Qb_Inv3']['_DesignObj']._CalculateDesignParameter(**_Caculation_Parameters)

        ## Define Sref _XYcoordinate: ex)'_PMOSA_POWER'
        self._DesignParameter['SRF_Qb_Inv3']['_XYCoordinates'] = [[0, 0]]
        ...
        target_coordx = tmp1_1[0][0][-1][0]['_XY_right'][0]
                                ##y
        tmp1_2 = self.get_param_KJH4('SRF_Slv_Inv2','SRF_PMOS','BND_{}Layer'.format(_Slv_Inv2_PMOS_XVT))
        target_coordy = tmp1_2[0][0][0][0]['_XY_down'][1]

        target_coord = [target_coordx,target_coordy]
                            ## Approaching_coord: _XY_type2
                                ##X
        tmp2_1 = self.get_param_KJH4('SRF_Qb_Inv3','SRF_PMOS','BND_PODummyLayer')
        approaching_coordx = tmp2_1[0][0][0][0]['_XY_left'][0]
                                ##Y
        tmp2_2 = self.get_param_KJH4('SRF_Qb_Inv3','SRF_PMOS','BND_{}Layer'.format(_Qb_Inv3_PMOS_XVT))
        approaching_coordy = tmp2_2[0][0][0][0]['_XY_down'][1]

        approaching_coord = [approaching_coordx,approaching_coordy]
                            ## Sref coord
        tmp3 = self.get_param_KJH4('SRF_Qb_Inv3')
        Scoord = tmp3[0][0]['_XY_origin']
                            ## Cal
        New_Scoord = self.get_Scoord_KJH4(target_coord, approaching_coord, Scoord)
        New_Scoord[0] = New_Scoord[0] +  _Test_distance
        tmpXY.append(New_Scoord)
                    ## Define Coordinates
        self._DesignParameter['SRF_Qb_Inv3']['_XYCoordinates'] = tmpXY


        ## Find XvtTop2Pbody_tmp and XvtDown2Nbody_tmp
        tmp1 = self.get_param_KJH4('SRF_Qb_Inv3','SRF_PMOS','BND_{}Layer'.format(_Qb_Inv3_PMOS_XVT))
        tmp2 = self.get_param_KJH4('SRF_Qb_Inv3','SRF_Nbody', 'SRF_NbodyContactPhyLen', 'BND_Met1Layer')
        XvtDown2Nbody_tmp = abs( tmp2[0][0][0][0][0]['_XY_down'][1] - tmp1[0][0][0][0]['_XY_down'][1] )

        if XvtDown2Nbody_tmp > XvtDown2Nbody:
            XvtDown2Nbody = XvtDown2Nbody_tmp

        tmp3 =  self.get_param_KJH4('SRF_Qb_Inv3','SRF_NMOS','BND_{}Layer'.format(_Qb_Inv3_NMOS_XVT))
        tmp4 =  self.get_param_KJH4('SRF_Qb_Inv3', 'SRF_Pbody', 'SRF_PbodyContactPhyLen', 'BND_Met1Layer')
        XvtTop2Pbody_tmp = abs( tmp3[0][0][0][0]['_XY_up'][1] - tmp4[0][0][0][0][0]['_XY_up'][1]  )
        ...
        ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## Apply PMOS XvtTop2Pbody and NMOS XvtDown2Nbody
        ...
        _Caculation_Parameters['_NMOS_NMOSDummy_placement'] = _Mst_Xgate1_NMOSDummy_Placement
        _Caculation_Parameters['_NMOS_Pbody_NumCont'] = _DFF_Pbody_NumCont
        _Caculation_Parameters['_NMOS_Pbody_XlvtTop2Pdoby'] = XvtTop2Pbody
        ...
        _Caculation_Parameters['_PMOS_PMOSDummy_placement'] = _Mst_Xgate1_PMOSDummy_Placement
        _Caculation_Parameters['_PMOS_Nbody_NumCont'] = _DFF_Nbody_NumCont
        _Caculation_Parameters['_PMOS_Nbody_Xlvtdown2Ndoby'] = XvtDown2Nbody

        _Caculation_Parameters['_PMOSXvt2NMOSXvt'] = _DFF_PMOSXvt2NMOSXvt

        ## Generate Sref: ex)self._DesignParameter['_PMOSA_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_PMOSA_power_v2._PMOSA_POWER( _DesignParameter=None, _Name='{}:PMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_Mst_Xgate1'] = self._SrefElementDeclaration(
            _DesignObj=D01_02_Xgate_KJH1._Xgate(_DesignParameter=None, _Name='{}:SRF_Mst_Xgate1'.format(_Name)))[0]
        ...
        ## Generate Sref: ex)self._DesignParameter['_PMOSA_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_PMOSA_power_v2._PMOSA_POWER( _DesignParameter=None, _Name='{}:PMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_Mst_Xgate2'] = self._SrefElementDeclaration(
            _DesignObj=D01_02_Xgate_KJH1._Xgate(_DesignParameter=None, _Name='{}:SRF_Mst_Xgate2'.format(_Name)))[0]
        ...
        target_coordx = tmp1_1[0][0][0][-1][0]['_XY_right'][0]
        ##y
        tmp1_2 = self.get_param_KJH4('SRF_Mst_Xgate1', 'SRF_PMOS', 'SRF_PMOS',
        ...
        approaching_coordx = tmp2_1[0][0][0][-1][0]['_XY_right'][0]
        ##Y
        tmp2_2 = self.get_param_KJH4('SRF_Mst_Xgate2', 'SRF_PMOS', 'SRF_PMOS',
                                     'BND_{}Layer'.format(_Mst_Xgate2_PMOS_XVT))
        approaching_coordy = tmp2_2[0][0][0][0][0]['_XY_down'][1]
        ...
        _Caculation_Parameters['_NMOSAB_Pbody_NumCont'] = _DFF_Pbody_NumCont
        _Caculation_Parameters['_NMOSAB_Pbody_XlvtTop2Pdoby'] = XvtTop2Pbody
        ...
        _Caculation_Parameters['_PMOSAB_Nbody_NumCont'] = _DFF_Nbody_NumCont
        _Caculation_Parameters['_PMOSAB_Nbody_Xlvtdown2Ndoby'] = XvtDown2Nbody

        _Caculation_Parameters['_PMOSXvt2NMOSXvt'] = _DFF_PMOSXvt2NMOSXvt

        ## Generate Sref: ex)self._DesignParameter['_PMOSA_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_PMOSA_power_v2._PMOSA_POWER( _DesignParameter=None, _Name='{}:PMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_Mst_Nor1'] = self._SrefElementDeclaration(
            _DesignObj=D02_02_Nor_KJH0._Nor(_DesignParameter=None, _Name='{}:SRF_Mst_Nor1'.format(_Name)))[0]
        ...
        target_coordx = tmp1_1[0][0][0][0][0]['_XY_left'][0]
        ##y
        tmp1_2 = self.get_param_KJH4('SRF_Mst_Xgate2', 'SRF_PMOS', 'SRF_PMOS',
                                     'BND_{}Layer'.format(_Mst_Xgate2_PMOS_XVT))
        target_coordy = tmp1_2[0][0][0][0][0]['_XY_down'][1]
        ...
        approaching_coordx = tmp2_1[0][0][0][0][0]['_XY_left'][0]
        ##Y
        tmp2_2 = self.get_param_KJH4('SRF_Mst_Nor1', 'SRF_Pullup', 'SRF_PMOSA',
                                     'BND_{}Layer'.format(_Mst_Nor1_PMOS_XVT))
        approaching_coordy = tmp2_2[0][0][0][0][0]['_XY_down'][1]
        ...
        ## Generate Sref: ex)self._DesignParameter['_PMOSA_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_PMOSA_power_v2._PMOSA_POWER( _DesignParameter=None, _Name='{}:PMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_Mst_Nor2'] = self._SrefElementDeclaration(
            _DesignObj=D02_02_Nor_KJH0._Nor(_DesignParameter=None, _Name='{}:SRF_Mst_Nor2'.format(_Name)))[0]
        ...
        target_coordx = tmp1_1[0][0][0][-1][0]['_XY_right'][0]
        ##y
        tmp1_2 = self.get_param_KJH4('SRF_Mst_Nor1', 'SRF_Pullup', 'SRF_PMOSB',
                                     'BND_{}Layer'.format(_Mst_Nor1_PMOS_XVT))
        target_coordy = tmp1_2[0][0][0][0][0]['_XY_down'][1]
        ...
        approaching_coordx = tmp2_1[0][0][0][0][0]['_XY_left'][0]
        ##Y
        tmp2_2 = self.get_param_KJH4('SRF_Mst_Nor2', 'SRF_Pullup', 'SRF_PMOSA',
                                     'BND_{}Layer'.format(_Mst_Nor2_PMOS_XVT))
        approaching_coordy = tmp2_2[0][0][0][0][0]['_XY_down'][1]
        ...
        target_coordx = tmp1_1[0][0][0][-1][0]['_XY_right'][0]
        ##y
        tmp1_2 = self.get_param_KJH4('SRF_Mst_Nor2', 'SRF_Pullup', 'SRF_PMOSB',
                                     'BND_{}Layer'.format(_Mst_Nor2_PMOS_XVT))
        target_coordy = tmp1_2[0][0][0][0][0]['_XY_down'][1]
        ...
        ## Generate Sref: ex)self._DesignParameter['_PMOSA_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_PMOSA_power_v2._PMOSA_POWER( _DesignParameter=None, _Name='{}:PMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_Mst_Inv2'] = self._SrefElementDeclaration(
            _DesignObj=D00_00_Inverter_KJH1._Inverter(_DesignParameter=None, _Name='{}:SRF_Mst_Inv2'.format(_Name)))[0]
        ...
        ## Generate Sref: ex)self._DesignParameter['_PMOSA_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_PMOSA_power_v2._PMOSA_POWER( _DesignParameter=None, _Name='{}:PMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_Clk_Inv3'] = self._SrefElementDeclaration(
            _DesignObj=D00_00_Inverter_KJH1._Inverter(_DesignParameter=None, _Name='{}:SRF_Clk_Inv3'.format(_Name)))[0]
        ...
        ## Generate Sref: ex)self._DesignParameter['_PMOSA_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_PMOSA_power_v2._PMOSA_POWER( _DesignParameter=None, _Name='{}:PMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_Slv_Xgate1'] = self._SrefElementDeclaration(
            _DesignObj=D01_02_Xgate_KJH1._Xgate(_DesignParameter=None, _Name='{}:SRF_Slv_Xgate1'.format(_Name)))[0]
        ...
        approaching_coordx = tmp2_1[0][0][0][0][0]['_XY_left'][0]
        ##Y
        tmp2_2 = self.get_param_KJH4('SRF_Slv_Xgate1', 'SRF_PMOS', 'SRF_PMOS',
                                     'BND_{}Layer'.format(_Slv_Xgate1_PMOS_XVT))
        approaching_coordy = tmp2_2[0][0][0][0][0]['_XY_down'][1]
        ...
        ## Generate Sref: ex)self._DesignParameter['_PMOSA_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_PMOSA_power_v2._PMOSA_POWER( _DesignParameter=None, _Name='{}:PMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_Slv_Xgate2'] = self._SrefElementDeclaration(
            _DesignObj=D01_02_Xgate_KJH1._Xgate(_DesignParameter=None, _Name='{}:SRF_Slv_Xgate2'.format(_Name)))[0]
        ...
        target_coordx = tmp1_1[0][0][0][-1][0]['_XY_right'][0]
        ##y
        tmp1_2 = self.get_param_KJH4('SRF_Slv_Xgate1', 'SRF_PMOS', 'SRF_PMOS',
                                     'BND_{}Layer'.format(_Slv_Xgate1_PMOS_XVT))
        target_coordy = tmp1_2[0][0][0][0][0]['_XY_down'][1]
        ...
        approaching_coordx = tmp2_1[0][0][0][-1][0]['_XY_right'][0]
        ##Y
        tmp2_2 = self.get_param_KJH4('SRF_Slv_Xgate2', 'SRF_PMOS', 'SRF_PMOS',
                                     'BND_{}Layer'.format(_Slv_Xgate2_PMOS_XVT))
        approaching_coordy = tmp2_2[0][0][0][0][0]['_XY_down'][1]
        ...
        ## Generate Sref: ex)self._DesignParameter['_PMOSA_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_PMOSA_power_v2._PMOSA_POWER( _DesignParameter=None, _Name='{}:PMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_Slv_Nor1'] = self._SrefElementDeclaration(
            _DesignObj=D02_02_Nor_KJH0._Nor(_DesignParameter=None, _Name='{}:SRF_Slv_Nor1'.format(_Name)))[0]
        ...
        target_coordx = tmp1_1[0][0][0][0][0]['_XY_left'][0]
        ##y
        tmp1_2 = self.get_param_KJH4('SRF_Slv_Xgate2', 'SRF_PMOS', 'SRF_PMOS',
                                     'BND_{}Layer'.format(_Slv_Xgate2_PMOS_XVT))
        target_coordy = tmp1_2[0][0][0][0][0]['_XY_down'][1]
        ...
        approaching_coordx = tmp2_1[0][0][0][0][0]['_XY_left'][0]
        ##Y
        tmp2_2 = self.get_param_KJH4('SRF_Slv_Nor1', 'SRF_Pullup', 'SRF_PMOSA',
                                     'BND_{}Layer'.format(_Slv_Nor1_PMOS_XVT))
        approaching_coordy = tmp2_2[0][0][0][0][0]['_XY_down'][1]
        ...
        ## Generate Sref: ex)self._DesignParameter['_PMOSA_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_PMOSA_power_v2._PMOSA_POWER( _DesignParameter=None, _Name='{}:PMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_Slv_Nor2'] = self._SrefElementDeclaration(
            _DesignObj=D02_02_Nor_KJH0._Nor(_DesignParameter=None, _Name='{}:SRF_Slv_Nor2'.format(_Name)))[0]
        ...
        target_coordx = tmp1_1[0][0][0][-1][0]['_XY_right'][0]
        ##y
        tmp1_2 = self.get_param_KJH4('SRF_Slv_Nor1', 'SRF_Pullup', 'SRF_PMOSB',
                                     'BND_{}Layer'.format(_Slv_Nor1_PMOS_XVT))
        target_coordy = tmp1_2[0][0][0][0][0]['_XY_down'][1]
        ...
        approaching_coordx = tmp2_1[0][0][0][0][0]['_XY_left'][0]
        ##Y
        tmp2_2 = self.get_param_KJH4('SRF_Slv_Nor2', 'SRF_Pullup', 'SRF_PMOSA',
                                     'BND_{}Layer'.format(_Slv_Nor2_PMOS_XVT))
        approaching_coordy = tmp2_2[0][0][0][0][0]['_XY_down'][1]
        ...
        ## Generate Sref: ex)self._DesignParameter['_PMOSA_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_PMOSA_power_v2._PMOSA_POWER( _DesignParameter=None, _Name='{}:PMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_Slv_Inv1'] = self._SrefElementDeclaration(
            _DesignObj=D00_00_Inverter_KJH1._Inverter(_DesignParameter=None, _Name='{}:SRF_Slv_Inv1'.format(_Name)))[0]
        ...
        target_coordx = tmp1_1[0][0][0][-1][0]['_XY_right'][0]
        ##y
        tmp1_2 = self.get_param_KJH4('SRF_Slv_Nor2', 'SRF_Pullup', 'SRF_PMOSB',
                                     'BND_{}Layer'.format(_Slv_Nor2_PMOS_XVT))
        target_coordy = tmp1_2[0][0][0][0][0]['_XY_down'][1]
        ...
        ## Generate Sref: ex)self._DesignParameter['_PMOSA_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_PMOSA_power_v2._PMOSA_POWER( _DesignParameter=None, _Name='{}:PMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_Slv_Inv2'] = self._SrefElementDeclaration(
            _DesignObj=D00_00_Inverter_KJH1._Inverter(_DesignParameter=None, _Name='{}:SRF_Slv_Inv2'.format(_Name)))[0]
        ...
        ## Generate Sref: ex)self._DesignParameter['_PMOSA_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_PMOSA_power_v2._PMOSA_POWER( _DesignParameter=None, _Name='{}:PMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_Qb_Inv3'] = self._SrefElementDeclaration(
            _DesignObj=D00_00_Inverter_KJH1._Inverter(_DesignParameter=None, _Name='{}:SRF_Qb_Inv3'.format(_Name)))[0]
...
if __name__ == '__main__':
    ...
    cellname = 'D04_00_SetRstDFF_v0_67'
    ...
    ## Master Nor1
        ...
        _Mst_Nor1_PMOSA_Channel_Width = 400, # number
        _Mst_Nor1_PMOSA_Dummy_Length = None, # None/number
        _Mst_Nor1_PMOSA_Dummy_Placement = None, # None/'Up'/'Dn'
            ## PMOSB
        _Mst_Nor1_PMOSB_NumberofGate=4,
        _Mst_Nor1_PMOSB_Channel_Width = 400, # number
        _Mst_Nor1_PMOSB_Dummy_Length = None, # None/number
        _Mst_Nor1_PMOSB_Dummy_Placement = None, # None/'Up'/'Dn'
    ...
    ## Master Nor2
        ...
        _Mst_Nor2_PMOSA_Channel_Width = 400, # number
        _Mst_Nor2_PMOSA_Dummy_Length = None, # None/number
        _Mst_Nor2_PMOSA_Dummy_Placement = None, # None/'Up'/'Dn'
            ## PMOSB
        _Mst_Nor2_PMOSB_NumberofGate=4,
        _Mst_Nor2_PMOSB_Channel_Width = 400, # number
        _Mst_Nor2_PMOSB_Dummy_Length = None, # None/number
        _Mst_Nor2_PMOSB_Dummy_Placement = None, # None/'Up'/'Dn'
    ...
    ## Slave Nor1
        ...
        _Slv_Nor1_PMOSA_Channel_Width = 400, # number
        _Slv_Nor1_PMOSA_Dummy_Length = None, # None/number
        _Slv_Nor1_PMOSA_Dummy_Placement = None, # None/'Up'/'Dn'
            ## PMOSB
        _Slv_Nor1_PMOSB_NumberofGate=4,
        _Slv_Nor1_PMOSB_Channel_Width = 400, # number
        _Slv_Nor1_PMOSB_Dummy_Length = None, # None/number
        _Slv_Nor1_PMOSB_Dummy_Placement = None, # None/'Up'/'Dn'
    ...
    ## Slave Nor2
        ...
        _Slv_Nor2_PMOSA_Channel_Width = 400, # number
        _Slv_Nor2_PMOSA_Dummy_Length = None, # None/number
        _Slv_Nor2_PMOSA_Dummy_Placement = None, # None/'Up'/'Dn'
            ## PMOSB
        _Slv_Nor2_PMOSB_NumberofGate=4,
        _Slv_Nor2_PMOSB_Channel_Width = 400, # number
        _Slv_Nor2_PMOSB_Dummy_Length = None, # None/number
        _Slv_Nor2_PMOSB_Dummy_Placement = None, # None/'Up'/'Dn'
