...
## ########################################################################################################################################################## Class_HEADER
class _NmosWithDummy_KJH2(StickDiagram_KJH1._StickDiagram_KJH):
...
if __name__ == '__main__':
    ...
    libname = 'Proj_ADC_A_building_block_Nmoswithdummy_v1'
...
_NMOSDummy_placement = None, #None/'Up'/'Dn'/
    ...
    LayoutObj = _NmosWithDummy_KJH2(_DesignParameter=None, _Name=cellname)
