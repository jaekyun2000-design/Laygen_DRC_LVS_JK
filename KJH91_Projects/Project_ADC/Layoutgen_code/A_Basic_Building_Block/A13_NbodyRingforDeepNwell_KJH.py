...
## ########################################################################################################################################################## Class_HEADER
class _NbodyRingforDeepNwell_KJH(StickDiagram_KJH1._StickDiagram_KJH):
...
_NwellWidth         = None,  # Number
        ...
        _Caculation_Parameters = copy.deepcopy( A12_NbodyContactPhyLenforDeepNwell_KJH._NbodyContactPhyLenforDeepNwell_KJH._ParametersForDesignCalculation)
        ...
        #Generate Sref
        self._DesignParameter['SRF_NbodyTop'] = self._SrefElementDeclaration(_DesignObj=A12_NbodyContactPhyLenforDeepNwell_KJH._NbodyContactPhyLenforDeepNwell_KJH( _DesignParameter=None, _Name='{}:SRF_NbodyTop'.format(_Name)))[0]
        ...
        #Generate Sref
        self._DesignParameter['SRF_NbodyBottom'] = self._SrefElementDeclaration(_DesignObj=A12_NbodyContactPhyLenforDeepNwell_KJH._NbodyContactPhyLenforDeepNwell_KJH( _DesignParameter=None, _Name='{}:SRF_NbodyBottom'.format(_Name)))[0]
        ...
        #Generate Sref
        self._DesignParameter['SRF_NbodyLeft'] = self._SrefElementDeclaration(_DesignObj=A12_NbodyContactPhyLenforDeepNwell_KJH._NbodyContactPhyLenforDeepNwell_KJH( _DesignParameter=None, _Name='{}:SRF_NbodyLeft'.format(_Name)))[0]
        ...
        #Generate Sref
        self._DesignParameter['SRF_NbodyRight'] = self._SrefElementDeclaration(_DesignObj=A12_NbodyContactPhyLenforDeepNwell_KJH._NbodyContactPhyLenforDeepNwell_KJH( _DesignParameter=None, _Name='{}:SRF_NbodyRight'.format(_Name)))[0]
...
if __name__ == '__main__':
    ...
    cellname = 'A13_NbodyRingforDeepNwell_KJH_97'
...
_NwellWidth         = 1000, #Number
    ...
    LayoutObj = _NbodyRingforDeepNwell_KJH(_DesignParameter=None, _Name=cellname)
