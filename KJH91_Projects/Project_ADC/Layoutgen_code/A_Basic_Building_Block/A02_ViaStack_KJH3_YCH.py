...
## ########################################################################################################################################################## Class_HEADER
class _ViaStack(StickDiagram_KJH1._StickDiagram_KJH):
...
_COY=None,
        ...
        if 0 >= _Layer1 and 0 < _Layer2 :
            ...
            _Caculation_Parameters = copy.deepcopy( A02_ViaM0toM1_KJH3._ViaM0toM1_KJH._ParametersForDesignCalculation)
            _Caculation_Parameters['_COX']  = _COX
            _Caculation_Parameters['_COY']  = _COY

            #Generate Sref
            self._DesignParameter['SRF_ViaM0M1'] = self._SrefElementDeclaration(_DesignObj=A02_ViaM0toM1_KJH3._ViaM0toM1_KJH( _DesignParameter=None, _Name='{}:SRF_ViaM0M1'.format(_Name)))[0]
        ...
        if 1 >= _Layer1 and 1 < _Layer2 :
            ## ################################################################################################################### Gen ViaM1M2
            #Define Calculation_Parameters
            _Caculation_Parameters = copy.deepcopy( A02_ViaM1toM2_KJH3._ViaM1toM2_KJH._ParametersForDesignCalculation)
            _Caculation_Parameters['_COX']  = _COX
            _Caculation_Parameters['_COY']  = _COY

            #Generate Sref
            self._DesignParameter['SRF_ViaM1M2'] = self._SrefElementDeclaration(_DesignObj=A02_ViaM1toM2_KJH3._ViaM1toM2_KJH( _DesignParameter=None, _Name='{}:SRF_ViaM1M2'.format(_Name)))[0]
        ...
        if 2 >= _Layer1 and 2 < _Layer2 :
            ## ################################################################################################################### Gen ViaM2M3
            #Define Calculation_Parameters
            _Caculation_Parameters = copy.deepcopy( A02_ViaM2toM3_KJH3._ViaM2toM3_KJH._ParametersForDesignCalculation)
            _Caculation_Parameters['_COX']  = _COX
            _Caculation_Parameters['_COY']  = _COY

            #Generate Sref
            self._DesignParameter['SRF_ViaM2M3'] = self._SrefElementDeclaration(_DesignObj=A02_ViaM2toM3_KJH3._ViaM2toM3_KJH( _DesignParameter=None, _Name='{}:SRF_ViaM2M3'.format(_Name)))[0]
        ...
        if 3 >= _Layer1 and 3 < _Layer2 :
            ## ################################################################################################################### Gen ViaM3M4
            #Define Calculation_Parameters
            _Caculation_Parameters = copy.deepcopy( A02_ViaM3toM4_KJH3._ViaM3toM4_KJH._ParametersForDesignCalculation)
            _Caculation_Parameters['_COX']  = _COX
            _Caculation_Parameters['_COY']  = _COY

            #Generate Sref
            self._DesignParameter['SRF_ViaM3M4'] = self._SrefElementDeclaration(_DesignObj=A02_ViaM3toM4_KJH3._ViaM3toM4_KJH( _DesignParameter=None, _Name='{}:SRF_ViaM3M4'.format(_Name)))[0]
        ...
        if 4 >= _Layer1 and 4 < _Layer2 :
            ## ################################################################################################################### Gen ViaM4M5
            #Define Calculation_Parameters
            _Caculation_Parameters = copy.deepcopy( A02_ViaM4toM5_KJH3._ViaM4toM5_KJH._ParametersForDesignCalculation)
            _Caculation_Parameters['_COX']  = _COX
            _Caculation_Parameters['_COY']  = _COY

            #Generate Sref
            self._DesignParameter['SRF_ViaM4M5'] = self._SrefElementDeclaration(_DesignObj=A02_ViaM4toM5_KJH3._ViaM4toM5_KJH( _DesignParameter=None, _Name='{}:SRF_ViaM4M5'.format(_Name)))[0]
        ...
        if 5 >= _Layer1 and 5 < _Layer2 :
            ## ################################################################################################################### Gen ViaM5M6
            #Define Calculation_Parameters
            _Caculation_Parameters = copy.deepcopy( A02_ViaM5toM6_KJH3._ViaM5toM6_KJH._ParametersForDesignCalculation)
            _Caculation_Parameters['_COX']  = _COX
            _Caculation_Parameters['_COY']  = _COY

            #Generate Sref
            self._DesignParameter['SRF_ViaM5M6'] = self._SrefElementDeclaration(_DesignObj=A02_ViaM5toM6_KJH3._ViaM5toM6_KJH( _DesignParameter=None, _Name='{}:SRF_ViaM5M6'.format(_Name)))[0]
        ...
        if 6 >= _Layer1 and 6 < _Layer2 :
            ## ################################################################################################################### Gen ViaM6M7
            #Define Calculation_Parameters
            _Caculation_Parameters = copy.deepcopy( A02_ViaM6toM7_KJH3._ViaM6toM7_KJH._ParametersForDesignCalculation)
            _Caculation_Parameters['_COX']  = _COX
            _Caculation_Parameters['_COY']  = _COY

            #Generate Sref
            self._DesignParameter['SRF_ViaM6M7'] = self._SrefElementDeclaration(_DesignObj=A02_ViaM6toM7_KJH3._ViaM6toM7_KJH( _DesignParameter=None, _Name='{}:SRF_ViaM6M7'.format(_Name)))[0]
        ...
        if 7 >= _Layer1 and 7 < _Layer2 :
            ## ################################################################################################################### Gen ViaM7M8
            #Define Calculation_Parameters
            _Caculation_Parameters = copy.deepcopy( A02_ViaM7toM8_KJH3._ViaM7toM8_KJH._ParametersForDesignCalculation)
            _Caculation_Parameters['_COX']  = _COX
            _Caculation_Parameters['_COY']  = _COY

            #Generate Sref
            self._DesignParameter['SRF_ViaM7M8'] = self._SrefElementDeclaration(_DesignObj=A02_ViaM7toM8_KJH3._ViaM7toM8_KJH( _DesignParameter=None, _Name='{}:SRF_ViaM7M8'.format(_Name)))[0]
...
if __name__ == '__main__':
    ...
    libname = 'ZZ_test_tsmc28'
    cellname = 'Viastack_v1'
