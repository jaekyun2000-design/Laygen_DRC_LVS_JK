...
from KJH91_Projects.Project_ADC.Layoutgen_code.A_Basic_Building_Block import A50_TIA_P1_random
from KJH91_Projects.Project_ADC.Layoutgen_code.A_Basic_Building_Block import A50_TIA_P2_random
from KJH91_Projects.Project_ADC.Layoutgen_code.A_Basic_Building_Block import A50_TIA_P4_random
...
class _TIA_P1P2P4_YCH(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        _Caculation_Parameters = copy.deepcopy(A50_TIA_P4_random._TIA_P4_YCH._ParametersForDesignCalculation)
        ...
        self._DesignParameter['SRF_Pmos_Tr4'] = self._SrefElementDeclaration(_DesignObj=A50_TIA_P4_random._TIA_P4_YCH(_DesignParameter=None, _Name='{}:SRF_Pmos_Tr4'.format(_Name)))[0]
        ...
        ## SREF Generation Tr1
        ## Copy Calculation_Parameters from low-level-block ex)copy.deepcopy(B16_nmos_power_v2._NMOS_POWER._ParametersForDesignCalculation)
        _Caculation_Parameters = copy.deepcopy(A50_TIA_P1_random._TIA_P1_YCH._ParametersForDesignCalculation)
        ## Define Calculation_Parameters ex) _Caculation_Parameters['_NMOSPOWER_PbodyContact_1_Length']  = _NMOSPOWER_PbodyContact_1_Length
        ...
        ## Generate Sref: ex)self._DesignParameter['_NMOS_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_nmos_power_v2._NMOS_POWER( _DesignParameter=None, _Name='{}:NMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_Pmos_Tr1'] = self._SrefElementDeclaration(_DesignObj=A50_TIA_P1_random._TIA_P1_YCH(_DesignParameter=None,_Name='{}:SRF_Pmos_Tr1'.format(_Name)))[0]
        ...
        ## SREF Generation Tr2
        ## Copy Calculation_Parameters from low-level-block ex)copy.deepcopy(B16_nmos_power_v2._NMOS_POWER._ParametersForDesignCalculation)
        _Caculation_Parameters = copy.deepcopy(A50_TIA_P2_random._TIA_P2_YCH._ParametersForDesignCalculation)
        ## Define Calculation_Parameters ex) _Caculation_Parameters['_NMOSPOWER_PbodyContact_1_Length']  = _NMOSPOWER_PbodyContact_1_Length
        ...
        self._DesignParameter['SRF_Pmos_Tr2'] = self._SrefElementDeclaration(
            _DesignObj=A50_TIA_P2_random._TIA_P2_YCH(_DesignParameter=None, _Name='{}:SRF_Pmos_Tr2'.format(_Name)))[0]
...
if __name__ == '__main__':
    ...
    for _iter in range(10):
        libname = 'Proj_A51_TIA_P1P2P4_v{}'.format(_iter + 21)
