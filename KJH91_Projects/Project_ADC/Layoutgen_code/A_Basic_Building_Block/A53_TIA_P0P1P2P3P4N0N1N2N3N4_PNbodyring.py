...
from KJH91_Projects.Project_ADC.Layoutgen_code.A_Basic_Building_Block import A52_TIA_P1P2P4_Nbodyring
from KJH91_Projects.Project_ADC.Layoutgen_code.A_Basic_Building_Block import A51_TIA_N2N3
from KJH91_Projects.Project_ADC.Layoutgen_code.A_Basic_Building_Block import A51_TIA_P0P3
from KJH91_Projects.Project_ADC.Layoutgen_code.A_Basic_Building_Block import A51_TIA_N0N1N4
...
class _TIA_P0P1P2P3P4N0N1N2N3N4_PNbodyring_YCH(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        _Caculation_Parameters = copy.deepcopy(A52_TIA_P1P2P4_Nbodyring._TIA_P1P2P4_Nbodyring_YCH._ParametersForDesignCalculation)
        ...
        self._DesignParameter['SRF_Pmos_Tr1Tr2Tr4_Nbodyring'] = self._SrefElementDeclaration(
            _DesignObj=A52_TIA_P1P2P4_Nbodyring._TIA_P1P2P4_Nbodyring_YCH(_DesignParameter=None,_Name='{}:SRF_Pmos_Tr1Tr2Tr4_Nbodyring'.format(_Name)))[0]
        ...
        ## Copy Calculation_Parameters from low-level-block ex)copy.deepcopy(B16_nmos_power_v2._NMOS_POWER._ParametersForDesignCalculation)
        _Caculation_Parameters = copy.deepcopy(A51_TIA_P0P3._TIA_P0P3_YCH._ParametersForDesignCalculation)
        ...
        self._DesignParameter['SRF_Pmos_Tr0Tr3'] = self._SrefElementDeclaration(
            _DesignObj=A51_TIA_P0P3._TIA_P0P3_YCH(_DesignParameter=None,_Name='{}:SRF_Pmos_Tr0Tr3'.format(_Name)))[0]
...
## ################################################################################################################### Nbodyring_P0P3_Nwell_extension
        ...
        ## Copy Calculation_Parameters from low-level-block ex)copy.deepcopy(B16_nmos_power_v2._NMOS_POWER._ParametersForDesignCalculation)
        _Caculation_Parameters = copy.deepcopy(A51_TIA_N2N3._TIA_N2N3_YCH._ParametersForDesignCalculation)
        ## Define Calculation_Parameters ex) _Caculation_Parameters['_NMOSPOWER_PbodyContact_1_Length']  = _NMOSPOWER_PbodyContact_1_Length
        ...
        self._DesignParameter['SRF_Nmos_Tr2Tr3'] = self._SrefElementDeclaration(
            _DesignObj=A51_TIA_N2N3._TIA_N2N3_YCH(_DesignParameter=None, _Name='{}:SRF_Nmos_Tr2Tr3'.format(_Name)))[0]
...
## ################################################################################################################### Pbodyring
        ...
        ## Copy Calculation_Parameters from low-level-block ex)copy.deepcopy(B16_nmos_power_v2._NMOS_POWER._ParametersForDesignCalculation)
        _Caculation_Parameters = copy.deepcopy(A51_TIA_N0N1N4._TIA_N0N1N4_YCH._ParametersForDesignCalculation)
        ## Define Calculation_Parameters ex) _Caculation_Parameters['_NMOSPOWER_PbodyContact_1_Length']  = _NMOSPOWER_PbodyContact_1_Length
        ...
        self._DesignParameter['SRF_Nmos_Tr0Tr1Tr4'] = self._SrefElementDeclaration(
            _DesignObj=A51_TIA_N0N1N4._TIA_N0N1N4_YCH(_DesignParameter=None, _Name='{}:SRF_Nmos_Tr0Tr1Tr4'.format(_Name)))[0]
...
## ################################################################################################################### NMOS2 Drain, NMOS3 Source connect METAL2
        ...
        self._DesignParameter['BND_Metal2Layer_Connect_N2_N3_Drain_Source']['_XWidth'] = (
            abs(tmp2[0][0][0][0][0][-1][0]['_XY_right'][0] - tmp1[0][0][0][0]['_XY_left'][0]))
...
## ################################################################################################################### Metal2 PMOS0 Gate PMOS3 Gate connect
        ...
        # Define Boundary_element _XWidth
        self._DesignParameter['BND_Metal5Layer_Connect_N0_P1_Drain']['_XWidth'] = 1000
        ...
        tmp2 = self.get_param_KJH4('SRF_Pmos_Tr1Tr2Tr4_Nbodyring', 'BND_Metal3Layer_Connect_P1_Drain')
        if (tmp1[0][0][0][0]['_XY_left'][0] > tmp2[0][0][0]['_XY_right'][0]):
            # Define Boundary_element
            ...
            # Define Boundary_element _YWidth
            self._DesignParameter['BND_Metal3Layer_Extension_P1_Drain']['_YWidth'] = tmp1[0][0][0][0]['_Ywidth']
...
## ################################################################################################################### PMOS1,2 Source PMOS0 Drain connect Metal4
        ...
        # Define Boundary_element _YWidth
        self._DesignParameter['BND_Metal3Layer_Connect_N1_Drain_extension']['_YWidth'] = tmp2[0][0][0][0]['_Ywidth']
...
## ################################################################################################################### Cao0, Cap1 portA Pmos4, Nmos4 Drain connect METAL6
        ...
        # Define Boundary_element _YWidth
        self._DesignParameter['BND_Metal3Layer_Connect_N1_extension']['_YWidth'] = tmp1[0][0][0]['_Ywidth']
...
if __name__ == '__main__':
    ...
    libname = 'Proj_A53_TIA_P0P1P2P3P4N0N1N2N3N4_PNbodyring_thesis_v6'
    cellname = 'A53_TIA_P0P1P2P3P4N0N1N2N3N4_PNbodyring'
    _fileName = cellname + '.gds'

    ''' Input Parameters for Layout Object '''
    InputParams = dict(
        # PMOS
        _Tr0_PMOSNumberofGate=10,
        _Tr0_PMOSChannelWidth=12000,
        ...
        # PMOS
        _Tr1_PMOSNumberofGate=40,
        _Tr1_PMOSChannelWidth=9000,
        _Tr1_PMOSChannellength=150,
        _Tr1_PMOSGateSpacing=None,
        _Tr1_PMOSSDWidth	= None,
        _Tr1_PMOSXVT			= 'EG',
        ...
        # PMOS
        _Tr2_PMOSNumberofGate	= 40,
        _Tr2_PMOSChannelWidth	= 9000,
        ...
        # PMOS
        _Tr3_PMOSNumberofGate=1,
        _Tr3_PMOSChannelWidth=12000,
        ...
        # PMOS
        _Tr4_PMOSNumberofGate=15,
        _Tr4_PMOSChannelWidth=9000,
        ...
        # NMOS Tr0
        _Tr0_NMOSNumberofGate=10,
        _Tr0_NMOSChannelWidth=6000,
        _Tr0_NMOSChannellength=150,
        _Tr0_NMOSGateSpacing=None,
        _Tr0_NMOSSDWidth	= None,
        _Tr0_NMOSXVT			= 'EG',
        ...
        # NMOS Tr1
        _Tr1_NMOSNumberofGate=10,
        _Tr1_NMOSChannelWidth=6000,
        _Tr1_NMOSChannellength=150,
        _Tr1_NMOSGateSpacing	= None,
        _Tr1_NMOSSDWidth			= None,
        _Tr1_NMOSXVT				= 'EG',
        ...
        # NMOS
        _Tr2_NMOSNumberofGate=10,
        _Tr2_NMOSChannelWidth=12000,
        _Tr2_NMOSChannellength=150,
        _Tr2_NMOSGateSpacing=None,
        _Tr2_NMOSSDWidth	= None,
        _Tr2_NMOSXVT			= 'EG',
        ...
        # NMOS Tr4
        _Tr4_NMOSNumberofGate=15,
        _Tr4_NMOSChannelWidth=6000,
        _Tr4_NMOSChannellength=150,
        _Tr4_NMOSGateSpacing	= None,
        _Tr4_NMOSSDWidth			= None,
        _Tr4_NMOSXVT				= 'EG',
