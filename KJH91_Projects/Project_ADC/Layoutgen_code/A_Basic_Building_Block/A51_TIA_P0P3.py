...
from KJH91_Projects.Project_ADC.Layoutgen_code.A_Basic_Building_Block import A50_TIA_P0
from KJH91_Projects.Project_ADC.Layoutgen_code.A_Basic_Building_Block import A50_TIA_P3
...
class _TIA_P0P3_YCH(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        _Caculation_Parameters = copy.deepcopy(A50_TIA_P0._TIA_P0_YCH._ParametersForDesignCalculation)
        ...
        self._DesignParameter['SRF_Pmos_Tr0'] = self._SrefElementDeclaration(
            _DesignObj=A50_TIA_P0._TIA_P0_YCH(_DesignParameter=None, _Name='{}:SRF_Pmos_Tr0'.format(_Name)))[0]
        ...
        ## SREF Generation Tr3
        ## Copy Calculation_Parameters from low-level-block ex)copy.deepcopy(B16_nmos_power_v2._NMOS_POWER._ParametersForDesignCalculation)
        _Caculation_Parameters = copy.deepcopy(A50_TIA_P3._TIA_P3_YCH._ParametersForDesignCalculation)
        ## Define Calculation_Parameters ex) _Caculation_Parameters['_NMOSPOWER_PbodyContact_1_Length']  = _NMOSPOWER_PbodyContact_1_Length
        ...
        self._DesignParameter['SRF_Pmos_Tr3'] = self._SrefElementDeclaration(
            _DesignObj=A50_TIA_P3._TIA_P3_YCH(_DesignParameter=None, _Name='{}:SRF_Pmos_Tr3'.format(_Name)))[0]
