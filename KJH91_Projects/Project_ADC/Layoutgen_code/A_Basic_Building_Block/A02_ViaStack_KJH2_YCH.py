...
from KJH91_Projects.Project_ADC.Layoutgen_code.A_Basic_Building_Block import A02_ViaM8toM9_KJH2
...
_COY=None,
        ...
        if 8 >= _Layer1 and 8 < _Layer2:
            ## ################################################################################################################### Gen ViaM8M9
            # Define Calculation_Parameters
            _Caculation_Parameters = copy.deepcopy(A02_ViaM8toM9_KJH2._ViaM8toM9_KJH._ParametersForDesignCalculation)
            _Caculation_Parameters['_COX'] = _COX
            _Caculation_Parameters['_COY'] = _COY

            # Generate Sref
            self._DesignParameter['SRF_ViaM8M9'] = self._SrefElementDeclaration(
                _DesignObj=A02_ViaM8toM9_KJH2._ViaM8toM9_KJH(_DesignParameter=None,
                                                             _Name='{}:SRF_ViaM8M9'.format(_Name)))[0]

            # Define Sref Relection
            self._DesignParameter['SRF_ViaM8M9']['_Reflect'] = [0, 0, 0]

            # Define Sref Angle
            self._DesignParameter['SRF_ViaM8M9']['_Angle'] = 0

            # Calculate Sref Layer by using Calculation_Parameter
            self._DesignParameter['SRF_ViaM8M9']['_DesignObj']._CalculateDesignParameter(**_Caculation_Parameters)

            # Define Sref _XYcoordinate
            self._DesignParameter['SRF_ViaM8M9']['_XYCoordinates'] = [[0, 0]]
            ...
            target_coord = CenterCoord
            ## Approaching_coord: _XY_type2
            tmp2 = self.get_param_KJH4('SRF_ViaM8M9', 'BND_Met9Layer')
            approaching_coord = tmp2[0][0][0]['_XY_cent']
            ## Sref coord
            tmp3 = self.get_param_KJH4('SRF_ViaM8M9')
            Scoord = tmp3[0][0]['_XY_origin']
            ## Cal
            New_Scoord = self.get_Scoord_KJH4(target_coord, approaching_coord, Scoord)
            tmpXY.append(New_Scoord)
            ## Define Coordinates
            self._DesignParameter['SRF_ViaM8M9']['_XYCoordinates'] = tmpXY
    ...
    def _CalculateDesignParameterXmin(self,
        ...
        if 8 >= _Layer1 and 8 < _Layer2:
            ...
            # Calculate Sref Layer by using Calculation_Parameter
            self._DesignParameter['SRF_ViaM8M9']['_DesignObj']._CalculateDesignParameterXmin(
...
_COY=None,
        ...
        if 8 >= _Layer1 and 8 < _Layer2 :
            ...
            #Generate Sref
            self._DesignParameter['SRF_ViaM8M9'] = self._SrefElementDeclaration(_DesignObj=A02_ViaM8toM9_KJH2._ViaM8toM9_KJH( _DesignParameter=None, _Name='{}:SRF_ViaM7M8'.format(_Name)))[0]
            ...
            #Calculate Sref Layer by using Calculation_Parameter
            self._DesignParameter['SRF_ViaM8M9']['_DesignObj']._CalculateDesignParameterYmin(**_Caculation_Parameters)
...
if __name__ == '__main__':
    ...
    libname = 'Proj_A02_ViaStack_KJH2_YCH_v3'
    cellname = 'A02_ViaStack_KJH2_YCH'
