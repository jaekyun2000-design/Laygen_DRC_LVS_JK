...
## ########################################################################################################################################################## Class_HEADER
class _TIA_P3_YCH(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        _Caculation_Parameters['_PMOSNumberofGate'] = _Tr3_PMOSNumberofGate
        _Caculation_Parameters['_PMOSChannelWidth'] = _Tr3_PMOSChannelWidth
        _Caculation_Parameters['_PMOSChannellength'] = _Tr3_PMOSChannellength
        ...
        _Caculation_Parameters['_PMOSDummy'] = _Tr3_PMOSDummy
        _Caculation_Parameters['_PMOSDummy_length'] = _Tr3_PMOSDummy_length
        _Caculation_Parameters['_PMOSDummy_placement'] = _Tr3_PMOSDummy_placement
...
## ################################################################################################################### POLY_Metal1 connect
        ...
        SRF_Drain_ViaM1M2_count = self.get_param_KJH4('SRF_Pmos', 'SRF_Drain_ViaM1M2', 'SRF_ViaM1M2', 'BND_Met1Layer')
        print(len(SRF_Drain_ViaM1M2_count[0]))
        if (_Tr3_PMOSNumberofGate > 1):
...
## ################################################################################################################### _Gate_ViaM0M1
        ...
        elif (_Tr3_PMOSNumberofGate % 2 == 1):
...
## ################################################################################################################### Metal1 Drain_Gate connect
        ...
        tmp1 = self.get_param_KJH4('BND_Met1Layer_Gate_connect')
        # tmp2 = self.get_param_KJH4('BND_Met1Layer_extension')
        tmp3 = self.get_param_KJH4('SRF_Pmos', 'SRF_Drain_ViaM1M2', 'SRF_ViaM1M2', 'BND_Met1Layer')

        # Define Boundary_element _YWidth
        self._DesignParameter['BND_Met1Layer_Drain_Gate_connect']['_YWidth'] = abs(tmp1[0][0]['_XY_up'][1]-tmp3[0][0][0][0][0]['_XY_cent'][1])

        # Define Boundary_element _XWidth
        self._DesignParameter['BND_Met1Layer_Drain_Gate_connect']['_XWidth'] = tmp3[0][0][0][0][0]['_Xwidth']
...
if __name__ == '__main__':
    ...
    for _iter in range(10):
        libname = 'Proj_A50_TIA_P3_v{}'.format(_iter + 27)
        cellname = 'A50_TIA_P3'
        ...
        InputParams = dict(
            ...
            #PMOS Tr0
            _Tr3_PMOSNumberofGate	= random.randrange(1, 10, 1),
            _Tr3_PMOSChannelWidth	= random.randrange(3000, 10000, 1000),
        ...
        LayoutObj = _TIA_P3_YCH(_DesignParameter=None, _Name=cellname)
