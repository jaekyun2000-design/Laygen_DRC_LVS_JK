...
class _TIA_YCH(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        tmp12 = self.get_param_KJH4('SRF_Pbodyring_ResA','BND_ExtenMet1Layer_Bottom')
        target_coordx = tmp12[0][0][0]['_XY_cent'][0]
        target_coordy = tmp11[0][0][0][0][0][0][0][0]['_XY_left'][1] - _DRCObj._PpMinSpace
        target_coord = [target_coordx, target_coordy]

        ## Approaching_coord: _XY_type2
        tmp21 = self.get_param_KJH4('SRF_2ndFB','SRF_PbodyTop_Res_2nd','SRF_PbodyContactPhyLen','BND_PPLayer')
        tmp22 = self.get_param_KJH4('SRF_2ndFB','SRF_Res_2nd','SRF_OutputPort1_Via','SRF_ViaM3M4','BND_Met4Layer')
        tmp22 = self.get_outter_KJH4('SRF_2ndFB')

        approaching_coordx = tmp22['_Mostleft']['coord'][0]
        approaching_coordy = tmp21[0][0][0][0][0]['_XY_up_right'][1]
        approaching_coord = [approaching_coordx, approaching_coordy]
        ...
        tmp2 = self.get_param_KJH4('SRF_2ndFB','SRF_Res_2nd','SRF_OutputPort1_Via','SRF_ViaM4M5','BND_Met5Layer')
        ...
        ### amp2 output - RC feedback connection
        self._DesignParameter['BND_MetalLayer_amp2out_2ndFB_2'] = self._BoundaryElementDeclaration(
            _Layer=DesignParameters._LayerMapping['METAL{}'.format(_LayoutOption_2nd[-1])][0],
            _Datatype=DesignParameters._LayerMapping['METAL{}'.format(_LayoutOption_2nd[-1])][1],
            _XWidth=None,
            _YWidth=None,
        ...
        tmp1 = self.get_param_KJH4('BND_MetalLayer_amp2out_2ndFB')
        tmp2 = self.get_param_KJH4('SRF_2ndFB', 'BND_MetLayer_CTopConn_2')

        self._DesignParameter['BND_MetalLayer_amp2out_2ndFB_2']['_XWidth'] = tmp1[0][0]['_XY_down_right'][0] - tmp2[0][0][0]['_XY_down_left'][0]
        self._DesignParameter['BND_MetalLayer_amp2out_2ndFB_2']['_YWidth'] = tmp2[0][0][0]['_Ywidth']

        # Calculate Sref XYcoord
        # initialize coordinate
        self._DesignParameter['BND_MetalLayer_amp2out_2ndFB_2']['_XYCoordinates'] = [[0, 0]]
        tmpXY = []
        target_coord = tmp1[0][0]['_XY_down_right']

        tmp3 = self.get_param_KJH4('BND_MetalLayer_amp2out_2ndFB_2')
        ...
        ## Define Coordinates
        self._DesignParameter['BND_MetalLayer_amp2out_2ndFB_2']['_XYCoordinates'] = tmpXY
        ...
        target_coordy = tmp11['_Mostdown']['coord'][0] - _DRCObj._PpMinSpace - 170
        target_coord = [target_coordx, target_coordy]
        ...
        tmp1 = self.get_param_KJH4('SRF_amp1','BND_Metal6Layer_Connect_C0_C1_PortA_P4_N4_Drain')
        tmp2 = self.get_param_KJH4('SRF_1stFB','BND_Met3Layer_PortB_Switch')

        self._DesignParameter['BND_Met6Layer_amp1out_1stFB']['_XWidth'] = tmp1[0][0][0]['_Xwidth']
        self._DesignParameter['BND_Met6Layer_amp1out_1stFB']['_YWidth'] = tmp1[0][0][0]['_XY_up'][1] - tmp2[0][0][0]['_XY_down'][1]
        ...
        self._DesignParameter['TXT_VSS'] = self._TextElementDeclaration(
            ...
            # Portname
        self._DesignParameter['TXT_VSS']['_TEXT'] = 'VSS'

            ## Calculate Sref XYcoord
        tmpXY = []

        tmp = self.get_param_KJH4('SRF_amp1','SRF_PbodyLeft_res0','SRF_PbodyContactPhyLen','BND_Met1Layer')
        tmpXY.append(tmp[0][0][0][0][0]['_XY_cent'])

        tmp = self.get_param_KJH4('SRF_amp2','SRF_PbodyLeft_res0','SRF_PbodyContactPhyLen','BND_Met1Layer')
        tmpXY.append(tmp[0][0][0][0][0]['_XY_cent'])

        tmp = self.get_param_KJH4('SRF_Pbodyring_ResA','BND_ExtenMet1Layer_Left')
        tmpXY.append(tmp[0][0][0]['_XY_cent'])

        tmp = self.get_param_KJH4('SRF_1stFB','SRF_cap_1st','SRF_Pbodyring','BND_ExtenMet1Layer_Left')
        tmpXY.append(tmp[0][0][0][0][0]['_XY_cent'])

        tmp = self.get_param_KJH4('SRF_2ndFB','SRF_cap_2nd','SRF_Pbodyring','BND_ExtenMet1Layer_Left')
        tmpXY.append(tmp[0][0][0][0][0]['_XY_cent'])

        tmp = self.get_param_KJH4('SRF_1stFB','SRF_cap_Switch','SRF_Pbody','SRF_PbodyContactPhyLen','BND_Met1Layer')
        tmpXY.append(tmp[0][0][0][0][0][0]['_XY_cent'])

        self._DesignParameter['TXT_VSS']['_XYCoordinates'] = tmpXY


        ####### Port Label Creation
        ## Labeling: ex)METAL1PIN, METAL2PIN, METAL3PIN, METAL4PIN, METAL5PIN, METAL6PIN, METAL7PIN, METAL8PIN(IA), METAL9PIN(IB),
        self._DesignParameter['TXT_VDD'] = self._TextElementDeclaration(
            _Layer=DesignParameters._LayerMapping['METAL1PIN'][0],
            _Datatype=DesignParameters._LayerMapping['METAL1PIN'][1],
            _Presentation=[0, 1, 1], _Reflect=[0, 0, 0], _Mag=0.01, _Angle=0, _TEXT=None,
            _XYCoordinates=None,
            ...
            # Portname
        self._DesignParameter['TXT_VDD']['_TEXT'] = 'VDD'

            ## Calculate Sref XYcoord
        tmpXY = []

        tmp = self.get_param_KJH4('SRF_amp1','SRF_NbodyLeft_P0P3','SRF_NbodyContactPhyLen','BND_Met1Layer')
        tmpXY.append(tmp[0][0][0][0][0]['_XY_cent'])

        tmp = self.get_param_KJH4('SRF_amp2','SRF_NbodyLeft_P0P3','SRF_NbodyContactPhyLen','BND_Met1Layer')
        tmpXY.append(tmp[0][0][0][0][0]['_XY_cent'])

        tmp = self.get_param_KJH4('SRF_1stFB','SRF_Res_Series','SRF_TG_Switch','SRF_Nbody','SRF_NbodyContactPhyLen','BND_Met1Layer')
        tmpXY.append(tmp[0][0][0][0][0][0][0]['_XY_cent'])

        tmp = self.get_param_KJH4('SRF_1stFB','SRF_Res_Parallel','SRF_Runit_Switch','SRF_TG_Switch','SRF_Nbody','SRF_NbodyContactPhyLen','BND_Met1Layer')
        for i in range((_Parallel_Stack + 1)//2 ):
            tmpXY.append(tmp[0][0][i][0][0][0][0][0]['_XY_cent'])

        tmp = self.get_param_KJH4('SRF_1stFB','SRF_cap_Switch','SRF_Nbody','SRF_NbodyContactPhyLen','BND_Met1Layer')
        tmpXY.append(tmp[0][0][0][0][0][0]['_XY_cent'])

        self._DesignParameter['TXT_VDD']['_XYCoordinates'] = tmpXY


        ####### Port Label Creation
        ## Labeling: ex)METAL1PIN, METAL2PIN, METAL3PIN, METAL4PIN, METAL5PIN, METAL6PIN, METAL7PIN, METAL8PIN(IA), METAL9PIN(IB),
        self._DesignParameter['TXT_IIN'] = self._TextElementDeclaration(
            ...
            # Portname
        self._DesignParameter['TXT_IIN']['_TEXT'] = 'IIN'

            ## Calculate Sref XYcoord
        tmpXY = []

        tmp = self.get_param_KJH4('SRF_amp1','SRF_Pmos_Tr1Tr2Tr4_Nbodyring','SRF_Pmos_Tr1Tr2Tr4','SRF_Pmos_Tr1','BND_Metal4Layer_Hrz_Gate')
        tmpXY.append(tmp[0][0][0][0][0][0]['_XY_cent'])

        self._DesignParameter['TXT_IIN']['_XYCoordinates'] = tmpXY

        ####### Port Label Creation
        ## Labeling: ex)METAL1PIN, METAL2PIN, METAL3PIN, METAL4PIN, METAL5PIN, METAL6PIN, METAL7PIN, METAL8PIN(IA), METAL9PIN(IB),
        self._DesignParameter['TXT_VREF_TIA'] = self._TextElementDeclaration(
            _Layer=DesignParameters._LayerMapping['METAL4PIN'][0],
            _Datatype=DesignParameters._LayerMapping['METAL4PIN'][1],
            _Presentation=[0, 1, 1], _Reflect=[0, 0, 0], _Mag=0.01, _Angle=0, _TEXT=None,
            _XYCoordinates=None,
            ...
            # Portname
        self._DesignParameter['TXT_VREF_TIA']['_TEXT'] = 'VREF_TIA'

            ## Calculate Sref XYcoord
        tmpXY = []

        tmp = self.get_param_KJH4('SRF_amp1','SRF_Pmos_Tr1Tr2Tr4_Nbodyring','SRF_Pmos_Tr1Tr2Tr4','SRF_Pmos_Tr2','BND_Metal4Layer_Hrz_Gate')
        tmpXY.append(tmp[0][0][0][0][0][0]['_XY_cent'])

        self._DesignParameter['TXT_VREF_TIA']['_XYCoordinates'] = tmpXY

        ####### Port Label Creation
        ## Labeling: ex)METAL1PIN, METAL2PIN, METAL3PIN, METAL4PIN, METAL5PIN, METAL6PIN, METAL7PIN, METAL8PIN(IA), METAL9PIN(IB),
        self._DesignParameter['TXT_VOCM'] = self._TextElementDeclaration(
            _Layer=DesignParameters._LayerMapping['METAL4PIN'][0],
            _Datatype=DesignParameters._LayerMapping['METAL4PIN'][1],
            _Presentation=[0, 1, 1], _Reflect=[0, 0, 0], _Mag=0.01, _Angle=0, _TEXT=None,
            _XYCoordinates=None,
            ...
            # Portname
        self._DesignParameter['TXT_VOCM']['_TEXT'] = 'VOCM'

            ## Calculate Sref XYcoord
        tmpXY = []

        tmp = self.get_param_KJH4('SRF_amp2','SRF_Pmos_Tr1Tr2Tr4_Nbodyring','SRF_Pmos_Tr1Tr2Tr4','SRF_Pmos_Tr2','BND_Metal4Layer_Hrz_Gate')
        tmpXY.append(tmp[0][0][0][0][0][0]['_XY_cent'])

        self._DesignParameter['TXT_VOCM']['_XYCoordinates'] = tmpXY

        tmp1 = self.get_param_KJH4('SRF_1stFB','SRF_Res_Parallel','SRF_Runit_Switch','SRF_TG_Switch','BND_Met1Layer_PASS')
        tmp2 = self.get_param_KJH4('SRF_1stFB','SRF_Res_Parallel','SRF_Runit_Switch_flip','SRF_TG_Switch','BND_Met1Layer_PASS')

        for i in range(_Parallel_Stack):
            ## Labeling: ex)METAL1PIN, METAL2PIN, METAL3PIN, METAL4PIN, METAL5PIN, METAL6PIN, METAL7PIN, METAL8PIN(IA), METAL9PIN(IB),
            self._DesignParameter['TXT_Ctrl_TIGainP{}'.format(i)] = self._TextElementDeclaration(
                _Layer=DesignParameters._LayerMapping['METAL1PIN'][0],
                _Datatype=DesignParameters._LayerMapping['METAL1PIN'][1],
                _Presentation=[0, 1, 1], _Reflect=[0, 0, 0], _Mag=0.01, _Angle=0, _TEXT=None,
                _XYCoordinates=None,
            ...
            # Portname
            self._DesignParameter['TXT_Ctrl_TIGainP{}'.format(i)]['_TEXT'] = 'Ctrl_TIGainP<{}>'.format(i)

            ## Calculate Sref XYcoord
            tmpXY = []
            if i % 2 == 0:
                tmpXY.append(tmp1[0][0][i//2][0][0][0]['_XY_right'])
            else:
                tmpXY.append(tmp2[0][0][i//2][0][0][0]['_XY_right'])

            self._DesignParameter['TXT_Ctrl_TIGainP{}'.format(i)]['_XYCoordinates'] = tmpXY


        ## Labeling: ex)METAL1PIN, METAL2PIN, METAL3PIN, METAL4PIN, METAL5PIN, METAL6PIN, METAL7PIN, METAL8PIN(IA), METAL9PIN(IB),
        self._DesignParameter['TXT_Ctrl_TIGainA'] = self._TextElementDeclaration(
            _Layer=DesignParameters._LayerMapping['METAL1PIN'][0],
            _Datatype=DesignParameters._LayerMapping['METAL1PIN'][1],
            _Presentation=[0, 1, 1], _Reflect=[0, 0, 0], _Mag=0.01, _Angle=0, _TEXT=None,
            _XYCoordinates=None,
            ...
            # Portname
        self._DesignParameter['TXT_Ctrl_TIGainA']['_TEXT'] = 'Ctrl_TIGainA'

            ## Calculate Sref XYcoord
        tmpXY = []

        tmp = self.get_param_KJH4('SRF_1stFB','SRF_Res_Series','SRF_TG_Switch','BND_Met1Layer_PASS')
        tmpXY.append(tmp[0][0][0][0][0]['_XY_right'])

        self._DesignParameter['TXT_Ctrl_TIGainA']['_XYCoordinates'] = tmpXY


        ## Labeling: ex)METAL1PIN, METAL2PIN, METAL3PIN, METAL4PIN, METAL5PIN, METAL6PIN, METAL7PIN, METAL8PIN(IA), METAL9PIN(IB),
        self._DesignParameter['TXT_Ctrl_CFB'] = self._TextElementDeclaration(
            _Layer=DesignParameters._LayerMapping['METAL1PIN'][0],
            _Datatype=DesignParameters._LayerMapping['METAL1PIN'][1],
            _Presentation=[0, 1, 1], _Reflect=[0, 0, 0], _Mag=0.01, _Angle=0, _TEXT=None,
            _XYCoordinates=None,
            ...
            # Portname
        self._DesignParameter['TXT_Ctrl_CFB']['_TEXT'] = 'Ctrl_CFB'

            ## Calculate Sref XYcoord
        tmpXY = []

        tmp = self.get_param_KJH4('SRF_1stFB','SRF_cap_Switch','BND_Met1Layer_PASS')
        tmpXY.append(tmp[0][0][0][0]['_XY_right'])

        self._DesignParameter['TXT_Ctrl_CFB']['_XYCoordinates'] = tmpXY


        ## Labeling: ex)METAL1PIN, METAL2PIN, METAL3PIN, METAL4PIN, METAL5PIN, METAL6PIN, METAL7PIN, METAL8PIN(IA), METAL9PIN(IB),
        self._DesignParameter['TXT_VOUT'] = self._TextElementDeclaration(
            _Layer=DesignParameters._LayerMapping['METAL4PIN'][0],
            _Datatype=DesignParameters._LayerMapping['METAL4PIN'][1],
            _Presentation=[0, 1, 1], _Reflect=[0, 0, 0], _Mag=0.01, _Angle=0, _TEXT=None,
            _XYCoordinates=None,
            ...
            # Portname
        self._DesignParameter['TXT_VOUT']['_TEXT'] = 'VOUT'

            ## Calculate Sref XYcoord
        tmpXY = []

        tmp = self.get_param_KJH4('SRF_amp2','SRF_Pmos4_Drain_ViaM3M5','SRF_ViaM3M4','BND_Met4Layer')
        tmpXY.append(tmp[0][0][0][0][0]['_XY_cent'])

        self._DesignParameter['TXT_VOUT']['_XYCoordinates'] = tmpXY
...
if __name__ == '__main__':
    ...
    for _iter in range(50):
        libname = 'Proj_A55_TIA_v{}'.format(_iter +20)
        cellname = 'A55_TIA'
        ...
        InputParams = dict(
            ...
            # ResA
            _ResWidth_resA=random.randrange(200,2000,100), # 조절 가능할듯
            _ResLength_resA=2800,
            _CONUMX_resA=None,
            _CONUMY_resA=None,
            _SeriesStripes_resA=random.randrange(1,21,2), # 홀수
            _ParallelStripes_resA=1,

            # 2nd Stage FB
            # Res_2nd
            _ResWidth_2nd=1000,
            _ResLength_2nd=random.randrange(2000,20001,100),
            _CONUMX_2nd=None,
            _CONUMY_2nd=None,
            _SeriesStripes_2nd=random.randrange(1,30,2),
            ...
            _Par_ResLength=1300,
            _Par_SeriesStripes=random.randrange(1,201,1),
            _Par_ParallelStripes=1,

            _Ser_ResWidth=random.randrange(160,500,10),
            _Ser_ResLength=1300,
            _Ser_SeriesStripes=random.randrange(2,201,2),
            _Ser_ParallelStripes=1,

            _TG_NumberofGate=50,  # number
            ...
            # Cap_1st
            _Length_1st=random.randrange(4300,20001,100),
            _LayoutOption_1st=[2, 3, 4],
            _NumFigPair_1st=25,
            _Array_1st_row=2,
            _Array_1st_col=2,
        ...
        with open("./gds_params/params_v{}.txt".format(_iter +20), "w", encoding="utf-8") as f:
        ...
        testStreamFile = open('./gds_params/{}'.format(_fileName), 'wb')
