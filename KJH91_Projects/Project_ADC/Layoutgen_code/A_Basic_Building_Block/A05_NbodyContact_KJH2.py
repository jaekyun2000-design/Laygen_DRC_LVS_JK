...
## ########################################################################################################################################################## Class_HEADER
class _NbodyContact_KJH2(StickDiagram_KJH1._StickDiagram_KJH):
...
_COY	= None,
        ...
        self._DesignParameter['BND_Nwell'] = self._BoundaryElementDeclaration(
                                                                            _Layer=
                                                                            DesignParameters._LayerMapping['NWELL'][0],
                                                                            _Datatype=
                                                                            DesignParameters._LayerMapping['NWELL'][1],
                                                                            _XWidth=None,
                                                                            _YWidth=None,
                                                                            _XYCoordinates=[ ],
                                                                          )
        ...
        #Define NWELL Xwidth
        self._DesignParameter['BND_Nwell']['_XWidth'] = self._DesignParameter['BND_ODLayer']['_XWidth'] + _DRCObj._PpMinExtensiononPactive*2

        #Define NWELL Ywidth
        self._DesignParameter['BND_Nwell']['_YWidth'] = self._DesignParameter['BND_ODLayer']['_YWidth'] + _DRCObj._PpMinExtensiononPactive*2
        ...
        Scoord = tmp3[0][0]['_XY_origin']
                ## Cal
        New_Scoord = self.get_Scoord_KJH4(target_coord, approaching_coord, Scoord)
        New_Scoord[0] = New_Scoord[0] - _DRCObj._PpMinExtensiononPactive
        New_Scoord[1] = New_Scoord[1] + _DRCObj._PpMinExtensiononPactive
...
if __name__ == '__main__':
    ...
    cellname = 'A05_NbodyContact_KJH2_98'
...
_COY=8,
    ...
    LayoutObj = _NbodyContact_KJH2(_DesignParameter=None, _Name=cellname)
