...
class _Opppcres_b_YCH(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        tmp = []
        _CONUMXmax = int((self._DesignParameter['_POLayer']['_XWidth'] - _DRCObj._CoMinEnclosureByPO2 * 2 - _DRCObj._CoMinWidth) // (
...
if __name__ == '__main__':
    ...
    libname = 'Proj_A50_opppcres_b_v14'
    ...
    LayoutObj = _Opppcres_b_YCH(_DesignParameter=None, _Name=cellname)
