...
from KJH91_Projects.Project_ADC.Layoutgen_code.A_Basic_Building_Block import A53_TIA_P0P1P2P3P4N0N1N2N3N4_PNbodyring_random
...
class _TIA_YCH(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        _Caculation_Parameters = copy.deepcopy(A53_TIA_P0P1P2P3P4N0N1N2N3N4_PNbodyring_random._TIA_P0P1P2P3P4N0N1N2N3N4_PNbodyring_YCH._ParametersForDesignCalculation)
        ...
        self._DesignParameter['SRF_amp1'] = self._SrefElementDeclaration(
            _DesignObj=A53_TIA_P0P1P2P3P4N0N1N2N3N4_PNbodyring_random._TIA_P0P1P2P3P4N0N1N2N3N4_PNbodyring_YCH(_DesignParameter=None,_Name='{}:SRF_amp1'.format(_Name)))[0]
        ...
        self._DesignParameter['SRF_amp2'] = self._SrefElementDeclaration(
            _DesignObj=A53_TIA_P0P1P2P3P4N0N1N2N3N4_PNbodyring_random._TIA_P0P1P2P3P4N0N1N2N3N4_PNbodyring_YCH(
...
if __name__ == '__main__':
    ...
    for _iter in range(10):
        ...
        InputParams = dict(
            # first op-amp
            # PMOS
            _op1_Tr0_PMOSNumberofGate=_TR0_PMOSNumberofGate,
            _op1_Tr0_PMOSChannelWidth=_TRP0_P3_N2_N3_ChannelWidth,
            _op1_Tr0_PMOSChannellength=150,
            _op1_Tr0_PMOSXVT			= 'EG',

            # PMOS
            _op1_Tr1_PMOSNumberofGate=_TR1_2_PMOSNumberofGate,
            _op1_Tr1_PMOSChannelWidth=_TRP1_P2_P4_ChannelWidth,
            _op1_Tr1_PMOSChannellength=150,
            _op1_Tr1_PMOSXVT			= 'EG',

            # PMOS
            _op1_Tr2_PMOSNumberofGate	= _TR1_2_PMOSNumberofGate,
            _op1_Tr2_PMOSChannelWidth	= _TRP1_P2_P4_ChannelWidth,
            _op1_Tr2_PMOSChannellength	= 150,
            _op1_Tr2_PMOSXVT				= 'EG',

            # PMOS3
            _op1_Tr3_PMOSNumberofGate=_TR3_PMOSNumberofGate,
            _op1_Tr3_PMOSChannelWidth=_TRP0_P3_N2_N3_ChannelWidth,
            _op1_Tr3_PMOSChannellength=150,
            _op1_Tr3_PMOSXVT			= 'EG',

            # PMOS4
            _op1_Tr4_PMOSNumberofGate=_TR4_PMOSNumberofGate,
            _op1_Tr4_PMOSChannelWidth=_TRP1_P2_P4_ChannelWidth,
            _op1_Tr4_PMOSChannellength=150,
            _op1_Tr4_PMOSXVT				= 'EG',

            # NMOS Tr0
            _op1_Tr0_NMOSNumberofGate=_TR0_1_NMOSNumberofGate,
            _op1_Tr0_NMOSChannelWidth=_TRN0_N1_N4_ChannelWidth,
            _op1_Tr0_NMOSChannellength=150,
            _op1_Tr0_NMOSXVT			= 'EG',

            # NMOS Tr1
            _op1_Tr1_NMOSNumberofGate=_TR0_1_NMOSNumberofGate,
            _op1_Tr1_NMOSChannelWidth=_TRN0_N1_N4_ChannelWidth,
            _op1_Tr1_NMOSChannellength=150,
            _op1_Tr1_NMOSXVT				= 'EG',

            # NMOS tr2
            _op1_Tr2_NMOSNumberofGate=_TR2_NMOSNumberofGate,
            _op1_Tr2_NMOSChannelWidth=_TRP0_P3_N2_N3_ChannelWidth,
            _op1_Tr2_NMOSChannellength=150,
            _op1_Tr2_NMOSXVT			= 'EG',

            # NMOS tr3
            _op1_Tr3_NMOSNumberofGate=_TR3_NMOSNumberofGate,
            _op1_Tr3_NMOSChannelWidth=_TRP0_P3_N2_N3_ChannelWidth,
            _op1_Tr3_NMOSChannellength=150,
            _op1_Tr3_NMOSXVT				= 'EG',

            # NMOS Tr4
            _op1_Tr4_NMOSNumberofGate=_TR4_NMOSNumberofGate,
            _op1_Tr4_NMOSChannelWidth=_TRN0_N1_N4_ChannelWidth,
            _op1_Tr4_NMOSChannellength=150,
            _op1_Tr4_NMOSXVT				= 'EG',

            # Res0
            _op1_ResWidth_res0 = _Res_Width,
            _op1_ResLength_res0 = _Res_Length,

            # Res1
            _op1_ResWidth_res1=_Res_Width,
            _op1_ResLength_res1=_Res_Length,

            # Cap0
            _op1_Length_cap0=_Cap_Length,
            _op1_NumFigPair_cap0=_Cap_finger,

            # Cap1
            _op1_Length_cap1=_Cap_Length,
            _op1_NumFigPair_cap1=_Cap_finger,


            # second op-amp
            # PMOS tr0
            _op2_Tr0_PMOSNumberofGate   =_TR0_PMOSNumberofGate,
            _op2_Tr0_PMOSChannelWidth   =_TRP0_P3_N2_N3_ChannelWidth,
            _op2_Tr0_PMOSChannellength  =150,
            _op2_Tr0_PMOSXVT	        = 'EG',
            # PMOS tr1
            _op2_Tr1_PMOSNumberofGate   =_TR1_2_PMOSNumberofGate,
            _op2_Tr1_PMOSChannelWidth   =_TRP1_P2_P4_ChannelWidth,
            _op2_Tr1_PMOSChannellength  =150,
            _op2_Tr1_PMOSXVT			= 'EG',

            # PMOS tr2
            _op2_Tr2_PMOSNumberofGate	= _TR1_2_PMOSNumberofGate,
            _op2_Tr2_PMOSChannelWidth	= _TRP1_P2_P4_ChannelWidth,
            _op2_Tr2_PMOSChannellength	= 150,
            _op2_Tr2_PMOSXVT			= 'EG',

            # PMOS tr3
            _op2_Tr3_PMOSNumberofGate   =_TR3_PMOSNumberofGate,
            _op2_Tr3_PMOSChannelWidth   =_TRP0_P3_N2_N3_ChannelWidth,
            _op2_Tr3_PMOSChannellength  =150,
            _op2_Tr3_PMOSXVT			= 'EG',

            # PMOS tr4
            _op2_Tr4_PMOSNumberofGate   =_TR4_PMOSNumberofGate,
            _op2_Tr4_PMOSChannelWidth   =_TRP1_P2_P4_ChannelWidth,
            _op2_Tr4_PMOSChannellength  =150,
            _op2_Tr4_PMOSXVT			= 'EG',

            # NMOS Tr0
            _op2_Tr0_NMOSNumberofGate   =_TR0_1_NMOSNumberofGate,
            _op2_Tr0_NMOSChannelWidth   =_TRN0_N1_N4_ChannelWidth,
            _op2_Tr0_NMOSChannellength  =150,
            _op2_Tr0_NMOSXVT			= 'EG',

            # NMOS Tr1
            _op2_Tr1_NMOSNumberofGate=_TR0_1_NMOSNumberofGate,
            _op2_Tr1_NMOSChannelWidth=_TRN0_N1_N4_ChannelWidth,
            _op2_Tr1_NMOSChannellength=150,
            _op2_Tr1_NMOSXVT				= 'EG',

            # NMOS tr2
            _op2_Tr2_NMOSNumberofGate=_TR2_NMOSNumberofGate,
            _op2_Tr2_NMOSChannelWidth=_TRP0_P3_N2_N3_ChannelWidth,
            _op2_Tr2_NMOSChannellength=150,
            _op2_Tr2_NMOSXVT			= 'EG',

            # NMOS tr3
            _op2_Tr3_NMOSNumberofGate=_TR3_NMOSNumberofGate,
            _op2_Tr3_NMOSChannelWidth=_TRP0_P3_N2_N3_ChannelWidth,
            _op2_Tr3_NMOSChannellength=150,
            _op2_Tr3_NMOSXVT				= 'EG',

            # NMOS Tr4
            _op2_Tr4_NMOSNumberofGate=_TR4_NMOSNumberofGate,
            _op2_Tr4_NMOSChannelWidth=_TRN0_N1_N4_ChannelWidth,
            _op2_Tr4_NMOSChannellength=150,
            _op2_Tr4_NMOSXVT				= 'EG',


            # Res0
            _op2_ResWidth_res0 = _Res_Width,
            _op2_ResLength_res0 = _Res_Length,

            # Res1
            _op2_ResWidth_res1=_Res_Width,
            _op2_ResLength_res1=_Res_Length,

            # Cap0
            _op2_Length_cap0=_Cap_Length,
            _op2_NumFigPair_cap0=_Cap_finger,

            # Cap1
            _op2_Length_cap1=_Cap_Length,
            _op2_NumFigPair_cap1=_Cap_finger,
            ...
            ### 1st Feedback
            # Parallel Res
            _Par_ResWidth=random.randrange(160,500,10),
            _Par_ResLength= 1292,                # random.randrange(1000,1500,100),
            _Par_SeriesStripes=random.randrange(21,101,1),
            _Par_ParallelStripes=1,

            _Ser_ResWidth=random.randrange(160,500,10),
            _Ser_ResLength= 1292,                    # random.randrange(1000,1500,100),
            _Ser_SeriesStripes=random.randrange(20,101,2), # 짝수로 넣기
            _Ser_ParallelStripes=1,

            _TG_NumberofGate=random.randrange(50,100,10),  # number
            ...
            # Cap_1st
            _Length_1st=random.randrange(6000,10000,1000),
            _LayoutOption_1st=[2, 3, 4],
            _NumFigPair_1st=random.randrange(10,30,2),
            _Array_1st_row=2,
            _Array_1st_col=2,
