...
if __name__ == '__main__':
    ...
    for _iter in range(10):
        libname = 'Proj_ADC_A_building_block_NMOS_Random_v{}'.format(_iter + 1)
        ...
        InputParams = dict(
            ...
            #NMOS
            _NMOSNumberofGate	= random.randrange(1, 10, 1),
            _NMOSChannelWidth	= random.randrange(1000, 10000, 1000),
