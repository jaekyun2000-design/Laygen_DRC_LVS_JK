...
## ########################################################################################################################################################## Class_HEADER
class _NbodyRing(StickDiagram_KJH1._StickDiagram_KJH):
...
_NumContRight		= None,
        ...
        #Generate Sref
        self._DesignParameter['SRF_NbodyTop'] = self._SrefElementDeclaration(_DesignObj=A07_NbodyContactPhyLen_KJH3._NbodyContactPhyLen( _DesignParameter=None, _Name='{}:SRF_NbodyTop'.format(_Name)))[0]
        ...
        #Generate Sref
        self._DesignParameter['SRF_NbodyBottom'] = self._SrefElementDeclaration(_DesignObj=A07_NbodyContactPhyLen_KJH3._NbodyContactPhyLen( _DesignParameter=None, _Name='{}:SRF_NbodyBottom'.format(_Name)))[0]
        ...
        #Generate Sref
        self._DesignParameter['SRF_NbodyLeft'] = self._SrefElementDeclaration(_DesignObj=A07_NbodyContactPhyLen_KJH3._NbodyContactPhyLen( _DesignParameter=None, _Name='{}:SRF_NbodyLeft'.format(_Name)))[0]
        ...
        #Generate Sref
        self._DesignParameter['SRF_NbodyRight'] = self._SrefElementDeclaration(_DesignObj=A07_NbodyContactPhyLen_KJH3._NbodyContactPhyLen( _DesignParameter=None, _Name='{}:SRF_NbodyRight'.format(_Name)))[0]
...
if __name__ == '__main__':
    ...
    libname = 'Proj_A50_TIA_Nbodyring_v1'
    cellname = 'A50_TIA_Nbodyring'
...
_NumContRight		= 3,
    ...
    LayoutObj = _NbodyRing(_DesignParameter=None, _Name=cellname)
