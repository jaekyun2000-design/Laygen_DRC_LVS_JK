...
class "-Classname-"(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        self._DesignParameter['--elementname--'] = self._BoundaryElementDeclaration(
        ...
        self._DesignParameter['--elementname--']['_YWidth'] = '?'

                ## Define Boundary_element _XWidth
        self._DesignParameter['--elementname--']['_XWidth'] = '?'
        ...
        self._DesignParameter['--Vianame--'] = self._SrefElementDeclaration(_DesignObj=A02_ViaStack_KJH3._ViaStack(_DesignParameter=None, _Name='{}:--Vianame--'.format(_Name)))[0]
