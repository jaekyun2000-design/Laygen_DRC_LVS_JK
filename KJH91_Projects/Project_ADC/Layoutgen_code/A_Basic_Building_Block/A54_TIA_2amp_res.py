...
## ########################################################################################################################################################## Class_HEADER
class _TIA_2amp_res_YCH(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        # 4/13 DRC, LVS 검증 완료, 초안 완성 / 추후 작업 : R,C 피드백 회로 만들어서 밑에 붙이기
...
if __name__ == '__main__':
    ...
    LayoutObj = _TIA_2amp_res_YCH(_DesignParameter=None, _Name=cellname)
