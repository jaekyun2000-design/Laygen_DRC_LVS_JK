...
## ################################################################################################################### POLY_Metal1 connect
        ...
        #
        # # Define Boundary_element _YWidth
        # self._DesignParameter['BND_Met1Layer_Gate_extension']['_YWidth'] = 384
        #
        # # Define Boundary_element _XWidth
        # tmp = self.get_param_KJH4('BND_Met1Layer_Gate_connect')
        # self._DesignParameter['BND_Met1Layer_Gate_extension']['_XWidth'] = tmp[-1][0]['_XY_right'][0] - tmp[0][0]['_XY_left'][0]
        #
        # # Calculate Sref XYcoord
        # # initialize coordinate
...
## ################################################################################################################### _Gate_ViaM0M1
        ...
        elif (_Tr0_PMOSNumberofGate % 2 == 1):
...
if __name__ == '__main__':
    ...
    for _iter in range(10):
        libname = 'Proj_A50_TIA_P0_v{}'.format(_iter + 11)
        cellname = 'A50_TIA_P0'
        ...
        InputParams = dict(
            ...
            #PMOS Tr0
            _Tr0_PMOSNumberofGate	= random.randrange(1, 10, 1),
            _Tr0_PMOSChannelWidth	= random.randrange(3000, 10000, 1000),
