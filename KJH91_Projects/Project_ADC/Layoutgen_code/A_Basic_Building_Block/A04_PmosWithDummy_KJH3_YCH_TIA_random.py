...
if __name__ == '__main__':
    ...
    for _iter in range(10):
        libname = 'Proj_ADC_A_building_block_PMOS_Random_v{}'.format(_iter + 1)
        cellname = 'A04_PmosWithDummy_YCH'
        ...
        InputParams = dict(
            ...
            #PMOS
            _PMOSNumberofGate	= random.randrange(1, 10, 1),
            _PMOSChannelWidth	= random.randrange(1000, 10000, 1000),
