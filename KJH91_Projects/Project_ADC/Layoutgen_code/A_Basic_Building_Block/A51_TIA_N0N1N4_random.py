...
from KJH91_Projects.Project_ADC.Layoutgen_code.A_Basic_Building_Block import A50_TIA_N0_random
from KJH91_Projects.Project_ADC.Layoutgen_code.A_Basic_Building_Block import A50_TIA_N1_random
from KJH91_Projects.Project_ADC.Layoutgen_code.A_Basic_Building_Block import A50_TIA_N4_random
...
class _TIA_N0N1N4_YCH(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        _Caculation_Parameters = copy.deepcopy(A50_TIA_N4_random._TIA_N4_YCH._ParametersForDesignCalculation)
        ...
        self._DesignParameter['SRF_Nmos_Tr4'] = self._SrefElementDeclaration(_DesignObj=A50_TIA_N4_random._TIA_N4_YCH(_DesignParameter=None, _Name='{}:SRF_Nmos_Tr4'.format(_Name)))[0]
        ...
        ## SREF Generation Tr0
        ## Copy Calculation_Parameters from low-level-block ex)copy.deepcopy(B16_nmos_power_v2._NMOS_POWER._ParametersForDesignCalculation)
        _Caculation_Parameters = copy.deepcopy(A50_TIA_N0_random._TIA_N0_YCH._ParametersForDesignCalculation)
        ## Define Calculation_Parameters ex) _Caculation_Parameters['_NMOSPOWER_PbodyContact_1_Length']  = _NMOSPOWER_PbodyContact_1_Length
        ...
        ## Generate Sref: ex)self._DesignParameter['_NMOS_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_nmos_power_v2._NMOS_POWER( _DesignParameter=None, _Name='{}:NMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_Nmos_Tr0'] = self._SrefElementDeclaration(_DesignObj=A50_TIA_N0_random._TIA_N0_YCH(_DesignParameter=None,_Name='{}:SRF_Nmos_Tr0'.format(_Name)))[0]
        ...
        ## SREF Generation Tr1
        ## Copy Calculation_Parameters from low-level-block ex)copy.deepcopy(B16_nmos_power_v2._NMOS_POWER._ParametersForDesignCalculation)
        _Caculation_Parameters = copy.deepcopy(A50_TIA_N1_random._TIA_N1_YCH._ParametersForDesignCalculation)
        ## Define Calculation_Parameters ex) _Caculation_Parameters['_NMOSPOWER_PbodyContact_1_Length']  = _NMOSPOWER_PbodyContact_1_Length
        ...
        ## Generate Sref: ex)self._DesignParameter['_NMOS_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_nmos_power_v2._NMOS_POWER( _DesignParameter=None, _Name='{}:NMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_Nmos_Tr1'] = self._SrefElementDeclaration(_DesignObj=A50_TIA_N1_random._TIA_N1_YCH(_DesignParameter=None,_Name='{}:SRF_Nmos_Tr1'.format(_Name)))[0]
...
if __name__ == '__main__':
    ...
    for _iter in range(10):
        ...
        libname = 'Proj_A51_TIA_N0N1N4_random_v{}'.format(_iter + 31)
        cellname = 'A51_TIA_N0N1N4'
        _fileName = cellname + '.gds'

        _TR0_1_NMOSNumberofGate = random.randrange(1, 10, 1)
        _TR4_NMOSNumberofGate = random.randrange(1, 10, 1)
        _TR0_1_4_NMOSChannelWidth = random.randrange(1000, 10000, 1000)
        ...
        InputParams = dict(
            ...
            _Tr0_NMOSChannelWidth=_TR0_1_4_NMOSChannelWidth,
            ...
            _Tr1_NMOSChannelWidth=_TR0_1_4_NMOSChannelWidth,
            ...
            _Tr4_NMOSChannelWidth=_TR0_1_4_NMOSChannelWidth,
