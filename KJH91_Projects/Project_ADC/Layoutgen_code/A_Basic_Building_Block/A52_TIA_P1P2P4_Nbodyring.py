...
from KJH91_Projects.Project_ADC.Layoutgen_code.A_Basic_Building_Block import A51_TIA_P1P2P4
...
class _TIA_P1P2P4_Nbodyring_YCH(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        _Caculation_Parameters = copy.deepcopy(A51_TIA_P1P2P4._TIA_P1P2P4_YCH._ParametersForDesignCalculation)
        ...
        self._DesignParameter['SRF_Pmos_Tr1Tr2Tr4'] = self._SrefElementDeclaration(
                             _DesignObj=A51_TIA_P1P2P4._TIA_P1P2P4_YCH(_DesignParameter=None, _Name='{}:SRF_Pmos_Tr1Tr2Tr4'.format(_Name)))[0]
...
## ################################################################################################################### Metal3_Layer_Connect_P1_Drain
        ...
        # Define Boundary_element _YWidth
        self._DesignParameter['BND_Metal3Layer_Connect_P1_Drain']['_YWidth'] = tmp1[0][0][0][0]['_Ywidth'] / 3
...
## ################################################################################################################### Metal3_Layer_Connect_P2_Drain
        ...
        # Define Boundary_element _YWidth
        self._DesignParameter['BND_Metal3Layer_Connect_P2_Drain']['_YWidth'] = tmp1[0][0][0][0]['_Ywidth'] / 3
...
if __name__ == '__main__':
    ...
    libname = 'Proj_A52_TIA_P1P2P4_Nbodyring_v1'
