...
## ########################################################################################################################################################## Class_HEADER
class _NmosWithDummy(StickDiagram_KJH1._StickDiagram_KJH):
...
_XVT				= None, #'XVT' ex)SLVT LVT RVT HVT EG
...
_NMOSXvt_placement=None,  # None/'Up'/'Dn'/
    ...
    ## Initially Defined design_parameterf
        ...
        for i in [0,-1]:
            if i == 0:
                ...
                Scoord = tmp3[0][0]['_XY_origin']
                        #Cal
                New_Scoord = self.get_Scoord_KJH4(target_coord,approaching_coord,Scoord)
                New_Scoord[0] = New_Scoord[0] - _DRCObj._PODummyMinSpace2 - _NMOSChannellength
                tmpXY.append(New_Scoord)
            else:
                    #Calculate
                        #Target_coord
...
if __name__ == '__main__':
    ...
    libname = 'Proj_ADC_A_building_block_NMOSwithdummy_test_inverter_v1'
    cellname = 'A03_NmosWithDummy_YCH'
...
#NMOS
_NMOSNumberofGate	= 2,
_NMOSChannelWidth	= 2000,
_NMOSChannellength	= 150,
_GateSpacing		= None,
_SDWidth			= None,
_XVT				= 'EG',
_PCCrit				= None,
...
_NMOSXvt_placement = None, #None/'Up'/'Dn'/
    ...
    LayoutObj = _NmosWithDummy(_DesignParameter=None, _Name=cellname)
