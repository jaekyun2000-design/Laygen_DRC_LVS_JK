...
## ########################################################################################################################################################## Class_HEADER
class _PbodyRing_KJH2(StickDiagram_KJH1._StickDiagram_KJH):
...
_NumContRight		= None,
        ...
        #Generate Sref
        self._DesignParameter['SRF_PbodyTop'] = self._SrefElementDeclaration(_DesignObj=A08_PbodyContactPhyLen_KJH2._PbodyContactPhyLen_KJH2( _DesignParameter=None, _Name='{}:SRF_PbodyTop'.format(_Name)))[0]
        ...
        #Generate Sref
        self._DesignParameter['SRF_PbodyBottom'] = self._SrefElementDeclaration(_DesignObj=A08_PbodyContactPhyLen_KJH2._PbodyContactPhyLen_KJH2( _DesignParameter=None, _Name='{}:SRF_PbodyBottom'.format(_Name)))[0]
        ...
        #Generate Sref
        self._DesignParameter['SRF_PbodyLeft'] = self._SrefElementDeclaration(_DesignObj=A08_PbodyContactPhyLen_KJH2._PbodyContactPhyLen_KJH2( _DesignParameter=None, _Name='{}:SRF_PbodyLeft'.format(_Name)))[0]
        ...
        #Generate Sref
        self._DesignParameter['SRF_PbodyRight'] = self._SrefElementDeclaration(_DesignObj=A08_PbodyContactPhyLen_KJH2._PbodyContactPhyLen_KJH2( _DesignParameter=None, _Name='{}:SRF_PbodyRight'.format(_Name)))[0]
...
_NumContRight		= 6,
    ...
    LayoutObj = _PbodyRing_KJH2(_DesignParameter=None, _Name=cellname)
