...
## ########################################################################################################################################################## Class_HEADER
class _TIA_P2_YCH(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        _Caculation_Parameters['_PMOSNumberofGate'] = _Tr2_PMOSNumberofGate
        _Caculation_Parameters['_PMOSChannelWidth'] = _Tr2_PMOSChannelWidth
        _Caculation_Parameters['_PMOSChannellength'] = _Tr2_PMOSChannellength
        ...
        _Caculation_Parameters['_PMOSDummy'] = _Tr2_PMOSDummy
        _Caculation_Parameters['_PMOSDummy_length'] = _Tr2_PMOSDummy_length
        _Caculation_Parameters['_PMOSDummy_placement'] = _Tr2_PMOSDummy_placement
        ...
        self._DesignParameter['BND_Metal1Layer_Hrz_Gate_extension']['_YWidth'] = abs(
            tmp2[0][0][0][0]['_XY_up'][1] - tmp1[0][0]['_XY_down'][1])
        ...
        tmpXY = []
        # if (_Tr2_PMOSNumberofGate % 2 == 1):
        for i in range(0, int(_Tr2_PMOSNumberofGate / 2) + 1):
            # Calculate
            # Target_coord
        ...
        # else:
        #     for i in range(0, int(_Tr2_PMOSNumberofGate / 2)):
        #         # Calculate
        #         # Target_coord
        #         tmp1 = self.get_param_KJH4('SRF_Pmos', 'BND_Met1Layer_Source')
        #         target_coord = tmp1[0][i][0]['_XY_up_left']
        ...
        self._DesignParameter['SRF_Drain_ViaM2M3'] = self._SrefElementDeclaration(
            _DesignObj=A02_ViaStack_KJH2._ViaStack_KJH2(_DesignParameter=None,
                                                        _Name='{}:SRF_Drain_ViaM2M3'.format(_Name)))[0]
...
if __name__ == '__main__':
    ...
    LayoutObj = _TIA_P2_YCH(_DesignParameter=None, _Name=cellname)
