...
from KJH91_Projects.Project_ADC.Layoutgen_code.A_Basic_Building_Block import A13_NbodyRingforDeepNwell_KJH
    ...
    ##
from KJH91_Projects.Project_ADC.Layoutgen_code.C09_Tr6_KJH import C09_00_Tr6_YCH
...
class _Guardring(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        _Caculation_Parameters = copy.deepcopy(C09_00_Tr6_YCH._Tr6._ParametersForDesignCalculation)
        ...
        self._DesignParameter['SRF_Tr6'] = self._SrefElementDeclaration(_DesignObj=C09_00_Tr6_YCH._Tr6(_DesignParameter=None, _Name='{}:SRF_Tr6'.format(_Name)))[0]
