...
from KJH91_Projects.Project_ADC.Layoutgen_code.C05_Tr8 import C05_01_Guardring_YCH
...
class _Pin(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        _Caculation_Parameters = copy.deepcopy(C05_01_Guardring_YCH._Guardring._ParametersForDesignCalculation)
        ...
        self._DesignParameter['SRF_Guardring'] = self._SrefElementDeclaration(_DesignObj=C05_01_Guardring_YCH._Guardring(_DesignParameter=None, _Name='{}:SRF_Guardring'.format(_Name)))[0]
...
if __name__ == '__main__':
    ...
    libname = 'Proj_ADC_C05_Tr8_v2'
    ## CellName: ex)C01_cap_array_v2_84
    cellname = 'C05_02_Pin_v0_98'
