...
## Define Class
class _Tr8(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        _Caculation_Parameters['_NMOSNumberofGate']     =   _Tr8_NMOSNumberofGate
        _Caculation_Parameters['_NMOSChannelWidth']     =   _Tr8_NMOSChannelWidth
        _Caculation_Parameters['_NMOSChannellength']    =   _Tr8_NMOSChannellength
        _Caculation_Parameters['_GateSpacing']          =   _Tr8_GateSpacing
        _Caculation_Parameters['_SDWidth']              =   _Tr8_SDWidth
        _Caculation_Parameters['_XVT']                  =   _Tr8_XVT
        _Caculation_Parameters['_PCCrit']               =   _Tr8_PCCrit
        _Caculation_Parameters['_Source_Via_TF']        =   _Tr8_Source_Via_TF
        _Caculation_Parameters['_Drain_Via_TF']         =   _Tr8_Drain_Via_TF
        _Caculation_Parameters['_NMOSDummy']            =   _Tr8_NMOSDummy
        _Caculation_Parameters['_NMOSDummy_length']     =   _Tr8_NMOSDummy_length
        _Caculation_Parameters['_NMOSDummy_placement']  =   _Tr8_NMOSDummy_placement
        ...
        self._DesignParameter['BND_NMOS_Source_Vtc_M2']['_YWidth'] = _DRCobj._MetalxMinSpace41 + abs(tmp1[0][0][0][0][0]['_XY_up'][1] - outter_coord[0])
        ...
        self._DesignParameter['BND_NMOS_Drain_Vtc_M2']['_YWidth'] = _DRCobj._MetalxMinSpace41 + abs(tmp1[0][0][0][0][0]['_XY_down'][1] - outter_coord[0])
...
if __name__ == '__main__':
    ...
    ## Gen Object:
    LayoutObj = _Tr8(_DesignParameter=None, _Name=cellname)
