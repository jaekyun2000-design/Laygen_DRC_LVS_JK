...
from KJH91_Projects.Project_ADC.Layoutgen_code.A_Basic_Building_Block import A13_NbodyRingforDeepNwell_KJH
    ...
    ##
from KJH91_Projects.Project_ADC.Layoutgen_code.C05_Tr8 import C05_00_Tr8_YCH
...
class _Guardring(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        _Caculation_Parameters = copy.deepcopy(C05_00_Tr8_YCH._Tr8._ParametersForDesignCalculation)
        ...
        self._DesignParameter['SRF_Tr8'] = self._SrefElementDeclaration(_DesignObj=C05_00_Tr8_YCH._Tr8(_DesignParameter=None, _Name='{}:SRF_Tr8'.format(_Name)))[0]
