...
## Define Class
class _Tr9(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        _Caculation_Parameters['_PMOSNumberofGate']     = _Tr9_PMOSNumberofGate
        _Caculation_Parameters['_PMOSChannelWidth']     = _Tr9_PMOSChannelWidth
        _Caculation_Parameters['_PMOSChannellength']    = _Tr9_PMOSChannellength
        _Caculation_Parameters['_GateSpacing']          = _Tr9_GateSpacing
        _Caculation_Parameters['_SDWidth']              = _Tr9_SDWidth
        _Caculation_Parameters['_XVT']                  = _Tr9_XVT
        _Caculation_Parameters['_PCCrit']               = _Tr9_PCCrit
        _Caculation_Parameters['_Source_Via_TF']        = _Tr9_Source_Via_TF
        _Caculation_Parameters['_Drain_Via_TF']         = _Tr9_Drain_Via_TF
        _Caculation_Parameters['_PMOSDummy']            = _Tr9_PMOSDummy
        _Caculation_Parameters['_PMOSDummy_length']     = _Tr9_PMOSDummy_length
        _Caculation_Parameters['_PMOSDummy_placement']  = _Tr9_PMOSDummy_placement
        ...
        ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ##########  Tr5, pfet: Drain M2 up connection
            ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## Tr5, pfet: Drain M2 up connection: Vtc
        ...
        self._DesignParameter['BND_Pmos_Drain_Vtc_M2']['_YWidth'] = _DRCobj._MetalxMinSpace41 + abs(tmp1[0][0][0][0][0]['_XY_up'][1] - outter_coord[0])
        ...
        target_coord = [tmp1_1, tmp1[0][0]['_XY_down'][1]]
        ## Approaching_coord: _XY_type2
...
if __name__ == '__main__':
    ...
    ## Gen Object:
    LayoutObj = _Tr9(_DesignParameter=None, _Name=cellname)
