...
##
from KJH91_Projects.Project_ADC.Layoutgen_code.C02_Tr5Tr7Tr9_Ctop_KJH import C02_00_Tr5_YCH
from KJH91_Projects.Project_ADC.Layoutgen_code.C02_Tr5Tr7Tr9_Ctop_KJH import C02_01_Tr7_YCH
from KJH91_Projects.Project_ADC.Layoutgen_code.C02_Tr5Tr7Tr9_Ctop_KJH import C02_02_Tr9_YCH
...
class _Tr5Tr7Tr9(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        _Caculation_Parameters = copy.deepcopy(C02_00_Tr5_YCH._Tr5._ParametersForDesignCalculation)
        ...
        self._DesignParameter['SRF_Tr5'] = self._SrefElementDeclaration(_DesignObj=C02_00_Tr5_YCH._Tr5(_DesignParameter=None, _Name='{}:SRF_Tr5'.format(_Name)))[0]
        ...
        ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## Tr7, slvtpfet+np: SRF gen.
            ## SREF Generation
                ## Copy Calculation_Parameters from low-level-block ex)copy.deepcopy(B16_nmos_power_v2._NMOS_POWER._ParametersForDesignCalculation)
        _Caculation_Parameters = copy.deepcopy(C02_01_Tr7_YCH._Tr7._ParametersForDesignCalculation)
                ## Define Calculation_Parameters ex) _Caculation_Parameters['_NMOSPOWER_PbodyContact_1_Length']  = _NMOSPOWER_PbodyContact_1_Length
        ...
        _Caculation_Parameters['_Tr7_PMOSDummy_placement']  = _Tr7_PMOSDummy_placement
                ...
                ## Generate Sref: ex)self._DesignParameter['_NMOS_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_nmos_power_v2._NMOS_POWER( _DesignParameter=None, _Name='{}:NMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_Tr7'] = self._SrefElementDeclaration(_DesignObj=C02_01_Tr7_YCH._Tr7(_DesignParameter=None, _Name='{}:SRF_Tr7'.format(_Name)))[0]
        ...
        ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## Tr9, rvtpfet+np
            ## SREF Generation
                ## Copy Calculation_Parameters from low-level-block ex)copy.deepcopy(B16_nmos_power_v2._NMOS_POWER._ParametersForDesignCalculation)
        _Caculation_Parameters = copy.deepcopy(C02_02_Tr9_YCH._Tr9._ParametersForDesignCalculation)
                ## Define Calculation_Parameters ex) _Caculation_Parameters['_NMOSPOWER_PbodyContact_1_Length']  = _NMOSPOWER_PbodyContact_1_Length
        ...
        _Caculation_Parameters['_Tr9_PMOSDummy_placement']  = _Tr9_PMOSDummy_placement
                ...
                ## Generate Sref: ex)self._DesignParameter['_NMOS_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_nmos_power_v2._NMOS_POWER( _DesignParameter=None, _Name='{}:NMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_Tr9'] = self._SrefElementDeclaration(_DesignObj=C02_02_Tr9_YCH._Tr9(_DesignParameter=None, _Name='{}:SRF_Tr9'.format(_Name)))[0]
