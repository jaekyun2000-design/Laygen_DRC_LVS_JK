...
## Define Class
class _Tr7(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        _Caculation_Parameters['_PMOSNumberofGate']     = _Tr7_PMOSNumberofGate
        _Caculation_Parameters['_PMOSChannelWidth']     = _Tr7_PMOSChannelWidth
        _Caculation_Parameters['_PMOSChannellength']    = _Tr7_PMOSChannellength
        _Caculation_Parameters['_GateSpacing']          = _Tr7_GateSpacing
        _Caculation_Parameters['_SDWidth']              = _Tr7_SDWidth
        _Caculation_Parameters['_XVT']                  = _Tr7_XVT
        _Caculation_Parameters['_PCCrit']               = _Tr7_PCCrit
        _Caculation_Parameters['_Source_Via_TF']        = _Tr7_Source_Via_TF
        _Caculation_Parameters['_Drain_Via_TF']         = _Tr7_Drain_Via_TF
        _Caculation_Parameters['_PMOSDummy']            = _Tr7_PMOSDummy
        _Caculation_Parameters['_PMOSDummy_length']     = _Tr7_PMOSDummy_length
        _Caculation_Parameters['_PMOSDummy_placement']  = _Tr7_PMOSDummy_placement
        ...
        self._DesignParameter['BND_Pmos_Source_Vtc_M2']['_YWidth'] = _DRCobj._MetalxMinSpace41 + abs(tmp1[0][0][0][0][0]['_XY_down'][1] - outter_coord[1])
...
if __name__ == '__main__':
    ...
    ## Gen Object:
    LayoutObj = _Tr7(_DesignParameter=None, _Name=cellname)
