...
class _Tr5(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        self._DesignParameter['BND_Pmos_Drain_Vtc_M2']['_YWidth'] = _DRCobj._MetalxMinSpace41 + abs(tmp1[0][0][0][0][0]['_XY_down'][1] - outter_coord[0])
...
if __name__ == '__main__':
    ...
    libname = 'Proj_ADC_C02_Tr5Tr7Tr9_Tr5_test_v5'
