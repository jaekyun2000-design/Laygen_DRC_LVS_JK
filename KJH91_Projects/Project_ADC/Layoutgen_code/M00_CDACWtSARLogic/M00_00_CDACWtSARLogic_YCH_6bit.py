...
from KJH91_Projects.Project_ADC.Layoutgen_code.L00_SARLogicWtComparator import L00_SARLogicWtComparator_YCH
...
from KJH91_Projects.Project_ADC.Layoutgen_code.C13_C07C11C12TieCellsRouted_YJH import C13_01_CtopCbotRouted_YJ_v01_00_YCH_v2
...
class _CDACWtSARLogic(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        _Caculation_Parameters1 = copy.deepcopy(
            L00_SARLogicWtComparator_YCH._SARLogicWtComparator._ParametersForDesignCalculation)
        ...
        self._DesignParameter['SRF_SARLogicWtComparator'] = self._SrefElementDeclaration(
            _DesignObj=L00_SARLogicWtComparator_YCH._SARLogicWtComparator(_DesignParameter=None,
        ...
        ## Copy Calculation_Parameters from low-level-block ex)copy.deepcopy(B16_nmos_power_v2._NMOS_POWER._ParametersForDesignCalculation)
        _Caculation_Parameters = copy.deepcopy(C13_01_CtopCbotRouted_YJ_v01_00_YCH_v2._CtopCbotRouted._ParametersForDesignCalculation)
        ...
        self._DesignParameter['SRF_BootSW_Pos'] = self._SrefElementDeclaration(_DesignObj=C13_01_CtopCbotRouted_YJ_v01_00_YCH_v2._CtopCbotRouted(_DesignParameter=None, _Name='{}:SRF_BootSW_Pos'.format(_Name)))[0]
        ...
        ## Generate Sref: ex)self._DesignParameter['_NMOS_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_nmos_power_v2._NMOS_POWER( _DesignParameter=None, _Name='{}:NMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_BootSW_Neg'] = self._SrefElementDeclaration(_DesignObj=C13_01_CtopCbotRouted_YJ_v01_00_YCH_v2._CtopCbotRouted(_DesignParameter=None, _Name='{}:SRF_BootSW_Neg'.format(_Name)))[0]
        ...
        ## Boundary_element Generation
        ## Generate Boundary_element: ex)LayerName: METAL1 / DIFF (_ODLayer) / POLY / PIMP (_PPLayer) / NWELL / SLVT LVT RVT HVT / OP(OPpress) / CONT (CA) / PCCRIT
        self._DesignParameter['BND_BootSWCLKSignalPath_M4'] = self._BoundaryElementDeclaration(
            _Layer=DesignParameters._LayerMapping['METAL4'][0],
            _Datatype=DesignParameters._LayerMapping['METAL4'][1],
            _XWidth=None,
            _YWidth=None,
        ...
        ## Define Boundary_element _YWidth
        tmp1 = self.get_param_KJH4('SRF_SARLogicWtComparator', 'SRF_Comparator', 'SRF_CLKSampInv_Input_ViaM1M4', 'SRF_ViaM3M4', 'BND_Met4Layer')
        tmp2 = self.get_param_KJH4('SRF_BootSWCLKSignalPath_ViaM4M5', 'SRF_ViaM4M5', 'BND_Met4Layer')

        self._DesignParameter['BND_BootSWCLKSignalPath_M4']['_YWidth'] = abs(
            tmp1[0][0][0][0][0][0]['_XY_up'][1] - tmp2[0][0][0][0]['_XY_down'][1])

        ## Define Boundary_element _XWidth
        self._DesignParameter['BND_BootSWCLKSignalPath_M4']['_XWidth'] = tmp2[0][0][0][0]['_Xwidth']

        ## Define Boundary_element _XYCoordinates
        self._DesignParameter['BND_BootSWCLKSignalPath_M4']['_XYCoordinates'] = [[0, 0]]
        ...
        ## Approaching_coord: _XY_type2
        tmp2 = self.get_param_KJH4('BND_BootSWCLKSignalPath_M4')
        approaching_coord = tmp2[0][0]['_XY_down_right']
        ## Sref coord
        tmp3 = self.get_param_KJH4('BND_BootSWCLKSignalPath_M4')
        Scoord = tmp3[0][0]['_XY_origin']
        ...
        tmpXY.append(New_Scoord)
        ## Define coordinates
        self._DesignParameter['BND_BootSWCLKSignalPath_M4']['_XYCoordinates'] = tmpXY
...
if __name__ == '__main__':
    ...
    libname = 'M00_00_6bit_SARADC_300MSs_target_v8'
    ## CellName: ex)C01_cap_array_v2_84
    cellname = 'M00_00_CDACWtSARLogic_unfold6_c'
    ...
    InputParams = dict(
        ...
        _Samp_Tr11_PMOSChannelWidth=400,
