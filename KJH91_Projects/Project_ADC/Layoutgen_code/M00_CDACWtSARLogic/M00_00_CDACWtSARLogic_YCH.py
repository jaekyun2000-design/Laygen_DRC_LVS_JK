...
if __name__ == '__main__':
    ...
    libname = 'M00_00_6bit_SARADC_300MSs_target_v5'
    ## CellName: ex)C01_cap_array_v2_84
    cellname = 'M00_00_CDACWtSARLogic_unfold6'
    ...
    InputParams = dict(
        ...
        ## Inverter Chain
        ## Inv1 common
        _Buf_CLKSrc_NumberofGate=[1,4,16,64,64,128],  # Vector
        _Buf_CLKSrc_ChannelLength=30,  # Scalar
        _Buf_CLKSrc_XVT='SLVT',  # 'SLVT'
        ...
        # Tr4
        _Samp_Tr4_NMOSNumberofGate=1,  # number
        _Samp_Tr4_NMOSChannelWidth=200,  # number
        ...
        # Tr8
        _Samp_Tr8_NMOSNumberofGate=1,  # number (ref:4)
        _Samp_Tr8_NMOSChannelWidth=200,  # number (ref:500)
        ...
        ## VddTieCell4
        # VddTieCell4 NMOS
        _Samp_Tie4N_NMOSNumberofGate=1,  # number
        ...
        # VddTieCell4 PMOS
        _Samp_Tie4P_PMOSNumberofGate=1,  # number
        ...
        ## VddTieCell8
        # VddTieCell8 NMOS
        _Samp_Tie8N_NMOSNumberofGate=1,  # number
        ...
        # VddTieCell8 PMOS
        _Samp_Tie8P_PMOSNumberofGate=1,  # number
        ...
        # Tr3
        _Samp_Tr3_NMOSNumberofGate=1,  # number
        ...
        # HDVNCAP_Array
        _Samp_HDVNCAP_Length=5500,  # 22u M
        _Samp_HDVNCAP_LayoutOption=[3, 4, 5, 6],
        _Samp_HDVNCAP_NumFigPair=19,  # 9.55u M == 94개
