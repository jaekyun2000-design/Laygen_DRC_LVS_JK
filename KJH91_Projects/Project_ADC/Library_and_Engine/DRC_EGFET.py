...
class DRCNP:
    def __init__(self):
        ...
        if DesignParameters._Technology == 'SS28nm': # There is no NP layer in 28nm, junung
            self._NpMinWidth = 180
            self._NpMinSpace = 180
...
class DRCPOLYGATE:
    def __init__(self):
        ...
        if DesignParameters._Technology== 'SS28nm':
            ...
            self._PolygateMinSpace=114 # EG에 맞게 바꿈
            self._PolygateMinSpace2=140 # polygateminspace -> EG에 맞게 바꿈
...
class DRCCO:
    def __init__(self):
        ...
        if DesignParameters._Technology == 'SS28nm':
            self._CoMinWidth = 40 # EGFET DRC 바꾼 부분
            self._CoMinSpace = 60
...
class DRCMETAL1:
    def __init__(self):
        ...
        if DesignParameters._Technology== 'SS28nm':
            ...
            # self._Metal1MinEnclosureViaX = 32  # jihoon
            # self._Metal1MinEnclosureViaY = 24  # jihoon
...
class DRCNW:
    def __init__(self):
        ...
        if DesignParameters._Technology == 'SS28nm':
            ...
            self._NwMinEnclosurePactive=56
            self._NwMinEnclosurePactive2 = 164  # GR260a  # EGFET 바꾼 부분
...
class DRCVIAx:
    def __init__(self):
        ...
        if DesignParameters._Technology== 'SS28nm':
            ...
            # self._VIAxMinSpaceX=84 # jihoon, by
            # self._VIAxMinSpaceY=92 # jihoon
...
# class DRCEG:
    ...
    #         self._EGMinWidth =
    #         self._EGMinSpace =
    #         self._EGMinExtensionOnOD =
    #         self._EGMinArea =
    #         self._EGMinArea2 =    ## EG (BH) Minimum Area ??, junung
    #
    # def DRCSLVTMinSpace(self, _Width=None, _ParallelLength=None):
    #     if DesignParameters._Technology == 'SS28nm':
    #         if _Width == None and _ParallelLength == None:
    #             return self._EGMinSpace
    #         else:
    #             return self._EGMinSpace

class DRCXVT:
    # XVT means {SLVT, LVT, HVT}. So far, all XVT's DRC rules are all the same. If different rules are found, it should be changed. EG 추가됨
    def __init__(self):
        if DesignParameters._Technology == 'SS28nm': # EG 용 DRC
            self._XvtMinWidth = 100
            self._XvtMinSpace = 100
            self._XvtMinExtensionOnOD = 250   # GRSLVT9b
            self._XvtMinEnclosureOfODX = 130 # 못 찾겠음  # This value is calculated by GRSLVT9a(horizontal direction)
            self._XvtMinEnclosureOfODY = 250  # GRSLVT9b (vertical direction,  same with _XvtMinExtensionOnOD)
            self._XvtMinArea = 160000
...
class DRC_HDVNCAP_KJH:
    #
    def __init__(self):
        if DesignParameters._Technology == 'SS28nm':
            self._PortABSpace = 50
            self._PortABZigzag = 150
            self._FingertoBoundary = 100
            self._FingerWidth = 50

class DRC_DeepNwell_KJH:
    #
    def __init__(self):
        if DesignParameters._Technology == 'SS28nm':
            self._T3NwellOverlap = 450 #margin 50
            self._T3toT3minspace = 3500

class DRC_Etc_KJH:
    #
    def __init__(self):
        if DesignParameters._Technology == 'SS28nm':
            self._GR353 = 56 #Rx p+ junction mimimum within BP

class DRC(DRCMultiplicantForMinEdgeWidth, DRCOD, DRCPOLYGATE, DRCPP, DRCNP, DRCCO, DRCMETAL1, DRCMETALy, DRCVIAy, DRCMETALz, DRCVIAz, DRCMETALr, DRCVIAr, DRCNW, DRCVIAx,DRCMETALx, DRCMinSnapSpacing, DRCRPO, DRCSLVT, DRCXVT, DRC_HDVNCAP_KJH):
    def __init__(self ):
        DRCNW.__init__(self)
        DRCOD.__init__(self)
        ...
        DRC_HDVNCAP_KJH.__init__(self)
        DRC_DeepNwell_KJH.__init__(self)
        DRC_Etc_KJH.__init__(self)
