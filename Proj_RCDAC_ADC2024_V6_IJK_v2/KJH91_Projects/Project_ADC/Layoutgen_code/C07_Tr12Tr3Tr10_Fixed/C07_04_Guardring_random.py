...
from KJH91_Projects.Project_ADC.Layoutgen_code.A_Basic_Building_Block import A09_NbodyRing_KJH3
    ...
    ## KJH91 Basic Building Blocks
from Proj_RCDAC_ADC2024_V6_IJK_v2.KJH91_Projects.Project_ADC.Layoutgen_code.C07_Tr12Tr3Tr10_Fixed import C07_03_Tr12Tr3Tr10_v2
...
if __name__ == '__main__':
    ...
    for _iter in range(5):
        ...
        cellname = 'C07_04_Guardring_v{}'.format(_iter + 1)
        _fileName = cellname + '.gds'

        _Tr12_Gate = random.randrange(1, 5, 1)
        _Tr3_Gate = random.randrange(1, 5, 1)
        _Tr10_Gate = random.randrange(1, 5, 1)
        _Tr12_Tr3_Tr10_Width = random.randrange(400, 1000, 100)
        ''' Input Parameters for Layout Object '''
        InputParams = dict(
    # TR12
        # Physical dimension
        _Tr12_NumberofGate	            = _Tr12_Gate,       # Number
        _Tr12_ChannelWidth	            = _Tr12_Tr3_Tr10_Width,     # Number
        _Tr12_ChannelLength	            = 30,       # Number
        _Tr12_XVT				        = 'RVT',    # 'XVT' ex)SLVT/LVT/RVT/HVT
    # TR3
        # Physical dimension
        _Tr3_NumberofGate	            = _Tr3_Gate,       # Number
        _Tr3_ChannelWidth	            = _Tr12_Tr3_Tr10_Width,     # Number
        _Tr3_ChannelLength	            = 30,       # Number
        _Tr3_XVT				        = 'LVT',    # 'XVT' ex)SLVT/LVT/RVT/HVT
    # TR10
        # Physical dimension
        _Tr10_NumberofGate	            = _Tr10_Gate,       # Number
        _Tr10_ChannelWidth	            = _Tr12_Tr3_Tr10_Width,     # Number
        _Tr10_ChannelLength	            = 30,       # Number
        _Tr10_XVT				        = 'RVT',    # 'XVT' ex)SLVT/LVT/RVT/HVT
