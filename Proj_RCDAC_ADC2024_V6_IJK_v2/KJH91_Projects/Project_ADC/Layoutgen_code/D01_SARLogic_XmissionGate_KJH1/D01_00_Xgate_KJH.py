...
class _Xgate(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    # PMosfet
        ...
        _PMOS_PODummy_Placement          = 'Dn',  # None/'Up'/'Dn'/
...
if __name__ == '__main__':
    ...
    libname = 'Proj_RcdacSar_D01_SARLogic_XmissionGate_KJH1'
    ...
    # NMosfet
        ...
        _NMOS_Source_Via_TF              = True,     # True/False
                # Via close to POpin
        _NMOS_Source_Via_Close2POpin_TF  = True,     # True/False
            # Comb setting: If Via is True
        _NMOS_Source_Comb_TF             = True,     # True/False
                # Comb POPinward
        _NMOS_Source_Comb_POpinward_TF   = False,     # True/False
                # Comb vertical_length
        _NMOS_Source_Comb_Length         = None,     # None/Number
        ...
        _NMOS_Drain_Via_TF               = True,     # True/False
                # Via close to POpin
        _NMOS_Drain_Via_Close2POpin_TF   = False,     # True/False
            # Comb setting: If Via is True
        _NMOS_Drain_Comb_TF              = True,     # True/False
                # Comb POPinward
        _NMOS_Drain_Comb_POpinward_TF    = True,     # True/False
    ...
    # PMosfet
        ...
        _PMOS_Source_Via_TF              = True,     # True/False
                # Via close to POpin
        _PMOS_Source_Via_Close2POpin_TF  = True,     # True/False
            # Comb setting: If Via is True
        _PMOS_Source_Comb_TF             = True,     # True/False
                # Comb POPinward
        _PMOS_Source_Comb_POpinward_TF   = False,     # True/False
                # Comb vertical_length
        _PMOS_Source_Comb_Length         = None,     # None/Number
        ...
        _PMOS_Drain_Via_TF               = True,     # True/False
                # Via close to POpin
        _PMOS_Drain_Via_Close2POpin_TF   = False,     # True/False
            # Comb setting: If Via is True
        _PMOS_Drain_Comb_TF              = True,     # True/False
                # Comb POPinward
        _PMOS_Drain_Comb_POpinward_TF    = True,     # True/False
                # Comb vertical_length
        _PMOS_Drain_Comb_Length          = None,     # None/Number
