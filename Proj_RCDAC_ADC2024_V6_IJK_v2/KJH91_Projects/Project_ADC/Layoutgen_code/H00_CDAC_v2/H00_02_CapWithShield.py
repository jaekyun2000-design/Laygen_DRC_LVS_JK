...
from Proj_RCDAC_ADC2024_V6_IJK_v2.KJH91_Projects.Project_ADC.Layoutgen_code.H00_CDAC_v2 import H00_01_UCAP
...
class _CapWithShield(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        ## CALCULATION START
        CapWithShield_start_time = time.time()
        print('##############################')
        ...
        _Caculation_Parameters = copy.deepcopy(H00_01_UCAP._UCAP._ParametersForDesignCalculation)
        ...
        self._DesignParameter['SRF_UCAP'] = self._SrefElementDeclaration(_DesignObj=H00_01_UCAP._UCAP(_DesignParameter=None, _Name='{}:SRF_UCAP'.format(_Name)))[0]
    ...
    ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## Via Gen: Extended node via
        ...
        for i in range(_NumOfElement) :
            for j in range(2) :
                ## Calculate
                ## Target_coord
                tmp1 = self.get_param_KJH4('SRF_UCAP','SRF_ECAP','SRF_Top_ViaM{}M{}'.format(_LayoutOption[0],7),'SRF_ViaM{}M{}'.format(6,7),'BND_Met{}Layer'.format(6))
                ...
                ## Approaching_coord
                tmp2 = self.get_param_KJH4('SRF_Shield_ViaM{}M{}'.format(_ShieldingLayer,7),'SRF_ViaM{}M{}'.format(6,7),'BND_Met{}Layer'.format(6))
        ...
        print('##############################')
        CapWithShield_end_time = time.time()
        self.CapWithShield_elapsed_time = CapWithShield_end_time - CapWithShield_start_time
...
if __name__ == '__main__':
    ...
    libname = 'Proj_ZZ00_RcdacSar_H00_02_CapWidthShield'
    cellname = 'H00_02_CDAC_CapWithShield99'
