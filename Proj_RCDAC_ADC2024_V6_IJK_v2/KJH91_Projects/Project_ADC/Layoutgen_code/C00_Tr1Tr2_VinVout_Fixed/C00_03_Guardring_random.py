...
# Guardring
    ...
    _NwellWidth     = 850,  # number
        ...
        _Caculation_Parameters = copy.deepcopy(C00_02_Tr1Tr2._Tr1Tr2._ParametersForDesignCalculation)
        ...
        self._DesignParameter['SRF_Tr1Tr2'] = self._SrefElementDeclaration(_DesignObj=C00_02_Tr1Tr2._Tr1Tr2(_DesignParameter=None, _Name='{}:SRF_Tr1Tr2'.format(_Name)))[0]

                ## Define Sref Reflection: ex)self._DesignParameter['_NMOS_POWER']['_Reflect'] = [0, 0, 0]
        self._DesignParameter['SRF_Tr1Tr2']['_Reflect'] = [0, 0, 0]

                ## Define Sref Angle: ex)'_NMOS_POWER'
        self._DesignParameter['SRF_Tr1Tr2']['_Angle'] = 0

                ## Calculate Sref Layer by using Calculation_Parameter: ex)'_NMOS_POWER'
        self._DesignParameter['SRF_Tr1Tr2']['_DesignObj']._CalculateDesignParameter(**_Caculation_Parameters)

                ## Define Sref _XYcoordinate: ex)'_NMOS_POWER'
        self._DesignParameter['SRF_Tr1Tr2']['_XYCoordinates'] = [[0, 0]]
        ...
        tmp = self.get_outter_KJH4('SRF_Tr1Tr2')
        ...
        ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## Tr2_Source_Pbody_M1connect(Cbot)
        ## Generate Boundary_element: ex)LayerName: METAL1 / DIFF (_ODLayer) / POLY / PIMP (_PPLayer) / NWELL / SLVT LVT RVT HVT / OP(OPpress) / CONT (CA) / PCCRIT
        self._DesignParameter['BND_Tr2_Source_Vtc_M1'] = self._BoundaryElementDeclaration(
        ...
        tmp2 = self.get_param_KJH4('SRF_Tr1Tr2', 'SRF_Tr2','SRF_Nmos', 'BND_Source_M1')
        self._DesignParameter['BND_Tr2_Source_Vtc_M1']['_YWidth'] = abs( tmp2[0][0][0][0][0]['_XY_down'][1] - tmp1[0][0][0][0][0]['_XY_up'][1])

        ## Define Boundary_element _XWidth
        tmp = self.get_param_KJH4('SRF_Tr1Tr2', 'SRF_Tr2', 'SRF_Nmos', 'BND_Source_M1')
        self._DesignParameter['BND_Tr2_Source_Vtc_M1']['_XWidth'] = tmp[0][0][0][0][0]['_Xwidth']

        ## Define Boundary_element _XYCoordinates
        self._DesignParameter['BND_Tr2_Source_Vtc_M1']['_XYCoordinates'] = [[0, 0]]
        ...
        self._DesignParameter['BND_Tr2_Source_Vtc_M1']['_XYCoordinates'] = [[0, 0]]
        tmp = self.get_param_KJH4('SRF_Tr1Tr2', 'SRF_Tr2', 'SRF_Nmos', 'BND_Source_M1')
        tmp2 = self.get_param_KJH4('BND_Tr2_Source_Vtc_M1')
        tmp3 = self.get_param_KJH4('BND_Tr2_Source_Vtc_M1')

        for i in range(0, len(tmp[0][0][0])):
            ## Calculate
            ## Target_coord: _XY_type1
            tmp1 = self.get_param_KJH4('SRF_Tr1Tr2', 'SRF_Tr2', 'SRF_Nmos','BND_Source_M1')
            ...
            tmpXY.append(New_Scoord)
            ## Define coordinates
        self._DesignParameter['BND_Tr2_Source_Vtc_M1']['_XYCoordinates'] = tmpXY
        ...
        _Caculation_Parameters['_Vtc_flag'] = True
                ...
                ## Cal length
        tmp1 = self.get_param_KJH4('SRF_Pbodyring', 'SRF_PbodyRight', 'SRF_PbodyContactPhyLen', 'BND_Met1Layer')
        _Caculation_Parameters['_Length'] = tmp1[0][0][0][0][0]['_Ywidth']

                ## Generate Sref: ex)self._DesignParameter['_NMOS_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_nmos_power_v2._NMOS_POWER( _DesignParameter=None, _Name='{}:NMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_Nbody_withinPIsolated'] = self._SrefElementDeclaration(_DesignObj=A07_NbodyContactPhyLen_KJH3._NbodyContactPhyLen(_DesignParameter=None, _Name='{}:SRF_Nbody_withinPIsolated'.format(_Name)))[0]
        ...
        tmpXY = []
                        ## Calculate
                                ##y
        tmp1_1 = self.get_param_KJH4('SRF_Pbodyring', 'SRF_PbodyRight', 'SRF_PbodyContactPhyLen', 'BND_Met1Layer')
        target_coord = tmp1_1[0][0][0][0][0]['_XY_up_right']
        ...
        Scoord = tmp3[0][0]['_XY_origin']
        Scoord[0] = Scoord[0] + max(SpaceBtwPbodyRingNbodyContactInT3, _DRCobj._PpMinSpace)
        ...
        del self._DesignParameter['SRF_Nbody_withinPIsolated']['_DesignObj']._DesignParameter['SRF_NbodyContactPhyLen']['_DesignObj']._DesignParameter['BND_Nwell']
        ...
        tmp1_3 = self.get_param_KJH4('SRF_Nbody_withinPIsolated', 'SRF_NbodyContactPhyLen', 'BND_Met1Layer')
        tmp_mostright = self.get_param_KJH4('SRF_Pbodyring', 'BND_ExtenPPLayer_Right')
        tmp_mostleft  = self.get_param_KJH4('SRF_Pbodyring', 'BND_ExtenPPLayer_Left')
        tmp_mostup    = self.get_param_KJH4('SRF_Pbodyring', 'BND_ExtenPPLayer_Top')
        tmp_mostdown  = self.get_param_KJH4('SRF_Pbodyring', 'BND_ExtenPPLayer_Bottom')

        ## Define _XlengthIntn
        # _Caculation_Parameters['_XlengthIntn'] = abs( tmp1_3[0][0][0][0]['_XY_right'][0] - tmp['_Mostleft']['coord'][0]) + 2*_NwellWidth + _right_margin2 + _left_margin2
        _Caculation_Parameters['_XlengthIntn'] = abs( tmp_mostright[0][0][0]['_XY_right'][0] - tmp_mostleft[0][0][0]['_XY_left'][0]) + 2*_NwellWidth + _right_margin2 + _left_margin2

        ## Define _YlengthIntn
        _Caculation_Parameters['_YlengthIntn'] = abs( tmp_mostup[0][0][0]['_XY_up'][1] - tmp_mostdown[0][0][0]['_XY_down'][1]) + 2*_NwellWidth + _up_margin2 + _down_margin2
        ...
        ## Calculate
        ## Target_coord
        target_coord = [tmp_mostleft[0][0][0]['_XY_left'][0], tmp_mostdown[0][0][0]['_XY_down'][1]]
        ## Approaching_coord
        ## x
        ...
        _Caculation_Parameters['_Length'] = tmp1[0][0][0][0]['_Ywidth']

                ## Generate Sref: ex)self._DesignParameter['_NMOS_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_nmos_power_v2._NMOS_POWER( _DesignParameter=None, _Name='{}:NMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_Pbody_withinNW'] = self._SrefElementDeclaration(_DesignObj=A08_PbodyContactPhyLen_KJH3._PbodyContactPhyLen(_DesignParameter=None, _Name='{}:SRF_Pbody_withinNW'.format(_Name)))[0]
        ...
        tmp1_2 = self.get_param_KJH4('SRF_Nbodyring', 'SRF_NbodyRight', 'SRF_NbodyContactPhyLen', 'BND_Met1Layer')
        target_coord = [tmp1_2[0][0][0][0][0]['_XY_left'][0], tmp1_1[0][0][0][0]['_XY_up'][1]]
        ...
        Scoord = tmp3[0][0]['_XY_origin']
        Scoord[0] = Scoord[0] - max(SpaceBtwNbodyRingPbodyContactInNW, _DRCobj._OdMinSpace2Pp)
        ...
        self._DesignParameter['BND_PPEnclosurePBody_withinNW']['_YWidth'] = tmp1[0][0][0][0]['_Ywidth'] + 2 * _DRCobj._PpMinExtensiononPactive

        ## Define Boundary_element _XWidth
        self._DesignParameter['BND_PPEnclosurePBody_withinNW']['_XWidth'] = tmp1[0][0][0][0]['_Xwidth'] + 2 * _DRCobj._PpMinExtensiononPactive
        ## Calculate Sref XYcoord
        tmpXY = []
        ## initialized Sref coordinate
        ...
        _XYCoordinates=[],
                ...
                ## Define Boundary_element _YWidth
        Pbody_Nbody_withinPsub_M1HrzPathWidth = 300
        self._DesignParameter['BND_Pbody_Nbody_withinPsub_Hrz_M1']['_YWidth'] = Pbody_Nbody_withinPsub_M1HrzPathWidth

                ## Define Boundary_element _XWidth
        tmp2 = self.get_param_KJH4('SRF_Nbody_withinPIsolated', 'SRF_NbodyContactPhyLen', 'BND_Met1Layer')
        tmp3 = self.get_param_KJH4('SRF_Pbody_withinNW', 'SRF_PbodyContactPhyLen', 'BND_Met1Layer')
        self._DesignParameter['BND_Pbody_Nbody_withinPsub_Hrz_M1']['_XWidth'] = abs(tmp2[0][0][0][0]['_XY_left'][0] - tmp3[0][0][0][0]['_XY_right'][0])
        ...
        self._DesignParameter['BND_Pbody_Nbody_withinPsub_Hrz_M1']['_XYCoordinates'] = [[0, 0]]
                        ## Calculate
                            ## Target_coord: _XY_type1
        target_coord = tmp2[0][0][0][0]['_XY_left']
                            ## Approaching_coord: _XY_type2
...
if __name__ == '__main__':
    ...
    # libname = 'Proj_ZZ01_C00_03_Guardring_fixed'
    ## CellName: ex)C01_cap_array_v2_84
    cellname = 'C00_03_Guardring_v0'
...
# TR1
    ...
    _Tr1_ChannelWidth	            = 100,     # Number
    _Tr1_ChannelLength	            = 30,       # Number
    _Tr1_XVT				        = 'LVT',    # 'XVT' ex)SLVT/LVT/RVT/HVT
