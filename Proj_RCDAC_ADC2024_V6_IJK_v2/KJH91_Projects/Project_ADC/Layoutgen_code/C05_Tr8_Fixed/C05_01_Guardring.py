...
from KJH91_Projects.Project_ADC.Layoutgen_code.A_Basic_Building_Block import A13_NbodyRingforDeepNwell_KJH
    ...
    ##
from Proj_RCDAC_ADC2024_V6_IJK_v2.KJH91_Projects.Project_ADC.Layoutgen_code.C05_Tr8_Fixed import C05_00_Tr8
...
# TR8
    ...
    _Tr8_XVT				        = 'RVT',    # 'XVT' ex)SLVT/LVT/RVT/HVT
        ...
        _XYCoordinates=[],
                ...
                ## Define Boundary_element _YWidth
        tmp1 = self.get_param_KJH4('SRF_Tr8','SRF_Nmos','BND_Source_M1')
        ...
        self._DesignParameter['BND_Tr8_Source_Vtc_M1']['_YWidth'] = abs(tmp1[0][0][0][0]['_XY_down'][1] - tmp2[0][0][0][0][0]['_XY_up'][1])
                ...
                ## Define Boundary_element _XWidth
        tmp = self.get_param_KJH4('SRF_Tr8','SRF_Nmos','BND_Source_M1')
...
if __name__ == '__main__':
    ...
    libname = 'Proj_ZZ01_C05_01_Guardring_Fixed'
