...
from KJH91_Projects.Project_ADC.Layoutgen_code.L00_SARLogicWtComparator import L00_SARLogicWtComparator_YJH
...
from KJH91_Projects.Project_ADC.Layoutgen_code.C13_C07C11C12TieCellsRouted_Fixed import C13_01_CtopCbotRouted_YJ_v01_00_random
from KJH91_Projects.Project_ADC.Layoutgen_code.D00_SARLogic_Inverter_KJH1 import D00_00_Inverter_KJH

global RuntimeRecord, elapsed_time, CDAC_time, SARLogic_time, BootSW_time
...
class _CDACWtSARLogic(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    _ParametersForDesignCalculation = dict(
        ...
        # Tr1 and Tr2
        # Tr1
        _Samp_Tr1_NumberofGate=3,  # number
        _Samp_Tr1_ChannelWidth=1000,  # number
        _Samp_Tr1_ChannelLength=30,  # number
        _Samp_Tr1_XVT='LVT',  # 'XVT' ex)SLVT LVT RVT HVT
    ...
    def _CalculateDesignParameter(self,
        ...
        _Caculation_Parameters1 = copy.deepcopy(
            L00_SARLogicWtComparator_YJH._SARLogicWtComparator._ParametersForDesignCalculation)
        ...
        self._DesignParameter['SRF_SARLogicWtComparator'] = self._SrefElementDeclaration(
            _DesignObj=L00_SARLogicWtComparator_YJH._SARLogicWtComparator(_DesignParameter=None,
        ...
        SARLogic_time = time.time() - start_time
        ...
        ## Calculate Sref Layer by using Calculation_Parameter: ex)'_NMOS_POWER'
        # self._DesignParameter['SRF_CDAC_Neg']['_DesignObj']._CalculateDesignParameter(**_Caculation_Parameters0)
        ...
        CDAC_time = time.time() - start_time
        ...
        _Caculation_Parameters['_Sampler_Inputnode_width'] = _Samp_Inputnode_width
        _Caculation_Parameters['_Sampler_Outputnode_width'] = _Samp_Outputnode_width

        _Caculation_Parameters['_Sampler_Tr1_NumberofGate'] = _Samp_Tr1_NumberofGate
        _Caculation_Parameters['_Sampler_Tr1_ChannelWidth'] = _Samp_Tr1_ChannelWidth
        _Caculation_Parameters['_Sampler_Tr1_ChannelLength'] = _Samp_Tr1_ChannelLength
        _Caculation_Parameters['_Sampler_Tr1_XVT'] = _Samp_Tr1_XVT

        _Caculation_Parameters['_Sampler_Tr2_NumberofGate'] = _Samp_Tr2_NumberofGate
        _Caculation_Parameters['_Sampler_Tr2_ChannelWidth'] = _Samp_Tr2_ChannelWidth
        _Caculation_Parameters['_Sampler_Tr2_ChannelLength'] = _Samp_Tr2_ChannelLength
        _Caculation_Parameters['_Sampler_Tr2_XVT'] = _Samp_Tr2_XVT

        _Caculation_Parameters['_Sampler_Tr4_NumberofGate'] = _Samp_Tr4_NumberofGate
        _Caculation_Parameters['_Sampler_Tr4_ChannelWidth'] = _Samp_Tr4_ChannelWidth
        _Caculation_Parameters['_Sampler_Tr4_ChannelLength'] = _Samp_Tr4_ChannelLength
        _Caculation_Parameters['_Sampler_Tr4_XVT'] = _Samp_Tr4_XVT

        _Caculation_Parameters['_Sampler_Tr5_NumberofGate'] = _Samp_Tr5_NumberofGate
        _Caculation_Parameters['_Sampler_Tr5_ChannelWidth'] = _Samp_Tr5_ChannelWidth
        _Caculation_Parameters['_Sampler_Tr5_ChannelLength'] = _Samp_Tr5_ChannelLength
        _Caculation_Parameters['_Sampler_Tr5_XVT'] = _Samp_Tr5_XVT

        _Caculation_Parameters['_Sampler_Tr7_NumberofGate'] = _Samp_Tr7_NumberofGate
        _Caculation_Parameters['_Sampler_Tr7_ChannelWidth'] = _Samp_Tr7_ChannelWidth
        _Caculation_Parameters['_Sampler_Tr7_ChannelLength'] = _Samp_Tr7_ChannelLength
        _Caculation_Parameters['_Sampler_Tr7_XVT'] = _Samp_Tr7_XVT

        _Caculation_Parameters['_Sampler_Tr9_NumberofGate'] = _Samp_Tr9_NumberofGate
        _Caculation_Parameters['_Sampler_Tr9_ChannelWidth'] = _Samp_Tr9_ChannelWidth
        _Caculation_Parameters['_Sampler_Tr9_ChannelLength'] = _Samp_Tr9_ChannelLength
        _Caculation_Parameters['_Sampler_Tr9_XVT'] = _Samp_Tr9_XVT

        _Caculation_Parameters['_Sampler_Tr8_NumberofGate'] = _Samp_Tr8_NumberofGate
        _Caculation_Parameters['_Sampler_Tr8_ChannelWidth'] = _Samp_Tr8_ChannelWidth
        _Caculation_Parameters['_Sampler_Tr8_ChannelLength'] = _Samp_Tr8_ChannelLength
        _Caculation_Parameters['_Sampler_Tr8_XVT'] = _Samp_Tr8_XVT

        _Caculation_Parameters['_Sampler_Tr6_NumberofGate'] = _Samp_Tr6_NumberofGate
        _Caculation_Parameters['_Sampler_Tr6_ChannelWidth'] = _Samp_Tr6_ChannelWidth
        _Caculation_Parameters['_Sampler_Tr6_ChannelLength'] = _Samp_Tr6_ChannelLength
        _Caculation_Parameters['_Sampler_Tr6_XVT'] = _Samp_Tr6_XVT

        _Caculation_Parameters['_Sampler_Tr11_NumberofGate'] = _Samp_Tr11_NumberofGate
        _Caculation_Parameters['_Sampler_Tr11_ChannelWidth'] = _Samp_Tr11_ChannelWidth
        _Caculation_Parameters['_Sampler_Tr11_ChannelLength'] = _Samp_Tr11_ChannelLength
        _Caculation_Parameters['_Sampler_Tr11_XVT'] = _Samp_Tr11_XVT

        _Caculation_Parameters['_Sampler_Tie4N_NumberofGate'] = _Samp_Tie4N_NumberofGate
        _Caculation_Parameters['_Sampler_Tie4N_ChannelWidth'] = _Samp_Tie4N_ChannelWidth
        _Caculation_Parameters['_Sampler_Tie4N_ChannelLength'] = _Samp_Tie4N_ChannelLength
        _Caculation_Parameters['_Sampler_Tie4N_XVT'] = _Samp_Tie4N_XVT

        _Caculation_Parameters['_Sampler_Tie4P_NumberofGate'] = _Samp_Tie4P_NumberofGate
        _Caculation_Parameters['_Sampler_Tie4P_ChannelWidth'] = _Samp_Tie4P_ChannelWidth
        _Caculation_Parameters['_Sampler_Tie4P_ChannelLength'] = _Samp_Tie4P_ChannelLength
        _Caculation_Parameters['_Sampler_Tie4P_XVT'] = _Samp_Tie4P_XVT

        _Caculation_Parameters['_Sampler_Tie8N_NumberofGate'] = _Samp_Tie8N_NumberofGate
        _Caculation_Parameters['_Sampler_Tie8N_ChannelWidth'] = _Samp_Tie8N_ChannelWidth
        _Caculation_Parameters['_Sampler_Tie8N_ChannelLength'] = _Samp_Tie8N_ChannelLength
        _Caculation_Parameters['_Sampler_Tie8N_XVT'] = _Samp_Tie8N_XVT

        _Caculation_Parameters['_Sampler_Tie8P_NumberofGate'] = _Samp_Tie8P_NumberofGate
        _Caculation_Parameters['_Sampler_Tie8P_ChannelWidth'] = _Samp_Tie8P_ChannelWidth
        _Caculation_Parameters['_Sampler_Tie8P_ChannelLength'] = _Samp_Tie8P_ChannelLength
        _Caculation_Parameters['_Sampler_Tie8P_XVT'] = _Samp_Tie8P_XVT

        _Caculation_Parameters['_Sampler_Tr12_NumberofGate'] = _Samp_Tr12_NumberofGate
        _Caculation_Parameters['_Sampler_Tr12_ChannelWidth'] = _Samp_Tr12_ChannelWidth
        _Caculation_Parameters['_Sampler_Tr12_ChannelLength'] = _Samp_Tr12_ChannelLength
        _Caculation_Parameters['_Sampler_Tr12_XVT'] = _Samp_Tr12_XVT

        _Caculation_Parameters['_Sampler_Tr3_NumberofGate'] = _Samp_Tr3_NumberofGate
        _Caculation_Parameters['_Sampler_Tr3_ChannelWidth'] = _Samp_Tr3_ChannelWidth
        _Caculation_Parameters['_Sampler_Tr3_ChannelLength'] = _Samp_Tr3_ChannelLength
        _Caculation_Parameters['_Sampler_Tr3_XVT'] = _Samp_Tr3_XVT

        _Caculation_Parameters['_Sampler_Tr10_NumberofGate'] = _Samp_Tr10_NumberofGate
        _Caculation_Parameters['_Sampler_Tr10_ChannelWidth'] = _Samp_Tr10_ChannelWidth
        _Caculation_Parameters['_Sampler_Tr10_ChannelLength'] = _Samp_Tr10_ChannelLength
        _Caculation_Parameters['_Sampler_Tr10_XVT'] = _Samp_Tr10_XVT

        _Caculation_Parameters['_Sampler_HDVNCAP_Length'] = _Samp_HDVNCAP_Length
        _Caculation_Parameters['_Sampler_HDVNCAP_LayoutOption'] = _Samp_HDVNCAP_LayoutOption
        _Caculation_Parameters['_Sampler_HDVNCAP_NumFigPair'] = _Samp_HDVNCAP_NumFigPair
        _Caculation_Parameters['_Sampler_HDVNCAP_Array'] = _Samp_HDVNCAP_Array
        _Caculation_Parameters['_Sampler_HDVNCAP_Cbot_Ctop_metalwidth'] = _Samp_HDVNCAP_Cbot_Ctop_metalwidth
        ...
        BootSW_time = time.time() - start_time
...
if __name__ == '__main__':
    ...
    libname = 'Proj_ADC_M00_FianlADCBlock_RuntimeCheck_NewSampler'
    ## CellName: ex)C01_cap_array_v2_84
    cellname = 'M00_00_CDACWtSARLogic_unfold8_RenamedVersion2'
    ...
    InputParams = dict(
        ...
        _Driver_DecimationIfDriverPlacedInCommonCentroid=True,
        _Driver_DecimationFactor=[2, 0, 0],
        ...
        _SARLogic_CLKBufTreeTop_XOffSet=-79,  # (8Bit DRC check:-79)
        ...
        _CDAC_ShieldingLayer=4,  # Poly:0, M1:1, M2:2 ...
        _CDAC_MetalWidth=50,
        _CDAC_MetalLength=1410,  # (8bit size: 1414/ 10bit size: 2800/ 12bit size: 4200)
        _CDAC_MetalSpacing=50,
        ...
        # # CommonCentroid With Driving node
        _CDAC_CapArrayWDrivingNodeDistance=1500,
    ...
    # h, m = divmod(m, 60)
    # global RuntimeRecord
    # RuntimeRecord = open('Runtime_{}.txt'.format(cellname), 'w')
    # print('#############################      Runtime       ################################', file=RuntimeRecord)
    # print(cellname, file=RuntimeRecord)
    # print(str(h)+'h '+str(m)+ 'm '+str(s)+'s', file=RuntimeRecord)
    # RuntimeRecord.close
    ...
    print(cellname, file=RuntimeRecord)
    timeline = []
    timeline.append(SARLogic_time)
    timeline.append(CDAC_time)
    timeline.append(BootSW_time)
    timeline.append(elapsed_time)
    for i in timeline:
        m, s = divmod(i, 60)
        h, m = divmod(m, 60)
        print(str(h)+'h '+str(m)+ 'm '+str(s)+'s', file=RuntimeRecord)
    print('#############################      Sys Info       ################################', file=RuntimeRecord)
    print('OS                   :\t', platform.system(), file=RuntimeRecord)
    print('OS Version           :\t', platform.version(), file=RuntimeRecord)
    print('Process information  :\t', platform.processor(), file=RuntimeRecord)
    print('Process Architecture :\t', platform.machine(), file=RuntimeRecord)
    print('RAM Size             :\t', str(round(psutil.virtual_memory().total / (1024.0 ** 3))) + "(GB)", file=RuntimeRecord)
    RuntimeRecord.close
