...
if __name__ == '__main__':
    ...
    InputParams = dict(
        ...
        # PMOSA
        _NANDS_PMOSA_PMOSNumberofGate=1,  # number
        ...
        # PMOSB
        _NANDS_PMOSB_PMOSNumberofGate=1,  # number
        ...
        # PMOSA
        _NANDR_PMOSA_PMOSNumberofGate=1,  # number
        ...
        # PMOSB
        _NANDR_PMOSB_PMOSNumberofGate=1,  # number
