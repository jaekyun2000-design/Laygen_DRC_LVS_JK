...
class _AND(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        _Calculation_Parameters['_NMOSA_PCCrit'] = False
        ...
        _Calculation_Parameters['_NMOSB_PCCrit'] = False
        ...
        _Calculation_Parameters['_PMOSA_PCCrit'] = False
        ...
        _Calculation_Parameters['_PMOSB_PCCrit'] = False
        ...
        self._DesignParameter['SRF_NAND'] = self._SrefElementDeclaration(_DesignObj=E01_02_NAND_YJH_revision._NAND(_DesignParameter=None, _Name='{}:SRF_NAND'.format(_Name)))[0]
...
if __name__ == '__main__':
    ...
    for _iter in range(5):
        ...
        libname = 'Proj_ADC_E01_ComparatorWtLatch_random_v{}'.format(_iter + 6)
