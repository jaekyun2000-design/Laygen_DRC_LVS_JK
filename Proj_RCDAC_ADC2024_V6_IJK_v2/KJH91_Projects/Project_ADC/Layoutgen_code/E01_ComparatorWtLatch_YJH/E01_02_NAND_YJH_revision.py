...
from Proj_RCDAC_ADC2024_V6_IJK_v2.KJH91_Projects.Project_ADC.Layoutgen_code.A_Basic_Building_Block import A03_NmosWithDummy_KJH3
from Proj_RCDAC_ADC2024_V6_IJK_v2.KJH91_Projects.Project_ADC.Layoutgen_code.A_Basic_Building_Block import A04_PmosWithDummy_KJH3
...
from Proj_RCDAC_ADC2024_V6_IJK_v2.KJH91_Projects.Project_ADC.Layoutgen_code.D03_SARLogic_Nand_KJH import D03_00_Pulldown_KJH0
from Proj_RCDAC_ADC2024_V6_IJK_v2.KJH91_Projects.Project_ADC.Layoutgen_code.D03_SARLogic_Nand_KJH import D03_01_Pullup_KJH0
...
class _NAND(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        if _NMOSAB_Pbody_XlvtTop2Pdoby == None:
            ...
            target_coordx = tmp1_1[0][0][0][0]['_XY_down_left']
                                    ## Y
        ...
        if _PMOSAB_Nbody_Xlvtdown2Ndoby == None:
            ...
            target_coordx = tmp1_1[0][0][0][0]['_XY_up_left']
                                    ## Y
        ...
        self._DesignParameter['BND_InputA_Vtc_M1']['_XYCoordinates'] = [[0, 0]]
            ## Calculate
                ## Target_coord: _XY_type1
        if _PMOSA_PMOSNumberofGate == 1 and _NMOSA_NMOSNumberofGate != 1:
            tmp1 = self.get_param_KJH4('SRF_Pulldown','BND_NMOSA_Gate_Hrz_M1')
            target_coord = tmp1[0][0][0]['_XY_down_left']
                    ## Approaching_coord: _XY_type2
            tmp2 = self.get_param_KJH4('BND_InputA_Vtc_M1')
            approaching_coord = tmp2[0][0]['_XY_down_left']
        elif _NMOSA_NMOSNumberofGate == 1 and _PMOSA_PMOSNumberofGate != 1:
            tmp1 = self.get_param_KJH4('SRF_Pullup','BND_PMOSA_Gate_Hrz_M1')
        ...
        ## Define Boundary_element _YWidth
        if (_PMOSA_PMOSNumberofGate == 1 and _NMOSA_NMOSNumberofGate != 1) or (_NMOSA_NMOSNumberofGate == 1 and _PMOSA_PMOSNumberofGate != 1):
            tmp1 = self.get_param_KJH4('SRF_Pulldown', 'BND_NMOSB_Gate_Hrz_M1')
            tmp2 = self.get_param_KJH4('SRF_Pullup', 'BND_PMOSB_Gate_Hrz_M1')
            self._DesignParameter['BND_InputB_Vtc_M1']['_YWidth'] = abs( tmp2[0][0][0]['_XY_up'][1] - tmp1[0][0][0]['_XY_down'][1]) - 91
        else:
            tmp1 = self.get_param_KJH4('SRF_Pulldown', 'BND_NMOSB_Gate_Hrz_M1')
            tmp2 = self.get_param_KJH4('SRF_Pullup', 'BND_PMOSB_Gate_Hrz_M1')
        ...
        ## Input B Horizontal M1 (Extension)
        if (_PMOSA_PMOSNumberofGate == 1 and _NMOSA_NMOSNumberofGate != 1) or (_NMOSA_NMOSNumberofGate == 1 and _PMOSA_PMOSNumberofGate != 1):
            ## Boundary_element Generation
            ## Generate Boundary_element: ex)LayerName: METAL1 / DIFF (_ODLayer) / POLY / PIMP (_PPLayer) / NWELL / SLVT LVT RVT HVT / OP(OPpress) / CONT (CA) / PCCRIT
            ...
            ## Define Boundary_element _YWidth
            if _NMOSA_NMOSNumberofGate == 1 and _PMOSA_PMOSNumberofGate != 1:
                tmp1 = self.get_param_KJH4('SRF_Pulldown', 'BND_NMOSB_Gate_Hrz_M1')
                tmp2 = self.get_param_KJH4('BND_InputB_Vtc_M1')
                self._DesignParameter['BND_InputB_Hrz_M1']['_XWidth'] = abs(tmp2[0][0]['_XY_right'][0] - tmp1[0][0][0]['_XY_left'][0])
            else:
                tmp1 = self.get_param_KJH4('SRF_Pullup', 'BND_PMOSB_Gate_Hrz_M1')
                tmp2 = self.get_param_KJH4('BND_InputB_Vtc_M1')
                self._DesignParameter['BND_InputB_Hrz_M1']['_XWidth'] = abs(tmp2[0][0]['_XY_right'][0] - tmp1[0][0][0]['_XY_left'][0])
            ## Define Boundary_element _XWidth
            ...
            ## Calculate
            ## Target_coord: _XY_type1
            tmp1 = self.get_param_KJH4('BND_InputB_Vtc_M1')
            ...
            tmp1 = self.get_param_KJH4('SRF_Pullup', 'BND_PMOSB_Gate_Hrz_M1')
            tmp2 = self.get_param_KJH4('BND_InputB_Vtc_M1')
            self._DesignParameter['BND_InputB_Hrz_M1']['_XWidth'] = abs(
                tmp2[0][0]['_XY_right'][0] - tmp1[0][0][0]['_XY_left'][0])
            ## Define Boundary_element _XWidth
            self._DesignParameter['BND_InputB_Hrz_M1']['_YWidth'] = tmp1[0][0][0]['_Ywidth']
            ...
            tmp1 = self.get_param_KJH4('SRF_Pullup', 'BND_PMOSA_Gate_Hrz_M1')
            tmp2 = self.get_param_KJH4('BND_InputA_Vtc_M1')
            self._DesignParameter['BND_InputA_Hrz_M1']['_XWidth'] = abs(
                tmp2[0][0]['_XY_right'][0] - tmp1[0][0][0]['_XY_left'][0])
            ## Define Boundary_element _XWidth
            self._DesignParameter['BND_InputA_Hrz_M1']['_YWidth'] = tmp1[0][0][0]['_Ywidth']
            ...
            ## Calculate
            ## Target_coord: _XY_type1
            tmp1 = self.get_param_KJH4('BND_InputA_Vtc_M1')
            target_coord = tmp1[0][0]['_XY_up_right']
            ## Approaching_coord: _XY_type2
        ...
        #     self._DesignParameter['SRF_Pulldown']['_DesignObj']._DesignParameter['SRF_NMOSA']['_DesignObj']._DesignParameter['SRF_Source_ViaM1M2']['_XYCoordinates'][i][1] = tmp2
        #
        # NumOfDrain = len(self._DesignParameter['SRF_Pulldown']['_DesignObj']._DesignParameter['SRF_NMOSA']['_DesignObj']._DesignParameter['SRF_Drain_ViaM1M2']['_XYCoordinates'])
        # for i in range(NumOfDrain):
        #     self._DesignParameter['SRF_Pulldown']['_DesignObj']._DesignParameter['SRF_NMOSA']['_DesignObj']._DesignParameter['SRF_Drain_ViaM1M2']['_XYCoordinates'][i][1] = tmp1
...
if __name__ == '__main__':
    ...
    InputParams = dict(
        ...
        _PMOSA_PMOSChannelWidth=800,  # number
        _PMOSA_PMOSChannellength=30,  # number
        _PMOSA_GateSpacing=None,  # None/number
        _PMOSA_SDWidth=None,  # None/number
        _PMOSA_XVT='SLVT',  # 'XVT' ex)SLVT LVT RVT HVT
        _PMOSA_PCCrit=None,  # None/True
        ...
        _PMOSB_PMOSChannelWidth=800,  # number
        _PMOSB_PMOSChannellength=30,  # number
        _PMOSB_GateSpacing=None,  # None/number
        _PMOSB_SDWidth=None,  # None/number
        _PMOSB_XVT='SLVT',  # 'XVT' ex)SLVT LVT RVT HVT
        _PMOSB_PCCrit=None,  # None/True
