...
from Proj_RCDAC_ADC2024_V6_IJK_v2.KJH91_Projects.Project_ADC.Layoutgen_code.E01_ComparatorWtLatch_YJH import E01_02_NAND_YJH_revision
...
class _SRLatch(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        _Calculation_Parameters = copy.deepcopy(E01_02_NAND_YJH_revision._NAND._ParametersForDesignCalculation)
        ...
        self._DesignParameter['SRF_NANDS'] = self._SrefElementDeclaration(
            _DesignObj=E01_02_NAND_YJH_revision._NAND(_DesignParameter=None,
        ...
        ###### NAND S gate <-> R drain Routing # 1/13 수정
        ...
        self._DesignParameter['SRF_SGateRDrain_ViaM1M2']['_DesignObj']._CalculateDesignParameterXmin(**_Caculation_Parameters)
        ...
        target_coord = [tmpx[0][0][0]['_XY_down_left'][0], upperroutepnty]
        ## Approaching_coord
        ...
        self._DesignParameter['BND_SGateRDrain_M1'] = self._BoundaryElementDeclaration(
        ...
        self._DesignParameter['BND_SGateRDrain_M1']['_YWidth'] = 50
        ...
        self._DesignParameter['BND_SGateRDrain_M1']['_XWidth'] = abs(tmp2_1[0][0][0][0]['_XY_left'][0] - tmp2_2[0][0][0]['_XY_right'][0])

                ## Define Boundary_element _XYCoordinates
        self._DesignParameter['BND_SGateRDrain_M1']['_XYCoordinates'] = [[0, 0]]
        ...
        target_coord = [tmp1[0][0][0][0]['_XY_left'][0], upperroutepnty]
                            ## Approaching_coord: _XY_type2
        tmp2 = self.get_param_KJH4('BND_SGateRDrain_M1')
        approaching_coord = tmp2[0][0]['_XY_left']
                            ## Sref coord
        tmp3 = self.get_param_KJH4('BND_SGateRDrain_M1')
        Scoord = tmp3[0][0]['_XY_origin']
                            ## Cal
        New_Scoord = self.get_Scoord_KJH4(target_coord, approaching_coord, Scoord)
        tmpXY.append(New_Scoord)
                            ## Define coordinates
        self._DesignParameter['BND_SGateRDrain_M1']['_XYCoordinates'] = tmpXY
        ...
        ## Sref ViaX declaration
        self._DesignParameter['SRF_SGateRDrain_ViaM1M2_2'] = self._SrefElementDeclaration(
            _DesignObj=A02_ViaStack_KJH3._ViaStack(_DesignParameter=None,
                                                   _Name='{}:SRF_SGateRDrain_ViaM1M2_2'.format(_Name)))[0]

        ## Define Sref Relection
        self._DesignParameter['SRF_SGateRDrain_ViaM1M2_2']['_Reflect'] = [0, 0, 0]

        ## Define Sref Angle
        self._DesignParameter['SRF_SGateRDrain_ViaM1M2_2']['_Angle'] = 0

        ## Generate Metal(x), Metal(x+1) and C0(Viax) layer:  Option: _CalculateDesignParameter, _CalculateDesignParameterXmin, _CalculateDesignParameterYmin, _CalculateDesignParameterXYsame
        self._DesignParameter['SRF_SGateRDrain_ViaM1M2_2']['_DesignObj']._CalculateDesignParameterXmin(
            **_Caculation_Parameters)

        ## Calculate Sref XYcoord
        tmpXY = []
        ## initialized Sref coordinate
        self._DesignParameter['SRF_SGateRDrain_ViaM1M2_2']['_XYCoordinates'] = [[0, 0]]
        ## Calculate
        ## Target_coord
        tmpx = self.get_param_KJH4('BND_SGateRDrain_M1')
        target_coord = tmpx[0][0]['_XY_down_right']
        ## Approaching_coord
        tmp2 = self.get_param_KJH4('SRF_SGateRDrain_ViaM1M2_2', 'SRF_ViaM1M2', 'BND_Met1Layer')
        approaching_coord = tmp2[0][0][0][0]['_XY_down_right']
        ## Sref coord
        tmp3 = self.get_param_KJH4('SRF_SGateRDrain_ViaM1M2_2')
        Scoord = tmp3[0][0]['_XY_origin']
        ## Calculate
        New_Scoord = self.get_Scoord_KJH4(target_coord, approaching_coord, Scoord)
        tmpXY.append(New_Scoord)
        ## Define
        self._DesignParameter['SRF_SGateRDrain_ViaM1M2_2']['_XYCoordinates'] = tmpXY
        ...
        ## Generate Metal(x), Metal(x+1) and C0(Viax) layer:  Option: _CalculateDesignParameter, _CalculateDesignParameterXmin, _CalculateDesignParameterYmin, _CalculateDesignParameterXYsame
        self._DesignParameter['SRF_RGateSDrain_ViaM1M2']['_DesignObj']._CalculateDesignParameterXmin(**_Caculation_Parameters)
        ...
        target_coord = [tmpx[0][0][0]['_XY_down_left'][0], lowerroutepnty]
        ## Approaching_coord
        ...
        ####### NAND S gate <-> R drain Routing/ M2 Metal Bnd element gen.
            ## Boundary_element Generation
                ## Generate Boundary_element: ex)LayerName: METAL1 / DIFF (_ODLayer) / POLY / PIMP (_PPLayer) / NWELL / SLVT LVT RVT HVT / OP(OPpress) / CONT (CA) / PCCRIT
        self._DesignParameter['BND_RGateSDrain_M1'] = self._BoundaryElementDeclaration(
        _Layer=DesignParameters._LayerMapping['METAL1'][0],
        _Datatype=DesignParameters._LayerMapping['METAL1'][1],
        _XWidth=None,
        _YWidth=None,
        ...
        self._DesignParameter['BND_RGateSDrain_M1']['_YWidth'] = 50
        ...
        self._DesignParameter['BND_RGateSDrain_M1']['_XWidth'] = abs(tmp2_1[0][0][0][0]['_XY_right'][0] - tmp2_2[0][0][0]['_XY_right'][0])

                ## Define Boundary_element _XYCoordinates
        self._DesignParameter['BND_RGateSDrain_M1']['_XYCoordinates'] = [[0, 0]]
        ...
        target_coord = [tmp1[0][0][0][0]['_XY_right'][0], lowerroutepnty]
                            ## Approaching_coord: _XY_type2
        tmp2 = self.get_param_KJH4('BND_RGateSDrain_M1')
        approaching_coord = tmp2[0][0]['_XY_right']
                            ## Sref coord
        tmp3 = self.get_param_KJH4('BND_RGateSDrain_M1')
        Scoord = tmp3[0][0]['_XY_origin']
                            ## Cal
        New_Scoord = self.get_Scoord_KJH4(target_coord, approaching_coord, Scoord)
        tmpXY.append(New_Scoord)
                            ## Define coordinates
        self._DesignParameter['BND_RGateSDrain_M1']['_XYCoordinates'] = tmpXY
        ...
        ## Sref ViaX declaration
        self._DesignParameter['SRF_RGateSDrain_ViaM1M2_2'] = self._SrefElementDeclaration(
            _DesignObj=A02_ViaStack_KJH3._ViaStack(_DesignParameter=None,
                                                   _Name='{}:SRF_RGateSDrain_ViaM1M2_2'.format(_Name)))[0]

        ## Define Sref Relection
        self._DesignParameter['SRF_RGateSDrain_ViaM1M2_2']['_Reflect'] = [0, 0, 0]

        ## Define Sref Angle
        self._DesignParameter['SRF_RGateSDrain_ViaM1M2_2']['_Angle'] = 0

        ## Generate Metal(x), Metal(x+1) and C0(Viax) layer:  Option: _CalculateDesignParameter, _CalculateDesignParameterXmin, _CalculateDesignParameterYmin, _CalculateDesignParameterXYsame
        self._DesignParameter['SRF_RGateSDrain_ViaM1M2_2']['_DesignObj']._CalculateDesignParameterXmin(
            **_Caculation_Parameters)

        ## Calculate Sref XYcoord
        tmpXY = []
        ## initialized Sref coordinate
        self._DesignParameter['SRF_RGateSDrain_ViaM1M2_2']['_XYCoordinates'] = [[0, 0]]
        ## Calculate
        ## Target_coord
        tmpx = self.get_param_KJH4('BND_RGateSDrain_M1')
        target_coord = tmpx[0][0]['_XY_up_left']
        ## Approaching_coord
        tmp2 = self.get_param_KJH4('SRF_RGateSDrain_ViaM1M2_2', 'SRF_ViaM1M2', 'BND_Met1Layer')
        approaching_coord = tmp2[0][0][0][0]['_XY_up_left']
        ## Sref coord
        tmp3 = self.get_param_KJH4('SRF_RGateSDrain_ViaM1M2_2')
        Scoord = tmp3[0][0]['_XY_origin']
        ## Calculate
        New_Scoord = self.get_Scoord_KJH4(target_coord, approaching_coord, Scoord)
        tmpXY.append(New_Scoord)
        ## Define
        self._DesignParameter['SRF_RGateSDrain_ViaM1M2_2']['_XYCoordinates'] = tmpXY
...
if __name__ == '__main__':
    ...
    for _iter in range(5):
        ...
        # XVT_list = ['SLVT']
        Selected_XVT = random.choice(XVT_list)
        ...
        InputParams = dict(
            ...
            ## NANDS Design parameters
            # NMOSA
            _NANDS_NMOSA_NMOSNumberofGate=2*MOSFinger,  # number
            _NANDS_NMOSA_NMOSChannelWidth=MOSWidth,  # number
            _NANDS_NMOSA_NMOSChannellength=30,  # number
            _NANDS_NMOSA_GateSpacing=None,  # None/number
            _NANDS_NMOSA_SDWidth=None,  # None/number
            _NANDS_NMOSA_XVT=Selected_XVT,  # 'XVT' ex)SLVT LVT RVT HVT
            _NANDS_NMOSA_PCCrit=False,  # None/True
            ...
            # NMOSB
            _NANDS_NMOSB_NMOSNumberofGate=2*MOSFinger,  # number
            _NANDS_NMOSB_NMOSChannelWidth=MOSWidth,  # number
            _NANDS_NMOSB_NMOSChannellength=30,  # number
            _NANDS_NMOSB_GateSpacing=None,  # None/number
            _NANDS_NMOSB_SDWidth=None,  # None/number
            _NANDS_NMOSB_XVT=Selected_XVT,  # 'XVT' ex)SLVT LVT RVT HVT
            _NANDS_NMOSB_PCCrit=False,  # None/True
            ...
            # NMOSAB Pbody
            _NANDS_NMOSAB_Pbody_NumCont=2,  # Number
            _NANDS_NMOSAB_Pbody_XlvtTop2Pdoby=None,  # Number/None(Minimum)

            # PMOSA
            _NANDS_PMOSA_PMOSNumberofGate=MOSFinger,  # number
            _NANDS_PMOSA_PMOSChannelWidth=2*MOSWidth,  # number
            _NANDS_PMOSA_PMOSChannellength=30,  # number
            _NANDS_PMOSA_GateSpacing=None,  # None/number
            _NANDS_PMOSA_SDWidth=None,  # None/number
            _NANDS_PMOSA_XVT=Selected_XVT,  # 'XVT' ex)SLVT LVT RVT HVT
            _NANDS_PMOSA_PCCrit=False,  # None/True
            ...
            # PMOSB
            _NANDS_PMOSB_PMOSNumberofGate=MOSFinger,  # number
            _NANDS_PMOSB_PMOSChannelWidth=2*MOSWidth,  # number
            _NANDS_PMOSB_PMOSChannellength=30,  # number
            _NANDS_PMOSB_GateSpacing=None,  # None/number
            _NANDS_PMOSB_SDWidth=None,  # None/number
            _NANDS_PMOSB_XVT=Selected_XVT,  # 'XVT' ex)SLVT LVT RVT HVT
            _NANDS_PMOSB_PCCrit=False,  # None/True
            ...
            ## NANDR Design parameters
            # NMOSA
            _NANDR_NMOSA_NMOSNumberofGate=2*MOSFinger,  # number
            _NANDR_NMOSA_NMOSChannelWidth=MOSWidth,  # number
            _NANDR_NMOSA_NMOSChannellength=30,  # number
            _NANDR_NMOSA_GateSpacing=None,  # None/number
            _NANDR_NMOSA_SDWidth=None,  # None/number
            _NANDR_NMOSA_XVT=Selected_XVT,  # 'XVT' ex)SLVT LVT RVT HVT
            _NANDR_NMOSA_PCCrit=False,  # None/True
            ...
            # NMOSB
            _NANDR_NMOSB_NMOSNumberofGate=2*MOSFinger,  # number
            _NANDR_NMOSB_NMOSChannelWidth=MOSWidth,  # number
            _NANDR_NMOSB_NMOSChannellength=30,  # number
            _NANDR_NMOSB_GateSpacing=None,  # None/number
            _NANDR_NMOSB_SDWidth=None,  # None/number
            _NANDR_NMOSB_XVT=Selected_XVT,  # 'XVT' ex)SLVT LVT RVT HVT
            _NANDR_NMOSB_PCCrit=False,  # None/True
            ...
            # NMOSAB Pbody
            _NANDR_NMOSAB_Pbody_NumCont=2,  # Number
            _NANDR_NMOSAB_Pbody_XlvtTop2Pdoby=None,  # Number/None(Minimum)

            # PMOSA
            _NANDR_PMOSA_PMOSNumberofGate=MOSFinger,  # number
            _NANDR_PMOSA_PMOSChannelWidth=2*MOSWidth,  # number
            _NANDR_PMOSA_PMOSChannellength=30,  # number
            _NANDR_PMOSA_GateSpacing=None,  # None/number
            _NANDR_PMOSA_SDWidth=None,  # None/number
            _NANDR_PMOSA_XVT=Selected_XVT,  # 'XVT' ex)SLVT LVT RVT HVT
            _NANDR_PMOSA_PCCrit=False,  # None/True
            ...
            # PMOSB
            _NANDR_PMOSB_PMOSNumberofGate=MOSFinger,  # number
            _NANDR_PMOSB_PMOSChannelWidth=2*MOSWidth,  # number
            _NANDR_PMOSB_PMOSChannellength=30,  # number
            _NANDR_PMOSB_GateSpacing=None,  # None/number
            _NANDR_PMOSB_SDWidth=None,  # None/number
            _NANDR_PMOSB_XVT=Selected_XVT,  # 'XVT' ex)SLVT LVT RVT HVT
            _NANDR_PMOSB_PCCrit=False,  # None/True
