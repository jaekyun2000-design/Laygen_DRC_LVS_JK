...
from KJH91_Projects.Project_ADC.Layoutgen_code.A_Basic_Building_Block import A13_NbodyRingforDeepNwell_KJH
    ...
    ##
from Proj_RCDAC_ADC2024_V6_IJK_v2.KJH91_Projects.Project_ADC.Layoutgen_code.C00_Tr1Tr2_VinVout_Fixed import C00_03_Guardring_random
from Proj_RCDAC_ADC2024_V6_IJK_v2.KJH91_Projects.Project_ADC.Layoutgen_code.C02_Tr5Tr7Tr9_Ctop_Fixed import C02_04_Guardring
from Proj_RCDAC_ADC2024_V6_IJK_v2.KJH91_Projects.Project_ADC.Layoutgen_code.C03_Tr4_Fixed import C03_02_Pin
from Proj_RCDAC_ADC2024_V6_IJK_v2.KJH91_Projects.Project_ADC.Layoutgen_code.C05_Tr8_Fixed import C05_02_Pin
...
# TR8
    ...
    _Tr8_XVT				        = 'RVT',    # 'XVT' ex)SLVT/LVT/RVT/HVT
        ...
        ## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## ########## Tr1Tr2
            ...
            ## SREF Generation
                ## Copy Calculation_Parameters from low-level-block ex)copy.deepcopy(B16_nmos_power_v2._NMOS_POWER._ParametersForDesignCalculation)
        _Caculation_Parameters = copy.deepcopy(C00_03_Guardring_random._Guardring._ParametersForDesignCalculation)
                ## Define Calculation_Parameters ex) _Caculation_Parameters['_NMOSPOWER_PbodyContact_1_Length']  = _NMOSPOWER_PbodyContact_1_Length
        ...
        _Caculation_Parameters['_Outputnode_width']         = _Outputnode_width
                ...
                ## Generate Sref: ex)self._DesignParameter['_NMOS_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_nmos_power_v2._NMOS_POWER( _DesignParameter=None, _Name='{}:NMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_C00_03_Guardring'] = self._SrefElementDeclaration(_DesignObj=C00_03_Guardring_random._Guardring(_DesignParameter=None, _Name='{}:SRF_C00_03_Guardring'.format(_Name)))[0]
...
if __name__ == '__main__':
    ...
    for _iter in range(1):
        ...
        cellname = 'C12_00_Tr1Tr2_Tr5Tr7Tr9_Tr4_Tr8_v{}'.format(_iter + 6)
        ...
        _Tr2_Length = [i for i in range(30, 200, 10)]
        _Tr1_Length = [i for i in range(30, 200, 10)]

        _Tr4_Gate = random.randrange(2, 10, 1)
        # _Tr4_Length = [i for i in range(30, 200, 10) if i != 70]
        ...
        # _Tr5_Length = [i for i in range(30, 200, 10) if i != 70]
        # _Tr7_Length = [i for i in range(30, 200, 10) if i != 70]
        # _Tr9_Length = [i for i in range(30, 200, 10) if i != 70]

        _Tr8_Gate = random.randrange(2, 10, 1)
        # _Tr8_Length = [i for i in range(30, 200, 10) if i != 70]
    ...
    # TR1
        # Physical dimension
        _Tr1_NumberofGate	            = _Tr1_Gate,       # Number
        _Tr1_ChannelWidth	            = _Tr1_Tr2_Width,     # Number
        _Tr1_ChannelLength	            = random.choice(_Tr1_Length),       # Number
        _Tr1_XVT				        = 'SLVT',    # 'XVT' ex)SLVT/LVT/RVT/HVT

    # TR2
        # Physical dimension
        _Tr2_NumberofGate	            = _Tr2_Gate,       # Number
        _Tr2_ChannelWidth	            = _Tr1_Tr2_Width,     # Number
        _Tr2_ChannelLength	            = 30,       # Number
        _Tr2_XVT				        = 'SLVT',    # 'XVT' ex)SLVT/LVT/RVT/HVT

    # TR4
        # Physical dimension
        _Tr4_NumberofGate	            = _Tr4_Gate,       # Number
        _Tr4_ChannelWidth	            = _Tr4_Tr5_Tr7_Tr8_Tr9_Width,     # Number
        _Tr4_ChannelLength	            = 30,       # Number
        _Tr4_XVT				        = 'RVT',    # 'XVT' ex)SLVT/LVT/RVT/HVT

    # TR5
        # Physical dimension
        _Tr5_NumberofGate	            = _Tr5_Gate,       # Number
        _Tr5_ChannelWidth	            = _Tr4_Tr5_Tr7_Tr8_Tr9_Width,     # Number
        _Tr5_ChannelLength	            = 30,       # Number
        _Tr5_XVT				        = 'SLVT',    # 'XVT' ex)SLVT/LVT/RVT/HVT

    # TR7
        # Physical dimension
        _Tr7_NumberofGate               = _Tr7_Gate,  # Number
        _Tr7_ChannelWidth	            = _Tr4_Tr5_Tr7_Tr8_Tr9_Width,     # Number
        _Tr7_ChannelLength	            = 30,       # Number
        _Tr7_XVT				        = 'SLVT',    # 'XVT' ex)SLVT/LVT/RVT/HVT

    # TR9
        # Physical dimension
        _Tr9_NumberofGate               = _Tr9_Gate,  # Number
        _Tr9_ChannelWidth	            = _Tr4_Tr5_Tr7_Tr8_Tr9_Width,     # Number
        _Tr9_ChannelLength	            = 30,       # Number
        _Tr9_XVT				        = 'LVT',    # 'XVT' ex)SLVT/LVT/RVT/HVT

    # TR8
        # Physical dimension
        _Tr8_NumberofGate	= _Tr8_Gate,       # Number
        _Tr8_ChannelWidth	            = _Tr4_Tr5_Tr7_Tr8_Tr9_Width,     # Number
        _Tr8_ChannelLength	            = 30,       # Number
        _Tr8_XVT				        = 'RVT',    # 'XVT' ex)SLVT/LVT/RVT/HVT
