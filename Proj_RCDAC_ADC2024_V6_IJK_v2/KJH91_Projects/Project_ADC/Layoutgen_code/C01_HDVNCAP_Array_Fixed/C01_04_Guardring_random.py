...
from KJH91_Projects.Project_ADC.Layoutgen_code.A_Basic_Building_Block import A13_NbodyRingforDeepNwell_KJH
    ...
    ## Building blocks
from Proj_RCDAC_ADC2024_V6_IJK_v2.KJH91_Projects.Project_ADC.Layoutgen_code.C01_HDVNCAP_Array_Fixed import C01_03_Array
...
if __name__ == '__main__':
    ...
    # libname = 'Proj_ZZ01_C01_04_Guardring'
    ## CellName: ex)C01_cap_array_v2_84
    for _iter in range(5):

        cellname = 'C01_04_Guardring_v{}'.format(_iter + 5)
        ...
        _Length = random.randrange(2000, 10000, 1000),
        _LayoutOption = [3,4,5,6], # Writedown [number1, number2, number3, ...]
        _NumFigPair = random.randrange(10, 50, 2), #number (ref:75)
