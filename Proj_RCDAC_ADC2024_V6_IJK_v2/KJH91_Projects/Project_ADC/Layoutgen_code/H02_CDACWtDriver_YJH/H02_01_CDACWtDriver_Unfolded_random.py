...
class _CDACWtDriver_Unfolded(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        self._DesignParameter['SRF_CDACWtDriver'] = self._SrefElementDeclaration(
            _DesignObj=H02_00_CDACWtDriver._CDACWtDriver(_DesignParameter=None,
                                                         _Name='{}:SRF_CDACWtDriver'.format(_Name)))[0]
...
if __name__ == '__main__':
    ...
    for _iter in range(10):
        ...
        libname = 'Proj_ZZ01_H02_01_CDAC_Driver_Unfold_random_v{}'.format(_iter + 23)
        ## CellName: ex)C01_cap_array_v2_84
        cellname = 'H02_00_CDACWDriver_unfolded8'
