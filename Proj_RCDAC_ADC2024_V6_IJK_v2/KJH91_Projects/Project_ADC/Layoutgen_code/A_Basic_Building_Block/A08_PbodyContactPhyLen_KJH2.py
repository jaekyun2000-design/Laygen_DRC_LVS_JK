...
from Proj_RCDAC_ADC2024_V6_IJK_v2.KJH91_Projects.Project_ADC.Layoutgen_code.A_Basic_Building_Block import A06_PbodyContact_KJH2

## ########################################################################################################################################################## Class_HEADER
class _PbodyContactPhyLen_KJH2(StickDiagram_KJH1._StickDiagram_KJH):
...
_Vtc_flag	= None,
        ...
        #Generate Sref
        self._DesignParameter['SRF_PbodyContactPhyLen'] = self._SrefElementDeclaration(_DesignObj=A06_PbodyContact_KJH2._PbodyContact_KJH2( _DesignParameter=None, _Name='{}:SRF_PbodyContactPhyLen'.format(_Name)))[0]
...
_Vtc_flag	= False,
    ...
    LayoutObj = _PbodyContactPhyLen_KJH2(_DesignParameter=None, _Name=cellname)
