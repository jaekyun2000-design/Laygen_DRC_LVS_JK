...
_COY=None,
        ...
        ##  METAL6 Layer
        # Define Boundary_element
        self._DesignParameter['BND_Met6Layer'] = self._BoundaryElementDeclaration(
        ...
        self._DesignParameter['BND_Met6Layer']['_YWidth'] = _Via_YWidth + 2 * max([_DRCObj._Metal1MinEnclosureVia12,_DRCObj._MetalxMinEnclosureCO2])

        # Define Boundary_element _XWidth
        _Via_XWidth = abs(tmp[-1][0]['_XY_right'][0] - tmp[0][0]['_XY_left'][0])
        self._DesignParameter['BND_Met6Layer']['_XWidth'] = _Via_XWidth + 2 * max([_DRCObj._Metal1MinEnclosureVia12,_DRCObj._MetalxMinEnclosureCO2])

        # Define Boundary_element Coordinates
        self._DesignParameter['BND_Met6Layer']['_XYCoordinates'] = [[0, 0]]
        ...
        tmp2 = self.get_param_KJH4('BND_Met6Layer')
        approaching_coord = tmp2[0][0]['_XY_up_left']
        ## Sref coord
        tmp3 = self.get_param_KJH4('BND_Met6Layer')
        ...
        ## Define Coordinates
        self._DesignParameter['BND_Met6Layer']['_XYCoordinates'] = tmpXY
        ...
        tmp = self.get_param_KJH4('BND_COLayer')
        _Via_YWidth = abs(tmp[0][0]['_XY_up'][1] - tmp[-1][0]['_XY_down'][1])
        self._DesignParameter['BND_Met7Layer']['_YWidth'] = _Via_YWidth + 2 * max([_DRCObj._Metal1MinEnclosureVia12,_DRCObj._MetalxMinEnclosureCO2])

        # Define Boundary_element _XWidth
        _Via_XWidth = abs(tmp[-1][0]['_XY_right'][0] - tmp[0][0]['_XY_left'][0])
        self._DesignParameter['BND_Met7Layer']['_XWidth'] = _Via_XWidth + 2 * max([_DRCObj._Metal1MinEnclosureVia12,_DRCObj._MetalxMinEnclosureCO2])
...
_COY=None
        ...
        # Define Boundary_element _XWidth
        _Via_XWidth = abs(tmp[-1][0]['_XY_right'][0] - tmp[0][0]['_XY_left'][0])
        self._DesignParameter['BND_Met6Layer']['_XWidth'] = _Via_XWidth + 2 * max([_DRCObj._Metal1MinEnclosureVia1,_DRCObj._MetalxMinEnclosureCO])
        ...
        # Define Boundary_element _XWidth
        _Via_XWidth = abs(tmp[-1][0]['_XY_right'][0] - tmp[0][0]['_XY_left'][0])
        self._DesignParameter['BND_Met7Layer']['_XWidth'] = _Via_XWidth + 2 * max([_DRCObj._Metal1MinEnclosureVia1,_DRCObj._MetalxMinEnclosureCO])
...
_COY=None
        ...
        tmp = self.get_param_KJH4('BND_COLayer')
        _Via_YWidth = abs(tmp[0][0]['_XY_up'][1] - tmp[-1][0]['_XY_down'][1])
        self._DesignParameter['BND_Met6Layer']['_YWidth'] = _Via_YWidth + 2 * max([_DRCObj._Metal1MinEnclosureVia1,_DRCObj._MetalxMinEnclosureCO])
        ...
        tmp = self.get_param_KJH4('BND_COLayer')
        _Via_YWidth = abs(tmp[0][0]['_XY_up'][1] - tmp[-1][0]['_XY_down'][1])
        self._DesignParameter['BND_Met7Layer']['_YWidth'] = _Via_YWidth + 2 * max([_DRCObj._Metal1MinEnclosureVia1,_DRCObj._MetalxMinEnclosureCO])
