...
## ########################################################################################################################################################## Class_HEADER
class _ViaM3toM4_KJH(StickDiagram_KJH1._StickDiagram_KJH):
...
_COY=None,
        ...
        self._DesignParameter['BND_COLayer'] = self._BoundaryElementDeclaration(
            _Layer=DesignParameters._LayerMapping['VIA34'][0],
            _Datatype=DesignParameters._LayerMapping['VIA34'][1],
            _XWidth=None,
            _YWidth=None,
            _XYCoordinates=[],
        )
...
_COY = 4 ,
    ...
    LayoutObj = _ViaM3toM4_KJH(_DesignParameter=None, _Name=cellname)
