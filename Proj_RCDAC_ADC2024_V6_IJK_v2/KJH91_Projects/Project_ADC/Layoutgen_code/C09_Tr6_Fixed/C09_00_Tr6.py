...
# TR6
    ...
    _Tr6_XVT				        = 'RVT',    # 'XVT' ex)SLVT/LVT/RVT/HVT
        ...
        _Caculation_Parameters['_NumberofGate'] = _Tr6_NumberofGate
        _Caculation_Parameters['_ChannelWidth'] = _Tr6_ChannelWidth
        _Caculation_Parameters['_ChannelLength'] = _Tr6_ChannelLength
        ...
        tmp = self.get_param_KJH4('SRF_Nmos','BND_Source_Hrz_M2')
        ...
        tmp2 = self.get_param_KJH4('SRF_Nmos','BND_Source_Hrz_M2')
...
if __name__ == '__main__':
    ...
    libname = 'Proj_ZZ01_C09_00_Tr6_Fixed'
    ## CellName: ex)C01_cap_array_v2_84
    cellname = 'C00_00_Tr6_v0_99'
