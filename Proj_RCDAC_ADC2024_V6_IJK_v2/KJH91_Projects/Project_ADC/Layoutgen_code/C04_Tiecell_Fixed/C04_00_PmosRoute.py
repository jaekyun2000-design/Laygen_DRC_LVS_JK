...
from Proj_RCDAC_ADC2024_V6_IJK_v2.KJH91_Projects.Project_ADC.Layoutgen_code.A_Basic_Building_Block import A14_Mosfet_KJH3
...
#TieP
    # Physical dimension
    _TieP_NumberofGate	            = 4,       # Number
    _TieP_ChannelWidth	            = 500,     # Number
    _TieP_ChannelLength	            = 30,       # Number
    _TieP_XVT				        = 'RVT',    # 'XVT' ex)SLVT/LVT/RVT/HVT
...
#TieP
    ...
    _TieP_XVT				        = 'RVT',    # 'XVT' ex)SLVT/LVT/RVT/HVT
        ...
        _Caculation_Parameters['_NumberofGate']     = _TieP_NumberofGate
        _Caculation_Parameters['_ChannelWidth']     = _TieP_ChannelWidth
        _Caculation_Parameters['_ChannelLength']    = _TieP_ChannelLength
        ...
        _Caculation_Parameters['_Drain_Comb_Length']            = _TieP_ChannelWidth
...
if __name__ == '__main__':
    ...
    libname = 'Proj_ZZ01_C04_00_PmosRoute_Fixed'
