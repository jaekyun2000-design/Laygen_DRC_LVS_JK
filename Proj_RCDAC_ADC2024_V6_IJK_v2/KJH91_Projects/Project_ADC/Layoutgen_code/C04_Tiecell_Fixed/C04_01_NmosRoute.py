...
# TieN
    # Physical dimension
    _TieN_NumberofGate	            = 4,       # Number
    _TieN_ChannelWidth	            = 250,     # Number
    _TieN_ChannelLength	            = 30,       # Number
...
# TieN
    ...
    _TieN_XVT				        = 'SLVT',    # 'XVT' ex)SLVT/LVT/RVT/HVT
        ...
        _Caculation_Parameters['_NumberofGate']     = _TieN_NumberofGate
        _Caculation_Parameters['_ChannelWidth']     = _TieN_ChannelWidth
        _Caculation_Parameters['_ChannelLength']    = _TieN_ChannelLength
        ...
        _Caculation_Parameters['_Drain_Comb_Length']            = _TieN_ChannelWidth
...
if __name__ == '__main__':
    ...
    libname = 'Proj_ZZ01_C04_01_NmosRoute_Fixed'
