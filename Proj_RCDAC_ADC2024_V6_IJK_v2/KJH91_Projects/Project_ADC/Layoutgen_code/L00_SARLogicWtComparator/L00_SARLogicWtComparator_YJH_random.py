...
class _SARLogicWtComparator(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        _Caculation_Parameters1 = copy.deepcopy(
            K00_02_SARLogicWtCDACPreDriver_YJH_random._SARLogicWtCDACPreDriver._ParametersForDesignCalculation)
        ...
        self._DesignParameter['SRF_SARLogicWtBuffers'] = self._SrefElementDeclaration(_DesignObj=K00_02_SARLogicWtCDACPreDriver_YJH_random._SARLogicWtCDACPreDriver(_DesignParameter=None, _Name='{}:SRF_SARLogicWtBuffers'.format(_Name)))[0]
        ...
        ## StrongARM Latch
        _Caculation_Parameters1 = copy.deepcopy(
            E01_05_StrongArmWtSRLatch_random._StrongArmWtSRLatch._ParametersForDesignCalculation)
        ## Define Calculation_Parameters ex) _Caculation_Parameters1['_NMOSPOWER_PbodyContact_1_Length']  = _NMOSPOWER_PbodyContact_1_Length
        ...
        ## Generate Sref: ex)self._DesignParameter['_NMOS_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_nmos_power_v2._NMOS_POWER( _DesignParameter=None, _Name='{}:NMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_Comparator'] = self._SrefElementDeclaration(_DesignObj=E01_05_StrongArmWtSRLatch_random._StrongArmWtSRLatch(_DesignParameter=None, _Name='{}:SRF_Comparator'.format(_Name)))[0]
        ...
        ## Generate Sref: ex)self._DesignParameter['_NMOS_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_nmos_power_v2._NMOS_POWER( _DesignParameter=None, _Name='{}:NMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_Buf_CLKSrc'] = self._SrefElementDeclaration(
            _DesignObj=J00_01_InverterChain_KJH._InverterChain(_DesignParameter=None,
                                                               _Name='{}:SRF_Buf_CLKSrc'.format(_Name)))[0]
        ...
        ## Define Boundary_element _XWidth
        self._DesignParameter['BND_CLKSampBufOut_Hrz_M3']['_XWidth'] = abs(
            tmp1[0][0][0][0][0]['_XY_left'][0] - tmp2[0][0][0][0][0]['_XY_left'][0])
        ...
        ## Calculate
        ## Target_coord: _XY_type1
        target_coord = tmp1[0][0][0][0][0]['_XY_up_left'] # 1/14 수정
        ## Approaching_coord: _XY_type2
        ...
        ## Define Boundary_element _XWidth
        self._DesignParameter['BND_CLKSrcIn_Hrz_M3']['_XWidth'] = abs(
            tmp1[0][0][0][0][0]['_XY_left'][0] - tmp2[0][0][0][0]['_XY_right'][0])
        ...
        ## Sref ViaX declaration
        self._DesignParameter['SRF_CLKSrcBuf_ViaM3M4'] = self._SrefElementDeclaration(
            _DesignObj=A02_ViaStack_KJH3._ViaStack(_DesignParameter=None,
                                                   _Name='{}:SRF_CLKSrcBuf_ViaM3M4'.format(_Name)))[0]

        ## Define Sref Relection
        self._DesignParameter['SRF_CLKSrcBuf_ViaM3M4']['_Reflect'] = [0, 0, 0]

        ## Define Sref Angle
        self._DesignParameter['SRF_CLKSrcBuf_ViaM3M4']['_Angle'] = 0

        ## Generate Metal(x), Metal(x+1) and C0(Viax) layer:  Option: _CalculateDesignParameter, _CalculateDesignParameterXmin, _CalculateDesignParameterYmin, _CalculateDesignParameterXYsame
        self._DesignParameter['SRF_CLKSrcBuf_ViaM3M4']['_DesignObj']._CalculateDesignParameterXmin(
            **_Caculation_Parameters)

        ## Calculate Sref XYcoord
        tmpXY = []
        ## initialized Sref coordinate
        self._DesignParameter['SRF_CLKSrcBuf_ViaM3M4']['_XYCoordinates'] = [[0, 0]]
        ## Calculate
        ## Target_coord
        tmp1 = self.get_param_KJH4('BND_CLKSrcIn_Hrz_M3')
        target_coord = tmp1[0][0]['_XY_down_left']
        ## Approaching_coord
        tmp2 = self.get_param_KJH4('SRF_CLKSrcBuf_ViaM3M4', 'SRF_ViaM3M4', 'BND_Met3Layer')
        approaching_coord = tmp2[0][0][0][0]['_XY_down_right']
        ## Sref coord
        tmp3 = self.get_param_KJH4('SRF_CLKSrcBuf_ViaM3M4')
        Scoord = tmp3[0][0]['_XY_origin']
        ## Calculate
        New_Scoord = self.get_Scoord_KJH4(target_coord, approaching_coord, Scoord)
        tmpXY.append(New_Scoord)
        ## Define
        self._DesignParameter['SRF_CLKSrcBuf_ViaM3M4']['_XYCoordinates'] = tmpXY

        ##### BND_BufCLKSrcIn_Vtc_M4
        ## Boundary_element Generation
        ## Generate Boundary_element: ex)LayerName: METAL1 / DIFF (_ODLayer) / POLY / PIMP (_PPLayer) / NWELL / SLVT LVT RVT HVT / OP(OPpress) / CONT (CA) / PCCRIT
        self._DesignParameter['BND_BufCLKSrcIn_Vtc_M4'] = self._BoundaryElementDeclaration(
            _Layer=DesignParameters._LayerMapping['METAL4'][0],
            _Datatype=DesignParameters._LayerMapping['METAL4'][1],
            _XWidth=None,
            _YWidth=None,
        ...
        tmp2 = self.get_param_KJH4('BND_CLKSrcIn_Hrz_M3')
        ## Define Boundary_element _YWidth
        self._DesignParameter['BND_BufCLKSrcIn_Vtc_M4']['_XWidth'] = CLKSrcInVtcM4MetalWidth

        ## Define Boundary_element _XWidth
        self._DesignParameter['BND_BufCLKSrcIn_Vtc_M4']['_YWidth'] = abs(
            tmp1[0][0][0][0][0]['_XY_down'][1] - tmp2[0][0]['_XY_down'][1])

        ## Define Boundary_element _XYCoordinates
        self._DesignParameter['BND_BufCLKSrcIn_Vtc_M4']['_XYCoordinates'] = [[0, 0]]
        ...
        target_coord = tmp2[0][0]['_XY_down_left']
        ## Approaching_coord: _XY_type2
        tmp2 = self.get_param_KJH4('BND_BufCLKSrcIn_Vtc_M4')
        approaching_coord = tmp2[0][0]['_XY_down_right']
        ## Sref coord
        tmp3 = self.get_param_KJH4('BND_BufCLKSrcIn_Vtc_M4')
        Scoord = tmp3[0][0]['_XY_origin']
        ## Cal
        New_Scoord = self.get_Scoord_KJH4(target_coord, approaching_coord, Scoord)
        tmpXY.append(New_Scoord)
        ## Define coordinates
        self._DesignParameter['BND_BufCLKSrcIn_Vtc_M4']['_XYCoordinates'] = tmpXY
        ...
        ## Define Boundary_element _XWidth
        self._DesignParameter['BND_CLKSrcBufOut_Hrz_M3']['_XWidth'] = abs(
            tmp1[0][0][0][0][0]['_XY_left'][0] - tmp2[0][0][0][0][0]['_XY_left'][0])
        ...
        ## Generate Metal(x), Metal(x+1) and C0(Viax) layer:  Option: _CalculateDesignParameter, _CalculateDesignParameterXmin, _CalculateDesignParameterYmin, _CalculateDesignParameterXYsame
        self._DesignParameter['SRF_CLKSrcANDIn_ViaM3M4']['_DesignObj']._CalculateDesignParameterXmin(
            **_Caculation_Parameters)
        ...
        approaching_coord = tmp2[0][0][0][0]['_XY_down_right'] # 1/14 수정
        ## Sref coord
...
if __name__ == '__main__':
    ...
    for _iter in range(5):
        ...
        DFF_MOSWidth = random.randrange(300, 601, 50)
        TreeBuf_MOSWidth = random.randrange(200, 601, 50)
        DAC_MSB_Buf_MOSWidth = random.randrange(200, 601, 50)

        SizeByStage1 = random.randrange(1, 5, 1)
        SizeByStage2 = random.randrange(1, 5, 1)
        SizeByStage3 = random.randrange(1, 5, 1)
        SizeByStage4 = random.randrange(1, 5, 1)

        DAC_MSB_Buf_inv1_MOSFinger = random.randrange(1, 10, 1)
        DAC_MSB_Buf_inv2_MOSFinger = random.randrange(1, 10, 1)

        Right_end_inv_MOSFinger = random.choice([i for i in range(1, 5) if i != 2])
        Right_end_AND_inv_MOSFinger = random.choice([i for i in range(1, 5) if i != 2])
        Right_end_AND_nand_MOSFinger = random.choice([i for i in range(1, 5) if i != 2])

        DFF_XVT_list = ['RVT', 'SLVT', 'LVT', 'HVT']
        # DFF_XVT_list = ['SLVT']
        DFF_Selected_XVT = random.choice(DFF_XVT_list)

        TreeBuf_XVT_list = ['RVT', 'SLVT', 'LVT', 'HVT']
        # TreeBuf_XVT_list = ['SLVT']
        TreeBuf_Selected_XVT = random.choice(TreeBuf_XVT_list)

        DAC_MSB_Buf_XVT_list = ['RVT', 'SLVT', 'LVT', 'HVT']
        # DAC_MSB_Buf_XVT_list = ['SLVT']
        DAC_MSB_Buf_Selected_XVT = random.choice(DAC_MSB_Buf_XVT_list)

        CLKinputPMOSFinger = random.randrange(4, 10, 2)
        PMOSFinger = random.randrange(3, 10, 1)
        PMOSChannelWidth = random.randrange(350, 1000, 50)
        DATAinputNMOSFinger = random.randrange(3, 10, 1)
        NMOSFinger = random.randrange(3, 10, 1)
        CLKinputNMOSFinger = random.randrange(3, 10, 1)
        NMOSChannelWidth = random.randrange(350, 1000, 50)

        Slicer_XVT_list = ['RVT', 'SLVT', 'LVT', 'HVT']
        # Slicer_XVT_list = ['SLVT']
        Slicer_Selected_XVT = random.choice(Slicer_XVT_list)

        SRinput_XVT_list = ['RVT', 'SLVT', 'LVT', 'HVT']
        # SRinput_XVT_list = ['SLVT']
        SRinput_Selected_XVT = random.choice(SRinput_XVT_list)
        SRinputMOS1Finger = random.choice([i for i in range(1, 5) if i != 2])
        ...
        INV_MOSFinger = random.choice([i for i in range(1, 5) if i != 2])
        NAND_MOSFinger = random.choice([i for i in range(1, 5) if i != 2])

        CompCLK_MOS1Finger = random.choice([i for i in range(1, 5) if i != 2])
        CompCLK_MOS2Finger = random.choice([i for i in range(1, 5) if i != 2])

        Buf_CLKSamp_MOSFinger1 = random.randrange(1, 10, 1)
        Buf_CLKSamp_MOSFinger2 = random.randrange(1, 10, 1)
        Buf_CLKSamp_MOSFinger3 = random.randrange(1, 10, 1)

        # Buf_CLKSamp_Inv_MOSChannelWidth = random.randrange(200, 601, 50)

        Buf_CLKSamp_XVT_list = ['RVT', 'SLVT', 'LVT', 'HVT']
        # Slicer_XVT_list = ['SLVT']
        Buf_CLKSamp_Selected_XVT = random.choice(Buf_CLKSamp_XVT_list)

        Buf_CompOut_MOSFinger1 = random.randrange(1, 10, 1)
        Buf_CompOut_MOSFinger2 = random.randrange(1, 10, 1)
        # Buf_CompOut_MOSChannelWidth = random.randrange(200, 601, 50)

        Buf_CompOut_XVT_list = ['RVT', 'SLVT', 'LVT', 'HVT']
        # Slicer_XVT_list = ['SLVT']
        Buf_CompOut_Selected_XVT = random.choice(Buf_CompOut_XVT_list)
        ...
        InputParams = dict(
            ...
            ## Xgate NMOS
            _SARLogic_Mst_Xgate1_NMOS_NumberofGate=Dinput_tg_MOSFinger,  # 1
            _SARLogic_Mst_Xgate1_NMOS_ChannelWidth=DFF_MOSWidth,  # 100
            _SARLogic_Mst_Xgate1_NMOS_ChannelLength=30,
            _SARLogic_Mst_Xgate1_NMOS_XVT=DFF_Selected_XVT,
            _SARLogic_Mst_Xgate1_NMOS_POGate_Comb_length=100,

            ## Xgate PMOS
            _SARLogic_Mst_Xgate1_PMOS_NumberofGate=Dinput_tg_MOSFinger,  # 1
            _SARLogic_Mst_Xgate1_PMOS_ChannelWidth=2*DFF_MOSWidth,  # 200
            _SARLogic_Mst_Xgate1_PMOS_ChannelLength=30,
            _SARLogic_Mst_Xgate1_PMOS_XVT=DFF_Selected_XVT,
            _SARLogic_Mst_Xgate1_PMOS_POGate_Comb_length=100,
            ...
            ## Xgate NMOS
            _SARLogic_Mst_Xgate2_NMOS_NumberofGate=master_tg_MOSFinger,
            _SARLogic_Mst_Xgate2_NMOS_ChannelWidth=DFF_MOSWidth,
            _SARLogic_Mst_Xgate2_NMOS_ChannelLength=30,
            _SARLogic_Mst_Xgate2_NMOS_XVT=DFF_Selected_XVT,
            _SARLogic_Mst_Xgate2_NMOS_POGate_Comb_length=100,

            ## Xgate PMOS
            _SARLogic_Mst_Xgate2_PMOS_NumberofGate=master_tg_MOSFinger,  # 2
            _SARLogic_Mst_Xgate2_PMOS_ChannelWidth=2*DFF_MOSWidth,
            _SARLogic_Mst_Xgate2_PMOS_ChannelLength=30,
            _SARLogic_Mst_Xgate2_PMOS_XVT=DFF_Selected_XVT,
            _SARLogic_Mst_Xgate2_PMOS_POGate_Comb_length=100,
            ...
            ## NMOS
            ## NMOS common
            _SARLogic_Mst_Nor1_NMOS_XVT=DFF_Selected_XVT,

            ## NMOSA
            _SARLogic_Mst_Nor1_NMOSA_NumberofGate=master_nor1_MOSFinger,
            _SARLogic_Mst_Nor1_NMOSA_ChannelWidth=DFF_MOSWidth,
            _SARLogic_Mst_Nor1_NMOSA_ChannelLength=30,
            _SARLogic_Mst_Nor1_NMOSA_POGate_Comb_length=100,

            ## NMOSB
            _SARLogic_Mst_Nor1_NMOSB_NumberofGate=master_nor1_MOSFinger,
            _SARLogic_Mst_Nor1_NMOSB_ChannelWidth=DFF_MOSWidth,
            _SARLogic_Mst_Nor1_NMOSB_ChannelLength=30,
            _SARLogic_Mst_Nor1_NMOSB_POGate_Comb_length=100,

            ## PMOS
            ## PMOS common
            _SARLogic_Mst_Nor1_PMOS_XVT=DFF_Selected_XVT,

            ## PMOSA
            _SARLogic_Mst_Nor1_PMOSA_NumberofGate=2 * master_nor1_MOSFinger,
            _SARLogic_Mst_Nor1_PMOSA_ChannelWidth=2 * DFF_MOSWidth,
            _SARLogic_Mst_Nor1_PMOSA_ChannelLength=30,
            _SARLogic_Mst_Nor1_PMOSA_POGate_Comb_length=100,

            ## PMOSB
            _SARLogic_Mst_Nor1_PMOSB_NumberofGate=2 * master_nor1_MOSFinger,
            _SARLogic_Mst_Nor1_PMOSB_ChannelWidth=2 * DFF_MOSWidth,
            _SARLogic_Mst_Nor1_PMOSB_ChannelLength=30,
            _SARLogic_Mst_Nor1_PMOSB_POGate_Comb_length=100,
            ...
            ## NMOS
            ## NMOS common
            _SARLogic_Mst_Nor2_NMOS_XVT=DFF_Selected_XVT,

            ## NMOSA
            _SARLogic_Mst_Nor2_NMOSA_NumberofGate=master_nor2_MOSFinger,
            _SARLogic_Mst_Nor2_NMOSA_ChannelWidth=DFF_MOSWidth,
            _SARLogic_Mst_Nor2_NMOSA_ChannelLength=30,
            _SARLogic_Mst_Nor2_NMOSA_POGate_Comb_length=100,

            ## NMOSB
            _SARLogic_Mst_Nor2_NMOSB_NumberofGate=master_nor2_MOSFinger,
            _SARLogic_Mst_Nor2_NMOSB_ChannelWidth=DFF_MOSWidth,
            _SARLogic_Mst_Nor2_NMOSB_ChannelLength=30,
            _SARLogic_Mst_Nor2_NMOSB_POGate_Comb_length=100,

            ## PMOS
            ## PMOS common
            _SARLogic_Mst_Nor2_PMOS_XVT=DFF_Selected_XVT,

            ## PMOSA
            _SARLogic_Mst_Nor2_PMOSA_NumberofGate=2 * master_nor2_MOSFinger,
            _SARLogic_Mst_Nor2_PMOSA_ChannelWidth=2 * DFF_MOSWidth,
            _SARLogic_Mst_Nor2_PMOSA_ChannelLength=30,
            _SARLogic_Mst_Nor2_PMOSA_POGate_Comb_length=100,

            ## PMOSB
            _SARLogic_Mst_Nor2_PMOSB_NumberofGate=2 * master_nor2_MOSFinger,
            _SARLogic_Mst_Nor2_PMOSB_ChannelWidth=2 * DFF_MOSWidth,
            _SARLogic_Mst_Nor2_PMOSB_ChannelLength=30,
            _SARLogic_Mst_Nor2_PMOSB_POGate_Comb_length=100,
            ...
            ## Inv1 NMOS
            _SARLogic_Mst_Inv1_NMOS_NumberofGate=SET_inv1_MOSFinger,
            _SARLogic_Mst_Inv1_NMOS_ChannelWidth=DFF_MOSWidth,
            _SARLogic_Mst_Inv1_NMOS_ChannelLength=30,
            _SARLogic_Mst_Inv1_NMOS_XVT=DFF_Selected_XVT,
            _SARLogic_Mst_Inv1_NMOS_POGate_Comb_length=100,

            ## Inv1 PMOS
            _SARLogic_Mst_Inv1_PMOS_NumberofGate=SET_inv1_MOSFinger,
            _SARLogic_Mst_Inv1_PMOS_ChannelWidth=2 * DFF_MOSWidth,
            _SARLogic_Mst_Inv1_PMOS_ChannelLength=30,
            _SARLogic_Mst_Inv1_PMOS_XVT=DFF_Selected_XVT,
            _SARLogic_Mst_Inv1_PMOS_POGate_Comb_length=100,
            ...
            ## Inv2 NMOS
            _SARLogic_Mst_Inv2_NMOS_NumberofGate=SET_inv2_MOSFinger,
            _SARLogic_Mst_Inv2_NMOS_ChannelWidth=DFF_MOSWidth,
            _SARLogic_Mst_Inv2_NMOS_ChannelLength=30,
            _SARLogic_Mst_Inv2_NMOS_XVT=DFF_Selected_XVT,
            _SARLogic_Mst_Inv2_NMOS_POGate_Comb_length=100,

            ## Inv2 PMOS
            _SARLogic_Mst_Inv2_PMOS_NumberofGate=SET_inv2_MOSFinger,
            _SARLogic_Mst_Inv2_PMOS_ChannelWidth=2*DFF_MOSWidth,
            _SARLogic_Mst_Inv2_PMOS_ChannelLength=30,
            _SARLogic_Mst_Inv2_PMOS_XVT=DFF_Selected_XVT,
            _SARLogic_Mst_Inv2_PMOS_POGate_Comb_length=100,
            ...
            ## Inv3 NMOS
            _SARLogic_Mst_Inv3_NMOS_NumberofGate=CLK_inv_MOSFinger,
            _SARLogic_Mst_Inv3_NMOS_ChannelWidth=DFF_MOSWidth,
            _SARLogic_Mst_Inv3_NMOS_ChannelLength=30,
            _SARLogic_Mst_Inv3_NMOS_XVT=DFF_Selected_XVT,
            _SARLogic_Mst_Inv3_NMOS_POGate_Comb_length=100,

            ## Inv3 PMOS
            _SARLogic_Mst_Inv3_PMOS_NumberofGate=CLK_inv_MOSFinger,
            _SARLogic_Mst_Inv3_PMOS_ChannelWidth=2*DFF_MOSWidth,
            _SARLogic_Mst_Inv3_PMOS_ChannelLength=30,
            _SARLogic_Mst_Inv3_PMOS_XVT=DFF_Selected_XVT,
            _SARLogic_Mst_Inv3_PMOS_POGate_Comb_length=100,
            ...
            ## Xgate NMOS
            _SARLogic_Slv_Xgate1_NMOS_NumberofGate=Center_tg_MOSFinger,
            _SARLogic_Slv_Xgate1_NMOS_ChannelWidth=DFF_MOSWidth,
            _SARLogic_Slv_Xgate1_NMOS_ChannelLength=30,
            _SARLogic_Slv_Xgate1_NMOS_XVT=DFF_Selected_XVT,
            _SARLogic_Slv_Xgate1_NMOS_POGate_Comb_length=100,

            ## Xgate NMOS
            _SARLogic_Slv_Xgate1_PMOS_NumberofGate=Center_tg_MOSFinger,
            _SARLogic_Slv_Xgate1_PMOS_ChannelWidth=2*DFF_MOSWidth,
            _SARLogic_Slv_Xgate1_PMOS_ChannelLength=30,
            _SARLogic_Slv_Xgate1_PMOS_XVT=DFF_Selected_XVT,
            _SARLogic_Slv_Xgate1_PMOS_POGate_Comb_length=100,
            ...
            ## Xgate NMOS
            _SARLogic_Slv_Xgate2_NMOS_NumberofGate=slave_tg_MOSFinger,
            _SARLogic_Slv_Xgate2_NMOS_ChannelWidth=DFF_MOSWidth,
            _SARLogic_Slv_Xgate2_NMOS_ChannelLength=30,
            _SARLogic_Slv_Xgate2_NMOS_XVT=DFF_Selected_XVT,
            _SARLogic_Slv_Xgate2_NMOS_POGate_Comb_length=100,

            ## Xgate NMOS
            _SARLogic_Slv_Xgate2_PMOS_NumberofGate=slave_tg_MOSFinger,
            _SARLogic_Slv_Xgate2_PMOS_ChannelWidth=2*DFF_MOSWidth,
            _SARLogic_Slv_Xgate2_PMOS_ChannelLength=30,
            _SARLogic_Slv_Xgate2_PMOS_XVT=DFF_Selected_XVT,
            _SARLogic_Slv_Xgate2_PMOS_POGate_Comb_length=100,
            ...
            ## NMOS
            ## NMOS common
            _SARLogic_Slv_Nor1_NMOS_XVT=DFF_Selected_XVT,

            ## NMOSA
            _SARLogic_Slv_Nor1_NMOSA_NumberofGate=slave_nor1_MOSFinger,
            _SARLogic_Slv_Nor1_NMOSA_ChannelWidth=DFF_MOSWidth,
            _SARLogic_Slv_Nor1_NMOSA_ChannelLength=30,
            _SARLogic_Slv_Nor1_NMOSA_POGate_Comb_length=100,

            ## NMOSB
            _SARLogic_Slv_Nor1_NMOSB_NumberofGate=slave_nor1_MOSFinger,
            _SARLogic_Slv_Nor1_NMOSB_ChannelWidth=DFF_MOSWidth,
            _SARLogic_Slv_Nor1_NMOSB_ChannelLength=30,
            _SARLogic_Slv_Nor1_NMOSB_POGate_Comb_length=100,

            ## PMOS
            ## PMOS common
            _SARLogic_Slv_Nor1_PMOS_XVT=DFF_Selected_XVT,

            ## PMOSA
            _SARLogic_Slv_Nor1_PMOSA_NumberofGate=2*slave_nor1_MOSFinger,
            _SARLogic_Slv_Nor1_PMOSA_ChannelWidth=2*DFF_MOSWidth,
            _SARLogic_Slv_Nor1_PMOSA_ChannelLength=30,
            _SARLogic_Slv_Nor1_PMOSA_POGate_Comb_length=100,

            ## PMOSB
            _SARLogic_Slv_Nor1_PMOSB_NumberofGate=2*slave_nor1_MOSFinger,
            _SARLogic_Slv_Nor1_PMOSB_ChannelWidth=2*DFF_MOSWidth,
            _SARLogic_Slv_Nor1_PMOSB_ChannelLength=30,
            _SARLogic_Slv_Nor1_PMOSB_POGate_Comb_length=100,
            ...
            ## NMOS
            ## NMOS common
            _SARLogic_Slv_Nor2_NMOS_XVT=DFF_Selected_XVT,

            ## NMOSA
            _SARLogic_Slv_Nor2_NMOSA_NumberofGate=slave_nor2_MOSFinger,
            _SARLogic_Slv_Nor2_NMOSA_ChannelWidth=DFF_MOSWidth,
            _SARLogic_Slv_Nor2_NMOSA_ChannelLength=30,
            _SARLogic_Slv_Nor2_NMOSA_POGate_Comb_length=100,

            ## NMOSB
            _SARLogic_Slv_Nor2_NMOSB_NumberofGate=slave_nor2_MOSFinger,
            _SARLogic_Slv_Nor2_NMOSB_ChannelWidth=DFF_MOSWidth,
            _SARLogic_Slv_Nor2_NMOSB_ChannelLength=30,
            _SARLogic_Slv_Nor2_NMOSB_POGate_Comb_length=100,

            ## PMOS
            ## PMOS common
            _SARLogic_Slv_Nor2_PMOS_XVT=DFF_Selected_XVT,

            ## PMOSA
            _SARLogic_Slv_Nor2_PMOSA_NumberofGate=2*slave_nor2_MOSFinger,
            _SARLogic_Slv_Nor2_PMOSA_ChannelWidth=2*DFF_MOSWidth,
            _SARLogic_Slv_Nor2_PMOSA_ChannelLength=30,
            _SARLogic_Slv_Nor2_PMOSA_POGate_Comb_length=100,

            ## PMOSB
            _SARLogic_Slv_Nor2_PMOSB_NumberofGate=2*slave_nor2_MOSFinger,
            _SARLogic_Slv_Nor2_PMOSB_ChannelWidth=2*DFF_MOSWidth,
            _SARLogic_Slv_Nor2_PMOSB_ChannelLength=30,
            _SARLogic_Slv_Nor2_PMOSB_POGate_Comb_length=100,
            ...
            ## Inv1 NMOS
            _SARLogic_Slv_Inv1_NMOS_NumberofGate=RESET_inv1_MOSFinger,
            _SARLogic_Slv_Inv1_NMOS_ChannelWidth=DFF_MOSWidth,
            _SARLogic_Slv_Inv1_NMOS_ChannelLength=30,
            _SARLogic_Slv_Inv1_NMOS_XVT=DFF_Selected_XVT,
            _SARLogic_Slv_Inv1_NMOS_POGate_Comb_length=100,

            ## Inv1 PMOS
            _SARLogic_Slv_Inv1_PMOS_NumberofGate=RESET_inv1_MOSFinger,
            _SARLogic_Slv_Inv1_PMOS_ChannelWidth=2*DFF_MOSWidth,
            _SARLogic_Slv_Inv1_PMOS_ChannelLength=30,
            _SARLogic_Slv_Inv1_PMOS_XVT=DFF_Selected_XVT,
            _SARLogic_Slv_Inv1_PMOS_POGate_Comb_length=100,
            ...
            ## Inv2 NMOS
            _SARLogic_Slv_Inv2_NMOS_NumberofGate=RESET_inv2_MOSFinger,
            _SARLogic_Slv_Inv2_NMOS_ChannelWidth=DFF_MOSWidth,
            _SARLogic_Slv_Inv2_NMOS_ChannelLength=30,
            _SARLogic_Slv_Inv2_NMOS_XVT=DFF_Selected_XVT,
            _SARLogic_Slv_Inv2_NMOS_POGate_Comb_length=100,

            ## Inv2 PMOS
            _SARLogic_Slv_Inv2_PMOS_NumberofGate=RESET_inv2_MOSFinger,
            _SARLogic_Slv_Inv2_PMOS_ChannelWidth=2*DFF_MOSWidth,
            _SARLogic_Slv_Inv2_PMOS_ChannelLength=30,
            _SARLogic_Slv_Inv2_PMOS_XVT=DFF_Selected_XVT,
            _SARLogic_Slv_Inv2_PMOS_POGate_Comb_length=100,
            ...
            ## Inv3 NMOS
            _SARLogic_Slv_Inv3_NMOS_NumberofGate=qb_out_inv_MOSFinger,  # 1
            _SARLogic_Slv_Inv3_NMOS_ChannelWidth=DFF_MOSWidth,
            _SARLogic_Slv_Inv3_NMOS_ChannelLength=30,
            _SARLogic_Slv_Inv3_NMOS_XVT=DFF_Selected_XVT,
            _SARLogic_Slv_Inv3_NMOS_POGate_Comb_length=100,

            ## Inv3 PMOS
            _SARLogic_Slv_Inv3_PMOS_NumberofGate=qb_out_inv_MOSFinger,  # 1
            _SARLogic_Slv_Inv3_PMOS_ChannelWidth=2*DFF_MOSWidth,
            _SARLogic_Slv_Inv3_PMOS_ChannelLength=30,
            _SARLogic_Slv_Inv3_PMOS_XVT=DFF_Selected_XVT,
            _SARLogic_Slv_Inv3_PMOS_POGate_Comb_length=100,

            # Top Clock  Tree Size
            _SARLogic_CLKBufTreeTop_NumOfStage=4,
            _SARLogic_CLKBufTreeTop_CLKSampBuf_SizeByStage=[SizeByStage1, SizeByStage2, SizeByStage3, SizeByStage4],
            _SARLogic_CLKBufTreeTop_CLKSrcBuf_SizeByStage=[SizeByStage1, SizeByStage2, SizeByStage3, SizeByStage4],  # 스테이지에 따른 버퍼 사이즈(UnitBuffer의 배수로 각 스테이지의 크기가 결정 됨.)
            _SARLogic_CLKBufTreeTop_XOffSet=-0,

            ## Top CLK Buffer Tree Size
            _SARLogic_CLKBufTreeTop_Inv_NMOS_ChannelWidth=TreeBuf_MOSWidth,  # Number
            _SARLogic_CLKBufTreeTop_Inv_NMOS_ChannelLength=30,  # Number
            _SARLogic_CLKBufTreeTop_Inv_NMOS_NumberofGate=1,  # Number
            _SARLogic_CLKBufTreeTop_Inv_NMOS_XVT=TreeBuf_Selected_XVT,  # 'XVT' ex)SLVT/LVT/RVT/HVT
            _SARLogic_CLKBufTreeTop_Inv_NMOS_POGate_Comb_length=100,  # None/Number

            _SARLogic_CLKBufTreeTop_Inv_PMOS_ChannelWidth=2*TreeBuf_MOSWidth,  # Number
            _SARLogic_CLKBufTreeTop_Inv_PMOS_ChannelLength=30,  # Number
            _SARLogic_CLKBufTreeTop_Inv_PMOS_NumberofGate=1,  # Number
            _SARLogic_CLKBufTreeTop_Inv_PMOS_XVT=TreeBuf_Selected_XVT,  # 'XVT' ex)SLVT/LVT/RVT/HVT
            _SARLogic_CLKBufTreeTop_Inv_PMOS_POGate_Comb_length=100,  # None/Number
            ...
            # Bottom Clock  Tree Size
            _SARLogic_CLKBufTreeBot_NumOfStage=4,
            _SARLogic_CLKBufTreeBot_CompOutBuf_SizeByStage=[SizeByStage1, SizeByStage2, SizeByStage3, SizeByStage4],
            _SARLogic_CLKBufTreeBot_CLKDoutBuf_SizeByStage=[SizeByStage1, SizeByStage2, SizeByStage3, SizeByStage4],  # 스테이지에 따른 버퍼 사이즈(UnitBuffer의 배수로 각 스테이지의 크기가 결정 됨.)
            _SARLogic_CLKBufTreeBot_XOffSet=0,

            ## Bottom CLK Buffer Tree Size
            _SARLogic_CLKBufTreeBot_Inv_NMOS_ChannelWidth=TreeBuf_MOSWidth,  # Number
            _SARLogic_CLKBufTreeBot_Inv_NMOS_ChannelLength=30,  # Number
            _SARLogic_CLKBufTreeBot_Inv_NMOS_NumberofGate=1,  # Number
            _SARLogic_CLKBufTreeBot_Inv_NMOS_XVT=TreeBuf_Selected_XVT,  # 'XVT' ex)SLVT/LVT/RVT/HVT
            _SARLogic_CLKBufTreeBot_Inv_NMOS_POGate_Comb_length=100,  # None/Number

            _SARLogic_CLKBufTreeBot_Inv_PMOS_ChannelWidth=2*TreeBuf_MOSWidth,  # Number
            _SARLogic_CLKBufTreeBot_Inv_PMOS_ChannelLength=30,  # Number
            _SARLogic_CLKBufTreeBot_Inv_PMOS_NumberofGate=1,  # Number
            _SARLogic_CLKBufTreeBot_Inv_PMOS_XVT=TreeBuf_Selected_XVT,  # 'XVT' ex)SLVT/LVT/RVT/HVT
            _SARLogic_CLKBufTreeBot_Inv_PMOS_POGate_Comb_length=100,  # None/Number
            ...
            ## Inverter Chain
            ## Inv1 common
            _CDACPreDriver_NumberofGate=[DAC_MSB_Buf_inv1_MOSFinger, DAC_MSB_Buf_inv2_MOSFinger],  # Vector
            _CDACPreDriver_ChannelLength=30,  # Scalar
            _CDACPreDriver_XVT=DAC_MSB_Buf_Selected_XVT,  # 'SLVT'

            ## Inv1 NMOS
            _CDACPreDriver_Inv_NMOS_ChannelWidth=DAC_MSB_Buf_MOSWidth,  # Scalar
            _CDACPreDriver_Inv_NMOS_POGate_Comb_length=100,  # Scalar

            ## Inv1 PMOS
            _CDACPreDriver_Inv_PMOS_ChannelWidth=2*DAC_MSB_Buf_MOSWidth,  # Scalar
            _CDACPreDriver_Inv_PMOS_POGate_Comb_length=100,  # Scalar

            ## CLKDout(OutSamp) Inverter & AND Common Option
            _CLKDout_XVT_Common=DFF_Selected_XVT,

            ## CLKDout(OutSamp) Inverter Size
            _CLKDout_Inv_NMOS_ChannelWidth=DFF_MOSWidth,  # Number
            _CLKDout_Inv_NMOS_ChannelLength=30,  # Number
            _CLKDout_Inv_NMOS_NumberofGate=Right_end_inv_MOSFinger,  # Number
            _CLKDout_Inv_NMOS_POGate_Comb_length=100,  # None/Number

            _CLKDout_Inv_PMOS_ChannelWidth=2*DFF_MOSWidth,  # Number
            _CLKDout_Inv_PMOS_ChannelLength=30,  # Number
            _CLKDout_Inv_PMOS_NumberofGate=Right_end_inv_MOSFinger,  # Number
            _CLKDout_Inv_PMOS_POGate_Comb_length=100,  # None/Number

            ## CLKDout(OutSamp) AND Size
            _CLKDout_AND_NAND_NMOS_ChannelWidth=DFF_MOSWidth,
            _CLKDout_AND_NAND_NMOS_ChannelLength=30,
            _CLKDout_AND_NAND_NMOS_NumberofGate=2*Right_end_AND_nand_MOSFinger,

            _CLKDout_AND_NAND_PMOS_ChannelWidth=2*DFF_MOSWidth,
            _CLKDout_AND_NAND_PMOS_ChannelLength=30,
            _CLKDout_AND_NAND_PMOS_NumberofGate=Right_end_AND_nand_MOSFinger,

            _CLKDout_AND_Inv_NMOS_ChannelWidth=DFF_MOSWidth,
            _CLKDout_AND_Inv_NMOS_ChannelLength=30,
            _CLKDout_AND_Inv_NMOS_NumberofGate=Right_end_AND_inv_MOSFinger,
            _CLKDout_AND_Inv_NMOS_POGate_Comb_length=100,

            _CLKDout_AND_Inv_PMOS_ChannelWidth=2*DFF_MOSWidth,
            _CLKDout_AND_Inv_PMOS_ChannelLength=30,
            _CLKDout_AND_Inv_PMOS_NumberofGate=Right_end_AND_inv_MOSFinger,
            _CLKDout_AND_Inv_PMOS_POGate_Comb_length=100,

            ## StrongARM Latch
            _Comp_SALatch_CLKinputPMOSFinger1=CLKinputPMOSFinger,  # random.randint(1, 15),  # 6
            _Comp_SALatch_CLKinputPMOSFinger2=CLKinputPMOSFinger,  # random.randint(1, 15),  # 3
            _Comp_SALatch_PMOSFinger=PMOSFinger,  # random.randint(1, 15),  # 3
            _Comp_SALatch_PMOSChannelWidth=PMOSChannelWidth,  # random.randrange(200, 1050, 2),  # 500
            _Comp_SALatch_DATAinputNMOSFinger=DATAinputNMOSFinger,  # random.randint(3, 15),  # 12
            _Comp_SALatch_NMOSFinger=NMOSFinger,  # random.randint(1, 15),  # 2
            _Comp_SALatch_CLKinputNMOSFinger=CLKinputNMOSFinger,  # random.randint(1, 15),  # 8
            _Comp_SALatch_NMOSChannelWidth=NMOSChannelWidth,  # random.randrange(200, 1050, 2),  # 500
            _Comp_SALatch_CLKinputNMOSChannelWidth=NMOSChannelWidth,  # random.randrange(200, 1050, 2),  # 800
            _Comp_SALatch_ChannelLength=30,  # random.randrange(30, 60, 2),  # 30
            _Comp_SALatch_Dummy=True,
            _Comp_SALatch_XVT=Slicer_Selected_XVT,
            _Comp_SALatch_GuardringWidth=200,
            _Comp_SALatch_Guardring=True,
            _Comp_SALatch_SlicerGuardringWidth=200,
            _Comp_SALatch_SlicerGuardring=None,
            _Comp_SALatch_NumSupplyCOY=None,
            _Comp_SALatch_NumSupplyCOX=None,
            _Comp_SALatch_SupplyMet1XWidth=None,
            ...
            ## StrongARMLatch Output Buffer Sizing
            # Inverter1
            _Comp_SAOutBuf_Inv1_NMOS_ChannelWidth=MOSChannelWidth,  # Number
            _Comp_SAOutBuf_Inv1_NMOS_ChannelLength=30,  # Number
            _Comp_SAOutBuf_Inv1_NMOS_NumberofGate=SRinputMOS1Finger,  # Number
            _Comp_SAOutBuf_Inv1_NMOS_XVT=SRinput_Selected_XVT,  # 'XVT' ex)SLVT/LVT/RVT/HVT
            _Comp_SAOutBuf_Inv1_NMOS_POGate_Comb_length=100,  # None/Number

            _Comp_SAOutBuf_Inv1_PMOS_ChannelWidth=2*MOSChannelWidth,  # Number
            _Comp_SAOutBuf_Inv1_PMOS_ChannelLength=30,  # Number
            _Comp_SAOutBuf_Inv1_PMOS_NumberofGate=SRinputMOS1Finger,  # Number
            _Comp_SAOutBuf_Inv1_PMOS_XVT=SRinput_Selected_XVT,  # 'XVT' ex)SLVT/LVT/RVT/HVT
            _Comp_SAOutBuf_Inv1_PMOS_POGate_Comb_length=100,  # None/Number

            # Inverter2
            _Comp_SAOutBuf_Inv2_NMOS_ChannelWidth=MOSChannelWidth,  # Number
            _Comp_SAOutBuf_Inv2_NMOS_ChannelLength=30,  # Number
            _Comp_SAOutBuf_Inv2_NMOS_NumberofGate=SRinputMOS2Finger,  # Number
            _Comp_SAOutBuf_Inv2_NMOS_XVT=SRinput_Selected_XVT,  # 'XVT' ex)SLVT/LVT/RVT/HVT
            _Comp_SAOutBuf_Inv2_NMOS_POGate_Comb_length=100,  # None/Number

            _Comp_SAOutBuf_Inv2_PMOS_ChannelWidth=2*MOSChannelWidth,  # Number
            _Comp_SAOutBuf_Inv2_PMOS_ChannelLength=30,  # Number
            _Comp_SAOutBuf_Inv2_PMOS_NumberofGate=SRinputMOS2Finger,  # Number
            _Comp_SAOutBuf_Inv2_PMOS_XVT=SRinput_Selected_XVT,  # 'XVT' ex)SLVT/LVT/RVT/HVT
            _Comp_SAOutBuf_Inv2_PMOS_POGate_Comb_length=100,  # None/Number

            ## SR Latch Size
            _Comp_SRLatch_NAND_NMOS_ChannelWidth=MOSChannelWidth,  # Number
            _Comp_SRLatch_NAND_NMOS_ChannelLength=30,  # Number
            _Comp_SRLatch_NAND_NMOS_NumberofGate=2*SRlatch_MOSFinger,  # Number
            _Comp_SRLatch_NAND_NMOS_XVT=SRinput_Selected_XVT,  # 'XVT' ex)SLVT/LVT/RVT/HVT
            _Comp_SRLatch_NAND_NMOS_POGate_Comb_length=100,  # None/Number

            _Comp_SRLatch_NAND_PMOS_ChannelWidth=2*MOSChannelWidth,  # Number
            _Comp_SRLatch_NAND_PMOS_ChannelLength=30,  # Number
            _Comp_SRLatch_NAND_PMOS_NumberofGate=SRlatch_MOSFinger,  # Number
            _Comp_SRLatch_NAND_PMOS_XVT=SRinput_Selected_XVT,  # 'XVT' ex)SLVT/LVT/RVT/HVT
            _Comp_SRLatch_NAND_PMOS_POGate_Comb_length=100,  # None/Number

            # CLK Input Logic Gates
            _Comp_CLKSamp_Inv_NMOS_ChannelWidth=Bottom_MOSChannelWidth,
            _Comp_CLKSamp_Inv_NMOS_ChannelLength=30,
            _Comp_CLKSamp_Inv_NMOS_NumberofGate=CLK_MOSFinger,
            _Comp_CLKSamp_Inv_NMOS_XVT=SRinput_Selected_XVT,
            _Comp_CLKSamp_Inv_NMOS_POGate_Comb_length=100,

            _Comp_CLKSamp_Inv_PMOS_ChannelWidth=2*Bottom_MOSChannelWidth,
            _Comp_CLKSamp_Inv_PMOS_ChannelLength=30,
            _Comp_CLKSamp_Inv_PMOS_NumberofGate=CLK_MOSFinger,
            _Comp_CLKSamp_Inv_PMOS_XVT=SRinput_Selected_XVT,
            _Comp_CLKSamp_Inv_PMOS_POGate_Comb_length=100,

            _Comp_CLKSrc_Inv_NMOS_ChannelWidth=Bottom_MOSChannelWidth,
            _Comp_CLKSrc_Inv_NMOS_ChannelLength=30,
            _Comp_CLKSrc_Inv_NMOS_NumberofGate=CLK_MOSFinger,
            _Comp_CLKSrc_Inv_NMOS_XVT=SRinput_Selected_XVT,
            _Comp_CLKSrc_Inv_NMOS_POGate_Comb_length=100,

            _Comp_CLKSrc_Inv_PMOS_ChannelWidth=2*Bottom_MOSChannelWidth,
            _Comp_CLKSrc_Inv_PMOS_ChannelLength=30,
            _Comp_CLKSrc_Inv_PMOS_NumberofGate=CLK_MOSFinger,
            _Comp_CLKSrc_Inv_PMOS_XVT=SRinput_Selected_XVT,
            _Comp_CLKSrc_Inv_PMOS_POGate_Comb_length=100,

            ## CLKSrc & CLKSample AND Gate
            _Comp_AND_NAND_NMOS_ChannelWidth=Bottom_MOSChannelWidth,
            _Comp_AND_NAND_NMOS_ChannelLength=30,
            _Comp_AND_NAND_NMOS_NumberofGate=2*NAND_MOSFinger,
            _Comp_AND_NAND_NMOS_XVT=SRinput_Selected_XVT,

            _Comp_AND_NAND_PMOS_ChannelWidth=2*Bottom_MOSChannelWidth,
            _Comp_AND_NAND_PMOS_ChannelLength=30,
            _Comp_AND_NAND_PMOS_NumberofGate=NAND_MOSFinger,
            _Comp_AND_NAND_PMOS_XVT=SRinput_Selected_XVT,

            _Comp_AND_Inv_NMOS_ChannelWidth=Bottom_MOSChannelWidth,
            _Comp_AND_Inv_NMOS_ChannelLength=30,
            _Comp_AND_Inv_NMOS_NumberofGate=INV_MOSFinger,
            _Comp_AND_Inv_NMOS_XVT=SRinput_Selected_XVT,
            _Comp_AND_Inv_NMOS_POGate_Comb_length=100,

            _Comp_AND_Inv_PMOS_ChannelWidth=2*Bottom_MOSChannelWidth,
            _Comp_AND_Inv_PMOS_ChannelLength=30,
            _Comp_AND_Inv_PMOS_NumberofGate=INV_MOSFinger,
            _Comp_AND_Inv_PMOS_XVT=SRinput_Selected_XVT,
            _Comp_AND_Inv_PMOS_POGate_Comb_length=100,

            ## CLK Buffer
            # Inverter1
            _Comp_CLKBuf_Inv1_NMOS_ChannelWidth=Bottom_MOSChannelWidth,  # Number
            _Comp_CLKBuf_Inv1_NMOS_ChannelLength=30,  # Number
            _Comp_CLKBuf_Inv1_NMOS_NumberofGate=CompCLK_MOS1Finger,  # Number
            _Comp_CLKBuf_Inv1_NMOS_XVT=SRinput_Selected_XVT,  # 'XVT' ex)SLVT/LVT/RVT/HVT
            _Comp_CLKBuf_Inv1_NMOS_POGate_Comb_length=100,  # None/Number

            _Comp_CLKBuf_Inv1_PMOS_ChannelWidth=2*Bottom_MOSChannelWidth,  # Number
            _Comp_CLKBuf_Inv1_PMOS_ChannelLength=30,  # Number
            _Comp_CLKBuf_Inv1_PMOS_NumberofGate=CompCLK_MOS1Finger,  # Number
            _Comp_CLKBuf_Inv1_PMOS_XVT=SRinput_Selected_XVT,  # 'XVT' ex)SLVT/LVT/RVT/HVT
            _Comp_CLKBuf_Inv1_PMOS_POGate_Comb_length=100,  # None/Number

            # Inverter2
            _Comp_CLKBuf_Inv2_NMOS_ChannelWidth=Bottom_MOSChannelWidth,  # Number
            _Comp_CLKBuf_Inv2_NMOS_ChannelLength=30,  # Number
            _Comp_CLKBuf_Inv2_NMOS_NumberofGate=CompCLK_MOS2Finger,  # Number
            _Comp_CLKBuf_Inv2_NMOS_XVT=SRinput_Selected_XVT,  # 'XVT' ex)SLVT/LVT/RVT/HVT
            _Comp_CLKBuf_Inv2_NMOS_POGate_Comb_length=100,  # None/Number

            _Comp_CLKBuf_Inv2_PMOS_ChannelWidth=2*Bottom_MOSChannelWidth,  # Number
            _Comp_CLKBuf_Inv2_PMOS_ChannelLength=30,  # Number
            _Comp_CLKBuf_Inv2_PMOS_NumberofGate=CompCLK_MOS2Finger,  # Number
            _Comp_CLKBuf_Inv2_PMOS_XVT=SRinput_Selected_XVT,  # 'XVT' ex)SLVT/LVT/RVT/HVT
            ...
            _Comp_BufSR_PMOS_Nbody_Xvtdown2Nbody=None,
            _Comp_BufSR_PMOSXvt2NMOSXvt=1500,

            _Comp_CLKInLogic_NMOS_Pbody_Xvtdown2Pbody=None,
            _Comp_CLKInLogic_PMOS_Nbody_NumCont=2,
            _Comp_CLKInLogic_PMOS_Nbody_Xvtdown2Nbody=None,
            _Comp_CLKInLogic_PMOSXvt2NMOSXvt=1500,
            ...
            ## Inverter Chain
            ## Inv1 common
            _Buf_CLKSamp_NumberofGate=[Buf_CLKSamp_MOSFinger1, Buf_CLKSamp_MOSFinger2, Buf_CLKSamp_MOSFinger3],  # Vector
            _Buf_CLKSamp_ChannelLength=30,  # Scalar
            _Buf_CLKSamp_XVT=Buf_CLKSamp_Selected_XVT,  # 'SLVT'

            ## Inv1 NMOS
            _Buf_CLKSamp_Inv_NMOS_ChannelWidth=DAC_MSB_Buf_MOSWidth,  # Scalar
            _Buf_CLKSamp_Inv_NMOS_POGate_Comb_length=100,  # Scalar

            ## Inv1 PMOS
            _Buf_CLKSamp_Inv_PMOS_ChannelWidth=2*DAC_MSB_Buf_MOSWidth,  # Scalar
            _Buf_CLKSamp_Inv_PMOS_POGate_Comb_length=100,  # Scalar
            ...
            ## Inverter Chain
            ## Inv1 common
            _Buf_CLKSrc_NumberofGate=[Buf_CLKSamp_MOSFinger1, Buf_CLKSamp_MOSFinger2, Buf_CLKSamp_MOSFinger3],  # Vector
            _Buf_CLKSrc_ChannelLength=30,  # Scalar
            _Buf_CLKSrc_XVT=Buf_CLKSamp_Selected_XVT,  # 'SLVT'

            ## Inv1 NMOS
            _Buf_CLKSrc_Inv_NMOS_ChannelWidth=DAC_MSB_Buf_MOSWidth,  # Scalar
            _Buf_CLKSrc_Inv_NMOS_POGate_Comb_length=100,  # Scalar

            ## Inv1 PMOS
            _Buf_CLKSrc_Inv_PMOS_ChannelWidth=2*DAC_MSB_Buf_MOSWidth,  # Scalar
            _Buf_CLKSrc_Inv_PMOS_POGate_Comb_length=100,  # Scalar
            ...
            ## Inv1 common
            _Buf_CompOut_NumberofGate=[Buf_CompOut_MOSFinger1, Buf_CompOut_MOSFinger2],  # Vector
            _Buf_CompOut_ChannelLength=30,  # Scalar
            _Buf_CompOut_XVT=Buf_CompOut_Selected_XVT,  # 'SLVT'

            ## Inv1 NMOS
            _Buf_CompOut_Inv_NMOS_ChannelWidth=DAC_MSB_Buf_MOSWidth,  # Scalar
            _Buf_CompOut_Inv_NMOS_POGate_Comb_length=100,  # Scalar

            ## Inv1 PMOS
            _Buf_CompOut_Inv_PMOS_ChannelWidth=2*DAC_MSB_Buf_MOSWidth,  # Scalar
            _Buf_CompOut_Inv_PMOS_POGate_Comb_length=100,  # Scalar
