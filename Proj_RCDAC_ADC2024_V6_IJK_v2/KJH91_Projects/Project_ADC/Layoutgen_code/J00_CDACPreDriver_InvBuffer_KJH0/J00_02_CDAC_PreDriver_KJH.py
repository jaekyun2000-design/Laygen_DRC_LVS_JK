...
class _CDAC_PreDriver(StickDiagram_KJH1._StickDiagram_KJH):
    ...
    def _CalculateDesignParameter(self,
        ...
        _Caculation_Parameters['_NumberofGate']                 = _NumberofGate
        ...
        self._DesignParameter['SRF_InvChain'] = self._SrefElementDeclaration(_DesignObj=J00_01_InverterChain_KJH._InverterChain(_DesignParameter=None, _Name='{}:SRF_InvChain'.format(_Name)))[0]

        ## Define Sref Reflection: ex)self._DesignParameter['_NMOS_POWER']['_Reflect'] = [0, 0, 0]
        self._DesignParameter['SRF_InvChain']['_Reflect'] = [0, 0, 0]

        ## Define Sref Angle: ex)'_NMOS_POWER'
        self._DesignParameter['SRF_InvChain']['_Angle'] = 0

        ## Calculate Sref Layer by using Calculation_Parameter: ex)'_NMOS_POWER'
        self._DesignParameter['SRF_InvChain']['_DesignObj']._CalculateDesignParameter(**_Caculation_Parameters)

        ## Define Sref _XYcoordinate: ex)'_NMOS_POWER'
        self._DesignParameter['SRF_InvChain']['_XYCoordinates'] = [[0, 0]]

                    ## Calculate Sref XYcoord
        tmpXY = self._DesignParameter['SRF_InvChain']['_XYCoordinates']
        for i in range(0,_NumBit-1):
                            ## Calculate
                                ## Target_coord: _XY_type1
                                ##X
            tmp1_1 = self.get_param_KJH4('SRF_InvChain','SRF_Input_ViaM1Mx','SRF_ViaM1M2','BND_Met1Layer')
            target_coord = tmp1_1[i][0][0][0][0]['_XY_left']
                                ## Approaching_coord: _XY_type2
            tmp2 = self.get_param_KJH4('SRF_InvChain','SRF_Input_ViaM1Mx','SRF_ViaM1M2','BND_Met1Layer')
            approaching_coord = tmp2[0][0][0][0][0]['_XY_left']
                                ## Sref coord
            tmp3 = self.get_param_KJH4('SRF_InvChain')
            ...
            tmpXY.append(New_Scoord)
                            ## Define coordinates
            self._DesignParameter['SRF_InvChain']['_XYCoordinates'] = tmpXY
        ...
        tmp1 = self.get_param_KJH4('SRF_InvChain','SRF_Pbody','SRF_PbodyContactPhyLen','BND_Met1Layer')
        self._DesignParameter['BND_Pbody_M1Exten']['_YWidth'] = tmp1[0][0][0][0][0]['_Ywidth']

                ## Define Boundary_element _XWidth
        tmp1 = self.get_param_KJH4('SRF_InvChain','SRF_Pbody','SRF_PbodyContactPhyLen','BND_Met1Layer')
        self._DesignParameter['BND_Pbody_M1Exten']['_XWidth'] = abs( tmp1[-1][0][0][0][0]['_XY_right'][0]- tmp1[0][0][0][0][0]['_XY_left'][0])
        ...
        ## Define Boundary_element _YWidth
        tmp1 = self.get_param_KJH4('SRF_InvChain', 'SRF_Pbody', 'SRF_PbodyContactPhyLen', 'BND_ODLayer')
        self._DesignParameter['BND_Pbody_RXExten']['_YWidth'] = tmp1[0][0][0][0][0]['_Ywidth']

        ## Define Boundary_element _XWidth
        tmp1 = self.get_param_KJH4('SRF_InvChain', 'SRF_Pbody', 'SRF_PbodyContactPhyLen', 'BND_ODLayer')
        self._DesignParameter['BND_Pbody_RXExten']['_XWidth'] = abs( tmp1[-1][0][0][0][0]['_XY_right'][0] - tmp1[0][0][0][0][0]['_XY_left'][0])
        ...
        ## Define Boundary_element _YWidth
        tmp1 = self.get_param_KJH4('SRF_InvChain','SRF_Pbody','SRF_PbodyContactPhyLen', 'BND_PPLayer')
        self._DesignParameter['BND_Pbody_PPExten']['_YWidth'] = tmp1[0][0][0][0][0]['_Ywidth']

        ## Define Boundary_element _XWidth
        tmp1 = self.get_param_KJH4('SRF_InvChain','SRF_Pbody','SRF_PbodyContactPhyLen', 'BND_PPLayer')
        self._DesignParameter['BND_Pbody_PPExten']['_XWidth'] = abs( tmp1[-1][0][0][0][0]['_XY_right'][0] - tmp1[0][0][0][0][0]['_XY_left'][0])
        ...
        _XYCoordinates=[],
                ...
                ## Define Boundary_element _YWidth
        tmp1 = self.get_param_KJH4('SRF_InvChain','SRF_Nbody','SRF_NbodyContactPhyLen','BND_Met1Layer')
        self._DesignParameter['BND_Nbody_M1Exten']['_YWidth'] = tmp1[0][0][0][0][0]['_Ywidth']

                ## Define Boundary_element _XWidth
        tmp1 = self.get_param_KJH4('SRF_InvChain','SRF_Nbody','SRF_NbodyContactPhyLen','BND_Met1Layer')
        self._DesignParameter['BND_Nbody_M1Exten']['_XWidth'] = abs( tmp1[-1][0][0][0][0]['_XY_right'][0]- tmp1[0][0][0][0][0]['_XY_left'][0])
        ...
        _XYCoordinates=[],
                ...
                ## Define Boundary_element _YWidth
        tmp1 = self.get_param_KJH4('SRF_InvChain','SRF_Nbody','SRF_NbodyContactPhyLen','BND_ODLayer')
        self._DesignParameter['BND_Nbody_RXExten']['_YWidth'] = tmp1[0][0][0][0][0]['_Ywidth']

                ## Define Boundary_element _XWidth
        tmp1 = self.get_param_KJH4('SRF_InvChain','SRF_Nbody','SRF_NbodyContactPhyLen','BND_ODLayer')
        self._DesignParameter['BND_Nbody_RXExten']['_XWidth'] = abs( tmp1[-1][0][0][0][0]['_XY_right'][0]- tmp1[0][0][0][0][0]['_XY_left'][0])
        ...
        _XYCoordinates=[],
                ...
                ## Define Boundary_element _YWidth
        tmp1 = self.get_param_KJH4('SRF_InvChain','SRF_INV0','BND_PMOS_NellExten')
        self._DesignParameter['BND_Nbody_NwellExten']['_YWidth'] = tmp1[0][0][0][0]['_Ywidth']

                ## Define Boundary_element _XWidth
        tmp1 = self.get_param_KJH4('SRF_InvChain','SRF_INV0','BND_PMOS_NellExten')
        tmp2 = self.get_param_KJH4('SRF_InvChain','SRF_INV{}'.format(len(_NumberofGate)-1),'BND_PMOS_NellExten')

        self._DesignParameter['BND_Nbody_NwellExten']['_XWidth'] = abs( tmp2[-1][0][0][0]['_XY_right'][0]- tmp1[0][0][0][0]['_XY_left'][0])
...
if __name__ == '__main__':
    ...
    libname = 'Proj_RcdacSar_J00_CDACPreDriver_InvBuffer_KJH'
    ...
    ## Inverter Chain
        ## Inv1 common
        _NumberofGate   =   [1, 4, 16, 64],  # Vector
        _ChannelLength  =   30,         # Scalar
        _XVT            =   'SLVT',     # 'SLVT'
