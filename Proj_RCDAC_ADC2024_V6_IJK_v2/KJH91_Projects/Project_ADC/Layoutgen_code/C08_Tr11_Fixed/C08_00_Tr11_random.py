...
# TR11
    ...
    _Tr11_XVT				        = 'RVT',    # 'XVT' ex)SLVT/LVT/RVT/HVT
        ...
        _Caculation_Parameters = copy.deepcopy(A14_Mosfet_KJH3_random._Mosfet._ParametersForDesignCalculation)
        ...
        self._DesignParameter['SRF_Pmos'] = self._SrefElementDeclaration(_DesignObj=A14_Mosfet_KJH3_random._Mosfet(_DesignParameter=None, _Name='{}:SRF_Pmos'.format(_Name)))[0]
...
if __name__ == '__main__':
    ...
    for _iter in range(5):
        cellname = 'C08_00_Tr11_v{}'.format(_iter + 1)
    ...
    # TR11
        ...
        _Tr11_ChannelWidth	            = random.randrange(1000, 10000, 1000),     # Number
        _Tr11_ChannelLength	            = 30,       # Number
        _Tr11_XVT				        = 'RVT',    # 'XVT' ex)SLVT/LVT/RVT/HVT
