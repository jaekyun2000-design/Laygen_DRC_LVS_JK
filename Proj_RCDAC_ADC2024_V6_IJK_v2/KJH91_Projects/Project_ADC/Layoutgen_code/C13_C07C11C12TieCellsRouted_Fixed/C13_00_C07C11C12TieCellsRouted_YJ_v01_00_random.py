...
# TR10
    ...
    _Tr10_XVT				        = 'RVT',    # 'XVT' ex)SLVT/LVT/RVT/HVT
        ...
        _Caculation_Parameters = copy.deepcopy(C12_00_Tr1Tr2_Tr5Tr7Tr9_Tr4_Tr8_random._Tr1Tr2_Tr5Tr7Tr9_Tr4_Tr8._ParametersForDesignCalculation)
        ...
        self._DesignParameter['SRF_C12'] = self._SrefElementDeclaration(_DesignObj=C12_00_Tr1Tr2_Tr5Tr7Tr9_Tr4_Tr8_random._Tr1Tr2_Tr5Tr7Tr9_Tr4_Tr8(_DesignParameter=None, _Name='{}:SRF_C12'.format(_Name)))[0]
        ...
        _Caculation_Parameters = copy.deepcopy(C11_00_Tr6Tr11Routed_v02_random._Tr4Tr6Routed._ParametersForDesignCalculation)
        ...
        _Caculation_Parameters['_Tr11_XVT']              = _Tr11_XVT
                ...
                ## Generate Sref: ex)self._DesignParameter['_NMOS_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_nmos_power_v2._NMOS_POWER( _DesignParameter=None, _Name='{}:NMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_C11'] = self._SrefElementDeclaration(_DesignObj=C11_00_Tr6Tr11Routed_v02_random._Tr4Tr6Routed(_DesignParameter=None, _Name='{}:SRF_C11'.format(_Name)))[0]
        ...
        _Caculation_Parameters = copy.deepcopy(C06_00_VddTieCell_random._TieCell4._ParametersForDesignCalculation)
        ...
        ## Generate Sref: ex)self._DesignParameter['_NMOS_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_nmos_power_v2._NMOS_POWER( _DesignParameter=None, _Name='{}:NMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_Tie4'] = self._SrefElementDeclaration(_DesignObj=C06_00_VddTieCell_random._TieCell4(_DesignParameter=None, _Name='{}:SRF_Tie4'.format(_Name)))[0]
        ...
        # ################## 1/13 GR134a_M2 DRC error 인해 vtc_M2를 vtc_M3로 변경
        # # Tie4 Drain <-> Tr4 gate route M3 Vtc Boundary
        # self._DesignParameter['BND_Tie4Tr4Route_Vtc_M3'] = self._BoundaryElementDeclaration(
        #     _Layer=DesignParameters._LayerMapping['METAL3'][0],
        #     _Datatype=DesignParameters._LayerMapping['METAL3'][1],
        #     _XWidth=None,
        #     _YWidth=None,
        ...
        # self._DesignParameter['BND_Tie4Tr4Route_Vtc_M3']['_YWidth'] = abs(tmp1[0][0]['_XY_up_right'][1] - tmp2[0][0][0][0][0][0][0]['_XY_down_right'][1])
        #
        #         ## Define Boundary_element _XWidth
        # Tie4Tr4Route_VtcRoutePathWidth = 300
        # self._DesignParameter['BND_Tie4Tr4Route_Vtc_M3']['_XWidth'] = Tie4Tr4Route_VtcRoutePathWidth
        #
        #             ## Calculate Sref XYcoord
        # tmpXY = []
        #                 ## initialized Sref coordinate
        # self._DesignParameter['BND_Tie4Tr4Route_Vtc_M3']['_XYCoordinates'] = [[0, 0]]
        #
        #                 ## Calculate
        #                     ## Target_coord: _XY_type1
        # target_coord = tmp1[0][0]['_XY_up_right']
        #                     ## Approaching_coord: _XY_type2
        # tmp3 = self.get_param_KJH4('BND_Tie4Tr4Route_Vtc_M3')
        ...
        # tmpXY.append(New_Scoord)
        #                     ## Define coordinates
        # self._DesignParameter['BND_Tie4Tr4Route_Vtc_M3']['_XYCoordinates'] = tmpXY
        #
        #
        # # Viastack (BND_Tie4Tr4Route_Tie4Hrz_M2 <-> BND_Tie4Tr4Route_Vtc_M3)
        ...
        # self._DesignParameter['SRF_Tie4Tr4Route_Tie4Hrz_ViaM2M3'] = self._SrefElementDeclaration(_DesignObj=A02_ViaStack_KJH3._ViaStack(_DesignParameter=None,_Name='{}:SRF_Tie4Tr4Route_Tie4Hrz_ViaM2M3'.format(_Name)))[0]
        #
        # ## Define Sref Relection
        # self._DesignParameter['SRF_Tie4Tr4Route_Tie4Hrz_ViaM2M3']['_Reflect'] = [0, 0, 0]
        #
        # ## Define Sref Angle
        # self._DesignParameter['SRF_Tie4Tr4Route_Tie4Hrz_ViaM2M3']['_Angle'] = 0
        #
        ...
        # self._DesignParameter['SRF_Tie4Tr4Route_Tie4Hrz_ViaM2M3']['_DesignObj']._CalculateDesignParameterYmin(**_Caculation_Parameters)
        #
        # ## Calculate Sref XYcoord
        # tmpXY = []
        # ## initialized Sref coordinate
        # self._DesignParameter['SRF_Tie4Tr4Route_Tie4Hrz_ViaM2M3']['_XYCoordinates'] = [[0, 0]]
        # ## Calculate
        # ## Target_coord
        # tmp1 =self.get_param_KJH4('BND_Tie4Tr4Route_Vtc_M3')
        # target_coord = tmp1[0][0]['_XY_up_right']
        # ## Approaching_coord
        # tmp2 = self.get_param_KJH4('SRF_Tie4Tr4Route_Tie4Hrz_ViaM2M3', 'SRF_ViaM2M3', 'BND_Met3Layer')
        # approaching_coord = tmp2[0][0][0][0]['_XY_up_right']
        # ## Sref coord
        # tmp3 = self.get_param_KJH4('SRF_Tie4Tr4Route_Tie4Hrz_ViaM2M3')
        # Scoord = tmp3[0][0]['_XY_origin']
        # ## Calculate
        # New_Scoord = self.get_Scoord_KJH4(target_coord, approaching_coord, Scoord)
        # tmpXY.append(New_Scoord)
        # ## Define
        # self._DesignParameter['SRF_Tie4Tr4Route_Tie4Hrz_ViaM2M3']['_XYCoordinates'] = tmpXY
        #
        # # Viastack (BND_Tie4Tr4Route_Tie4Hrz_M2 <-> BND_Tie4Tr4Route_Vtc_M3)
        # ## Sref generation: ViaX
        # ## Define ViaX Parameter
        ...
        #
        # ## Sref ViaX declaration
        # self._DesignParameter['SRF_Tie4Tr4Route_Tr4Hrz_ViaM2M3'] = self._SrefElementDeclaration(_DesignObj=A02_ViaStack_KJH3._ViaStack(_DesignParameter=None,_Name='{}:SRF_Tie4Tr4Route_Tr4Hrz_ViaM2M3'.format(_Name)))[0]
        #
        # ## Define Sref Relection
        # self._DesignParameter['SRF_Tie4Tr4Route_Tr4Hrz_ViaM2M3']['_Reflect'] = [0, 0, 0]
        #
        # ## Define Sref Angle
        # self._DesignParameter['SRF_Tie4Tr4Route_Tr4Hrz_ViaM2M3']['_Angle'] = 0
        #
        # ## Define _COX and _COY
        # _Caculation_Parameters['_COX'] = 2
        # _Caculation_Parameters['_COY'] = 1
        #
        # ## Generate Metal(x), Metal(x+1) and C0(Viax) layer:  Option: _CalculateDesignParameter, _CalculateDesignParameterXmin, _CalculateDesignParameterYmin, _CalculateDesignParameterXYsame
        # self._DesignParameter['SRF_Tie4Tr4Route_Tr4Hrz_ViaM2M3']['_DesignObj']._CalculateDesignParameterYmin(**_Caculation_Parameters)
        #
        # ## Calculate Sref XYcoord
        # tmpXY = []
        # ## initialized Sref coordinate
        # self._DesignParameter['SRF_Tie4Tr4Route_Tr4Hrz_ViaM2M3']['_XYCoordinates'] = [[0, 0]]
        # ## Calculate
        # ## Target_coord
        # tmp1 =self.get_param_KJH4('BND_Tie4Tr4Route_Vtc_M3')
        # target_coord = tmp1[0][0]['_XY_down_right']
        # ## Approaching_coord
        # tmp2 = self.get_param_KJH4('SRF_Tie4Tr4Route_Tr4Hrz_ViaM2M3', 'SRF_ViaM2M3', 'BND_Met3Layer')
        # approaching_coord = tmp2[0][0][0][0]['_XY_down_right']
        # ## Sref coord
        # tmp3 = self.get_param_KJH4('SRF_Tie4Tr4Route_Tr4Hrz_ViaM2M3')
        # Scoord = tmp3[0][0]['_XY_origin']
        # ## Calculate
        # New_Scoord = self.get_Scoord_KJH4(target_coord, approaching_coord, Scoord)
        # tmpXY.append(New_Scoord)
        # ## Define
        # self._DesignParameter['SRF_Tie4Tr4Route_Tr4Hrz_ViaM2M3']['_XYCoordinates'] = tmpXY
        ...
        self._DesignParameter['BND_Tie4Tr4Route_Tr4Hrz_M2'] = self._BoundaryElementDeclaration(
            ...
            _XYCoordinates=[],
                ...
                ## Define Boundary_element _YWidth
        tmp1 = self.get_param_KJH4('BND_Tie4Tr4Route_Vtc_M2') # 1/13 변경 for GR134_M2
        tmp2 = self.get_param_KJH4('SRF_C12', 'SRF_C03_02_Pin','SRF_Guardring','SRF_Tr4','SRF_Nmos','BND_Gate_Hrz_Mx')
        ...
        _Caculation_Parameters = copy.deepcopy(C10_00_VddTieCell_random._TieCell8._ParametersForDesignCalculation)
        ...
        ## Generate Sref: ex)self._DesignParameter['_NMOS_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_nmos_power_v2._NMOS_POWER( _DesignParameter=None, _Name='{}:NMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_Tie8'] = self._SrefElementDeclaration(_DesignObj=C10_00_VddTieCell_random._TieCell8(_DesignParameter=None, _Name='{}:SRF_Tie8'.format(_Name)))[0]
        ...
        # ################## 1/13 GR134a_M2 DRC error 인해 vtc_M2를 vtc_M3로 변경
        # # Tie8 Drain <-> Tr8 gate route M3 Vtc Boundary
        # self._DesignParameter['BND_Tie8Tr8Route_Vtc_M3'] = self._BoundaryElementDeclaration(
        #     _Layer=DesignParameters._LayerMapping['METAL3'][0],
        #     _Datatype=DesignParameters._LayerMapping['METAL3'][1],
        #     _XWidth=None,
        #     _YWidth=None,
        ...
        # self._DesignParameter['BND_Tie8Tr8Route_Vtc_M3']['_YWidth'] = abs(tmp1[0][0]['_XY_up_left'][1] - tmp2[0][0][0][0][0][0][0]['_XY_down_left'][1])
        #
        # ## Define Boundary_element _XWidth
        # Tie4Tr4Route_VtcRoutePathWidth = 300
        # self._DesignParameter['BND_Tie8Tr8Route_Vtc_M3']['_XWidth'] = Tie4Tr4Route_VtcRoutePathWidth
        #
        # ## Calculate Sref XYcoord
        # tmpXY = []
        # ## initialized Sref coordinate
        # self._DesignParameter['BND_Tie8Tr8Route_Vtc_M3']['_XYCoordinates'] = [[0, 0]]
        #
        # ## Calculate
        # ## Target_coord: _XY_type1
        # target_coord = tmp1[0][0]['_XY_up_left']
        # ## Approaching_coord: _XY_type2
        # tmp3 = self.get_param_KJH4('BND_Tie8Tr8Route_Vtc_M3')
        ...
        # tmpXY.append(New_Scoord)
        # ## Define coordinates
        # self._DesignParameter['BND_Tie8Tr8Route_Vtc_M3']['_XYCoordinates'] = tmpXY
        #
        # # Viastack (BND_Tie4Tr4Route_Tie4Hrz_M2 <-> BND_Tie4Tr4Route_Vtc_M3)
        # ## Sref generation: ViaX
        # ## Define ViaX Parameter
        ...
        #
        # ## Sref ViaX declaration
        # self._DesignParameter['SRF_Tie8Tr8Route_Tie8Hrz_ViaM2M3'] = self._SrefElementDeclaration(
        #     _DesignObj=A02_ViaStack_KJH3._ViaStack(_DesignParameter=None,
        #                                            _Name='{}:SRF_Tie8Tr8Route_Tie8Hrz_ViaM2M3'.format(_Name)))[0]
        #
        # ## Define Sref Relection
        # self._DesignParameter['SRF_Tie8Tr8Route_Tie8Hrz_ViaM2M3']['_Reflect'] = [0, 0, 0]
        #
        # ## Define Sref Angle
        # self._DesignParameter['SRF_Tie8Tr8Route_Tie8Hrz_ViaM2M3']['_Angle'] = 0
        #
        # ## Define _COX and _COY
        # _Caculation_Parameters['_COX'] = 2
        # _Caculation_Parameters['_COY'] = 1
        #
        # ## Generate Metal(x), Metal(x+1) and C0(Viax) layer:  Option: _CalculateDesignParameter, _CalculateDesignParameterXmin, _CalculateDesignParameterYmin, _CalculateDesignParameterXYsame
        # self._DesignParameter['SRF_Tie8Tr8Route_Tie8Hrz_ViaM2M3']['_DesignObj']._CalculateDesignParameterYmin(
        #     **_Caculation_Parameters)
        #
        # ## Calculate Sref XYcoord
        # tmpXY = []
        # ## initialized Sref coordinate
        # self._DesignParameter['SRF_Tie8Tr8Route_Tie8Hrz_ViaM2M3']['_XYCoordinates'] = [[0, 0]]
        # ## Calculate
        # ## Target_coord
        # tmp1 = self.get_param_KJH4('BND_Tie8Tr8Route_Vtc_M3')
        # target_coord = tmp1[0][0]['_XY_up_right']
        # ## Approaching_coord
        # tmp2 = self.get_param_KJH4('SRF_Tie8Tr8Route_Tie8Hrz_ViaM2M3', 'SRF_ViaM2M3', 'BND_Met3Layer')
        # approaching_coord = tmp2[0][0][0][0]['_XY_up_right']
        # ## Sref coord
        # tmp3 = self.get_param_KJH4('SRF_Tie8Tr8Route_Tie8Hrz_ViaM2M3')
        # Scoord = tmp3[0][0]['_XY_origin']
        # ## Calculate
        # New_Scoord = self.get_Scoord_KJH4(target_coord, approaching_coord, Scoord)
        # tmpXY.append(New_Scoord)
        # ## Define
        # self._DesignParameter['SRF_Tie8Tr8Route_Tie8Hrz_ViaM2M3']['_XYCoordinates'] = tmpXY
        #
        # # Viastack (BND_Tie4Tr4Route_Tie4Hrz_M2 <-> BND_Tie4Tr4Route_Vtc_M3)
        # ## Sref generation: ViaX
        # ## Define ViaX Parameter
        ...
        #
        # ## Sref ViaX declaration
        # self._DesignParameter['SRF_Tie8Tr8Route_Tr8Hrz_ViaM2M3'] = self._SrefElementDeclaration(
        #     _DesignObj=A02_ViaStack_KJH3._ViaStack(_DesignParameter=None,
        #                                            _Name='{}:SRF_Tie8Tr8Route_Tr8Hrz_ViaM2M3'.format(_Name)))[0]
        #
        # ## Define Sref Relection
        # self._DesignParameter['SRF_Tie8Tr8Route_Tr8Hrz_ViaM2M3']['_Reflect'] = [0, 0, 0]
        #
        # ## Define Sref Angle
        # self._DesignParameter['SRF_Tie8Tr8Route_Tr8Hrz_ViaM2M3']['_Angle'] = 0
        #
        # ## Define _COX and _COY
        # _Caculation_Parameters['_COX'] = 2
        # _Caculation_Parameters['_COY'] = 1
        #
        # ## Generate Metal(x), Metal(x+1) and C0(Viax) layer:  Option: _CalculateDesignParameter, _CalculateDesignParameterXmin, _CalculateDesignParameterYmin, _CalculateDesignParameterXYsame
        # self._DesignParameter['SRF_Tie8Tr8Route_Tr8Hrz_ViaM2M3']['_DesignObj']._CalculateDesignParameterYmin(
        #     **_Caculation_Parameters)
        #
        # ## Calculate Sref XYcoord
        # tmpXY = []
        # ## initialized Sref coordinate
        # self._DesignParameter['SRF_Tie8Tr8Route_Tr8Hrz_ViaM2M3']['_XYCoordinates'] = [[0, 0]]
        # ## Calculate
        # ## Target_coord
        # tmp1 = self.get_param_KJH4('BND_Tie8Tr8Route_Vtc_M3')
        # target_coord = tmp1[0][0]['_XY_down_right']
        # ## Approaching_coord
        # tmp2 = self.get_param_KJH4('SRF_Tie8Tr8Route_Tr8Hrz_ViaM2M3', 'SRF_ViaM2M3', 'BND_Met3Layer')
        # approaching_coord = tmp2[0][0][0][0]['_XY_down_right']
        # ## Sref coord
        # tmp3 = self.get_param_KJH4('SRF_Tie8Tr8Route_Tr8Hrz_ViaM2M3')
        # Scoord = tmp3[0][0]['_XY_origin']
        # ## Calculate
        # New_Scoord = self.get_Scoord_KJH4(target_coord, approaching_coord, Scoord)
        # tmpXY.append(New_Scoord)
        # ## Define
        # self._DesignParameter['SRF_Tie8Tr8Route_Tr8Hrz_ViaM2M3']['_XYCoordinates'] = tmpXY
        ...
        self._DesignParameter['BND_Tie8Tr8Route_Tr8Hrz_M2'] = self._BoundaryElementDeclaration(
            ...
            _XYCoordinates=[],
                ...
                ## Define Boundary_element _YWidth
        tmp1 = self.get_param_KJH4('BND_Tie8Tr8Route_Vtc_M2') # 1/13 GR134a_M2 위해 수정
        tmp2 = self.get_param_KJH4('SRF_C12', 'SRF_C05_02_Pin','SRF_Guardring','SRF_Tr8','SRF_Nmos' ,'BND_Gate_Hrz_Mx')
        ...
        _Caculation_Parameters = copy.deepcopy(C07_04_Guardring_random._Guardring._ParametersForDesignCalculation)
        ...
        ## Generate Sref: ex)self._DesignParameter['_NMOS_POWER'] = self._SrefElementDeclaration(_DesignObj=B16_nmos_power_v2._NMOS_POWER( _DesignParameter=None, _Name='{}:NMOS_POWER'.format(_Name)))[0]
        self._DesignParameter['SRF_C07'] = self._SrefElementDeclaration(_DesignObj=C07_04_Guardring_random._Guardring(_DesignParameter=None, _Name='{}:SRF_C07'.format(_Name)))[0]
...
if __name__ == '__main__':
    ...
    cellname = 'C13_00_C07C11C12TieCellsRouted_v3'
