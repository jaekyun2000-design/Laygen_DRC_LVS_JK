...
class _MainWindow(QMainWindow):
    ...
    def initUI(self):
        ...
        self.dockContentWidget3_2.send_SendCopyConstraint_signal.connect(self.design_delegator.copy_qt_constraint)
        ...
        self.dockContentWidget3.send_SendCopyConstraint_signal.connect(self.design_delegator.copy_qt_constraint)
        ...
        self.calculator_window.send_variable_wo_post_ast.connect(lambda target_ast:
    ...
    def create_generator_file(self):
        ...
        cal_code = f"\ndrc = DRC.DRC()\n" \
                   f"_Name = self._DesignParameter['_Name']['_Name']\n" \
                   f"{cal_code}"
    ...
    def get_hierarchy_return_layer(self, hierarchy_list):
        ...
        if len(hierarchy_list) == 0:
            ...
            if '_Layer' not in module[hierarchy_list[0]]._DesignParameter:
                return
